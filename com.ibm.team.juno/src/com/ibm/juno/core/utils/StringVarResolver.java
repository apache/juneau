...
public class StringVarResolver {
	...
	public static final StringVarResolver DEFAULT = new StringVarResolver()
		.addVar("S", StringVars.SYSTEM_PROPERTIES_VAR)
		.addVar("E", StringVars.ENV_VARIABLES_VAR);
	...
	/**
	 * Adds a parent var resolver to this var resolver.
	 *
	 * @param parent - The new parent object.
	 * @param replaceExisting - If <jk>true</jk>, then the existing parent (if there is one)
	 * 	will be replaced with the new one.  Otherwise, we'll recursively call this method
	 * 	to set it as the parent on the current top-level parent.
	 * @return This object (for method chaining).
	 */
	public StringVarResolver setParent(StringVarResolver parent, boolean replaceExisting) {
		if (this.parent == null || replaceExisting)
			this.parent = parent;
		else
