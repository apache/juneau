...
public abstract class ConfigFile implements Map<String,Section> {
	...
	private volatile StringVar stringVar;
	 ...
	 * 	have their values first resolved by the specified {@link StringVarResolver}.
	 * <p>
	 * @param vr The variable resolver for resolving string variables.
	 * @param augment - If <jk>false</jk>, the specified var resolver replaces the
	 * 	existing var resolver.  If <jk>true</jk>, then if the config file has an
	 * 	associated var resolver with it, that var resolver will be added as a parent
	 * 	to the specified var resolver.  By specifying <jk>true</jk>, you can inherit
	 * 	the functionality of the previous resolver, but augument it with new
	 * 	variables or override the behavior on previous variables.
	 * @return This config file wrapped in an instance of {@link ConfigFileWrapped}.
	 */
	public abstract ConfigFile getResolving(StringVarResolver vr, boolean augment);
	...
	/**
	 * Create an instance of a {@link StringVarWithDefault} that returns values in this config file.
	 *
				...
				if (stringVar == null) {
					stringVar = new StringVarWithDefault() {
						...
						public String resolve(String varVal) {
							return ConfigFile.this.getString(varVal);
						}
					};
				}
			}
