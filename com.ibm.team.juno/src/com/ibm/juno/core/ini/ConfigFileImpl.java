...
public final class ConfigFileImpl extends ConfigFile {
	...
	public ConfigFile getResolving(StringVarResolver vr) {
		return getResolving(vr, false);
	}

	@Override /* ConfigFile */
	public ConfigFile getResolving(StringVarResolver vr, boolean augment) {
	...
	public ConfigFile getResolving() {
		return getResolving(new StringVarResolver(StringVarResolver.DEFAULT).addVar("C", getStringVar()));
	}
