 ...
 *
 * <p>
 * The MCP {@code 2026-07-28} authorization spec requires clients support BOTH discovery mechanisms.  {@link #discover()}
 * therefore tries {@code AuthorizationServerMetadata.resolve(...)} (RFC 8414) first and falls back to
 ...
 *
 * <p>
 * The full SEP-2351 path-insertion well-known-URI construction (path-bearing issuers, ordered fallbacks) is deferred to
 * F3; this class implements the two-endpoint (RFC 8414 &rarr; OIDC) fallback required by the baseline.
 *
