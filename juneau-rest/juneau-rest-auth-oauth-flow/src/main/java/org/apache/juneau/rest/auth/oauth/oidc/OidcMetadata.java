...
public record OidcMetadata(
	...
	/**
	 * Returns whether the authorization server advertises {@code authorization_response_iss_parameter_supported}
	 * (RFC 9207).
	 *
	 * <p>
	...
	public boolean authorizationResponseIssParameterSupported() {
		return Boolean.TRUE.equals(extras.get("authorization_response_iss_parameter_supported"));
	}
}
