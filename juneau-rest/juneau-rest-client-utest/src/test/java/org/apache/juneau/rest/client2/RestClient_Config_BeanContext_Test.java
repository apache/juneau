...
public class RestClient_Config_BeanContext_Test {
	...
	public void a02_beanConstructorVisibility() throws Exception {
		RestResponse x = client(A2b.class).beanConstructorVisibility(Visibility.PROTECTED).build().post("/test",new A2a(1)).header("X",new A2a(1)).run().cacheBody().assertBody().is("1").assertHeader("X").is("1");
	...
	public void a03_beanFieldVisibility() throws Exception {
		RestResponse x = client(A2b.class).beanFieldVisibility(Visibility.PROTECTED).build().post("/test",A3.get()).header("X",A3.get()).run().cacheBody().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
	...
	public void a04_beanFilters() throws Exception {
		RestResponse x = client(A2b.class).bpi(A4b.class,"f1").build().post("/test",A4b.get()).header("X",A4b.get()).run().cacheBody().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
		assertEquals(0,x.getBody().as(A4b.class).f2);
		assertEquals(0,x.getHeader("X").as(A4b.class).f2);

		x = client(A2b.class).bpi(A4b.class,"f1").build().post("/test",A4b.get()).header("X",A4b.get()).run().cacheBody().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
		assertEquals(0,x.getBody().as(A4b.class).f2);
		assertEquals(0,x.getHeader("X").as(A4b.class).f2);
		...
		x = client(A2b.class).interfaces(A4a.class).build().post("/test",A4b.get()).header("X",A4b.get()).run().cacheBody().assertBody().is("{f3:3}").assertHeader("X").is("f3=3");
	...
	public void a05_beanMethodVisibility() throws Exception {
		RestResponse x = client(A2b.class).beanMethodVisibility(Visibility.PROTECTED).build().post("/test",A5.get()).header("X",A5.get()).run().cacheBody().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
	...
	public void a07_beansRequireDefaultConstructor() throws Exception {
		client(A2b.class).build().post("/test",new A7("1")).header("X",new A7("1")).run().assertBody().is("{f1:'1'}").assertHeader("X").is("f1=1");
		client(A2b.class).beansRequireDefaultConstructor().build().post("/test",new A7("1")).header("X",new A7("1")).run().assertBody().is("'1'").assertHeader("X").is("1");
	}

	@Test
	public void a08_beansRequireSerializable() throws Exception {
		client(A2b.class).build().post("/test",new A7("1")).header("X",new A7("1")).run().assertBody().is("{f1:'1'}").assertHeader("X").is("f1=1");
		client(A2b.class).beansRequireSerializable().build().post("/test",new A7("1")).header("X",new A7("1")).run().assertBody().is("'1'").assertHeader("X").is("1");
	}
	...
	public void a09_beansRequireSettersForGetters() throws Exception {
		client(A2b.class).build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
		client(A2b.class).beansRequireSettersForGetters().build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
	}

	@Test
	public void a10_bpi() throws Exception {
		client(A2b.class).bpi(OMap.of("A9","f2")).build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpi(A9.class,"f2").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpi("A9","f2").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpi(A9.class.getName(),"f2").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
	}
	...
	public void a11_bpro() throws Exception {
		...
		x = client(A2b.class).bpro(OMap.of("09","f2")).build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());

		x = client(A2b.class).bpro(A9.class,"f2").build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());

		x = client(A2b.class).bpro("O9","f2").build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1,f2:2}").assertHeader("X").is("f1=1,f2=2");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());
	}
	...
	public void a12_bpwo() throws Exception {
		...
		x = client(A2b.class).bpwo(OMap.of("A9","f2")).build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());

		x = client(A2b.class).bpwo(A9.class,"f2").build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());

		x = client(A2b.class).bpwo("A9","f2").build().post("/test",A9.get()).header("X",A9.get()).run().cacheBody().assertBody().is("{f1:1}").assertHeader("X").is("f1=1");
		assertEquals("1/0",x.getBody().as(A9.class).toString());
		assertEquals("1/0",x.getHeader("X").as(A9.class).toString());
	}
	...
	public void a13_bpx() throws Exception {
		client(A2b.class).bpx(OMap.of("A9","f1")).build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpx(A9.class,"f1").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpx("A9","f1").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
		client(A2b.class).bpx(A9.class.getName(),"f1").build().post("/test",A9.get()).header("X",A9.get()).run().assertBody().is("{f2:2}").assertHeader("X").is("f2=2");
	}
