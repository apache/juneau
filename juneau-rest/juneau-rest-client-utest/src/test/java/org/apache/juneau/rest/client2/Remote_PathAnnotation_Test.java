...
public class Remote_PathAnnotation_Test {
	...
	public void a01_path_objectTypes() throws Exception {
		...
		assertEquals("bar", x.getX18(BasicNameValuePair.of("x", "bar")));
		assertEquals("bar", x.getX19(BasicNameValuePair.of("x", "bar")));
		assertEquals("bar", x.getX20(new NameValuePair[]{BasicNameValuePair.of("x", "bar")}));
