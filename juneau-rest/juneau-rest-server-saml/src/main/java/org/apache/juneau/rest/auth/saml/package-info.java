 ...
 * {@link org.apache.juneau.rest.auth.AuthFilter AuthFilter} framework.
 *
 * <p>
 ...
 * <ul>
 * 	<li class='jc'>{@link org.apache.juneau.rest.auth.saml.SamlAssertionValidator}
 * 		&mdash; validates a {@code <samlp:Response>} XML document and returns a
 * 		{@link org.apache.juneau.rest.auth.ClaimsPrincipal} marked with {@code issuerType=SAML}.
 * 	<li class='jc'>{@link org.apache.juneau.rest.auth.saml.SamlAuthFilter}
 * 		&mdash; servlet filter that recognizes SAML responses delivered via HTTP POST or HTTP Redirect.
 * 	<li class='jc'>{@link org.apache.juneau.rest.auth.saml.SamlBinding}
 * 		&mdash; enum identifying the SAML 2.0 transport binding the filter expects.
 * 	<li class='jc'>{@link org.apache.juneau.rest.auth.saml.SamlMetadataResolvers}
 ...
 * 		{@link org.apache.juneau.rest.auth.saml.SamlAssertionValidator.Builder#decryptionCredential(org.opensaml.security.credential.Credential) decryptionCredential}.
 * </ul>
 *
