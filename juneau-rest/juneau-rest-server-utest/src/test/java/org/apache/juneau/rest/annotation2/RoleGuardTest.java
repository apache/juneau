...
public class RoleGuardTest {
	...
	public void c02h_andPatternsWithSingleAmp_fail() throws Exception {
		// @RestMethod(roleGuard="fo* & *ar")
		c2d.get().roles().run().assertStatus().equals(403);
		c2d.get().roles("foo").run().assertStatus().equals(403);
		c2d.get().roles("bar").run().assertStatus().equals(403);
		c2d.get().roles("baz").run().assertStatus().equals(403);
	}

	@Test
	public void c02i_andPatternsWithDoubleAmp_pass() throws Exception {
		// @RestMethod(roleGuard="fo* && *ar")
		c2e.get().roles("foo","bar").run().assertStatus().equals(200);
		c2e.get().roles("foo","bar","baz").run().assertStatus().equals(200);
	}

	@Test
	public void c02j_andPatternsWithDoubleAmp_fail() throws Exception {
		// @RestMethod(roleGuard="fo* && *ar")
		c2e.get().roles().run().assertStatus().equals(403);
		c2e.get().roles("foo").run().assertStatus().equals(403);
		c2e.get().roles("bar").run().assertStatus().equals(403);
		c2e.get().roles("baz").run().assertStatus().equals(403);
	}

	@Test
	public void c02k_andPatternsWithDoubleAmpAndParens_pass() throws Exception {
		// @RestMethod(roleGuard="(fo*) && (*ar)")
		c2f.get().roles("foo","bar").run().assertStatus().equals(200);
		c2f.get().roles("foo","bar","baz").run().assertStatus().equals(200);
	}

	@Test
	public void c02l_andPatternsWithDoubleAmpAndParens_fail() throws Exception {
		// @RestMethod(roleGuard="(fo*) && (*ar)")
		c2f.get().roles().run().assertStatus().equals(403);
		c2f.get().roles("foo").run().assertStatus().equals(403);
		c2f.get().roles("bar").run().assertStatus().equals(403);
		c2f.get().roles("baz").run().assertStatus().equals(403);
	}

	@Test
	public void c02m_complexPatterns_pass() throws Exception {
		// @RestMethod(roleGuard="fo* && (*ar || *az)")
		c2g.get().roles("foo","bar").run().assertStatus().equals(200);
		c2g.get().roles("foo","baz").run().assertStatus().equals(200);
		c2g.get().roles("foo","bar","baz").run().assertStatus().equals(200);
	}

	@Test
	public void c02n_complexPatterns_fail() throws Exception {
		// @RestMethod(roleGuard="fo* && (*ar || *az)")
		c2g.get().roles().run().assertStatus().equals(403);
		c2g.get().roles("foo").run().assertStatus().equals(403);
		c2g.get().roles("bar","baz").run().assertStatus().equals(403);
		c2g.get().roles("baz").run().assertStatus().equals(403);
	}

	@Test
	public void c02o_complexPatterns_pass() throws Exception {
		// @RestMethod(roleGuard="fo* || (*ar && *az)")
		c2h.get().roles("foo").run().assertStatus().equals(200);
		c2h.get().roles("bar","baz").run().assertStatus().equals(200);
		c2h.get().roles("foo","bar","baz").run().assertStatus().equals(200);
	}

	@Test
	public void c02p_complexPatterns_fail() throws Exception {
		// @RestMethod(roleGuard="fo* || (*ar && *az)")
		c2h.get().roles().run().assertStatus().equals(403);
		c2h.get().roles("bar").run().assertStatus().equals(403);
		c2h.get().roles("baz").run().assertStatus().equals(403);
	}
	...
	public void d01_patternsWithoutRoles_fail() throws Exception {
		...
		d.get().roles().run().assertStatus().equals(403);
		d.get().roles("foo").run().assertStatus().equals(403);
		d.get().roles("bar").run().assertStatus().equals(403);
		d.get().roles("baz").run().assertStatus().equals(403);
		d.get().roles("foo","bar").run().assertStatus().equals(403);
	}
	...
	public void e01_anyRole_pass() throws Exception {
		// @RestMethod(roleGuard="*")
		e.get().roles("foo").run().assertStatus().equals(200);
		e.get().roles("bar").run().assertStatus().equals(200);
		e.get().roles("baz").run().assertStatus().equals(200);
		e.get().roles("foo","bar").run().assertStatus().equals(200);
	}

	@Test
	public void e02_anyRole_fail() throws Exception {
		// @RestMethod(roleGuard="*")
		e.get().roles().run().assertStatus().equals(403);
	}
}
