...
public class RestBuilder_Test {
	...
	private static final String CNAME = RestBuilder_Test.class.getName();

	//------------------------------------------------------------------------------------------------------------------
	// Basic tests
	//------------------------------------------------------------------------------------------------------------------

	Rest a1 = RestBuilder.create()
		...
		.children(RestBuilder_Test.class)
		...
		.mimeTypes("mimeTypes")
		.on("on")
		.onClass(RestBuilder_Test.class)
		...
		.swagger(ResourceSwaggerBuilder.DEFAULT)
		.title("title")
	...
	public void c01_otherMethods() throws Exception {
		Rest c1 = RestBuilder.create(C1.class).on(C2.class).build();
		Rest c2 = RestBuilder.create("a").on("b").build();
