...
public class RestHookBuilder_Test {

	private static final String CNAME = RestHookBuilder_Test.class.getName();

	//------------------------------------------------------------------------------------------------------------------
	// Basic tests
	//------------------------------------------------------------------------------------------------------------------

	RestHook a1 = RestHookBuilder.create()
		.on("a")
		.value(HookEvent.INIT)
		.build();

	RestHook a2 = RestHookBuilder.create()
		.on("a")
		.value(HookEvent.INIT)
		.build();
	...
	public void c01_otherMethods() throws Exception {
		RestHook c4 = RestHookBuilder.create().on(C1.class.getMethod("m1")).on(C2.class.getMethod("m2")).build();
