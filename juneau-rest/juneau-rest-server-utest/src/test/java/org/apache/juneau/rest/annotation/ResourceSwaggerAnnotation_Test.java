...
public class ResourceSwaggerAnnotation_Test {

	//------------------------------------------------------------------------------------------------------------------
	// Basic tests
	//------------------------------------------------------------------------------------------------------------------

	ResourceSwagger a1 = ResourceSwaggerAnnotation.create()
	...
	ResourceSwagger a2 = ResourceSwaggerAnnotation.create()
		.contact(ContactAnnotation.DEFAULT)
		.description("description")
		.externalDocs(ExternalDocsAnnotation.DEFAULT)
		.license(LicenseAnnotation.DEFAULT)
	...
	ResourceSwagger d1 = D1.class.getAnnotationsByType(ResourceSwagger.class)[0];
	...
	ResourceSwagger d2 = D2.class.getAnnotationsByType(ResourceSwagger.class)[0];
