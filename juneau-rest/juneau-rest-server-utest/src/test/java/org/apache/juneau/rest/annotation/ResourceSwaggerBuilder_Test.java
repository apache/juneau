...
public class ResourceSwaggerBuilder_Test {

	//------------------------------------------------------------------------------------------------------------------
	// Basic tests
	//------------------------------------------------------------------------------------------------------------------

	ResourceSwagger a1 = ResourceSwaggerBuilder.create()
		.contact(ContactBuilder.DEFAULT)
		.description("description")
		.externalDocs(ExternalDocsBuilder.DEFAULT)
		.license(LicenseBuilder.DEFAULT)
	...
	ResourceSwagger a2 = ResourceSwaggerBuilder.create()
		.contact(ContactBuilder.DEFAULT)
		.description("description")
		.externalDocs(ExternalDocsBuilder.DEFAULT)
		.license(LicenseBuilder.DEFAULT)
