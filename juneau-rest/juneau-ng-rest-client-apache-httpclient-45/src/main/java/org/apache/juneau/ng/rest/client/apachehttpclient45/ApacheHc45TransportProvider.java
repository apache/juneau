...
/**
 * {@link HttpTransportProvider} implementation that supplies an {@link ApacheHc45Transport}.
 *
 * <p>
 * Registered via {@code META-INF/services/org.apache.juneau.ng.rest.client.HttpTransportProvider} so that
 * {@code NgRestClient} can auto-discover Apache HttpClient 4.5 when this module is on the classpath.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public final class ApacheHc45TransportProvider implements HttpTransportProvider {
