...
/**
 * Convenience base class exposing a {@code 2025-06-18} MCP endpoint on a Spring Boot resource with full
 ...
 * (the {@code 2025-06-18} MCP handler). This is the recommended way to expose MCP from a Spring Boot
