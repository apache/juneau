...
class LoopDetected_Test extends TestBase {
	...
	public static class A {
		...
		public void f5() throws LoopDetected {
			throw loopDetected().setHeader2("Foo", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new LoopDetected((Throwable)null);
		assertEquals(LoopDetected.REASON_PHRASE, x.getMessage());
	}
}