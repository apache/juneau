...
@SuppressWarnings({
	...
	"javadoc"    // {@link BctAssertions}, {@link BeanConverter}, {@link BasicBeanConverter} references not resolvable in this module
})
public class TestUtils extends Utils {
	...
	@SuppressWarnings("unused") // expectedType kept for caller-site type documentation; only the message substring is checked at runtime
	...
	public static Swagger getSwagger(Class<?> c) {
		try {
			...
			var rc = new RestContext(new RestContext.Args(r.getClass(), null, null, () -> r, "", null, null, null, false));
