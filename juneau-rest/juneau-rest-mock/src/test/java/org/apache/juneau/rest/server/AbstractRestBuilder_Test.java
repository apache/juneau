 ...
 */
// REST op method parameters are required by the framework dispatch signature even when not referenced in the body.
...
class AbstractRestBuilder_Test extends TestBase {
	...
	@Test void g04_swaggerProvider() {
		var b = b().swaggerProvider(org.apache.juneau.rest.server.swagger.BasicSwaggerProvider.class);
		assertEquals(org.apache.juneau.rest.server.swagger.BasicSwaggerProvider.class, b.toRestAnnotation().swaggerProvider());
	}

	@Test void g05_openApiProvider() {
		var b = b().openApiProvider(org.apache.juneau.rest.server.openapi.BasicOpenApiProvider.class);
		assertEquals(org.apache.juneau.rest.server.openapi.BasicOpenApiProvider.class, b.toRestAnnotation().openApiProvider());
	}
	...
	@Test void g08_staticFiles() {
		var b = b().staticFiles(org.apache.juneau.rest.server.staticfile.BasicStaticFiles.class);
		assertEquals(org.apache.juneau.rest.server.staticfile.BasicStaticFiles.class, b.toRestAnnotation().staticFiles());
	}
