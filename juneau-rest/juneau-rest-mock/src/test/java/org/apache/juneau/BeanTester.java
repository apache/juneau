...
@SuppressWarnings({
	...
	"javadoc",   // {@link BctAssertions} references not resolvable in this module's classpath
	"unused"     // jsonRoundTrip is a private utility method retained for completeness
})
