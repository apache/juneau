...
class Origin_Test extends TestBase {
	...
	@Test void a01_basic() throws Exception {
		...
		c.get().header(origin((Supplier<String>)null)).run().assertContent().isEmpty();
		c.get().header(origin(()->null)).run().assertContent().isEmpty();
	}
