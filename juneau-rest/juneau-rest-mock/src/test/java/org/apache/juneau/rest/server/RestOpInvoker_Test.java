...
class RestOpInvoker_Test extends TestBase {
	...
	public static class FailingArg implements org.apache.juneau.rest.server.arg.RestOpArg {
	...
	public static class HttpFailingArg implements org.apache.juneau.rest.server.arg.RestOpArg {
	...
	@Test void k01_threeArgConstructor_isUsable() throws Exception {
		...
		var invoker = new RestOpInvoker(m, new org.apache.juneau.rest.server.arg.RestOpArg[0], stats);
