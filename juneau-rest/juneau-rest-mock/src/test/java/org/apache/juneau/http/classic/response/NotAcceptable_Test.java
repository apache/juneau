...
class NotAcceptable_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws NotAcceptable {
	...
	@Test void a02_nullCause() {
		var x = new NotAcceptable((Throwable)null);
		assertEquals(NotAcceptable.REASON_PHRASE, x.getMessage());
	}
}