...
class Forbidden_Test extends TestBase {
	...
	public static class A {
		@RestGet
		public void f1() throws Forbidden {
			throw new Forbidden();
		}
		@RestGet
		public void f2() throws Forbidden {
			throw new Forbidden("foo {0}", "bar");
		}
		@RestGet
		public void f3() throws Forbidden {
			throw new Forbidden(new RuntimeException("baz"));
		}
		@RestGet
		public void f4() throws Forbidden {
	...
	@Test void a02_nullCause() {
		var x = new Forbidden((Throwable)null);
		assertEquals(Forbidden.REASON_PHRASE, x.getMessage());
	}
}