...
@SuppressWarnings({
	"unused",   // req/accept parameters kept for consistent @RestPostCall method signatures
	"resource"  // MockRestClient and response objects in tests are intentionally unassigned/unclosed
})
