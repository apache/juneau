...
public class RestOpContext extends Context implements Comparable<RestOpContext> {
	 ...
	 * at least one real backend ({@link org.apache.juneau.rest.server.metrics.MetricsRecorder} or
	 * {@link org.apache.juneau.rest.server.tracing.TracerHook}) is registered.
	 *
	 * <p>
	...
	private void checkOpObservabilityBackendPresent() {
		...
		var tracer = bs.getBean(org.apache.juneau.rest.server.tracing.TracerHook.class).orElse(null);
		boolean hasRecorder = recorder != null && !(recorder instanceof org.apache.juneau.rest.server.metrics.NoOpMetricsRecorder);
		boolean hasTracer = tracer != null && !(tracer instanceof org.apache.juneau.rest.server.tracing.NoOpTracerHook);
	 ...
	 * falls back to {@link org.apache.juneau.rest.server.metrics.NoOpMetricsRecorder} when no backend is wired.
	 ...
	 * {@link org.apache.juneau.rest.server.processor.AsyncResponseProcessor}.
	 *
