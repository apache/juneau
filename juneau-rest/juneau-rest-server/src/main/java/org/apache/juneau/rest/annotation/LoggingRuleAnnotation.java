...
/**
 * Utility classes and methods for the {@link LoggingRule @LoggingRule} annotation.
 */
public class LoggingRuleAnnotation {
	...
	public static class Builder extends AnnotationBuilder {
		 ...
		 * @return This object (for method chaining).
		 */
		public Builder debugOnly(String value) {
		 ...
		 * @return This object (for method chaining).
		 */
		public Builder req(String value) {
			this.req = value;
			return this;
		}
		 ...
		 * @return This object (for method chaining).
		 */
		public Builder res(String value) {
			this.res = value;
			return this;
		}
		 ...
		 * @return This object (for method chaining).
		 */
		public Builder verbose(String value) {
			this.verbose = value;
			return this;
		}
