...
public final class RestServerConstants {
	 ...
	 * default 30-second timeout applied by {@link org.apache.juneau.rest.server.processor.AsyncResponseProcessor} to
	 ...
	 * {@code org.apache.juneau.rest.server.filter.RequestIdFilter} is stashed.
	 *
	 * <p>
	 ...
	 * is stashed by {@code org.apache.juneau.rest.server.auth.BearerTokenGuard} /
	 * {@code org.apache.juneau.rest.server.auth.ApiKeyGuard} and resolved by
	 * {@code org.apache.juneau.rest.server.auth.AuthArg} for {@code @Auth Principal} parameters.
	 *
	 * <p>
	...
	/**
	 * Default header name read by {@code org.apache.juneau.rest.server.auth.ApiKeyGuard} when configured
	 * with the {@link org.apache.juneau.rest.server.auth.ApiKeyGuard.Source#HEADER HEADER} source and no
