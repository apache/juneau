...
/**
 * Standalone servlet companion of the {@link BasicAdminResource} mixin.
 *
 * <p>
 ...
 * mixin by delegating to a shared {@link BasicAdminResource} instance &mdash; so the two forms
 * cannot drift.
 *
 * <p>
 * Whereas the {@link BasicAdminResource} mixin pins its ops at {@code /admin/<endpoint>} for
 ...
 * 		<jk>return new</jk> BasicAdminServlet();  <jc>// auto-mounted at /admin/* by JettyServerComponent</jc>
 * 	}
 * </p>
 *
...
public class BasicAdminServlet extends RestServlet {

	private static final long serialVersionUID = 1L;

	private final transient BasicAdminResource delegate;

	/** No-arg constructor &mdash; uses a default {@link BasicAdminResource} delegate. */
	public BasicAdminServlet() {
		this(new BasicAdminResource());
	}
	 ...
	 */
	protected BasicAdminServlet(BasicAdminResource delegate) {
