...
public class RestPostAnnotation {
	...
	public static class Builder extends AnnotationObject.Builder {
		...
		/**
		 * Sets the {@link RestPost#observability()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#asyncCompletionExecutor()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#metricName()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#metricTags()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#allowedSerializerOptions()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#allowedParserOptions()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPost#noInherit()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
	...
	private static class Object extends AnnotationObject implements RestPost {
