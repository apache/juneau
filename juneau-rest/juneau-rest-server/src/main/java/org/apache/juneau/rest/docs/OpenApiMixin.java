 ...
 * {@link SwaggerUiMixin} (HTML-first mount at {@code /swagger}), and {@link RedocMixin}
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/myresource"</js>, mixins=OpenApiMixin.<jk>class</jk>)
