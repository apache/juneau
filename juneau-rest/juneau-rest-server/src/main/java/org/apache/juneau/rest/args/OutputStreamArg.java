...
public class OutputStreamArg extends SimpleRestOperationArg {
	 ...
	 * @return A new {@link OutputStreamArg}, or <jk>null</jk> if the parameter type is not {@link OutputStream}.
	 */
	public static OutputStreamArg create(ParamInfo paramInfo) {
		if (paramInfo.isType(OutputStream.class))
			return new OutputStreamArg();
		return null;
	}
