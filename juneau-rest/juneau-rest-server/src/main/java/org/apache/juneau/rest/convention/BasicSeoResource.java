 ...
 * {@link BasicVersionResource} ({@code /version} / {@code /info} / {@code /about}), and
 * {@link BasicWellKnownResource} ({@code /.well-known/*}). All four classes live in the
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/api"</js>, mixins=BasicSeoResource.<jk>class</jk>)
...
public class BasicSeoResource {
	...
	public static class Builder {
		...
		/** Constructor &mdash; package access for {@link BasicSeoResource#create()}. */
		protected Builder() {}
