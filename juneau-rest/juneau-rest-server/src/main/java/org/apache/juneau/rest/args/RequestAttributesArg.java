...
public class RequestAttributesArg extends SimpleRestOperationArg {
	 ...
	 * @return A new {@link RequestAttributesArg}, or <jk>null</jk> if the parameter type is not {@link RequestAttributes}.
	 */
	public static RequestAttributesArg create(ParamInfo paramInfo) {
		if (paramInfo.isType(RequestAttributes.class))
			return new RequestAttributesArg();
		return null;
	}
