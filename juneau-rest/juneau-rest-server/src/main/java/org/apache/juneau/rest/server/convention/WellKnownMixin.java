 ...
 * {@link VersionMixin}. All four classes live in the
 ...
 * {@link Rest#mixins() @Rest(mixins=WellKnownMixin.class)}; the
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/api"</js>, mixins=WellKnownMixin.<jk>class</jk>)
...
public class WellKnownMixin extends RestMixin {
	 ...
	 *
	 * <p>
	 * Extends {@link org.apache.juneau.rest.server.servlet.RestMixin.Builder} so the mixin's bespoke {@link #securityTxt(String)}
	...
	public static class Builder extends RestMixin.Builder<WellKnownMixin, Builder> {
		...
		/**
		 * Builds a {@link WellKnownMixin} instance.
		 *
