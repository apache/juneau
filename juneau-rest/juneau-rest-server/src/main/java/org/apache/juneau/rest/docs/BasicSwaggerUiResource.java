 ...
 * {@link BasicOpenApiResource} (OpenAPI 3.1 spec at {@code /openapi*}), and
 * {@link BasicRedocResource} (HTML-first mount at {@code /redoc}). All four classes live in the
 * {@code org.apache.juneau.rest.docs} api-docs mixin pack.
 *
 * <p>
 * Declares {@link Rest#mixins() @Rest(mixins={BasicSwaggerResource.class})} so transitive resolution
 * pulls in {@code BasicSwaggerResource} (and its {@code /api} mount) automatically when this mixin
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/myresource"</js>, mixins=BasicSwaggerUiResource.<jk>class</jk>)
 ...
 * 	<li class='jc'>{@link BasicOpenApiResource}
...
public class BasicSwaggerUiResource {
