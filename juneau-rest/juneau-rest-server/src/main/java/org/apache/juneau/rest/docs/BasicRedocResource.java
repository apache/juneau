 ...
 * {@link BasicSwaggerUiResource} (HTML-first mount at {@code /swagger}), and {@link BasicOpenApiResource}
 * (OpenAPI 3.1 spec at {@code /openapi*}). All four classes live in the
 * {@code org.apache.juneau.rest.docs} api-docs mixin pack.
 *
 * <p>
 * Declares {@link Rest#mixins() @Rest(mixins={BasicOpenApiResource.class})} so transitive resolution
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/myresource"</js>, mixins=BasicRedocResource.<jk>class</jk>)
...
public class BasicRedocResource {
