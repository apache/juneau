 ...
 *
 * <p>
 * Sibling of {@link BasicSwaggerUiResource} (HTML-first mount at {@code /swagger}),
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/myresource"</js>, mixins=BasicSwaggerResource.<jk>class</jk>)
...
public class BasicSwaggerResource {
