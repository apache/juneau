...
public abstract class RemoteableServlet extends BasicRestServlet {
	...
	private static final long serialVersionUID = 8207041758485477718L;
	...
	private boolean useOnlyAnnotated() {
		return getContext().getBooleanProperty(RemoteableServiceProperties.REMOTEABLE_includeOnlyRemotableMethods, false);
	}
