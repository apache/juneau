...
public class BasicStaticFiles implements StaticFiles {
	 ...
	 */
	public static StaticFiles.Builder create(WritableBeanStore beanStore) {
	...
	public boolean equals(Object o) {
		return this == o || (o instanceof BasicStaticFiles other && eq(this, other, (x, y) -> Arrays.equals(x.headers, y.headers)));
	}
