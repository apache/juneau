 ...
 *
 * <p>
 * Returned by {@link TracerHook#startSpan(org.apache.juneau.rest.server.RestRequest)}. The framework drives
 ...
 * bridge in {@code juneau-rest-server-tracing-otel}, for example, wraps an
