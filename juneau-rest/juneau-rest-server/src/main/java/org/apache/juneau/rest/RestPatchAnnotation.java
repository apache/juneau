...
public class RestPatchAnnotation {
	...
	public static class Builder extends AnnotationObject.Builder {
		...
		/**
		 * Sets the {@link RestPatch#problemDetails()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPatch#allowedSerializerOptions()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPatch#allowedParserOptions()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPatch#noInherit()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
