 ...
 * {@link BasicRouteIndexResource} ({@code /options} / {@code /routes}). All three classes live in
 ...
 *
 * <p class='bjava'>
 * 	<ja>@Rest</ja>(path=<js>"/api"</js>, mixins=BasicAdminResource.<jk>class</jk>)
...
public class BasicAdminResource {
	...
	public static class Builder {
		...
		/** Constructor &mdash; package access for {@link BasicAdminResource#create()}. */
		protected Builder() {}
