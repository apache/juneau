 ...
 * <p>
 * <ul class='javatree'>
 * 	<li class='jc'>{@link FluentRequestHeaderAssertion}
 * 	<ul class='javatreec'>
 * 		<li class='jm'>{@link FluentRequestHeaderAssertion#asBoolean() asBoolean()}
 * 		<li class='jm'>{@link FluentRequestHeaderAssertion#asInteger() asInteger()}
 * 		<li class='jm'>{@link FluentRequestHeaderAssertion#asLong() asLong()}
 * 		<li class='jm'>{@link FluentRequestHeaderAssertion#asZonedDateTime() asZonedDateTime()}
 * 		<li class='jm'>{@link FluentRequestHeaderAssertion#as(Class) as(Class)}
 * 	</ul>
 * 	<li class='jc'>{@link FluentStringAssertion}
 * 	<ul class='javatreec'>
...
public class FluentRequestHeaderAssertion<R> extends FluentStringAssertion<R> {
	...
	public FluentZonedDateTimeAssertion<R> asZonedDateTime() {
		return new FluentZonedDateTimeAssertion<>(this, value == null ? null : value.asDateHeader().asZonedDateTime().orElse(null), returns());
	}
