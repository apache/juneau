...
/**
 * An implementation of a {@link RestOperationParam} that takes in a {@link ThrowingFunction} for resolving a parameter value.
 */
public class SimpleRestOperationParam implements RestOperationParam {
	...
	protected <T> SimpleRestOperationParam(ThrowingFunction<RestCall,T> function) {
