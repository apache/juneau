...
/**
 * OpenAPI 3.1 attribute variable resolver — sibling of {@link SwaggerVar} for the OpenAPI 3.1 path.
 *
 * <p>
 * The format for this var is <js>"$OS{key1[,key2...]}"</js>.
 ...
 * </ul>
 */
public class OpenApiVar extends MultipartResolvingVar {
