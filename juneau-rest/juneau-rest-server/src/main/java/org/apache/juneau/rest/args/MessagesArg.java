...
public class MessagesArg extends SimpleRestOperationArg {
	 ...
	 * @return A new {@link MessagesArg}, or <jk>null</jk> if the parameter type is not {@link Messages}.
	 */
	public static MessagesArg create(ParamInfo paramInfo) {
		if (paramInfo.isType(Messages.class))
			return new MessagesArg();
		return null;
	}
