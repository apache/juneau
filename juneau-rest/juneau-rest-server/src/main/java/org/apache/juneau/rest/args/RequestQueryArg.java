 ...
 *
 * <p>
 * The parameter value is resolved using <c><jv>opSession</jv>.{@link RestOpSession#getRequest() getRequest}().{@link RestRequest#getQueryParams() getQueryParams}()</c>.
 */
public class RequestQueryArg extends SimpleRestOperationArg {
	...
	protected RequestQueryArg() {
		super((opSession)->opSession.getRequest().getQueryParams());
	}
}
