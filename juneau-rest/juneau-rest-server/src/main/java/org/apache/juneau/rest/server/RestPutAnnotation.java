...
public class RestPutAnnotation {
	...
	public static class Builder extends AnnotationObject.Builder {
		...
		/**
		 * Sets the {@link RestPut#problemDetails()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPut#debugMarshalling()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPut#observability()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPut#asyncCompletionExecutor()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPut#metricName()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		...
		/**
		 * Sets the {@link RestPut#metricTags()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
