...
class NamedHeaders_Test extends TestBase {
	...
	void coverAllFactoriesAndAccessors(Class<?> cls) throws Exception {
		...
		for (var m : cls.getDeclaredMethods()) {
			...
			try { instance.getValue(); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* lazy resolver may misalign with sample */ }
	...
	private static void exerciseTypedAccessors(HttpHeaderBean h) {
		...
		if (h instanceof HttpIntegerHeader x) {
			...
			try { x.toZonedDateTime(); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* unparseable sample */ }
			try { x.asZonedDateTime(); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* unparseable sample */ }
			...
			try { x.toUri(); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* unparseable sample */ }
			try { x.asUri(); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* unparseable sample */ }
			try { x.orElse(URI.create("http://x")); } catch (@SuppressWarnings("unused") RuntimeException ignored) { /* unparseable sample */ }
