...
class HttpParts_Test extends TestBase {
	...
	public static class C_StringCtor {
		public C_StringCtor(@SuppressWarnings("unused") String v) { /* no-op */ }
	}

	public static class C_NameValueCtor {
		public C_NameValueCtor(@SuppressWarnings("unused") String n, @SuppressWarnings("unused") String v) { /* no-op */ }
	}

	public static class C_NoMatchingCtor {
		public C_NoMatchingCtor(@SuppressWarnings("unused") int v) { /* no-op */ }
	}
