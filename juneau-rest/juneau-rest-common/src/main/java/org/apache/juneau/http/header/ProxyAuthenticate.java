...
/**
 * Represents an HTTP <c>Proxy-Authenticate</c> header.
 *
 * <p>
...
public class ProxyAuthenticate extends HttpStringHeader {
	 ...
	 */
	public ProxyAuthenticate(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static ProxyAuthenticate of(Supplier<String> valueSupplier) {
		return new ProxyAuthenticate(valueSupplier);
	}
	...
	/**
	 * Fluent builder for assembling an HTTP <c>Proxy-Authenticate</c> challenge value.
	 *
	 * <p>
	 * Composes the <c>scheme [ 1*SP #auth-param ]</c> challenge form defined by
	 * <a class='doclink' href='https://www.rfc-editor.org/rfc/rfc7235#section-4.3'>RFC 7235 §4.3</a>.  Typed setters
	 ...
	 * <p class='bjava'>
	 * 	String <jv>value</jv> = ProxyAuthenticate.<jsm>create</jsm>()
	 * 		.digest()
	 ...
	 *
	 * <h5 class='section'>See Also:</h5><ul>
	 * 	<li class='jc'>{@link ProxyAuthenticate}
	...
	public static class Builder {
		...
		/**
		 * Builds the rendered <c>Proxy-Authenticate</c> challenge value.
		 *
		 * <p>
		...
		/**
		 * Builds a {@link ProxyAuthenticate} header bean directly from this builder.
		 *
		 * @return A {@link ProxyAuthenticate} carrying {@link #build()}. Never <jk>null</jk>.
		 */
		public ProxyAuthenticate toHeader() {
			return ProxyAuthenticate.of(build());
		}
