...
/**
 * Represents an HTTP <c>Trailer</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Trailer extends HttpStringHeader {

	/** The header name */
	public static final String NAME = "Trailer";
	 ...
	 */
	public Trailer(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static Trailer of(Supplier<String> valueSupplier) {
		return new Trailer(valueSupplier);
	}
}
