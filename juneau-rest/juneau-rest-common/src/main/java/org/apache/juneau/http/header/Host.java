...
/**
 * Represents an HTTP <c>Host</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Host extends HttpStringHeader {
	 ...
	 */
	public Host(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static Host of(Supplier<String> valueSupplier) {
		return new Host(valueSupplier);
	}
}
