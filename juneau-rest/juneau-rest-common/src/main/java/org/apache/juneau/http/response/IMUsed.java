 ...
 * @since 9.2.1
 */
public class IMUsed extends BasicHttpResponse<IMUsed> {
	...
	public static final IMUsed INSTANCE = new IMUsed().unmodifiable();
	...
	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link IMUsed} response.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends IMUsed implements UnmodifiableBean {
		...
		protected Unmodifiable(IMUsed copyFrom) {
			super(copyFrom);
			freeze();
		}

		@Override /* Overridden from BasicHttpResponse */
		protected IMUsed modify(Runnable mutation) {
