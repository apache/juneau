 ...
 * @since 9.2.1
 */
public class IfNoneMatch extends HttpEntityTagsHeader {
	...
	private IfNoneMatch(Supplier<?> supplier, int lazyMode) {
	...
	public static IfNoneMatch ofLazyWire(Supplier<String> supplier) {
		return new IfNoneMatch(supplier, LAZY_WIRE_STRING);
	}

	public static IfNoneMatch ofLazyParsed(Supplier<EntityTags> supplier) {
		return new IfNoneMatch(supplier, LAZY_ENTITY_TAGS);
	}
}
