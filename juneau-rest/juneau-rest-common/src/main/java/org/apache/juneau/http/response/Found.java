 ...
 *
 * <p>
 * The resource was found but is available at a different URI.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Found extends BasicHttpResponse<Found> {
	...
	public static final Found INSTANCE = new Found().unmodifiable();
	...
	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Found} response.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Found implements UnmodifiableBean {
		...
		protected Unmodifiable(Found copyFrom) {
			super(copyFrom);
			freeze();
		}

		@Override /* Overridden from BasicHttpResponse */
		protected Found modify(Runnable mutation) {
