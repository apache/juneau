 ...
 * @since 9.2.1
 */
public class NonAuthoritativeInformation extends BasicHttpResponse<NonAuthoritativeInformation> {
	...
	public static final NonAuthoritativeInformation INSTANCE = new NonAuthoritativeInformation().unmodifiable();
	 ...
	 */
	public NonAuthoritativeInformation(HttpBody body) {
	 ...
	 */
	public NonAuthoritativeInformation(String body) {
		super(STATUS_LINE, body);
	}
	 ...
	 */
	public NonAuthoritativeInformation(NonAuthoritativeInformation copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpResponse */
	public NonAuthoritativeInformation unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link NonAuthoritativeInformation} response.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends NonAuthoritativeInformation implements UnmodifiableBean {
		...
		protected Unmodifiable(NonAuthoritativeInformation copyFrom) {
			super(copyFrom);
			freeze();
		}

		@Override /* Overridden from BasicHttpResponse */
		protected NonAuthoritativeInformation modify(Runnable mutation) {
