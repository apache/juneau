...
/**
 * Represents an <c>HTTP 409 Conflict</c> error response.
 *
 * <p>
...
public class Conflict extends BasicHttpException {
	 ...
	 */
	public Conflict(Conflict copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public Conflict unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Conflict} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Conflict implements UnmodifiableBean {
		...
		protected Unmodifiable(Conflict copyFrom) {
			super(copyFrom);
			freeze();
		}
