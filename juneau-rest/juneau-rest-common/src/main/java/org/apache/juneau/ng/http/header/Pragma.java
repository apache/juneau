...
/**
 * Represents an HTTP <c>Pragma</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Pragma extends HttpStringHeader {

	/** The header name */
	public static final String NAME = "Pragma";
	 ...
	 */
	public Pragma(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static Pragma of(Supplier<String> valueSupplier) {
		return new Pragma(valueSupplier);
	}
}
