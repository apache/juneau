...
/**
 * Represents an HTTP <c>Cache-Control</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class CacheControl extends HttpStringHeader {
	 ...
	 */
	public CacheControl(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static CacheControl of(Supplier<String> valueSupplier) {
		return new CacheControl(valueSupplier);
	}
	 ...
	 * <p class='bjava'>
	 * 	String <jv>value</jv> = CacheControl.<jsm>create</jsm>()
	 * 		.publicCache()
	 * 		.maxAge(3600)
	 * 		.mustRevalidate()
	 * 		.build();
