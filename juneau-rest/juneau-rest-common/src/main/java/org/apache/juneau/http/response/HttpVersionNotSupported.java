...
public class HttpVersionNotSupported extends BasicHttpException {
	...
	public HttpVersionNotSupported unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link HttpVersionNotSupported} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends HttpVersionNotSupported implements UnmodifiableBean {
		...
		protected Unmodifiable(HttpVersionNotSupported copyFrom) {
			super(copyFrom);
			freeze();
		}
