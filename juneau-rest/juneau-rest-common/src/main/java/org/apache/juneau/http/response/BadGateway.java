...
public class BadGateway extends BasicHttpException {
	 ...
	 */
	public BadGateway(String msg, Object...args) {
	 ...
	 * @param args Optional message arguments.
	 */
	public BadGateway(Throwable cause, String msg, Object...args) {
	...
	public BadGateway unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link BadGateway} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends BadGateway implements UnmodifiableBean {
		...
		protected Unmodifiable(BadGateway copyFrom) {
			super(copyFrom);
			freeze();
		}
