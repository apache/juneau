...
/**
 * Represents an HTTP <c>Client-Version</c> header.
 *
 * <p>
 * Juneau-specific header that identifies the version of a client.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class ClientVersion extends HttpStringHeader {

	/** The header name */
	public static final String NAME = "Client-Version";
	 ...
	 */
	public ClientVersion(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static ClientVersion of(Supplier<String> valueSupplier) {
		return new ClientVersion(valueSupplier);
	}
}
