...
/**
 * Represents an <c>HTTP 504 Gateway Timeout</c> error response.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class GatewayTimeout extends BasicHttpException {
	...
	/** Reason phrase */
	public static final String REASON_PHRASE = "Gateway Timeout";
	 ...
	 */
	public GatewayTimeout(String msg, Object...args) {
	 ...
	 * @param args Optional message arguments.
	 */
	public GatewayTimeout(Throwable cause, String msg, Object...args) {
	 ...
	 */
	public GatewayTimeout(GatewayTimeout copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public GatewayTimeout unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link GatewayTimeout} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends GatewayTimeout implements UnmodifiableBean {
		...
		protected Unmodifiable(GatewayTimeout copyFrom) {
			super(copyFrom);
			freeze();
		}
