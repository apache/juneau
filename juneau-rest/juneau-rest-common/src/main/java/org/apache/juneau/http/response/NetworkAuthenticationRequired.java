...
/**
 * Represents an <c>HTTP 511 Network Authentication Required</c> error response.
 *
 * <p>
...
public class NetworkAuthenticationRequired extends BasicHttpException {
	 ...
	 */
	public NetworkAuthenticationRequired(NetworkAuthenticationRequired copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public NetworkAuthenticationRequired unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link NetworkAuthenticationRequired} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends NetworkAuthenticationRequired implements UnmodifiableBean {
		...
		protected Unmodifiable(NetworkAuthenticationRequired copyFrom) {
			super(copyFrom);
			freeze();
		}
