...
/**
 * Represents an HTTP <c>Expect</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Expect extends HttpStringHeader {
	 ...
	 */
	public Expect(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static Expect of(Supplier<String> valueSupplier) {
		return new Expect(valueSupplier);
	}
}
