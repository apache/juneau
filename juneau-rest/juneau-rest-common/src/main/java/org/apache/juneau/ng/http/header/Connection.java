...
/**
 * Represents an HTTP <c>Connection</c> header.
 *
 * <p>
 ...
 * @since 9.2.1
 */
public class Connection extends HttpStringHeader {
	 ...
	 */
	public Connection(Supplier<String> valueSupplier) {
	 ...
	 * @return A new instance. Never <jk>null</jk>.
	 */
	public static Connection of(Supplier<String> valueSupplier) {
		return new Connection(valueSupplier);
	}
}
