...
/**
 * Represents an <c>HTTP 417 Expectation Failed</c> error response.
 *
 * <p>
...
public class ExpectationFailed extends BasicHttpException {
	 ...
	 */
	public ExpectationFailed(ExpectationFailed copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public ExpectationFailed unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link ExpectationFailed} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends ExpectationFailed implements UnmodifiableBean {
		...
		protected Unmodifiable(ExpectationFailed copyFrom) {
			super(copyFrom);
			freeze();
		}
