 ...
 * @since 9.2.1
 */
public class NonAuthoritativeInformation extends BasicHttpResponse {
	...
	public static final NonAuthoritativeInformation INSTANCE = new NonAuthoritativeInformation();
