...
/**
 * Represents an <c>HTTP 416 Range Not Satisfiable</c> error response.
 *
 * <p>
...
public class RangeNotSatisfiable extends BasicHttpException {
	 ...
	 */
	public RangeNotSatisfiable(RangeNotSatisfiable copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public RangeNotSatisfiable unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link RangeNotSatisfiable} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends RangeNotSatisfiable implements UnmodifiableBean {
		...
		protected Unmodifiable(RangeNotSatisfiable copyFrom) {
			super(copyFrom);
			freeze();
		}
