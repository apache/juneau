...
/**
 * Represents an <c>HTTP 423 Locked</c> error response.
 *
 * <p>
...
public class Locked extends BasicHttpException {
	 ...
	 */
	public Locked(Locked copyFrom) {
		super(copyFrom);
	}

	@Override /* Overridden from BasicHttpException */
	public Locked unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Locked} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Locked implements UnmodifiableBean {
		...
		protected Unmodifiable(Locked copyFrom) {
			super(copyFrom);
			freeze();
		}
