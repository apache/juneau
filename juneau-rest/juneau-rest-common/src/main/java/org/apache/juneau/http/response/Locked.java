...
public class Locked extends BasicHttpException {
	...
	public static final Locked INSTANCE = new Locked().setUnmodifiable();
	 ...
	 */
	protected Locked(Locked copyFrom) {
		super(copyFrom);
	}
	...
	public Locked setMessage(String message, Object...args) {
		super.setMessage(message, args);
		return this;
	}

	@Override /* Overridden from BasicRuntimeException */
	public Locked setUnmodifiable() {
		super.setUnmodifiable();
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Locked setHeader2(String name, Object value) {
		super.setHeader2(name, value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Locked setHeaders(HeaderList value) {
		super.setHeaders(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Locked setHeaders2(Header...values) {
	...
	@Override /* Overridden from BasicHttpException */
	public Locked setHeaders(List<Header> values) {
		super.setHeaders(values);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Locked setContent(String value) {
