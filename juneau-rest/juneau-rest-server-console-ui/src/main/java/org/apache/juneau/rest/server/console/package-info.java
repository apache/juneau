 ...
 *
 * <p>
 * This module is CSS-serving only &mdash; it ships no template files and has no view-engine dependency. It is the
 * module the per-engine FreeMarker (and, eventually, other) chrome add-ons build their template composition on top
 * of.
 *
 * @since 10.0.0
 */
