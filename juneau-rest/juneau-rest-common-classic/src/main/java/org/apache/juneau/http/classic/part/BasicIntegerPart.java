 ...
 */
@SuppressWarnings({
	"java:S2160" // equals() inherited from BasicPart compares name+value; typed Integer field is accessed via getValue()
})
public class BasicIntegerPart extends BasicPart {
	...
	public BasicIntegerPart(String name, String value) {
		super(name, value);
		this.value = ie(value) ? null : Integer.valueOf(value);
		this.supplier = null;
	}
