...
public class LengthRequired extends BasicHttpException {
	...
	public static final LengthRequired INSTANCE = new LengthRequired().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public LengthRequired unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link LengthRequired} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends LengthRequired implements UnmodifiableBean {
		...
		protected Unmodifiable(LengthRequired copyFrom) {
			super(copyFrom);
			freeze();
		}
