...
import static org.apache.juneau.http.classic.response.UnprocessableEntity.*;
...
public class UnprocessableEntity extends BasicHttpException {
	...
	public static final UnprocessableEntity INSTANCE = new UnprocessableEntity().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public UnprocessableEntity unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link UnprocessableEntity} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends UnprocessableEntity implements UnmodifiableBean {
		...
		protected Unmodifiable(UnprocessableEntity copyFrom) {
			super(copyFrom);
			freeze();
		}
