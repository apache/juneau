...
import static org.apache.juneau.http.classic.response.MethodNotAllowed.*;
...
public class MethodNotAllowed extends BasicHttpException {
	...
	public static final MethodNotAllowed INSTANCE = new MethodNotAllowed().unmodifiable();
	...
	public MethodNotAllowed setContent(HttpEntity value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public MethodNotAllowed setContent(String value) {
		super.setContent(value);
		return this;
	}
	...
	@Override /* Overridden from BasicHttpException */
	public MethodNotAllowed setHeaders(List<Header> values) {
	...
	@Override /* Overridden from BasicHttpException */
	public MethodNotAllowed setStatusCode2(int code) throws IllegalStateException {
	...
	@Override /* Overridden from BasicHttpException */
	public MethodNotAllowed unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link MethodNotAllowed} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends MethodNotAllowed implements UnmodifiableBean {
		...
		protected Unmodifiable(MethodNotAllowed copyFrom) {
			super(copyFrom);
			freeze();
		}
