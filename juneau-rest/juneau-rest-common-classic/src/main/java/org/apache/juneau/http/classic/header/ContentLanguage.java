...
public class ContentLanguage extends BasicCsvHeader {
	 ...
	 * factory (returning a {@link ContentLanguage}) rather than the inherited fixed-arity
	 * {@link BasicCsvHeader#of(String,String)}, which Java overload resolution would otherwise prefer.
	 *
