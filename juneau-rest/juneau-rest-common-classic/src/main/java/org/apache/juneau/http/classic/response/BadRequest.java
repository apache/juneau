...
public class BadRequest extends BasicHttpException {
	...
	public static final BadRequest INSTANCE = new BadRequest().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public BadRequest unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link BadRequest} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends BadRequest implements UnmodifiableBean {
		...
		protected Unmodifiable(BadRequest copyFrom) {
			super(copyFrom);
			freeze();
		}
