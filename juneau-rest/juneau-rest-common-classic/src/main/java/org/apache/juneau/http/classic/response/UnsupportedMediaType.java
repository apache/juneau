...
public class UnsupportedMediaType extends BasicHttpException {
	...
	public static final UnsupportedMediaType INSTANCE = new UnsupportedMediaType().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public UnsupportedMediaType setContent(String value) {
		super.setContent(value);
		return this;
	}
	...
	@Override /* Overridden from BasicHttpException */
	public UnsupportedMediaType setHeaders(List<Header> values) {
	...
	@Override /* Overridden from BasicHttpException */
	public UnsupportedMediaType unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link UnsupportedMediaType} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends UnsupportedMediaType implements UnmodifiableBean {
		...
		protected Unmodifiable(UnsupportedMediaType copyFrom) {
			super(copyFrom);
			freeze();
		}
