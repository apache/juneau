...
import static org.apache.juneau.http.classic.response.Unauthorized.*;
...
public class Unauthorized extends BasicHttpException {
	...
	public static final Unauthorized INSTANCE = new Unauthorized().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public Unauthorized unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Unauthorized} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Unauthorized implements UnmodifiableBean {
		...
		protected Unmodifiable(Unauthorized copyFrom) {
			super(copyFrom);
			freeze();
		}
