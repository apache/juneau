...
import static org.apache.juneau.http.classic.response.FailedDependency.*;
...
public class FailedDependency extends BasicHttpException {
	...
	public static final FailedDependency INSTANCE = new FailedDependency().unmodifiable();
	 ...
	 */
	protected FailedDependency(FailedDependency copyFrom) {
		super(copyFrom);
	}
	 ...
	 */
	public FailedDependency copy() {
		return new FailedDependency(this);
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setContent(HttpEntity value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setContent(String value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setHeader2(String name, Object value) {
		super.setHeader2(name, value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setHeaders(HeaderList value) {
		super.setHeaders(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setHeaders(List<Header> values) {
		super.setHeaders(values);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public FailedDependency setHeaders2(Header...values) {
	...
	public FailedDependency setMessage(String message, Object...args) {
	...
	@Override /* Overridden from BasicHttpException */
	public FailedDependency setReasonPhraseCatalog(ReasonPhraseCatalog value) {
	...
	@Override /* Overridden from BasicHttpException */
	public FailedDependency unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link FailedDependency} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends FailedDependency implements UnmodifiableBean {
		...
		protected Unmodifiable(FailedDependency copyFrom) {
			super(copyFrom);
			freeze();
		}
