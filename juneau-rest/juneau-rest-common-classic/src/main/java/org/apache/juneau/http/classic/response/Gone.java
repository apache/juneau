...
public class Gone extends BasicHttpException {
	...
	public static final Gone INSTANCE = new Gone().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public Gone setContent(String value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Gone setHeader2(String name, Object value) {
		super.setHeader2(name, value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Gone setHeaders(HeaderList value) {
		super.setHeaders(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Gone setHeaders(List<Header> values) {
		super.setHeaders(values);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Gone setHeaders2(Header...values) {
	...
	public Gone setMessage(String message, Object...args) {
	...
	@Override /* Overridden from BasicHttpException */
	public Gone unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Gone} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Gone implements UnmodifiableBean {
		...
		protected Unmodifiable(Gone copyFrom) {
			super(copyFrom);
			freeze();
		}
