...
import static org.apache.juneau.http.classic.response.TooManyRequests.*;
...
public class TooManyRequests extends BasicHttpException {
	...
	public static final TooManyRequests INSTANCE = new TooManyRequests().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public TooManyRequests unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link TooManyRequests} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends TooManyRequests implements UnmodifiableBean {
		...
		protected Unmodifiable(TooManyRequests copyFrom) {
			super(copyFrom);
			freeze();
		}
