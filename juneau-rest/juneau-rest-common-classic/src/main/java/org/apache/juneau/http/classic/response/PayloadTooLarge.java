...
public class PayloadTooLarge extends BasicHttpException {
	...
	public static final PayloadTooLarge INSTANCE = new PayloadTooLarge().unmodifiable();
	 ...
	 */
	protected PayloadTooLarge(PayloadTooLarge copyFrom) {
		super(copyFrom);
	}
	 ...
	 */
	public PayloadTooLarge copy() {
		return new PayloadTooLarge(this);
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setContent(HttpEntity value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setContent(String value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setHeader2(String name, Object value) {
		super.setHeader2(name, value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setHeaders(HeaderList value) {
		super.setHeaders(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setHeaders(List<Header> values) {
		super.setHeaders(values);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setHeaders2(Header...values) {
	...
	public PayloadTooLarge setMessage(String message, Object...args) {
	...
	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setReasonPhraseCatalog(ReasonPhraseCatalog value) {
		super.setReasonPhraseCatalog(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge setStatusCode2(int code) throws IllegalStateException {
	...
	@Override /* Overridden from BasicHttpException */
	public PayloadTooLarge unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link PayloadTooLarge} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends PayloadTooLarge implements UnmodifiableBean {
		...
		protected Unmodifiable(PayloadTooLarge copyFrom) {
			super(copyFrom);
			freeze();
		}
