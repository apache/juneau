...
import static org.apache.juneau.http.classic.response.UpgradeRequired.*;
...
public class UpgradeRequired extends BasicHttpException {
	...
	public static final UpgradeRequired INSTANCE = new UpgradeRequired().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public UpgradeRequired unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link UpgradeRequired} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends UpgradeRequired implements UnmodifiableBean {
		...
		protected Unmodifiable(UpgradeRequired copyFrom) {
			super(copyFrom);
			freeze();
		}
