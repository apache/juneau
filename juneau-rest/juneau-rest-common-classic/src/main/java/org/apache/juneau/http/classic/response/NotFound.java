...
public class NotFound extends BasicHttpException {
	...
	public static final NotFound INSTANCE = new NotFound().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public NotFound unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link NotFound} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends NotFound implements UnmodifiableBean {
		...
		protected Unmodifiable(NotFound copyFrom) {
			super(copyFrom);
			freeze();
		}
