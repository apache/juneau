...
import static org.apache.juneau.http.classic.response.NotAcceptable.*;
...
public class NotAcceptable extends BasicHttpException {
	...
	public static final NotAcceptable INSTANCE = new NotAcceptable().unmodifiable();
	 ...
	 */
	protected NotAcceptable(NotAcceptable copyFrom) {
		super(copyFrom);
	}
	...
	public NotAcceptable setContent(HttpEntity value) {
		super.setContent(value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public NotAcceptable setContent(String value) {
		super.setContent(value);
		return this;
	}
	...
	@Override /* Overridden from BasicHttpException */
	public NotAcceptable setHeaders(List<Header> values) {
	...
	@Override /* Overridden from BasicHttpException */
	public NotAcceptable unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link NotAcceptable} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends NotAcceptable implements UnmodifiableBean {
		...
		protected Unmodifiable(NotAcceptable copyFrom) {
			super(copyFrom);
			freeze();
		}
