...
import static org.apache.juneau.http.classic.response.Forbidden.*;
...
public class Forbidden extends BasicHttpException {
	...
	public static final Forbidden INSTANCE = new Forbidden().unmodifiable();
	 ...
	 */
	protected Forbidden(Forbidden copyFrom) {
		super(copyFrom);
	}
	...
	@Override /* Overridden from BasicHttpException */
	public Forbidden setHeader2(String name, Object value) {
		super.setHeader2(name, value);
		return this;
	}

	@Override /* Overridden from BasicHttpException */
	public Forbidden setHeaders(HeaderList value) {
	...
	@Override /* Overridden from BasicHttpException */
	public Forbidden setHeaders2(Header...values) {
	...
	public Forbidden setMessage(String message, Object...args) {
	...
	@Override /* Overridden from BasicHttpException */
	public Forbidden unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link Forbidden} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends Forbidden implements UnmodifiableBean {
		...
		protected Unmodifiable(Forbidden copyFrom) {
			super(copyFrom);
			freeze();
		}
