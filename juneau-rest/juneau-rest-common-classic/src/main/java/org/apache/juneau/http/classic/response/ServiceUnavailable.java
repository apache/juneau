...
public class ServiceUnavailable extends BasicHttpException {
	...
	public static final ServiceUnavailable INSTANCE = new ServiceUnavailable().unmodifiable();
	...
	@Override /* Overridden from BasicHttpException */
	public ServiceUnavailable unmodifiable() {
		return this instanceof UnmodifiableBean ? this : new Unmodifiable(this);
	}

	/**
	 * Unmodifiable point-in-time snapshot of the enclosing {@link ServiceUnavailable} exception.
	 *
	 * <p>
	 ...
	 */
	public static class Unmodifiable extends ServiceUnavailable implements UnmodifiableBean {
		...
		protected Unmodifiable(ServiceUnavailable copyFrom) {
			super(copyFrom);
			freeze();
		}
