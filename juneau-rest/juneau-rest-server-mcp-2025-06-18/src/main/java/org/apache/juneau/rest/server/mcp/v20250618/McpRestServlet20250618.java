 ...
 * @serial exclude
 */
public abstract class McpRestServlet20250618 extends McpRestServlet {
	private static final long serialVersionUID = 1L;

	@Override /* McpRestServlet */
	protected McpRevision revision() {
		return new Mcp20250618Revision(capabilities());
	}
	 ...
	 * class's own hierarchy — in particular, {@code Mcp20250618Revision} never calls back into it.
	 *
