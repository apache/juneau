...
/**
 * MockRest-level assertions for {@link MustacheMixin} composition + route wiring.
 *
 * <p>
 ...
 *
 * <h5 class='section'>Deferred &mdash; typed {@link org.apache.juneau.rest.server.server.view.View View} return
 * path:</h5>
 *
...
class MustacheMixin_MockRest_Test extends TestBase {
	...
	public static class B extends BasicRestServlet {
		...
		@Bean public MustacheMixin mustache() {
