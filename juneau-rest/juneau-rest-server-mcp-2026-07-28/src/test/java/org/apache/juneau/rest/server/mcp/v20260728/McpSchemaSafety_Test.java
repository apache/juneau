...
class McpSchemaSafety_Test {
	...
	void e01_v1FinitenessTest_hasZeroDiff() throws Exception {
		var relPath = "juneau-bean/juneau-bean-mcp-2025-06-18/src/test/java/org/apache/juneau/bean/mcp/v20250618/JsonSchema_Finiteness_Test.java";
		var root = repoRoot();
	...
	private static File repoRoot() {
		...
		} catch (@SuppressWarnings("unused") IOException | InterruptedException e) {
			return null;
		}
	}
}
