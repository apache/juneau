...
/**
 * Structured log entry produced after every {@link RestRequest#run()} invocation.
 *
 * <p>
 * Passed to a {@link RestLogger} in the {@code finally} block of {@link RestRequest#run()}.
...
public final class RestLogEntry {
	...
	RestLogEntry(RestRequest request, RestResponse response, Throwable error, Duration elapsed, boolean debug, System.Logger.Level level) {
	...
	/**
	 * Returns {@code true} if {@link RestRequest#debug()} was called on the originating request.
	 *
	...
	public static final class Builder {
		 ...
		 * @return This object.
		 */
		public Builder request(RestRequest value) {
			request = value;
			return this;
		}
		 ...
		 * @return This object.
		 */
		public Builder response(RestResponse value) {
			response = value;
			return this;
		}
		 ...
		 *
		 * @param value {@code true} if {@link RestRequest#debug()} was called.
		 * @return This object.
		 */
