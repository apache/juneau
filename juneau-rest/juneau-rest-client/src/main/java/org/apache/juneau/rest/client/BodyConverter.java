...
/**
 * Converts a Java object passed to {@link RestRequest#body(Object)} into a {@link TransportBody}.
 *
 * <p>
 * A list of converters is consulted in order; the first converter whose {@link #canConvert(Object)} returns
 * {@code true} wins. The default converter list (applied automatically by {@link RestClient}) handles
 * the common cases:
 * <ol>
...
public interface BodyConverter<T> {
	 ...
	 *
	 * @param value The value passed to {@link RestRequest#body(Object)}. May be <jk>null</jk>.
