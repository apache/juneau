...
public class RestClientBuilder extends BeanContextBuilder {
	...
	/**
	 * @deprecated Use {@link #addRootType(boolean)}
	 */
	...
	/**
	 * @deprecated Use {@link #addRootType()}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #redirectStrategy(RedirectStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #defaultCookieSpecRegistry(Lookup)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultCookieSpecRegistry(Lookup<CookieSpecProvider> cookieSpecRegistry) {
		return defaultCookieSpecRegistry(cookieSpecRegistry);
	}

	/**
	 * @deprecated Use {@link #requestExecutor(HttpRequestExecutor)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setRequestExecutor(HttpRequestExecutor requestExec) {
		return requestExecutor(requestExec);
	}

	/**
	 * @deprecated Use {@link #sslHostnameVerifier(HostnameVerifier)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setSSLHostnameVerifier(HostnameVerifier hostnameVerifier) {
		return sslHostnameVerifier(hostnameVerifier);
	}

	/**
	 * @deprecated Use {@link #publicSuffixMatcher(PublicSuffixMatcher)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setPublicSuffixMatcher(PublicSuffixMatcher publicSuffixMatcher) {
		return publicSuffixMatcher(publicSuffixMatcher);
	}

	/**
	 * @deprecated Use {@link #sslContext(SSLContext)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #sslSocketFactory(LayeredConnectionSocketFactory)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #maxConnTotal(int)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #maxConnPerRoute(int)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setMaxConnPerRoute(int maxConnPerRoute) {
		return maxConnPerRoute(maxConnPerRoute);
	}

	/**
	 * @deprecated Use {@link #defaultSocketConfig(SocketConfig)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultSocketConfig(SocketConfig config) {
		return defaultSocketConfig(config);
	}

	/**
	 * @deprecated Use {@link #defaultConnectionConfig(ConnectionConfig)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultConnectionConfig(ConnectionConfig config) {
		return defaultConnectionConfig(config);
	}

	/**
	 * @deprecated Use {@link #connectionTimeToLive(long,TimeUnit)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setConnectionTimeToLive(long connTimeToLive, TimeUnit connTimeToLiveTimeUnit) {
		return connectionTimeToLive(connTimeToLive, connTimeToLiveTimeUnit);
	}

	/**
	 * @deprecated Use {@link #connectionManager(HttpClientConnectionManager)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setConnectionManager(HttpClientConnectionManager connManager) {
		return connectionManager(connManager);
	}

	/**
	 * @deprecated Use {@link #connectionManagerShared(boolean)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setConnectionManagerShared(boolean shared) {
		return connectionManagerShared(shared);
	}

	/**
	 * @deprecated Use {@link #connectionReuseStrategy(ConnectionReuseStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setConnectionReuseStrategy(ConnectionReuseStrategy reuseStrategy) {
		return connectionReuseStrategy(reuseStrategy);
	}

	/**
	 * @deprecated Use {@link #keepAliveStrategy(ConnectionKeepAliveStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setKeepAliveStrategy(ConnectionKeepAliveStrategy keepAliveStrategy) {
		return keepAliveStrategy(keepAliveStrategy);
	}

	/**
	 * @deprecated Use {@link #targetAuthenticationStrategy(AuthenticationStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setTargetAuthenticationStrategy(AuthenticationStrategy targetAuthStrategy) {
		return targetAuthenticationStrategy(targetAuthStrategy);
	}

	/**
	 * @deprecated Use {@link #proxyAuthenticationStrategy(AuthenticationStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setProxyAuthenticationStrategy(AuthenticationStrategy proxyAuthStrategy) {
		return proxyAuthenticationStrategy(proxyAuthStrategy);
	}

	/**
	 * @deprecated Use {@link #userTokenHandler(UserTokenHandler)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setUserTokenHandler(UserTokenHandler userTokenHandler) {
		return userTokenHandler(userTokenHandler);
	}

	/**
	 * @deprecated Use {@link #schemePortResolver(SchemePortResolver)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setSchemePortResolver(SchemePortResolver schemePortResolver) {
		return schemePortResolver(schemePortResolver);
	}

	/**
	 * @deprecated Use {@link #defaultHeaders(Collection)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultHeaders(Collection<? extends Header> defaultHeaders) {
		return defaultHeaders(defaultHeaders);
	}

	/**
	 * @deprecated Use {@link #userAgent(String)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #httpProcessor(HttpProcessor)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setHttpProcessor(HttpProcessor httpprocessor) {
		return httpProcessor(httpprocessor);
	}

	/**
	 * @deprecated Use {@link #retryHandler(HttpRequestRetryHandler)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #proxy(HttpHost)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #routePlanner(HttpRoutePlanner)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #connectionBackoffStrategy(ConnectionBackoffStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setConnectionBackoffStrategy(ConnectionBackoffStrategy connectionBackoffStrategy) {
		return connectionBackoffStrategy(connectionBackoffStrategy);
	}

	/**
	 * @deprecated Use {@link #backoffManager(BackoffManager)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setBackoffManager(BackoffManager backoffManager) {
		return backoffManager(backoffManager);
	}

	/**
	 * @deprecated Use {@link #serviceUnavailableRetryStrategy(ServiceUnavailableRetryStrategy)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setServiceUnavailableRetryStrategy(ServiceUnavailableRetryStrategy serviceUnavailStrategy) {
		return serviceUnavailableRetryStrategy(serviceUnavailStrategy);
	}

	/**
	 * @deprecated Use {@link #defaultCookieStore(CookieStore)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #defaultCredentialsProvider(CredentialsProvider)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultCredentialsProvider(CredentialsProvider credentialsProvider) {
		return defaultCredentialsProvider(credentialsProvider);
	}

	/**
	 * @deprecated Use {@link #defaultAuthSchemeRegistry(Lookup)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setDefaultAuthSchemeRegistry(Lookup<AuthSchemeProvider> authSchemeRegistry) {
		return defaultAuthSchemeRegistry(authSchemeRegistry);
	}

	/**
	 * @deprecated Use {@link #contentDecoderRegistry(Map)}
	 */
	@SuppressWarnings("javadoc")
	@Deprecated
	public RestClientBuilder setContentDecoderRegistry(Map<String,InputStreamFactory> contentDecoderMap) {
		return contentDecoderRegistry(contentDecoderMap);
	}
	...
	public RestClientBuilder setDefaultRequestConfig(RequestConfig config) {
		return defaultRequestConfig(config);
	}

	/**
	 * @deprecated Use {@link #sslSocketFactory(LayeredConnectionSocketFactory)} and others.
	 */
