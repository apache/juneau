 ...
 * <ul>
 * 	<li>{@code ApacheHc45Transport} (module {@code juneau-rest-client-apache-httpclient-45})
 * 	<li>{@code ApacheHc5Transport} (module {@code juneau-rest-client-apache-httpclient-50})
 * 	<li>{@code JavaHttpTransport} (module {@code juneau-rest-client-java-httpclient})
 * 	<li>{@code OkHttpTransport} (module {@code juneau-rest-client-okhttp})
 * 	<li>{@code JettyHttpTransport} (module {@code juneau-rest-client-jetty})
