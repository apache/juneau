...
public final class RemoteClient {
	...
	private static final class RemoteInvocationHandler implements InvocationHandler {
		...
		private RestRequest buildRequest(String httpMethod, String path, Method method, Object[] args) {
		...
		private Object processReturn(RestRequest req, RemoteReturn returnMode, Class<?> returnType) throws Exception {
			...
			case BEAN, NONE -> throw new UnsupportedOperationException(
				"RestClient remote proxies support RemoteReturn.BODY, STATUS, and RESPONSE only; got " + returnMode);
			};
		}
