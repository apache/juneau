...
/**
 * Pluggable logging interface for REST calls made by {@link RestClient}.
 *
 * <p>
 * Called in the {@code finally} block of every {@link RestRequest#run()} invocation, regardless of success or failure.
