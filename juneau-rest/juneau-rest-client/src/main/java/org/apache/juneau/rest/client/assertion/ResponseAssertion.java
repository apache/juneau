...
/**
 * A fluent assertion class for validating {@link RestResponse} instances.
 *
 * <p>
 ...
 *
 * <p>
 * Obtain instances via {@link RestResponse#assertThat()}.
 *
 * <p class='bjava'>
 * 	<jk>try</jk> (RestResponse <jv>resp</jv> = client.get(<js>"/api/users"</js>).run()) {
...
public final class ResponseAssertion {
	 ...
	 */
	public ResponseAssertion(RestResponse response) {
