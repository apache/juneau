...
public class MessageBundle extends ResourceBundle {
	 ...
	 * 	This can be an absolute path (e.g. <js>"com.ibm.MyMessages"</js>) or a path
	 * 	relative to the package of the <l>forClass</l> (e.g. <js>"MyMessages"</js> if <l>forClass</l> is <js>"com.ibm.MyClass"</js>).
	 */
