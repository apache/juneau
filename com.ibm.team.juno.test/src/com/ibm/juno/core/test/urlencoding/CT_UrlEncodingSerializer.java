...
public class CT_UrlEncodingSerializer {
	...
	public void testMultiPartParametersOnBeansViaProperty() throws Exception {
		...
		String e = ""
			...
			+ "&f5=((e,f),(g,h))"
			+ "&f6=((i,j),(k,l))"
			+ "&f7=((a=a,b=1,c=true),(a=a,b=1,c=true))"
			+ "&f8=((a=a,b=1,c=true),(a=a,b=1,c=true))"
			+ "&f9=(((a=a,b=1,c=true)),((a=a,b=1,c=true)))"
		...
		s = UrlEncodingSerializer.DEFAULT_SIMPLE.clone().setProperty(UrlEncodingProperties.URLENC_expandedParams, true);
		r = s.serialize(t);
		e = ""
			+ "f1=a&f1=b"
			+ "&f2=c&f2=d"
			...
			+ "&f5=(e,f)&f5=(g,h)"
			+ "&f6=(i,j)&f6=(k,l)"
			+ "&f7=(a=a,b=1,c=true)&f7=(a=a,b=1,c=true)"
			+ "&f8=(a=a,b=1,c=true)&f8=(a=a,b=1,c=true)"
			+ "&f9=((a=a,b=1,c=true))&f9=((a=a,b=1,c=true))"
