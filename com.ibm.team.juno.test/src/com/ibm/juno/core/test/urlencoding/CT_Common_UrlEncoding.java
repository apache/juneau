...
public class CT_Common_UrlEncoding {
	...
	public void testRecursion() throws Exception {
		...
		try {
			...
			String msg = e.getLocalizedMessage();
			assertTrue(msg.contains("[0]root:com.ibm.juno.core.test.urlencoding.CT_Common_UrlEncoding$R1"));
			assertTrue(msg.contains("->[1]r2:com.ibm.juno.core.test.urlencoding.CT_Common_UrlEncoding$R2"));
			assertTrue(msg.contains("->[2]r3:com.ibm.juno.core.test.urlencoding.CT_Common_UrlEncoding$R3"));
			assertTrue(msg.contains("->[3]r1:com.ibm.juno.core.test.urlencoding.CT_Common_UrlEncoding$R1"));
		}
