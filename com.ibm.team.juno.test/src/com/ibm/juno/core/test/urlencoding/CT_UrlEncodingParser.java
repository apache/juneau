...
public class CT_UrlEncodingParser {
	...
	public void testMultiPartParametersOnBeansViaProperty() throws Exception {
		...
		p = UrlEncodingParser.DEFAULT.clone().setProperty(UrlEncodingProperties.URLENC_expandedParams, true);
		in = ""
			+ "f1=a&f1=b"
			+ "&f2=c&f2=d"
			+ "&f3=1&f3=2"
		...
		String e = "{"
			...
			+ "f5:[['e','f'],['g','h']],"
			+ "f6:[['i','j'],['k','l']],"
			+ "f7:[{a:'a',b:1,c:true},{a:'b',b:2,c:false}],"
			+ "f8:[{a:'a',b:1,c:true},{a:'b',b:2,c:false}],"
			+ "f9:[[{a:'a',b:1,c:true}],[{a:'b',b:2,c:false}]],"
