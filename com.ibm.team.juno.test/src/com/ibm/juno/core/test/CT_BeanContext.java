...
public class CT_BeanContext {
	...
	public void testReadOnlyProperties() throws Exception {
		...
		assertEquals("toString():name=x,age=123", bc.convertToType(o, String.class));
	...
	public void testProxyHandler() throws Exception {
		BeanContext bc = new BeanContextFactory().setClassLoader(A.class.getClassLoader()).getBeanContext();
	...
	public void testClassMetaCaching() throws Exception {
		...
		p1.setProperty(BEAN_addNotBeanPackages, "foo");
		assertDifferentCache(p1, p2);
		p2.setProperty(BEAN_addNotBeanPackages, "foo");
		assertSameCache(p1, p2);
		p1.setProperty(BEAN_addNotBeanPackages, "bar");
		assertDifferentCache(p1, p2);
		p2.setProperty(BEAN_addNotBeanPackages, "bar");
		assertSameCache(p1, p2);
		p1.setProperty(BEAN_addNotBeanPackages, "baz");
		p1.setProperty(BEAN_addNotBeanPackages, "bing");
		assertDifferentCache(p1, p2);
		p2.setProperty(BEAN_addNotBeanPackages, "bing");
		p2.setProperty(BEAN_addNotBeanPackages, "baz");
		assertSameCache(p1, p2);

		p1.setProperty(BEAN_removeNotBeanPackages, "bar");
		assertDifferentCache(p1, p2);
		p2.setProperty(BEAN_removeNotBeanPackages, "bar");
		assertSameCache(p1, p2);

		p1.addFilters(DummyPojoFilterA.class);
		assertDifferentCache(p1, p2);
		p2.addFilters(DummyPojoFilterA.class);
		assertSameCache(p1, p2);
		p1.addFilters(DummyPojoFilterB.class,DummyPojoFilterC.class);  // Order of filters is important!
		p2.addFilters(DummyPojoFilterC.class,DummyPojoFilterB.class);
		assertDifferentCache(p1, p2);

		p1 = new JsonParser();
		p2 = new JsonParser();
		p1.addFilters(DummyBeanFilterA.class);
		assertDifferentCache(p1, p2);
		p2.addFilters(DummyBeanFilterA.class);
		assertSameCache(p1, p2);
		p1.addFilters(DummyBeanFilterB.class,DummyBeanFilterC.class);  // Order of filters is important!
		p2.addFilters(DummyBeanFilterC.class,DummyBeanFilterB.class);
		assertDifferentCache(p1, p2);
	}

	public static class DummyPojoFilterA extends PojoFilter<A,ObjectMap> {}
	public static class DummyPojoFilterB extends PojoFilter<B,ObjectMap> {}
	public static class DummyPojoFilterC extends PojoFilter<C,ObjectMap> {}
