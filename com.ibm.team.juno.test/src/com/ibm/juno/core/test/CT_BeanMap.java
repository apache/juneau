...
public class CT_BeanMap {
	...
	public void testBeanPropertyAnnotation() throws Exception {
		...
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("l2")).get(0).getClass().getName());

		m.put("l3", "[{a:'a',i:1}]");
		assertEquals("com.ibm.juno.core.ObjectList", m.get("l3").getClass().getName());
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("l3")).get(0).getClass().getName());

		m.put("l4", "[{a:'a',i:1}]");
		assertEquals("java.util.LinkedList", m.get("l4").getClass().getName());
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("l4")).get(0).getClass().getName());
		...
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("m2")).get(0).getClass().getName());

		m.put("m3", "[{a:'a',i:1}]");
		assertEquals("com.ibm.juno.core.ObjectList", m.get("m3").getClass().getName());
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("m3")).get(0).getClass().getName());

		m.put("m4", "[{a:'a',i:1}]");
		assertEquals("java.util.LinkedList", m.get("m4").getClass().getName());
		assertEquals("com.ibm.juno.core.test.CT_BeanMap$G", ((List)m.get("m4")).get(0).getClass().getName());
	}
	...
	public void testBeanWithFluentStyleSetters() throws Exception {
		...
		assertObjectEquals("{f1:1,f2:2,f3:0}", m);
	}
	...
	//====================================================================================================
	// testCastToLinkedListUsingFilter - cast() to LinkedList<Calendar> using CalendarFilter
	//====================================================================================================
	@Test
	public void testCastToLinkedListUsingFilter() throws Exception {
		BeanContext bc = new BeanContextFactory().addFilters(CalendarFilter.ISO8601DTZ.class).getBeanContext();
	...
	public void testBeanMethodOrder() throws Exception {
		assertObjectEquals("{a1:'1',a2:'2',a3:'3',a4:'4'}", new W2());
		assertObjectEquals("{a3:'3',a4:'4',a5:'5',a6:'6'}", new W3());
	}
	...
	private BeanContext getBeanContext() {
		return new BeanContextFactory().setClassLoader(this.getClass().getClassLoader()).getBeanContext();
	}
