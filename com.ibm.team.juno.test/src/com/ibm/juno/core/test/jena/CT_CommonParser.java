...
public class CT_CommonParser {
	...
	private String wrap(String in) {
		return ""
		    ...
		    + " xmlns:j='http://www.ibm.com/juno/'"
		    + " xmlns:jp='http://www.ibm.com/junobp/'>"
		    + in
		    + "</rdf:RDF>";
	}
	...
	public void testFromSerializer() throws Exception {
		...
		ReaderParser p = new RdfParser.Xml().setProperty(RdfParserProperties.RDF_trimWhitespace, true).setClassLoader(getClass().getClassLoader());
		Map m = null;
		String in;
		...
		in = wrap("<rdf:Description><jp:x>com.ibm.juno.core.test.Person</jp:x><jp:addresses><rdf:Seq><rdf:li rdf:parseType='Resource'><jp:x>com.ibm.juno.core.test.Address</jp:x><jp:city>city A</jp:city><jp:state>state A</jp:state><jp:street>street A</jp:street><jp:zip rdf:datatype='http://www.w3.org/2001/XMLSchema#int'>12345</jp:zip></rdf:li></rdf:Seq></jp:addresses></rdf:Description>");
		m = (Map)p.parse(in, Object.class);
