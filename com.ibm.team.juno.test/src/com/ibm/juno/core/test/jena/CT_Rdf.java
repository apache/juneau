...
public class CT_Rdf {
	...
	public void testCollectionFormatProperties() throws Exception {
		...
		//--------------------------------------------------------------------------------
		expected =
			"<rdf:RDF a='http://ns/' j='http://www.ibm.com/juno/' jp='http://www.ibm.com/junobp/' rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>"
		...
		assertEquals(expected, sortXml(rdfXml));
	...
	public void testCollectionFormatAnnotations() throws Exception {
		...
		expected =
			 "<rdf:RDF b='http://ns/' j='http://www.ibm.com/juno/' jp='http://www.ibm.com/junobp/' rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>"
	...
	public void testLooseCollectionsOfBeans() throws Exception {
		...
		expected =
			"<rdf:RDF j='http://www.ibm.com/juno/' jp='http://www.ibm.com/junobp/' rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>"
