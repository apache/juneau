...
public class CT_PojoRest {
	...
	public void testBeans() throws Exception {
		...
		String expectedValue = "{_class:'com.ibm.juno.core.test.utils.CT_PojoRest$Person',name:'some name',age:123,addresses:[{street:'street A',city:'city A',state:'state A',zip:12345,isCurrent:true},{street:'street B',city:'city B',state:'state B',zip:12345,isCurrent:false}]}";
		...
		expectedValue = "{_class:'com.ibm.juno.core.test.utils.CT_PojoRest$Person',name:'some name',age:123,addresses:[{street:'street A',city:'city A',state:'state A',zip:12345,isCurrent:true},{street:'street B',city:'city B',state:'state B',zip:12345,isCurrent:false}]}";
		assertEquals(expectedValue, s);
