...
public class CT_JsonParser {
	...
	public void testNonStringAsString() throws Exception {
		...
		try {
			...
			assertTrue(e.getCause().getMessage().contains("Did not find quote character"));
		}
		...
		try {
			...
			assertTrue(e.getCause().getCause().getMessage().contains("Did not find quote character"));
		}
		...
		try {
			...
			assertTrue(e.getCause().getMessage().contains("Invalid quote character"));
		}
	}
	...
	public void testCognosJson() throws Exception {
		String json = TestUtils.readFile("/com/ibm/juno/core/test/json/BrokenCognosOutput.txt");
	...
	public void testStrictMode() throws Exception {
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='7'.  Missing value detected.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='7'.  Invalid quote character \"'\" being used.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='1'.  Invalid quote character \"'\" being used.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='1'.  Unquoted attribute detected.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='12'.  String concatenation detected.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='13'.  String concatenation detected.", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Parse exception occurred at line='1', column='8'.  Javascript comment detected.", e.getRootCause().getMessage());
		}
	}
	...
	public void testInvalidJsonNumbers() throws Exception {
		...
		try {
			...
			assertEquals("Invalid JSON number ''", e.getRootCause().getMessage());
		}
		...
		try {
			...
			assertEquals("Invalid JSON number '0123'", e.getRootCause().getMessage());
		}
		s = "-0123";
		r = p1.parse(s, Number.class);
		assertEquals(-0123, r.intValue());
		...
		try {
			...
			assertEquals("Invalid JSON number '0x123'", e.getRootCause().getMessage());
		}
		s = "-0x123";
		r = p1.parse(s, Number.class);
		assertEquals(-0x123, r.intValue());
