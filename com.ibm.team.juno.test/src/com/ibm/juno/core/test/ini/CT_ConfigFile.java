 ...
 *******************************************************************************/
package com.ibm.juno.core.test.ini;
...
public class CT_ConfigFile {
	...
	public void testCommentsOnly() throws Exception {
		...
		ConfigFile cfw = cf.getResolving(StringVarResolver.DEFAULT);
	...
	public void testBasics() throws Exception {
		...
		cf.save();
		cf = ConfigMgr.DEFAULT.create(f);
		cfw = cf.getResolving(StringVarResolver.DEFAULT);
	...
	public void testSerialization() throws Exception {
		...
		cf = cf.getResolving(StringVarResolver.DEFAULT);
		assertObjectEquals(expected, cf);
	}
	...
	public void testEncodedValues() throws Exception {
		...
		ConfigFile cf = ConfigMgr.DEFAULT.create(f)
			...
			.getResolving(StringVarResolver.DEFAULT);
		ConfigFile cfw = cf.getResolving(StringVarResolver.DEFAULT);
	...
	public void testListeners() throws Exception {
		ConfigFile[] cff = {
			...
			ConfigMgr.DEFAULT.create(FileUtils.createTempFile("CT_ConfigFile.cfg")).addLines(null, "a1=1").addLines("B", "b1=1").getResolving(StringVarResolver.DEFAULT)
		};
	...
	public void testEntryListener() throws Exception {
		ConfigFile[] cff = {
			...
			ConfigMgr.DEFAULT.create().addLines(null, "a1=1").addLines("B", "b1=1").getResolving(StringVarResolver.DEFAULT)
		};
	...
	public void testMerge() throws Exception {
		...
		cf1 = ConfigMgr.DEFAULT.create()
			.addLines(null, "# comment a1", "a1=1")
			.addLines("B", "# comment b1", "b1=1").addHeaderComments("B", "# comment B1")
			.addLines("C", "# comment c1", "bc=1").addHeaderComments("C", "# comment C1").getResolving(StringVarResolver.DEFAULT);
		cf2 = ConfigMgr.DEFAULT.create()
			.addLines(null, "# comment a2", "a2=2")
			.addLines("B", "# comment b2", "b2=2").addHeaderComments("B", "# comment B2")
			.addLines("D", "# comment d2", "d2=2").addHeaderComments("D", "# comment D2").getResolving(StringVarResolver.DEFAULT);
	...
	public void testDefaultSection() throws Exception {
		ConfigFile[] cff = {
			...
			ConfigMgr.DEFAULT.create().addLines(null, "a1=1").addLines("", "a2=2").addLines("default", "a3=3").getResolving(StringVarResolver.DEFAULT)
		};
	...
	public void testLoadFromReader() throws Exception {
		ConfigFile[] cff = {
			...
			ConfigMgr.DEFAULT.create().addLines(null, "a1=1").getResolving(StringVarResolver.DEFAULT)
		};
	...
	public void testResolvingWithOverride() throws Exception {
		...
		vr.addVar("A", new StringVar() {
			@Override
			public String resolve(String arg) {
				return 'a' + arg + 'a';
			}
		});
		vr.addVar("B", new StringVar() {
			@Override
			public String resolve(String arg) {
				return 'b' + arg + 'b';
			}
		...
		assertEquals("$C{X}", cf.getString("e"));

		// Create new resolver that addx $C and overrides $A
		StringVarResolver vr2 = new StringVarResolver();
		vr2.addVar("A", new StringVar() {
			@Override
			public String resolve(String arg) {
				return 'A' + arg + 'A';
			}
		});
		vr2.addVar("C", new StringVar() {
			@Override
			public String resolve(String arg) {
				return 'C' + arg + 'C';
			}
		...
		cf = cf.getResolving(vr2, true);
		assertEquals("AXA", cf.getString("a"));
		assertEquals("bXb", cf.getString("b"));
		assertEquals("AbXbA", cf.getString("c"));
		assertEquals("bAXAb", cf.getString("d"));
		assertEquals("CXC", cf.getString("e"));
	}
