...
public class CT_RoundTripObjectsAsStrings extends RoundTripTest {
	...
	public CT_RoundTripObjectsAsStrings(String label, WriterSerializer s, ReaderParser p, int flags) throws Exception {
	...
	public void testEnumWithOverriddenStringValue() throws Exception {
		...
		if (! returnOriginalObject) {
			String r = getSerializer().serialize(t);
			assertTrue(r.contains("X-2"));
		}
		t = roundTrip(t);
