...
public class CT_CommonParser {
	...
	public void testFromSerializer() throws Exception {
		...
		m = (Map)p.parse("<object><x type='string'>com.ibm.juno.core.test.Person</x><addresses type='array'><object><x type='string'>com.ibm.juno.core.test.Address</x><city type='string'>city A</city><state type='string'>state A</state><street type='string'>street A</street><zip type='number'>12345</zip></object></addresses></object>", Object.class);
