...
import com.ibm.juno.core.test.xml.xml1a.*;
import com.ibm.juno.core.test.xml.xml1b.*;
import com.ibm.juno.core.test.xml.xml1c.*;
...
public class CT_Xml {
	...
	public void testComparisonWithJson() throws Exception {
		String json1 = readFile("/com/ibm/juno/core/test/xml/testComparisonWithJson.json");
		String xml1 = readFile("/com/ibm/juno/core/test/xml/testComparisonWithJson.xml");
	...
	public void testNamespaces() throws Exception {
		String e = readFile("/com/ibm/juno/core/test/xml/testNamespaces.xml");
		ObjectMap m = (ObjectMap) JsonParser.DEFAULT.parse(readFile("/com/ibm/juno/core/test/xml/testComparisonWithJson.json"), Object.class);
	...
	public void testElementNameInInvalidLocations() throws Exception {
		...
		try {
			...
			assertEquals("com.ibm.juno.core.test.xml.CT_Xml$E: Annotation error on property 'f1'.  Found @Xml.name annotation can only be specified on types.", e.getLocalizedMessage());
		}
	}
	...
	public void testXmlFormatAttrWithNs() throws Exception {
		...
		t.f1 = 4; t.f2 = 5; t.f3 = 6;
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:bar='http://bar' xmlns:foo='http://foo' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' bar:f1='4' foo:f2='5' baz:f3='6'/>", r);
		t = p.parse(r, M.class);
		assertEquals(4, t.f1);
		assertEquals(5, t.f2);
		assertEquals(6, t.f3);
	...
	public void testNsOnClass() throws Exception {
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></object>", r);
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></object>", r);
		assertTrue(t.equals(p.parse(r, T1.class)));
		validateXml(t, s);
	...
	public void testNsOnClassWithElementName() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true);
		r = s.serialize(t);
		assertEquals("<foo:T2 xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></foo:T2>", r);
		...
		r = s.serialize(t);
		assertEquals("<foo:T2 xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></foo:T2>", r);
		assertTrue(t.equals(p.parse(r, T2.class)));
		validateXml(t, s);
	...
	public void testNsOnPackageNoNsOnClass() throws Exception {
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1><bar:f2>2</bar:f2><p1:f3>3</p1:f3><baz:f4>4</baz:f4></object>", r);
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:p1='http://p1' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1><bar:f2>2</bar:f2><p1:f3>3</p1:f3><baz:f4>4</baz:f4></object>", r);
		assertTrue(t.equals(p.parse(r, T3.class)));
		validateXml(t, s);
	...
	public void testNsOnPackageNoNsOnClassElementNameOnClass() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true);
		r = s.serialize(t);
		assertEquals("<p1:T4 xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1><bar:f2>2</bar:f2><p1:f3>3</p1:f3><baz:f4>4</baz:f4></p1:T4>", r);
		...
		r = s.serialize(t);
		assertEquals("<p1:T4 xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:p1='http://p1' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1><bar:f2>2</bar:f2><p1:f3>3</p1:f3><baz:f4>4</baz:f4></p1:T4>", r);
		assertTrue(t.equals(p.parse(r, T4.class)));
		validateXml(t, s);
		...
		s.setProperty(XML_enableNamespaces, true);
		r = s.serialize(t);
		assertEquals("<p1:T4 xmlns='http://www.ibm.com/2013/Juno' xmlns:p1='http://p1' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1><bar:f2>2</bar:f2><p1:f3>3</p1:f3><baz:f4>4</baz:f4></p1:T4>", r);
		assertTrue(t.equals(p.parse(r, T4.class)));
		validateXml(t, s);
	}
	...
	public void testNsOnPackageNsOnClassElementNameOnClass() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true);
		r = s.serialize(t);
		assertEquals("<foo:T5 xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></foo:T5>", r);
		...
		r = s.serialize(t);
		assertEquals("<foo:T5 xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><foo:f1>1</foo:f1><bar:f2>2</bar:f2><foo:f3>3</foo:f3><baz:f4>4</baz:f4></foo:T5>", r);
		assertTrue(t.equals(p.parse(r, T5.class)));
		validateXml(t, s);
	...
	public void testComboOfNsAndOverriddenBeanPropertyNames() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true).setProperty(XML_autoDetectNamespaces, false);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:g1>1</p1:g1><bar:g2>2</bar:g2><p1:g3>3</p1:g3><baz:g4>4</baz:g4></object>", r);
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:p1='http://p1' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:g1>1</p1:g1><bar:g2>2</bar:g2><p1:g3>3</p1:g3><baz:g4>4</baz:g4></object>", r);
		assertTrue(t.equals(p.parse(r, T7.class)));
		...
		s.setProperty(XML_enableNamespaces, true);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:p1='http://p1' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:g1>1</p1:g1><bar:g2>2</bar:g2><p1:g3>3</p1:g3><baz:g4>4</baz:g4></object>", r);
		assertTrue(t.equals(p.parse(r, T7.class)));
		validateXml(t, s);
	}
	...
	public void testXmlNsAnnotation() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p2:f1>1</p2:f1><p1:f2>2</p1:f2><c1:f3>3</c1:f3><f1:f4>4</f1:f4></object>", r);
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p2:f1>1</p2:f1><p1:f2>2</p1:f2><c1:f3>3</c1:f3><f1:f4>4</f1:f4></object>", r);
		...
		s.setProperty(XML_enableNamespaces, true);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:p2='http://p2' xmlns:p1='http://p1' xmlns:c1='http://c1' xmlns:f1='http://f1' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p2:f1>1</p2:f1><p1:f2>2</p1:f2><c1:f3>3</c1:f3><f1:f4>4</f1:f4></object>", r);
		assertTrue(t.equals(p.parse(r, T8.class)));
		validateXml(t, s);
	}
	...
	public void testXmlNsOnPackageNsUriInXmlNs() throws Exception {
		...
		s.setProperty(XML_addNamespaceUrisToRoot, true);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1></object>", r);
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:foo='http://foo' xmlns:bar='http://bar' xmlns:baz='http://baz' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1></object>", r);
		...
		s.setProperty(XML_enableNamespaces, true);
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:p1='http://p1' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><p1:f1>1</p1:f1></object>", r);
		assertTrue(t.equals(p.parse(r, T9.class)));
		validateXml(t, s);
	}
	...
	public void testXmlAttrs() throws Exception {
		...
		r = s.serialize(t);
		assertEquals("<object xmlns='http://www.ibm.com/2013/Juno' xmlns:ns='http://ns' xmlns:nsf1='http://nsf1' xmlns:nsf3='http://nsf3' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' nsf1:f1='http://xf1' ns:f2='xf2' nsf3:x3='xf3'/>", r);
		validateXml(t, s);
