...
public class RequestBeanProxyTest {
	...
	static A02_RemoteResource a02a = MockRestClient.build(A.class).getRemote(A02_RemoteResource.class);
	...
	static A03_RemoteResource a03a = MockRestClient.build(A.class).getRemote(A03_RemoteResource.class);
	...
	static A04_RemoteResource a04a = MockRestClient.build(A.class).getRemote(A04_RemoteResource.class);
	...
	static A05_RemoteResource a05a = MockRestClient.build(A.class).getRemote(A05_RemoteResource.class);
	...
	static A06_RemoteResource a06a = MockRestClient.build(A.class).getRemote(A06_RemoteResource.class);
	...
	static C02_RemoteResource c02a = MockRestClient.build(C.class).getRemote(C02_RemoteResource.class);
	...
	static C03_RemoteResource c03a = MockRestClient.build(C.class).getRemote(C03_RemoteResource.class);
	...
	static C04_RemoteResource c04a = MockRestClient.build(C.class).getRemote(C04_RemoteResource.class);
	...
	static C05_RemoteResource c05a = MockRestClient.build(C.class).getRemote(C05_RemoteResource.class);
	...
	static C06_RemoteResource c06a = MockRestClient.build(C.class).getRemote(C06_RemoteResource.class);
	...
	static E02_RemoteResource e02a = MockRestClient.build(E.class).getRemote(E02_RemoteResource.class);
	...
	static E03_RemoteResource e03a = MockRestClient.build(E.class).getRemote(E03_RemoteResource.class);
	...
	static E04_RemoteResource e04a = MockRestClient.build(E.class).getRemote(E04_RemoteResource.class);
	...
	static G01_RemoteResource g01a = MockRestClient.build(G.class).getRemote(G01_RemoteResource.class);
	...
	static G02_RemoteResource g02a = MockRestClient.build(G.class).getRemote(G02_RemoteResource.class);
	...
	static G03_RemoteResource g03a = MockRestClient.build(G.class).getRemote(G03_RemoteResource.class);
	...
	static G04_RemoteResource g04a = MockRestClient.build(G.class).getRemote(G04_RemoteResource.class);
