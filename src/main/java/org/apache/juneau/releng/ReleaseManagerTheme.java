 ...
 *
 * <p>
 * Its token values currently just restate {@link Theme#OPEN}'s own values &mdash; the app's existing look already
 * matches the shipped default. A dedicated class (rather than an inline builder call at the mixin-wiring site)
 * gives the app one obvious, named place to diverge its palette later. The logo and page-background image are
