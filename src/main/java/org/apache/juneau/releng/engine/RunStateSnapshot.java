...
/**
 * A compact projection of a {@link RunState} pushed to every connected New-Release tab over the run-state SSE
...
public class RunStateSnapshot {
	...
	/**
	 * Projects {@code rs} down to the fields the rail needs.
	 */
	public static RunStateSnapshot of(RunState rs) {
	...
	public static class StepSnapshot {
		...
		/**
		 * Constructs a snapshot for one step's id and status.
		 */
