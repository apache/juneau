...
![Import Project](/topics/MyJettyMicroserviceInstalling.Installing.1.png)

- Select the archive file and import the project:

![Select Archive](/topics/MyJettyMicroserviceInstalling.Installing.2.png)

- In your workspace, you should now see the following project:

![Project in Workspace](/topics/MyJettyMicroserviceInstalling.Installing.3.png)
