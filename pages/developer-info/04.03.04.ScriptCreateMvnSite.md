...
- The script requires a sibling `../master/` checkout (the Java tree) alongside `juneau-docs` - the Maven site is generated there, then copied over
- The script creates a log file (`create-mvn-site.log`) in the `master` checkout's root
