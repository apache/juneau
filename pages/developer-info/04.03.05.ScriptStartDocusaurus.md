...
- The script resolves its working directory relative to its own location (`scripts/../`), i.e. the `juneau-docs` repository root it lives in - it does not need to be run from any particular directory itself
