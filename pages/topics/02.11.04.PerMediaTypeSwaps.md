...
public class ObjectSwapTest {
    ...
    public static class MyJsonSwap extends StringSwap {
        ...
        @Override /* ObjectSwap */
        public String swap(MarshallingSession session, MyPojo pojo) throws Exception {
            return "It's JSON!";
        }
    }
    ...
    public void doTest() throws Exception {
        ...
        String json = serializers.getWriterSerializer("text/json").serialize(myPojo);
        assertEquals("'It\\'s JSON!'", json);

        String xml = serializers.getWriterSerializer("text/xml").serialize(myPojo);
        assertEquals("It's XML!", xml);

        String html = serializers.getWriterSerializer("text/html").serialize(myPojo);
