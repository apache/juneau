...
- Using a <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp(method=RRPC)</a> annotation on a Java method.
...
The <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp(method=RRPC)</a> approach is easier if you only have a single interface you want to expose.
...
<a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp</a>(method=RRPC, path="/addressbookproxy/*")
