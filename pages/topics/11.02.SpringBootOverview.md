...
public class App {
    ...
    // Our root REST bean.
    // Note that this must extend from <a href="/site/apidocs/org/apache/juneau/rest/server/springboot/SpringRestServlet.html" target="_blank">SpringRestServlet</a> to allow use of injection.
    // All REST objects are attached to this bean using the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#children()" target="_blank">Rest.children()</a> annotation.
    @Bean
