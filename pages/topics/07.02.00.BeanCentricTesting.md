---
id: 07.02.BeanCentricTesting
title: "Bean-Centric Testing"
slug: BeanCentricTesting
---
...
- [Custom Error Messages](CustomErrorMessages) - Enhanced error reporting
- [Customization](Customization) - Configuration via @BctConfig and BctConfiguration
  - [Stringifiers](Stringifiers) - Custom string conversions
  - [Listifiers](Listifiers) - Custom list conversions
  - [Swappers](Swappers) - Object transformation
- [Property Extractors](PropertyExtractors) - Custom property access
...
BCT is used extensively across the Apache Juneau project's own test suite:

- **Broad adoption**: a large share of Juneau's test files use BCT assertions in place of hand-written property checks.
- **Code reduction**: many lines of verbose property extraction are replaced with concise assertions.
- **Test clarity**: complex object validation is simplified to single-line assertions.
...
### [assertBean(Object, String, String)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertBean(java.lang.Object,java.lang.String,java.lang.String))
...
### [assertBeans(Collection, String, String...)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertBeans(java.lang.Object,java.lang.String,java.lang.String...))
...
### [assertList(Object, Object...)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertList(java.lang.Object,java.lang.Object...))
...
### [assertMapped(Object, BiFunction, String, String)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertMapped(java.lang.Object,java.util.function.BiFunction,java.lang.String,java.lang.String))
...
### [assertContains(String, Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertContains(java.lang.String,java.lang.Object))
...
### [assertContainsAll(Object, String...)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertContainsAll(java.lang.Object,java.lang.String...))
...
### [assertEmpty(Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertEmpty(java.lang.Object))
...
### [assertNotEmpty(Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertNotEmpty(java.lang.Object))
...
### [assertSize(int, Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertSize(int,java.lang.Object))
...
### [assertString(String, Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertString(java.lang.String,java.lang.Object))
...
### [assertMatchesGlob(String, Object)](pathname:///site/apidocs/org/apache/juneau/test/bct/BctAssertions.html#assertMatchesGlob(java.lang.String,java.lang.Object))
...
BCT provides several advanced configuration options for customizing assertion behavior:

### @BctConfig Annotation

The `@BctConfig` annotation provides a declarative way to configure BCT settings for your tests. It can be applied at the class level or method level, with method-level annotations taking precedence.
...
For more details, see [Customization](Customization).

### Custom Bean Converters

The default bean converter can be customized on a per-thread basis using `BctAssertions.setConverter(BeanConverter)` (a thin passthrough to `BctConfiguration.set(BeanConverter)`) or via the `@BctConfig` annotation. This is particularly useful in test setup methods to configure a custom converter for all tests in a test class or method.
...
**Thread Safety:** The converter is stored per-thread, allowing parallel test execution without cross-thread interference. Each test method running in parallel will have its own converter instance.

### See Advanced Topics

For detailed information on extending and customizing BCT, see:

- **[Custom Error Messages](CustomErrorMessages)** - Add contextual information to assertion failures
- **[Customization](Customization)** - Configure BCT via @BctConfig annotation and BctConfiguration class
  - **[Stringifiers](Stringifiers)** - Define how objects are converted to strings for comparison
  - **[Listifiers](Listifiers)** - Convert collection-like objects to lists for testing
  - **[Swappers](Swappers)** - Transform objects before processing (unwrap Optional, Supplier, etc.)
- **[Property Extractors](PropertyExtractors)** - Define custom property access logic for non-standard objects
