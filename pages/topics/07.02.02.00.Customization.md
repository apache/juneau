...
void setUp() {
    var converter = BasicBeanConverter.builder()
        ...
        .addStringifier(LocalDate.class, (conv,date) -> 
            date.format(DateTimeFormatter.ISO_LOCAL_DATE))
        .build();
    setConverter(converter); // BctAssertions.setConverter(...) - a thin passthrough to BctConfiguration.set(...)
}

@AfterEach
void tearDown() {
    resetConverter(); // BctAssertions.resetConverter() - a thin passthrough to BctConfiguration.clear()
}
```
