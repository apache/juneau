...
Date/time types (`Calendar`, `Date`, `Temporal` subtypes, `Duration`) and streamable sequence types
(`Iterator`, `Stream`) are also serialized natively without any configuration.
...
- [juneau-rest-server Basics](/docs/topics/JuneauRestServerBasics) for more information.
