...
- A static `create()` method on the POJO class that returns a builder instance.  
  ...
  public static Builder create() {...}
  ```
- A public constructor on the POJO class that takes in a single parameter that implements the <a href="/site/apidocs/org/apache/juneau/marshall/swap/Builder.html" target="_blank">Builder</a> interface.  
...
<node-0><java-abstract-class><a href="/site/apidocs/org/apache/juneau/marshall/swap/Builder.html" target="_blank">org.apache.juneau.marshall.swap.Builder</a></java-abstract-class></node-0>
</tree>
