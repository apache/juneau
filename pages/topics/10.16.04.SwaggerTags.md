...
Tags are also defined in the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Swagger.html" target="_blank">@Swagger</a> annotation
...
Tags are associated with operations using the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/OpSwagger.html#tags()" target="_blank">@OpSwagger(tags)</a> annotation:
