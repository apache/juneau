...
The <a href="/site/apidocs/org/apache/juneau/marshall/json/Json5Serializer.html" target="_blank">Json5Serializer</a> class can be used to serialized POJOs
...
- [JSON5L Basics](/docs/topics/Json5lBasics) — JSON5 combined with newline-delimited (one document per line) framing.
:::