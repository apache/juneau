...
- **Testing REST services** - Use the mock framework (add `juneau-rest-mock` as a test dependency — it is not bundled here)

<DependencyInfo artifact="juneau-shaded-rest-server" bazel />
...
- **Learn about REST server:** See [REST Server Basics](/docs/topics/JuneauRestServer)
- **Learn about Swagger integration:** See [Swagger Integration](/docs/topics/Swagger)
