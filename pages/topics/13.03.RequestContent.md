...
The request body can either be passed in with the client creator method (e.g. <a href="/site/apidocs/org/apache/juneau/rest/client/classic/RestClient.html#post(java.lang.Object)" target="_blank">post(uri,body)</a>), or can be specified via the following methods:
...
<node-1><java-method><a href="/site/apidocs/org/apache/juneau/rest/client/classic/RestRequest.html#content(java.lang.Object)" target="_blank">content(Object)</a></java-method></node-1>
<node-1><java-method><a href="/site/apidocs/org/apache/juneau/rest/client/classic/RestRequest.html#content(java.lang.Object)" target="_blank">content(Object,HttpPartSchema)</a></java-method></node-1>
</tree>

The request body can be any of the following types:

<tree>
<node-0><java-class><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" target="_blank">Object</a></java-class> - POJO to be converted to text using the <a href="/site/apidocs/org/apache/juneau/marshall/serializer/Serializer.html" target="_blank">Serializer</a> defined on the client or request.</node-0>
...
If the part serializer is also null, POJOs will be converted to strings using <a href="/site/apidocs/org/apache/juneau/marshall/ClassMeta.html#toString()" target="_blank">ClassMeta.toString(Object)</a> which typically just calls <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html#toString()" target="_blank">Object.toString()</a>.
:::
