...
|----------|------------------|-------------|---------------|
| **juneau-core** | [juneau‑assertions](/docs/topics/JuneauAssertionBasics) | Fluent-style assertions API | • *None* |
...
| | [juneau‑commons](/docs/topics/JuneauCommonsBasics) | Common utilities and APIs used across the Juneau ecosystem (collections, I/O, reflection, settings, etc.) | • *None* |
| | [juneau‑config](/docs/topics/JuneauConfigBasics) | Configuration File API | • *None* |
| | [juneau‑marshall](/docs/topics/JuneauMarshallBasics) | Serializers and parsers for JSON (various flavors), XML, HTML, URL-Encoding, UON, OpenAPI, PlainText, CSV, SOAP, and MessagePack. | • Apache HttpCore 4.4 |
...
| | [juneau‑svl](/docs/topics/MarshallSvlVariables) | Simple Variable Language for dynamic string processing | • *None* |
| **juneau-rest** | [juneau‑rest‑client](/docs/topics/JuneauRestClientBasics) | REST Client API | • Apache HttpClient 4.5 |
| | [juneau‑rest‑common](/docs/topics/JuneauRestCommonBasics) | REST APIs common to client and server side. | • Apache HttpCore 4.4 |
...
| **juneau-shaded** | [juneau‑shaded‑all](/docs/topics/JuneauShadedAll) | Complete framework in one JAR (4.0 MB)<br/>*Ideal for Bazel and simplified dependency management* | • Servlet API 6.1+<br/>• Apache HttpClient 5.x |
| | [juneau‑shaded‑core](/docs/topics/JuneauShadedCore) | Core marshalling and configuration in one JAR (2.0 MB) | • *None* |
