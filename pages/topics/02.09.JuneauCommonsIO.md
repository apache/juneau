...
The [org.apache.juneau.commons.io](/site/apidocs/org/apache/juneau/commons/io/package-summary.html) package provides file and stream utilities, console support, MIME type detection, and path builders for working with files and I/O operations.
...
String mimeType = MimeTypeDetector.DEFAULT.getContentType("file.pdf");  // "application/pdf"
...
- [JavaDoc: I/O Package](/site/apidocs/org/apache/juneau/commons/io/package-summary.html)
