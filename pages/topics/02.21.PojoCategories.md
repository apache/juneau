...
<table className="styled w800" style={{borderCollapse: 'collapse'}}>
  ...
  <tr className="dark bb" style={{backgroundColor: 'lightyellow'}}>
    ...
    <td>
      ...
      <br /><br />
      <i>Note: As of 9.5.0, date/time types (`Calendar`, `Date`, `Temporal` subtypes, `XMLGregorianCalendar`, `Duration`)
      are handled natively (group 2d) and no longer require swaps. Swap classes remain available as override mechanisms.</i>
    </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr className="light bb">
    ...
    <td>
      ...
      For example, a swap that converts a complex object to a simpler serializable form.
    </td>
    <td>
      <ul className="normal">
  ...
  <tr className="light bb">
    ...
    <td>
      ...
      For example, a swap that converts a complex object to a simpler serializable form where reconstruction is not possible.<br />
      <i>Note: As of 9.5.0, `Iterator` and `Enumeration` are handled natively (group 2c) and no longer require swaps.</i>
    </td>
    <td>&nbsp;</td>
    <td style={{backgroundColor: 'lightgreen', textAlign: 'center'}}><b>yes</b></td>
    <td style={{backgroundColor: 'salmon', textAlign: 'center'}}><b>no</b></td>
  ...
  <tr className="light bb" style={{backgroundColor: 'lightyellow'}}>
    ...
    <td>
      ...
      <ul>
        <li>`public X swap(MarshallingSession);` where `X` is in groups [1, 2a, 3ac].</li>
      ...
      <ul>
        ...
        <li>`public static T unswap(MarshallingSession,X);` where `X` is in groups [1, 2a, 3ac].</li>
      </ul>
    </td>
    <td>
      <ul className="normal">
  ...
  <tr className="light bb" style={{backgroundColor: 'lightyellow'}}>
    ...
    <td>
      ...
      <ul>
        <li>`public X swap(MarshallingSession);` where `X` is in groups [1, 2, 3].</li>
        <li>`public String toString();` where the string is any meaningful data.</li>
      </ul>
    </td>
    <td>&nbsp;</td>
