...
In the case of the `PetStoreResource.getPets()` method, we pull this information from a static field defined in the <a href="/site/apidocs/org/apache/juneau/rest/server/converter/Queryable.html" target="_blank">Queryable</a> class:
