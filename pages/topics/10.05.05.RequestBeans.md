...
The example above is identical in behavior to specifying individual annotated parameters on the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp</a>-annotated
method:
