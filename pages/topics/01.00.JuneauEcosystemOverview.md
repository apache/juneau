...
- **Universal Serialization** - Marshal POJOs to JSON (plus JSON5 and JSONL), XML, HTML, URL-Encoding, UON, OpenAPI, MessagePack, CSV, PlainText, and SOAP — plus RDF/XML, Turtle, N-Triple, and N3 via juneau-marshall-rdf
