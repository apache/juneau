...
What makes this possible is that method-level annotations such as <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp</a> and parameter-level annotations such as
...
In the example above, we chose to add the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp</a> annotation to the implementation class.
