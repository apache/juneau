...
In the special case of `Collections`/arrays of `Maps`/beans, a special XPath-like selector notation can be used in lieu of
...
:::note
This class is used in the <a href="/site/apidocs/org/apache/juneau/rest/server/converter/Traversable.html" target="_blank">Traversable</a> REST response
converter.
:::
