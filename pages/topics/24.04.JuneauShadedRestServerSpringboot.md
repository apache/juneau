...
<DependencyInfo artifact="juneau-shaded-rest-server-springboot" bazel />
...
public class MyResource extends SpringRestServlet {
}
```
...
- **Learn about Spring Boot integration:** See [Spring Boot Integration](/docs/topics/SpringBootOverview)
- **Learn about Spring Security:** See [Spring Security Integration](/docs/topics/RestSecurity)
