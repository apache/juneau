...
The <a href="/site/apidocs/org/apache/juneau/marshall/xml/Xml.html#format()" target="_blank">@Xml(format)</a> annotation can be used to tweak the
XML format of a POJO.
The value is set to an enum value of type <a href="/site/apidocs/org/apache/juneau/marshall/xml/XmlFormat.html" target="_blank">XmlFormat</a>.
...
The <a href="/site/apidocs/org/apache/juneau/marshall/xml/XmlFormat.html#ATTRS" target="_blank">XmlFormat.ATTRS</a> format can be applied to a
