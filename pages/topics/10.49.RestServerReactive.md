...
A single response processor — `ReactiveResponseProcessor` ([org.apache.juneau.rest.server.reactive](/site/apidocs/org/apache/juneau/rest/server/reactive/package-summary.html), shipped in the opt-in `juneau-rest-server-reactive` module) — is the shared spine for all reactive return-type support.
