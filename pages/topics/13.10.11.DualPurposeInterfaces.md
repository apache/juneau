...
What makes this possible is that method-level annotations such as <a href="/site/apidocs/org/apache/juneau/rest/server/RestOp.html" target="_blank">@RestOp</a> and parameter-level annotations such as
<a href="/site/apidocs/org/apache/juneau/http/Query.html" target="_blank">@Query</a> are inherited from parent classes.
...
In the example above, we chose to add the <a href="/site/apidocs/org/apache/juneau/rest/server/RestOp.html" target="_blank">@RestOp</a> annotation to the implementation class.
...
Note how we didn't need to use the <a href="/site/apidocs/org/apache/juneau/http/Header.html" target="_blank">@Header</a> and <a href="/site/apidocs/org/apache/juneau/http/Path.html" target="_blank">@Path</a> annotations in our implementation since the annotations were
