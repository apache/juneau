...
<a href="/site/apidocs/org/apache/juneau/marshall/Swap.html" target="_blank">@Swap</a> can be used to associate a swap class using an annotation.
...
public class MyObjectSwap extends ObjectSwap {
    @Override /* ObjectSwap */
    public String swap(MarshallingSession session, MyPojo pojo) {
        return pojo.toSomeSerializableForm();
    }
}
```

Multiple swaps can be associated with a class using multiple <a href="/site/apidocs/org/apache/juneau/marshall/Swap.html" target="_blank">@Swap</a> annotations:
...
public class MyJsonSwap extends ObjectSwap {
    ...
    public Reader swap(MarshallingSession session, MyPojo pojo) throws Exception {
        return new StringReader("{message:'Custom JSON!'}");
    }
}
```

The <a href="/site/apidocs/org/apache/juneau/marshall/Swap.html" target="_blank">@Swap</a> annotation can also be used on getters and setters as well to apply a swap to individual property values:
