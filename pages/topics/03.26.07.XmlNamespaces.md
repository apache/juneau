...
Enabling the <a href="/site/apidocs/org/apache/juneau/marshall/xml/XmlSerializer.Builder.html#addNamespaceUrisToRoot()" target="_blank">XmlSerializer.Builder.addNamespaceUrisToRoot()</a> setting results in the namespace URLs being added to the root
node:
