...
The canonical in-tree sample application is the [juneau-petstore](/docs/topics/JuneauPetstoreOverview), which ships two
...
For the full petstore walkthrough — modules, resources, running the app — see [juneau-petstore Overview](/docs/topics/JuneauPetstoreOverview).