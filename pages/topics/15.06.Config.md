...
`SYSTEM_DEFAULT` such as those implementing the <a href="/site/apidocs/org/apache/juneau/rest/server/servlet/BasicRestOperations.html" target="_blank">BasicRestConfig</a> interface.
