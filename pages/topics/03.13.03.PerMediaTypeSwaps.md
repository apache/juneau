...
The <a href="/site/apidocs/org/apache/juneau/marshall/swap/spi/ObjectSwap.html#forMediaTypes()" target="_blank">ObjectSwap.forMediaTypes()</a> method can be
...
public class ObjectSwapTest {
    ...
    public void doTest() throws Exception {
        ...
        String json = serializers.getWriterSerializer("text/json").orElseThrow().write(myPojo);
        assertEquals("'It\\'s JSON!'", json);

        String xml = serializers.getWriterSerializer("text/xml").orElseThrow().write(myPojo);
        assertEquals("It's XML!", xml);

        String html = serializers.getWriterSerializer("text/html").orElseThrow().write(myPojo);
