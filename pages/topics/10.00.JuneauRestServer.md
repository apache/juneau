---
id: 10.juneau-rest-server
title: "juneau-rest-server"
slug: JuneauRestServer
---

<DependencyInfo artifact="juneau-rest-server" bundle="org.apache.juneau.rest.server" />
...
The root class, <a href="/site/apidocs/org/apache/juneau/rest/server/servlet/RestServlet.html" target="_blank">RestServlet</a> is nothing but a specialized <a href="https://jakarta.ee/specifications/servlet/6.0/apidocs/jakarta/servlet/http/HttpServlet.html" target="_blank">HttpServlet</a>, 
and the <a href="/site/apidocs/org/apache/juneau/rest/server/RestRequest.html" target="_blank">RestRequest</a> and <a href="/site/apidocs/org/apache/juneau/rest/server/RestResponse.html" target="_blank">RestResponse</a> 
...
Many of the examples in this document are pulled directly from the [juneau-petstore](/docs/topics/JuneauPetstore) showcase application.
...
For the complete, up-to-date list of `@Rest` members, see [@Rest-Annotated Class](/docs/topics/RestAnnotatedClasses).
...
:::note
Request/response debug capture is no longer an `@Rest` attribute — it's driven by the resource's own JUL logger
level. See [Logging / Debugging](/docs/topics/RestServerLoggingAndDebugging).
:::
...
`ConfigResource`, `LogsResource`, and `ShutdownResource` are demo admin resources that live in the unpublished
`juneau-microservice-examples` module (package `org.apache.juneau.microservice.examples`) rather than in
`juneau-microservice` itself — see [Predefined Resource Classes](/docs/topics/PredefinedResourceClasses).
...
- Optionally annotated with config annotations such as <a href="/site/apidocs/org/apache/juneau/marshall/MarshalledConfig.html" target="_blank">@MarshalledConfig</a> and <a href="/site/apidocs/org/apache/juneau/marshall/html/HtmlDocConfig.html" target="_blank">@HtmlDocConfig</a> that customize the behavior of serializers and parsers at the method level.
...
- Support for Apache Http Core interfaces: <a href="https://hc.apache.org/httpcomponents-core-4.4.x/current/httpcore/apidocs/org/apache/http/HttpEntity.html" target="_blank">HttpEntity</a> / <a href="https://hc.apache.org/httpcomponents-core-4.4.x/current/httpcore/apidocs/org/apache/http/HttpResponse.html" target="_blank">HttpResponse</a> / <a href="/site/apidocs/org/apache/juneau/http/HttpResource.html" target="_blank">HttpResource</a>.
