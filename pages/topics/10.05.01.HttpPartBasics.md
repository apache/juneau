...
In previous examples we showed the ability to pass in annotated parameters on <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">RestOp</a>-annotated methods to parse standard HTTP parts:
