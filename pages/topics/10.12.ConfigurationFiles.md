...
Use `Config` parameter injection in `@RestOp` methods, `@RestInject` beans, or `RestContext.getConfig()`
from a supported `@RestInit` parameter. See the [v9.5 Migration Guide](/docs/topics/V9.5MigrationGuide).
:::
...
<node-1><java-method-annotation><a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#config()" target="_blank">config</a></java-method-annotation></node-1>
</tree>
