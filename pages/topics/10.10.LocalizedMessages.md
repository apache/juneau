...
The <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#messages()" target="_blank">@Rest(messages)</a> annotation identifies the
location of the resource bundle for a <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html" target="_blank">@Rest</a>-annotated class if it's different from the class name.
