...
The information is pulled from the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#swagger()" target="_blank">@Rest(swagger)</a>
annotation.
...
In this particular case, the Swagger is pulled in from a localized Swagger JSON file located in the `org.apache.juneau.examples.rest.petstore` package using the <a href="/site/apidocs/org/apache/juneau/rest/server/vars/FileVar.html" target="_blank">$F</a> variable.
...
The <a href="/site/apidocs/org/apache/juneau/rest/server/vars/FileVar.html" target="_blank">$F</a> variable simply expands to a string to fill the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Swagger.html#value()" target="_blank">@Swagger(value)</a> annotation.
...
A third option is to define your Swagger information in your <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#messages()" target="_blank">@Rest(messages)</a> resource bundle using predefined Swagger keywords:
