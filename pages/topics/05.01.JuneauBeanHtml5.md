...
The <a href="/site/apidocs/org/apache/juneau/marshall/html/HtmlParser.html" target="_blank">HtmlParser</a> class can be used convert these HTML documents
back into POJOs.

Other serializers and parsers (e.g.
<a href="/site/apidocs/org/apache/juneau/marshall/json/JsonSerializer.html" target="_blank">JsonSerializer</a>) can be used to represent these POJOs in
