...
Later in the section on REST resources, we describe how to associate configurations with REST resources using the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#config()" target="_blank">@Rest(config)</a> annotation.
