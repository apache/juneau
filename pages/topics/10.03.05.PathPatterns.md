...
The <a href="/site/apidocs/org/apache/juneau/rest/server/RestOp.html#path()" target="_blank">@RestOp(path)</a> annotation allows you to define
...
Any remainder after the match can be accessed through <a href="/site/apidocs/org/apache/juneau/rest/server/httppart/RequestPathParamList.html#getRemainder()" target="_blank">RequestPathParamList.getRemainder()</a> or parameters with the `@Path("/*")` annotation.
