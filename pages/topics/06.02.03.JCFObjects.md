...
<tr>
<td>`as(LinkedList.class)`</td>
<td>`LinkedList<?>`</td>
</tr>
<tr>
<td>`as(HashSet.class, Integer.class)`</td>
...
<tr>
<td>`as(HashMap.class)`</td>
<td>`HashMap<?,?>`</td>
</tr>
<tr>
<td>`as(LinkedHashMap.class, String.class, MyBean.class)`</td>
<td>`LinkedHashMap<String,MyBean>`</td>
</tr>
<tr>
<td>`as(HashMap.class, Integer.class, ArrayList.class, MyBean[].class)`</td>
...
Oftentimes, it might be useful to parse into the <a href="/site/apidocs/org/apache/juneau/marshall/collections/JsonList.html" target="_blank">JsonList</a>
and <a href="/site/apidocs/org/apache/juneau/marshall/collections/JsonMap.html" target="_blank">JsonMap</a>
