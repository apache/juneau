...
A REST resource is simply a Java class annotated with <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html" target="_blank">Rest</a>.
...
Child Resources are REST servlets or objects that are linked to parent resources through the <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html#children()" target="_blank">@Rest(children)</a> annotation.
...
Java methods on <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/Rest.html" target="_blank">@Rest</a>-annotated classes have the following
format:
...
- Annotated with <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestOp.html" target="_blank">@RestOp</a>.
- Also available: <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestGet.html" target="_blank">@RestGet</a> / <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestPut.html" target="_blank">@RestPut</a> / <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestPost.html" target="_blank">@RestPost</a> / <a href="/site/apidocs/org/apache/juneau/rest/server/annotation/RestDelete.html" target="_blank">@RestDelete</a>.
- Annotation optional if using standard naming conventions (e.g. `getFoo()` equivalent to `@RestGet(path="/foo")`).
- Optionally annotated with config annotations such as <a href="/site/apidocs/org/apache/juneau/annotation/MarshalledConfig.html" target="_blank">@MarshalledConfig</a> and <a href="/site/apidocs/org/apache/juneau/marshall/html/annotation/HtmlDocConfig.html" target="_blank">@HtmlDocConfig</a> that customize the behavior of serializers and parsers at the method level.
