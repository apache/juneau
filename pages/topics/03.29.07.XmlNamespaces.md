...
public class Person {
    ...
    // Bean properties
    public String name;
    @MarshalledProp(calendarFormat=CalendarFormat.ISO_INSTANT) public Calendar birthDate;
...
The namespace URLs can either be defined as part of the <a href="/site/apidocs/org/apache/juneau/marshall/xml/Xml.html" target="_blank">@Xml</a>
annotation, or can be defined at the package level with the <a href="/site/apidocs/org/apache/juneau/marshall/xml/XmlSchema.html" target="_blank">@XmlSchema</a> annotation.
...
Enabling the `XmlSerializer.XML_addNamespaceUrisToRoot` setting results in the namespace URLs being added to the root
node:
...
of namespaces to the serializer to avoid this scanning step using <a href="/site/apidocs/org/apache/juneau/marshall/xml/XmlSerializer.Builder.html#disableAutoDetectNamespaces()" target="_blank">XmlSerializer.Builder.disableAutoDetectNamespaces()</a>.
