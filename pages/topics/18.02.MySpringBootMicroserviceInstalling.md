...
![Import Project](/topics/MySpringBootMicroserviceInstalling.Installing.1.png)

- Select the archive file and import the project:

![Select Archive](/topics/MySpringBootMicroserviceInstalling.Installing.2.png)

- In your workspace, you should now see the following project:

![Project in Workspace](/topics/MySpringBootMicroserviceInstalling.Installing.3.png)
