...
public class CT_AddressBookResource {
	...
	public static void beforeClass() throws Exception {
		...
		for (RestClient c : clients) {
			c.getSerializer().addFilters(CalendarFilter.Medium.class);
			c.getParser().addFilters(CalendarFilter.Medium.class);
			c.getSerializer().setProperty(XmlSerializerProperties.XML_autoDetectNamespaces, true);
		}
	}
	...
	public void testBasic() throws Exception {
		String in = IOUtils.read(getClass().getResourceAsStream("/com/ibm/juno/server/test/CT_AddressBookResource_test0.json"));
		JsonParser p = new JsonParser().addFilters(CalendarFilter.Medium.class);
