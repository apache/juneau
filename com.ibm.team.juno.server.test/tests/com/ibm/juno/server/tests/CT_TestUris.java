...
public class CT_TestUris {
	...
	private static String URL2 = Constants.getServerTestUrl() + "/testuris";           // /jazz/juno/sample/testuris
	private static int port = getPort(Constants.getServerTestUrl());                  // 9443
	private static String path = Constants.getServerTestUri().getPath();              // /jazz/juno/sample
