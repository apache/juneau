...
public @interface RestMethod {
	 ...
	 * <p>
	 * 	Default converters are available in the {@link com.ibm.juno.server.converters} package.
	 */
	 ...
	 * 	<li>{@link Inherit#FILTERS} - Inherit class-level filters.
	 * </ul>
	 * <p>
	 * 	For example, to inherit all serializers, properties, and filters from the servlet class:
	 * </p>
	 * <p class='bcode'>
	 * 	<ja>@RestMethod</ja>(
	 * 		path=<js>"/foo"</js>,
	 * 		serializers=MySpecialSerializer.<jk>class</jk>,
	 * 		serializersInherit={<jsf>SERIALIZERS</jsf>,<jsf>PROPERTIES</jsf>,<jsf>FILTERS</jsf>}
	 * 	)
	 * </p>
	 */
	 ...
	 * </ul>
	 * <p>
	 * 	For example, to inherit all parsers, properties, and filters from the servlet class:
	 * </p>
	 * <p class='bcode'>
	 * 	<ja>@RestMethod</ja>(
	 * 		path=<js>"/foo"</js>,
	 * 		parsers=MySpecialParser.<jk>class</jk>,
	 * 		parsersInherit={<jsf>PARSERS</jsf>,<jsf>PROPERTIES</jsf>,<jsf>FILTERS</jsf>}
	 * 	)
	 * </p>
	 */
	...
	/**
	 * Appends the specified filters to all serializers and parsers used by this method.
	 */
