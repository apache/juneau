...
import com.ibm.juno.core.utils.log.JunoLogger;
...
public abstract class RestServlet extends HttpServlet {
	 ...
	 */
	protected JunoLogger getLogger() {
		if (logger == null)
			logger =  JunoLogger.getLogger(getClass());
		return logger;
	}
	...
	private class MethodMeta extends ResourceMethod implements Comparable<MethodMeta>  {
		...
		public int compareTo(MethodMeta o) {
			...
			c = Utils.compare(o.matchers.length, matchers.length);
			if (c != 0)
				return c;
	...
	protected StringVarResolver createVarResolver() {
		StringVarResolver r = new StringVarResolver()
			.addVar("C", new StringVarWithDefault() { // Config file properties.
				@Override /* StringVar */
				public String resolve(String arg) {
					return getConfig().getString(arg);
				}
			})
			.addVar("S", StringVars.SYSTEM_PROPERTIES_VAR)  // System properties.
			.addVar("E", StringVars.ENV_VARIABLES_VAR);  // Environment variables.
