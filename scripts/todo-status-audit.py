...
# before the slug, composing with every lifecycle prefix -- READY-R0447-HIPRI-slug.md,
# MAYBE-R0447-HIPRI-slug.md, and (deliberately kept through archival) FINISHED-R0447-HIPRI-slug.md.
...
HIPRI_MARKER_RE = re.compile(r"^(?:TODO|READY|MAYBE|HOLD|NEED_INPUT)-R\d+[a-z0-9]*-HIPRI-.*\.md$")
