...
~/Project Work/todos/juneau/ (FINISHED-/CANCELLED-*.md archives are explicitly out of scope --
per this repo's TODO-management skill, "status line is not required in FINISHED archives")
...
FILENAME_RE = re.compile(r"^(TODO|READY|MAYBE|HOLD|NEED_INPUT)-J\d+[a-z0-9]*-.*\.md$")
...
ID_FROM_FILENAME_RE = re.compile(r"^(?:TODO|READY|MAYBE|HOLD|NEED_INPUT)-J(\d+)")
...
def group_claims_by_numeric_id(files: list) -> dict:
    ...
    itself keys everything off int(...): "TODO-J0037-..." and a hypothetically-unpadded
    "TODO-J37-..." name the same id and must land in the same bucket.
    """
