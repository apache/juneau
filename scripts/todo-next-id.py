...
"Adding a new item" and "MAYBE Numbering" sections:
  ...
  2. Every "TODO-"/"READY-"/"MAYBE-"/"HOLD-"/"FINISHED-"/"CANCELLED-"/"NEED_INPUT-<n>[<letter>]-*.md"
     filename directly under ~/Project Work/todos/juneau/ and ~/Project Work/finished/juneau/.
...
# copy's project uses "J". Numeric part is always 4 digits. This scanner matches only
# TODO-J<digits>; ids from the other three projects are not counted here.
ID_PROJECT_LETTER = "J"
TRACKER_SLUG = "juneau"
...
# "otherproject:TODO-J0042" -- naming an id in ANOTHER repo's tracker, which must not
# consume one here.
...
def normalize_check_id(raw: str) -> str | None:
    ...
    Accepts `12`, `7a`, `TODO-12`, and (for prefixed projects) `J12` / `TODO-J12`.
    """
    candidate = raw.strip()
