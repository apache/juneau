...
public class TriG extends CharMarshaller {
	...
	/**
	 * Serializes a Java object to a TriG string.
	 *
	...
	/**
	 * Serializes a Java object to TriG output.
	 *
	 * @param object The object to serialize.
	...
	/**
	 * Parses a TriG input object to the specified Java type.
	 *
	...
	/**
	 * Parses a TriG input string to the specified type.
	 *
	 * @param <T> The class type of the object being created.
	...
	/**
	 * Parses a TriG input string to the specified Java type.
	 *
	 * @param <T> The class type of the object to create.
	 * @param input The input string.
	 * @param type The object type to create.
