...
public class RdfParser extends ReaderParser implements RdfCommon {
	...
	/**
	 * @deprecated Use {@link RdfXmlParser#DEFAULT}
	 */
	@Deprecated
	public static final RdfParser DEFAULT_XML = new RdfXmlParser(PropertyStore.DEFAULT);

	/**
	 * @deprecated Use {@link TurtleParser#DEFAULT}
	 */
	@Deprecated
	public static final RdfParser DEFAULT_TURTLE = new TurtleParser(PropertyStore.DEFAULT);

	/**
	 * @deprecated Use {@link NTripleParser#DEFAULT}
	 */
	@Deprecated
	public static final RdfParser DEFAULT_NTRIPLE = new NTripleParser(PropertyStore.DEFAULT);

	/**
	 * @deprecated Use {@link N3Parser#DEFAULT}
	 */
	@Deprecated
	public static final RdfParser DEFAULT_N3 = new N3Parser(PropertyStore.DEFAULT);

	/**
	 * @deprecated Use {@link RdfXmlParser}
	 */
	@Deprecated
	@SuppressWarnings("javadoc")
	public static class Xml extends RdfXmlParser {
	...
	/**
	 * @deprecated Use {@link NTripleParser}
	 */
	@Deprecated
	@SuppressWarnings("javadoc")
	public static class NTriple extends NTripleParser {
	...
	/**
	 * @deprecated Use {@link TurtleParser}
	 */
	@Deprecated
	@SuppressWarnings("javadoc")
	public static class Turtle extends TurtleParser {
	...
	/**
	 * @deprecated Use {@link N3Parser}
	 */
	@Deprecated
	@SuppressWarnings("javadoc")
	public static class N3 extends N3Parser {
