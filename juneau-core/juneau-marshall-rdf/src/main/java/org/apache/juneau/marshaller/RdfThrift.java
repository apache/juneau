...
public class RdfThrift extends StreamMarshaller {
	...
	/**
	 * Serializes a Java object to RDF/THRIFT bytes.
	 *
	...
	/**
	 * Serializes a Java object to RDF/THRIFT output stream.
	 *
	 * @param object The object to serialize.
	...
	/**
	 * Parses RDF/THRIFT bytes to the specified Java type.
	 *
	...
	/**
	 * Parses RDF/THRIFT input to the specified Java type.
	 *
	 * @param <T> The class type of the object being created.
