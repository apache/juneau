...
/**
 * Utility classes and methods for the {@link RdfApply @RdfApply} annotation.
 *
 */
public class RdfApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private RdfApplyAnnotation() {}

	/**
	 * Applies targeted {@link RdfApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<RdfApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(RdfApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<RdfApply> ai, Context.Builder b) {
			RdfApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Rdf value = RdfAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(RdfApply.class);
		}

		/**
		 * Sets the {@link RdfApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Rdf value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link RdfApply @RdfApply} object initialized with this builder.
		 *
		 * @return A new {@link RdfApply} object.
		 */
		public RdfApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements RdfApply {

		private final Rdf value;

		Object(RdfApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final RdfApply DEFAULT = create().build();
	 ...
	 * 	Can be <jk>null</jk> (returns <jk>true</jk>).
	 * @return <jk>true</jk> if the specified annotation contains all default values.
	 */
	public static boolean empty(RdfApply a) {
