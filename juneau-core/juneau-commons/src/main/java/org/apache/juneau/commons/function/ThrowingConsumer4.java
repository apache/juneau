 ...
 *
 * <p>
 * This interface extends {@link Consumer4} to allow the functional method
 * to throw checked exceptions. The default {@link #apply(Object, Object, Object, Object)} method wraps any checked exceptions in a
 * {@link RuntimeException}, making it compatible with standard {@link Consumer4} usage while still allowing
 * the implementation to throw checked exceptions via {@link #acceptThrows(Object, Object, Object, Object)}.
 *
 * <h5 class='section'>Features:</h5>
 * <ul class='spaced-list'>
 * 	<li>Functional interface - can be used with lambda expressions and method references
 * 	<li>Exception support - allows checked exceptions to be thrown via {@link #acceptThrows(Object, Object, Object, Object)}
 * 	<li>Compatible with Consumer4 - implements {@link Consumer4#apply(Object, Object, Object, Object)} by wrapping exceptions
 * 	<li>Dual interface - can be used as both Consumer4 and ThrowingConsumer4
 * </ul>
 *
 * <h5 class='section'>Use Cases:</h5>
 * <ul class='spaced-list'>
 * 	<li>Four-argument operations that may throw I/O exceptions
 ...
 * 	ThrowingConsumer4&lt;String,Integer,Boolean,Double&gt; <jv>fileWriter</jv> = (<jv>path</jv>, <jv>content</jv>, <jv>append</jv>, <jv>timeout</jv>) -&gt; {
 ...
 * 	<jk>try</jk> {
 * 		<jv>fileWriter</jv>.acceptThrows(<js>"/tmp/output.txt"</js>, <js>"Hello World"</js>, <jk>true</jk>, 5.0);
 * 	} <jk>catch</jk> (IOException <jv>e</jv>) {
 * 		<jc>// Handle checked exception</jc>
 * 	}
 *
 * 	<jc>// Using apply wraps exception in RuntimeException</jc>
 * 	<jv>fileWriter</jv>.apply(<js>"/tmp/output.txt"</js>, <js>"Hello World"</js>, <jk>true</jk>, 5.0);  <jc>// May throw RuntimeException</jc>
 * </p>
 *
 * <h5 class='section'>Exception Handling:</h5>
 * <ul class='spaced-list'>
 * 	<li>{@link #acceptThrows(Object, Object, Object, Object)} - Throws checked exceptions directly
 ...
 * 	<li>Use {@code apply} when you want standard Consumer4 behavior
 * </ul>
 *
...
public interface ThrowingConsumer4<A,B,C,D> extends Consumer4<A,B,C,D> {
	 ...
	 *
	 * <p>
	 * This is the default implementation that makes this interface compatible with {@link Consumer4}.
	 * It calls {@link #acceptThrows(Object, Object, Object, Object)} and wraps any checked exceptions.
	 *
	 ...
	 * @throws RuntimeException if {@link #acceptThrows(Object, Object, Object, Object)} throws a checked exception.
	 */
	@Override
	...
	/**
	 * Returns a composed {@link ThrowingConsumer4} that performs, in sequence, this operation followed by the {@code after} operation.
	 *
	 * <p>
	 ...
	 * to be thrown directly, unlike the standard {@link Consumer4#apply(Object, Object, Object, Object)} method.
	 *
	 * <h5 class='section'>Example:</h5>
	 * <p class='bjava'>
	 * 	ThrowingConsumer4&lt;String,Integer,Boolean,Double&gt; <jv>validator</jv> = (<jv>name</jv>, <jv>age</jv>, <jv>active</jv>, <jv>score</jv>) -&gt; {
	 ...
	 *
	 * 	<jk>try</jk> {
	 * 		<jv>validator</jv>.acceptThrows(<js>""</js>, -1, <jk>true</jk>, 0.0);
	 ...
	 */
	void acceptThrows(A a, B b, C c, D d) throws Exception;
}
