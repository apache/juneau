 ...
 *
 * <p>
 * This interface extends {@link Function4} to allow the functional method
 * to throw checked exceptions. The default {@link #apply(Object, Object, Object, Object)} method wraps any checked exceptions in a
 * {@link RuntimeException}, making it compatible with standard {@link Function4} usage while still allowing
 * the implementation to throw checked exceptions via {@link #applyThrows(Object, Object, Object, Object)}.
 *
 * <h5 class='section'>Features:</h5>
 * <ul class='spaced-list'>
 * 	<li>Functional interface - can be used with lambda expressions and method references
 * 	<li>Exception support - allows checked exceptions to be thrown via {@link #applyThrows(Object, Object, Object, Object)}
 * 	<li>Compatible with Function4 - implements {@link Function4#apply(Object, Object, Object, Object)} by wrapping exceptions
 * 	<li>Dual interface - can be used as both Function4 and ThrowingFunction4
 * </ul>
 *
 * <h5 class='section'>Use Cases:</h5>
 * <ul class='spaced-list'>
 * 	<li>Four-argument transformations that may throw I/O exceptions
 ...
 * 	ThrowingFunction4&lt;String,String,String,String,File&gt; <jv>fileParser</jv> = (<jv>dir</jv>, <jv>subdir1</jv>, <jv>subdir2</jv>, <jv>name</jv>) -&gt; {
 * 		Path <jv>path</jv> = Paths.get(<jv>dir</jv>, <jv>subdir1</jv>, <jv>subdir2</jv>, <jv>name</jv>);
 ...
 * 	<jk>try</jk> {
 * 		File <jv>file</jv> = <jv>fileParser</jv>.applyThrows(<js>"/tmp"</js>, <js>"data"</js>, <js>"2024"</js>, <js>"file.txt"</js>);
 ...
 * 	File <jv>file</jv> = <jv>fileParser</jv>.apply(<js>"/tmp"</js>, <js>"data"</js>, <js>"2024"</js>, <js>"file.txt"</js>);  <jc>// May throw RuntimeException</jc>
 * </p>
 *
 * <h5 class='section'>Exception Handling:</h5>
 * <ul class='spaced-list'>
 * 	<li>{@link #applyThrows(Object, Object, Object, Object)} - Throws checked exceptions directly
 * 	<li>{@link #apply(Object, Object, Object, Object)} - Wraps checked exceptions in {@link RuntimeException}
 * 	<li>Use {@code applyThrows} when you need to handle specific checked exceptions
 * 	<li>Use {@code apply} when you want standard Function4 behavior
 * </ul>
 *
...
public interface ThrowingFunction4<A,B,C,D,R> extends Function4<A,B,C,D,R> {
	 ...
	 *
	 * <p>
	 * This is the default implementation that makes this interface compatible with {@link Function4}.
	 * It calls {@link #applyThrows(Object, Object, Object, Object)} and wraps any checked exceptions.
	 *
	 ...
	 * @throws RuntimeException if {@link #applyThrows(Object, Object, Object, Object)} throws a checked exception.
	 */
	@Override
	default R apply(A a, B b, C c, D d) {
		try {
			return applyThrows(a, b, c, d);
		} catch (Exception e) {
			throw toRex(e);
		}
	}
	 ...
	 * to be thrown directly, unlike the standard {@link Function4#apply(Object, Object, Object, Object)} method.
	 *
	 * <h5 class='section'>Example:</h5>
	 * <p class='bjava'>
	 * 	ThrowingFunction4&lt;String,Integer,Boolean,Double,Integer&gt; <jv>parser</jv> = (<jv>s</jv>, <jv>base</jv>, <jv>signed</jv>, <jv>multiplier</jv>) -&gt; {
	 * 		<jk>try</jk> {
	 * 			<jk>int</jk> <jv>value</jv> = Integer.parseInt(<jv>s</jv>, <jv>base</jv>);
	 * 			<jv>value</jv> = <jv>signed</jv> ? <jv>value</jv> : Math.abs(<jv>value</jv>);
	 * 			<jk>return</jk> (<jk>int</jk>)(<jv>value</jv> * <jv>multiplier</jv>);
	 ...
	 *
	 * 	<jk>try</jk> {
	 * 		<jk>int</jk> <jv>value</jv> = <jv>parser</jv>.applyThrows(<js>"123"</js>, 10, <jk>true</jk>, 2.0);
