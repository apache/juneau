...
public interface BeanMetaInitializer {
	 ...
	 *
	 * @param marshallingContext The marshalling-side context (as an opaque {@link Object}).  Can be <jk>null</jk>.  The effect is implementation-dependent — see {@code org.apache.juneau.marshall.MarshalledBeanMetaInitializer}, the sole concrete implementer of this SPI.
	 * @param beanFilter The bean filter applied to this bean meta.  Can be <jk>null</jk>.  The effect is implementation-dependent — see {@code org.apache.juneau.marshall.MarshalledBeanMetaInitializer}.
	 ...
	 *
	 * @param marshallingContext The marshalling-side context.  Can be <jk>null</jk>.  The effect is implementation-dependent — see {@code org.apache.juneau.marshall.MarshalledBeanMetaInitializer}.
	 * @param classInfo The bean's class info.
