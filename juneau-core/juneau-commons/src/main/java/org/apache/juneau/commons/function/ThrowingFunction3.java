 ...
 *
 * <p>
 * This interface extends {@link Function3} to allow the functional method
 * to throw checked exceptions. The default {@link #apply(Object, Object, Object)} method wraps any checked exceptions in a
 * {@link RuntimeException}, making it compatible with standard {@link Function3} usage while still allowing
 * the implementation to throw checked exceptions via {@link #applyThrows(Object, Object, Object)}.
 *
 * <h5 class='section'>Features:</h5>
 * <ul class='spaced-list'>
 * 	<li>Functional interface - can be used with lambda expressions and method references
 * 	<li>Exception support - allows checked exceptions to be thrown via {@link #applyThrows(Object, Object, Object)}
 * 	<li>Compatible with Function3 - implements {@link Function3#apply(Object, Object, Object)} by wrapping exceptions
 * 	<li>Dual interface - can be used as both Function3 and ThrowingFunction3
 * </ul>
 *
 * <h5 class='section'>Use Cases:</h5>
 * <ul class='spaced-list'>
 * 	<li>Three-argument transformations that may throw I/O exceptions
 ...
 * 	ThrowingFunction3&lt;String,String,String,File&gt; <jv>fileParser</jv> = (<jv>dir</jv>, <jv>subdir</jv>, <jv>name</jv>) -&gt; {
 * 		Path <jv>path</jv> = Paths.get(<jv>dir</jv>, <jv>subdir</jv>, <jv>name</jv>);
 ...
 * 	<jk>try</jk> {
 * 		File <jv>file</jv> = <jv>fileParser</jv>.applyThrows(<js>"/tmp"</js>, <js>"data"</js>, <js>"file.txt"</js>);
 ...
 * 	File <jv>file</jv> = <jv>fileParser</jv>.apply(<js>"/tmp"</js>, <js>"data"</js>, <js>"file.txt"</js>);  <jc>// May throw RuntimeException</jc>
 * </p>
 *
 * <h5 class='section'>Exception Handling:</h5>
 * <ul class='spaced-list'>
 * 	<li>{@link #applyThrows(Object, Object, Object)} - Throws checked exceptions directly
 ...
 * 	<li>Use {@code apply} when you want standard Function3 behavior
 * </ul>
 *
...
public interface ThrowingFunction3<A,B,C,R> extends Function3<A,B,C,R> {
	 ...
	 *
	 * <p>
	 * This is the default implementation that makes this interface compatible with {@link Function3}.
	 * It calls {@link #applyThrows(Object, Object, Object)} and wraps any checked exceptions.
	 *
	 * @param a The first function argument.
	 * @param b The second function argument.
	 * @param c The third function argument.
	 * @return The function result.
	 * @throws RuntimeException if {@link #applyThrows(Object, Object, Object)} throws a checked exception.
	 */
	@Override
	 ...
	 * @return A composed {@link ThrowingFunction3} that first applies this function and then applies the {@code after} function.
	 * @throws NullPointerException if {@code after} is <jk>null</jk>.
	 */
	default <V> ThrowingFunction3<A,B,C,V> andThen(Function<? super R,? extends V> after) {
	 ...
	 * to be thrown directly, unlike the standard {@link Function3#apply(Object, Object, Object)} method.
	 *
	 * <h5 class='section'>Example:</h5>
	 * <p class='bjava'>
	 * 	ThrowingFunction3&lt;String,Integer,Boolean,Integer&gt; <jv>parser</jv> = (<jv>s</jv>, <jv>base</jv>, <jv>signed</jv>) -&gt; {
	 * 		<jk>try</jk> {
	 * 			<jk>int</jk> <jv>value</jv> = Integer.parseInt(<jv>s</jv>, <jv>base</jv>);
	 * 			<jk>return</jk> <jv>signed</jv> ? <jv>value</jv> : Math.abs(<jv>value</jv>);
	 ...
	 *
	 * 	<jk>try</jk> {
	 * 		<jk>int</jk> <jv>value</jv> = <jv>parser</jv>.applyThrows(<js>"123"</js>, 10, <jk>true</jk>);
	 ...
	 */
	R applyThrows(A a, B b, C c) throws Exception;
}
