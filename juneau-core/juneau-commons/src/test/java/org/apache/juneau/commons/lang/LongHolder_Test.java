...
class LongHolder_Test extends TestBase {
	...
	void b05_getAndIncrement_largeValues() {
		var v = LongHolder.of(Long.MAX_VALUE - 2);
	...
	void d02_trackingBytesProcessed() {
		var bytesProcessed = LongHolder.create();
	...
	void d03_trackingMaxTimestamp() {
		var maxTimestamp = LongHolder.of(0L);
	...
	void e03_increment_largeValue() {
		var v = LongHolder.of(Long.MAX_VALUE - 1);
		v.increment();
		assertEquals(Long.MAX_VALUE, v.get());
	}
	...
	void e06_decrement_minValue() {
		var v = LongHolder.of(Long.MIN_VALUE + 1);
		v.decrement();
	...
	void f05_add_largeValues() {
		var v = LongHolder.of(Long.MAX_VALUE - 100);
		v.add(50L);
	...
	void g05_isAny_largeValues() {
		var v = LongHolder.of(Long.MAX_VALUE);
