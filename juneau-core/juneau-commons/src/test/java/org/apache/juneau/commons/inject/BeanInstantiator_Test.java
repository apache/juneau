...
class BeanInstantiator_Test extends TestBase {
	...
	class W_builderSetters {
		...
		@Test
		@DisplayName("W09 - Supertype-only parent inner builder loses to the subtype's direct constructor")
		void w09_builderInParentClass() {
			...
			// build() only promises the *supertype* W_BeanWithInnerBuilder.  A
