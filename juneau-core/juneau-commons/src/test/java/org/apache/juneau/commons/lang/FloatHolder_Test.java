...
class FloatHolder_Test extends TestBase {
	...
	void c01_trackingRunningAverage() {
		var sum = FloatHolder.create();
		var count = FloatHolder.create();
	...
	void c03_trackingMinValue() {
		var min = FloatHolder.of(Float.MAX_VALUE);
	...
	void c04_multiplierChaining() {
		var multiplier = FloatHolder.of(1.0f);
