 ...
 *
 * <p>
 * Module-local copy used by {@code juneau-commons} tests. It only depends on the commons
 * {@link TimeProvider} type, so it can live in this module's test scope without pulling in
 * {@code juneau-test-utils} (which would introduce a Maven reactor cycle).
 */
