...
class Cache3_Test extends TestBase {
	...
	void d03_containsValue_nullValue() {
		...
		var x2 = Cache3.of(String.class, String.class, Integer.class, String.class).build();
	 ...
	 *
	 * <p>In WEAK mode {@code Cache3} stores its composite {@code Tuple3} keys in a weak map. Those keys are
