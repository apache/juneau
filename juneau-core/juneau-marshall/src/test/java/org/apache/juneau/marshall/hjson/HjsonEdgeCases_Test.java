...
class HjsonEdgeCases_Test extends TestBase {
	...
	void f01_emptyInput() throws Exception {
		var m = HjsonParser.DEFAULT.read("", Map.class, String.class, Object.class);
		assertNull(m);
	}
	...
	void f02_onlyComments() throws Exception {
		var hjson = "# comment\n// line\n/* block */";
		var m = HjsonParser.DEFAULT.read(hjson, Map.class, String.class, Object.class);
		assertNull(m);
	}
	...
	void f03_unicodeStrings() throws Exception {
		...
		var parsed = (Map<String, Object>) HjsonParser.DEFAULT.read(hjson, Map.class, String.class, Object.class);
	...
	void f04_windowsLineEndings() throws Exception {
		...
		var hjson2 = "{\"a\":1,\"b\":2}";
		var m2 = (Map<String, Object>) HjsonParser.DEFAULT.read(hjson2, Map.class, String.class, Object.class);
	...
	void f05_deeplyNested() throws Exception {
		...
		for (var i = 0; i < 12; i++)
			sb.append("}");
		var m = (Map<String, Object>) HjsonParser.DEFAULT.read(sb.toString(), Map.class, String.class, Object.class);
		var current = m;
		for (var i = 0; i < 12; i++) {
	...
	void f10_unicodeEscapeInQuoted() throws Exception {
		...
		var m2 = (Map<String, Object>) HjsonParser.DEFAULT.read(emoji, Map.class, String.class, Object.class);
