...
class MsgPackParser_Test extends TestBase {
	...
	@Test void a01_streamsAutoClose() throws Exception {
		...
		var r = p.read(is, Object.class);
		assertJson("0", r);
		assertThrowsWithMessage(Exception.class, "Stream is closed", ()->p.read(is, Object.class));
	}
	...
	@Test void a02_multipleObjectsInStream() throws Exception {
		...
		r = p.read(is, Object.class);
		assertString("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", r);		r = p.read(is, Object.class);
