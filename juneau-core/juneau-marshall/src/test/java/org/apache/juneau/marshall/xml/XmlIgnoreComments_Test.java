...
class XmlIgnoreComments_Test extends TestBase {
	...
	private static class Input {
		...
		final String input;
		final boolean skipWsTests;

		Input(String label, Class<?> type, Object expected, String input, boolean skipWsTests) {
			this.label = label;
			this.type = type;
	...
	private static Input input(String label, Class<?> type, Object expected, String input, boolean skipWsTests) {
