...
class ByteArrayBase64Swap_ComboRoundTripTest extends ComboRoundTripTest_Base {
	...
	private static final ComboRoundTrip_Tester<?>[] TESTERS = {
		...
		tester(2, "ByteArray2d", byte[][].class, new byte[][]{{1,2,3},{4,5,6},null})
			.json5("['AQID','BAUG',null]")
			.json5T("['AQID','BAUG',null]")
			.json5R("[\n\t'AQID',\n\t'BAUG',\n\tnull\n]")
			.json("[\"AQID\",\"BAUG\",null]")
		...
		tester(4, "MapOfByteArrays", getType(Map.class,String.class,byte[].class), mapBuilder(String.class,byte[].class).add("foo",bytes(1,2,3)).add("bar",null).add(null,bytes(4,5,6)).add("null",bytes(7,8,9)).build())
			...
			.build(),
		tester(5, "BeanWithByteArrayField", BeanWithByteArrayField.class, new BeanWithByteArrayField().init())
			.json5("{f:'AQID'}")
			.json5T("{f:'AQID'}")
			.json5R("{\n\tf: 'AQID'\n}")
			.json("{\"f\":\"AQID\"}")
		...
		tester(6, "BeanWithByteArray2dField", BeanWithByteArray2dField.class, new BeanWithByteArray2dField().init())
			.json5("{f:['AQID','BAUG',null]}")
			.json5T("{f:['AQID','BAUG',null]}")
			.json5R("{\n\tf: [\n\t\t'AQID',\n\t\t'BAUG',\n\t\tnull\n\t]\n}")
		...
		tester(9, "BeanWithByteArrayMapField", BeanWithByteArrayMapField.class, new BeanWithByteArrayMapField().init())
			.json5("{f:{foo:'AQID',bar:null,null:'BAUG'}}")
			.json5T("{f:{foo:'AQID',bar:null,null:'BAUG'}}")
			.json5R("{\n\tf: {\n\t\tfoo: 'AQID',\n\t\tbar: null,\n\t\tnull: 'BAUG'\n\t}\n}")
		...
		tester(10, "BeanWithByteArrayBeanListField", BeanWithByteArrayBeanListField.class, new BeanWithByteArrayBeanListField().init())
			.json5("{f:[{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}},null]}")
			.json5T("{f:[{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}},null]}")
			.json5R("{\n\tf: [\n\t\t{\n\t\t\tf1: 'AQID',\n\t\t\tf2: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: 'AQID',\n\t\t\t\tbar: null,\n\t\t\t\tnull: 'BAUG'\n\t\t\t}\n\t\t},\n\t\tnull\n\t]\n}")
		...
		tester(11, "BeanWithByteArrayBeanMapField", BeanWithByteArrayBeanMapField.class, new BeanWithByteArrayBeanMapField().init())
			.json5("{f:{foo:{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}},bar:null,null:{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}}}}")
			.json5T("{f:{foo:{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}},bar:null,null:{f1:'AQID',f2:['AQID','BAUG',null],f3:null,f4:['AQID','BAUG',null],f5:{foo:'AQID',bar:null,null:'BAUG'}}}}")
			.json5R("{\n\tf: {\n\t\tfoo: {\n\t\t\tf1: 'AQID',\n\t\t\tf2: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: 'AQID',\n\t\t\t\tbar: null,\n\t\t\t\tnull: 'BAUG'\n\t\t\t}\n\t\t},\n\t\tbar: null,\n\t\tnull: {\n\t\t\tf1: 'AQID',\n\t\t\tf2: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\t'AQID',\n\t\t\t\t'BAUG',\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: 'AQID',\n\t\t\t\tbar: null,\n\t\t\t\tnull: 'BAUG'\n\t\t\t}\n\t\t}\n\t}\n}")
	...
	public static class BeanWithByteArrayListField {
		...
		public BeanWithByteArrayListField init() {
			f = l(bytes(1,2,3),bytes(4,5,6),null);
			return this;
		}
	}
	...
	public static class BeanWithByteArrayMapField {
		...
		public BeanWithByteArrayMapField init() {
			f = m("foo",bytes(1,2,3),"bar",null,null,bytes(4,5,6));
			return this;
		}
	}
	...
	public static class B {
		...
		public B init() {
			...
			f3 = null;
			f4 = l(bytes(1,2,3),bytes(4,5,6),null);
			f5 = m("foo",bytes(1,2,3),"bar",null,null,bytes(4,5,6));
			return this;
		}
	}
}
