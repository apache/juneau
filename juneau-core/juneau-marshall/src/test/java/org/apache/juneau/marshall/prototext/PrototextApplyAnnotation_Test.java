...
class PrototextApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = PrototextApplyAnnotation.create(String.class).build();
		assertFalse(PrototextApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new PrototextApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = PrototextApplyAnnotation.DEFAULT;
