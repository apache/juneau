...
class OpenApiApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = OpenApiApplyAnnotation.create(String.class).build();
		assertFalse(OpenApiApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new OpenApiApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = OpenApiApplyAnnotation.DEFAULT;
