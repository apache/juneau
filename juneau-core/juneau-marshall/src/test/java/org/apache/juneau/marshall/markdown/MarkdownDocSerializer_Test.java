...
class MarkdownDocSerializer_Test {
	...
	@Test void b04_beanWithCollectionDoc() {
	...
	@Test void b05_beanWithListOfStrings() {
		var s = MarkdownDocSerializer.create().title("Report").build();
		var bean = new E();
		bean.name = "Tags";
	...
	@Test void b07_customHeadingLevel() {
	...
	@Test void b11_propertyOrdering() {
		var s = MarkdownDocSerializer.create().title("Person").build();
		var bean = new B();
		bean.name = "Alice";
		bean.age = 30;
	...
	@Test void b12_multipleNestedBeans() {
		var s = MarkdownDocSerializer.create().title("Person").build();
		var bean = new F();
		bean.name = "Alice";
	...
	@Test void b15_collectionRootDoc() {
