...
class Xml_Test extends TestBase {
	...
	@Test void a01_to() throws Exception {
		...
		{ var sw1 = stringWriter(); Xml.DEFAULT.write(in1, sw1); assertString(expected1, sw1); }
		assertString(expected2, Xml.of(in2));
		{ var sw2 = stringWriter(); Xml.DEFAULT.write(in2, sw2); assertString(expected2, sw2); }
	}
	...
	@Test void a02_from() throws Exception {
		...
		assertEquals(expected1, Xml.DEFAULT.read(stringReader(in1), String.class));
		assertJson(expected2, Xml.to(in2, Map.class, String.class, String.class));
		assertJson(expected2, Xml.DEFAULT.read(stringReader(in2), Map.class, String.class, String.class));
	}
