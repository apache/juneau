...
class CborApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = CborApplyAnnotation.create(String.class).build();
		assertFalse(CborApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new CborApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = CborApplyAnnotation.DEFAULT;
