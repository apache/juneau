...
class TomlSerializer_Test {
	...
	void a01_simpleBean() throws Exception {
		...
		String toml = org.apache.juneau.marshall.toml.TomlSerializer.DEFAULT.serialize(m);
		assertNotNull(toml);
	...
	void a03_nestedBean() throws Exception {
		...
		String toml = org.apache.juneau.marshall.toml.TomlSerializer.DEFAULT.serialize(config);
		assertNotNull(toml);
