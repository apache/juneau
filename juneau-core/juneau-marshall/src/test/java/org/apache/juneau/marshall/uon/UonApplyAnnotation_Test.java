...
class UonApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = UonApplyAnnotation.create(String.class).build();
		assertFalse(UonApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new UonApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = UonApplyAnnotation.DEFAULT;
