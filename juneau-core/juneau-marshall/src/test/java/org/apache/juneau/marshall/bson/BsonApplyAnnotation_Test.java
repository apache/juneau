...
class BsonApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = BsonApplyAnnotation.create(String.class).build();
		assertFalse(BsonApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new BsonApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = BsonApplyAnnotation.DEFAULT;
