...
/**
 * Round-trip tests for PrototextSerializer and PrototextParser.
 */
class PrototextRoundTrip_Test {
	...
	void a14_topLevelScalarLimitation() {
		var a = "bare";
		var proto = org.apache.juneau.marshall.marshaller.Prototext.of(a);
		var b = org.apache.juneau.marshall.marshaller.Prototext.to(proto, String.class);
		assertEquals("bare", b);
	}
