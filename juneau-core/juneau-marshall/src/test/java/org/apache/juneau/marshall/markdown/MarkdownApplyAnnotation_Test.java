...
class MarkdownApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = MarkdownApplyAnnotation.create(String.class).build();
		assertFalse(MarkdownApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new MarkdownApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = MarkdownApplyAnnotation.DEFAULT;
