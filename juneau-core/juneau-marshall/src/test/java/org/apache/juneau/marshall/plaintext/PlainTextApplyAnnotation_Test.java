...
class PlainTextApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = PlainTextApplyAnnotation.create(String.class).build();
		assertFalse(PlainTextApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new PlainTextApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = PlainTextApplyAnnotation.DEFAULT;
