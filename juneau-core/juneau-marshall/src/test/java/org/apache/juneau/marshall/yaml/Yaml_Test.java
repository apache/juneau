...
class Yaml_Test extends TestBase {
	...
	@Test void b01_parseEmptyString() throws Exception {
		assertNull(YamlParser.DEFAULT.parse("", String.class));
	}

	@Test void b02_parseWhitespaceOnly() throws Exception {
		assertNull(YamlParser.DEFAULT.parse("   \n  \t  \n", String.class));
	}

	@Test void b03_parseCommentOnly() throws Exception {
		assertNull(YamlParser.DEFAULT.parse("# just a comment\n", String.class));
	}

	@Test void b04_parseMultipleComments() throws Exception {
		assertNull(YamlParser.DEFAULT.parse("# c1\n# c2\n# c3\n", String.class));
	}
	...
	@Test void b06_parseLeadingWhitespaceWithValue() throws Exception {
		assertEquals("hello", YamlParser.DEFAULT.parse("   hello", String.class));
	}
	...
	@Test void b11_parseNullVariants_lowercase() throws Exception {
		assertNull(YamlParser.DEFAULT.parse("null", String.class));
	}
	...
	@Test void b14_parseTrueVariants() throws Exception {
		...
		assertEquals(Boolean.TRUE, YamlParser.DEFAULT.parse("true", Object.class));
		assertEquals(Boolean.TRUE, YamlParser.DEFAULT.parse("True", Object.class));
		assertEquals(Boolean.TRUE, YamlParser.DEFAULT.parse("TRUE", Object.class));
	}

	@Test void b15_parseFalseVariants() throws Exception {
		assertEquals(Boolean.FALSE, YamlParser.DEFAULT.parse("false", Object.class));
		assertEquals(Boolean.FALSE, YamlParser.DEFAULT.parse("False", Object.class));
		assertEquals(Boolean.FALSE, YamlParser.DEFAULT.parse("FALSE", Object.class));
	}

	@Test void b16_resolveScalarType_integer() throws Exception {
		var v = YamlParser.DEFAULT.parse("42", Object.class);
		assertEquals(Integer.valueOf(42), v);
	}

	@Test void b17_resolveScalarType_long() throws Exception {
		var v = YamlParser.DEFAULT.parse("9999999999", Object.class);
		assertEquals(Long.valueOf(9999999999L), v);
	}

	@Test void b18_resolveScalarType_double() throws Exception {
		var v = YamlParser.DEFAULT.parse("1.5", Object.class);
	...
	@Test void b21_resolveScalarType_leadingDot() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse(".5", Object.class);
		assertEquals(Double.valueOf(0.5), v);
	}

	@Test void b22_resolveScalarType_exponent() throws Exception {
		var v = YamlParser.DEFAULT.parse("1e3", Object.class);
	...
	@Test void b24_resolveScalarType_infinity_returnsString() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse("1e9999", Object.class);
		assertEquals("1e9999", v);
	}

	@Test void b25_resolveScalarType_notANumber_returnsString() throws Exception {
		var v = YamlParser.DEFAULT.parse("abc", Object.class);
		assertEquals("abc", v);
	}
	...
	@Test void c01_parseDocumentStart() throws Exception {
		assertEquals("hello", YamlParser.DEFAULT.parse("---\nhello", String.class));
	}

	@Test void c02_parseDocumentStartWithComment() throws Exception {
		assertEquals("hello", YamlParser.DEFAULT.parse("--- # doc start\nhello", String.class));
	}
	...
	@Test void c05_singleDotIsPlainScalar() throws Exception {
		var v = YamlParser.DEFAULT.parse(".x", Object.class);
		assertEquals(".x", v);
	}
	...
	@Test void d01_parseFlowMappingEmpty() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{}", JsonMap.class);
		assertEquals(0, m.size());
	}

	@Test void d02_parseFlowMappingSingle() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{a: 1}", JsonMap.class);
		assertEquals("1", m.getString("a"));
	}

	@Test void d03_parseFlowMappingQuotedKeys() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{'a': 1, \"b\": 2}", JsonMap.class);
		assertEquals("1", m.getString("a"));
	...
	@Test void d04_parseFlowMappingNullKey() throws Exception {
		...
		JsonMap m = YamlParser.DEFAULT.parse("{null: 1}", JsonMap.class);
	...
	@Test void d05_parseFlowMappingMissingOpenBrace() {
		...
		// Driving through doParse (no leading ws) — should error or return null.
		assertThrows(ParseException.class, () -> {
			// Pass valid content into a Map that requires flow opening.
			YamlParser.DEFAULT.parseIntoMap("not-a-map-just-text-no-{", new LinkedHashMap<>(), String.class, Object.class);
		});
	}

	@Test void d06_parseFlowMappingUnterminated() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("{a: 1", JsonMap.class));
	}
	...
	@Test void d10_parseFlowMappingNested() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{outer: {inner: val}}", JsonMap.class);
	...
	@Test void e01_parseFlowSequenceEmpty() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("[]", JsonList.class);
		assertEquals(0, l.size());
	}

	@Test void e02_parseFlowSequenceSingle() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("[a]", JsonList.class);
		assertEquals(1, l.size());
		assertEquals("a", l.getString(0));
	}

	@Test void e03_parseFlowSequenceWithSpaces() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("  [  a , b , c  ]  ", JsonList.class);
		assertEquals(3, l.size());
	}

	@Test void e04_parseFlowSequenceNested() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("[[1,2],[3,4]]", JsonList.class);
		assertEquals(2, l.size());
	}

	@Test void e05_parseFlowSequenceUnterminated() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("[a, b", JsonList.class));
	}
	...
	@Test void e07_parseFlowSequenceTrailingCommaErrors() {
		...
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("[a, ]", JsonList.class));
	}

	@Test void e08_parseFlowSequenceArray() throws Exception {
		String[] arr = YamlParser.DEFAULT.parse("[a, b, c]", String[].class);
	...
	@Test void f02_parseBlockSequenceWithComments() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("# top\n- a\n# middle\n- b\n- c", JsonList.class);
		assertEquals(3, l.size());
	}

	@Test void f03_parseBlockSequenceNested() throws Exception {
		String yaml = "- a\n- - b1\n  - b2\n- c";
		JsonList l = YamlParser.DEFAULT.parse(yaml, JsonList.class);
		assertEquals(3, l.size());
	}

	@Test void f04_parseBlockSequenceArray() throws Exception {
		String[] arr = YamlParser.DEFAULT.parse("- a\n- b\n- c", String[].class);
		assertEquals(3, arr.length);
	}
	...
	@Test void f05_parseBlockSequenceLastItemEmpty() throws Exception {
		...
		JsonList l = YamlParser.DEFAULT.parse("- a\n- \n- c", JsonList.class);
		assertTrue(l.size() >= 2);
	}

	@Test void f06_parseBlockSequenceIntoCollection() throws Exception {
		var l = new ArrayList<String>();
		YamlParser.DEFAULT.parseIntoCollection("- one\n- two", l, String.class);
		assertEquals(2, l.size());
	...
	@Test void f07_parseFlowSequenceIntoCollection() throws Exception {
		var l = new ArrayList<String>();
		YamlParser.DEFAULT.parseIntoCollection("[one, two, three]", l, String.class);
		assertEquals(3, l.size());
	}
	...
	@Test void g01_parseBlockMappingWithComments() throws Exception {
		String yaml = "# header\na: 1\n# middle\nb: 2";
		JsonMap m = YamlParser.DEFAULT.parse(yaml, JsonMap.class);
		assertEquals("1", m.getString("a"));
		assertEquals("2", m.getString("b"));
	}
	...
	@Test void g06_parseBlockMappingIntoMap() throws Exception {
		var m = new LinkedHashMap<String,Object>();
		YamlParser.DEFAULT.parseIntoMap("a: 1\nb: 2", m, String.class, Object.class);
		assertEquals(2, m.size());
	}

	@Test void g07_parseFlowMappingIntoMap() throws Exception {
		var m = new LinkedHashMap<String,Object>();
		YamlParser.DEFAULT.parseIntoMap("{a: 1, b: 2}", m, String.class, Object.class);
		assertEquals(2, m.size());
	}
	...
	@Test void h01_doubleQuoted_basicEscapes() throws Exception {
		assertEquals("\\", YamlParser.DEFAULT.parse("\"\\\\\"", String.class));
		assertEquals("\"", YamlParser.DEFAULT.parse("\"\\\"\"", String.class));
		assertEquals("\n", YamlParser.DEFAULT.parse("\"\\n\"", String.class));
		assertEquals("\t", YamlParser.DEFAULT.parse("\"\\t\"", String.class));
		assertEquals("\r", YamlParser.DEFAULT.parse("\"\\r\"", String.class));
	}

	@Test void h02_doubleQuoted_extendedEscapes() throws Exception {
		assertEquals("\0", YamlParser.DEFAULT.parse("\"\\0\"", String.class));
		assertEquals("", YamlParser.DEFAULT.parse("\"\\a\"", String.class));
		assertEquals("\b", YamlParser.DEFAULT.parse("\"\\b\"", String.class));
		assertEquals("\f", YamlParser.DEFAULT.parse("\"\\f\"", String.class));
		assertEquals("", YamlParser.DEFAULT.parse("\"\\e\"", String.class));
		assertEquals("/", YamlParser.DEFAULT.parse("\"\\/\"", String.class));
	}

	@Test void h03_doubleQuoted_hexEscape() throws Exception {
		assertEquals("A", YamlParser.DEFAULT.parse("\"\\x41\"", String.class));
	}

	@Test void h04_doubleQuoted_unicodeEscape() throws Exception {
		assertEquals("A", YamlParser.DEFAULT.parse("\"\\u0041\"", String.class));
	}

	@Test void h05_doubleQuoted_invalidHex() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("\"\\xZZ\"", String.class));
	}

	@Test void h06_doubleQuoted_invalidUnicode() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("\"\\uZZZZ\"", String.class));
	}

	@Test void h07_doubleQuoted_invalidEscape() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("\"\\q\"", String.class));
	}

	@Test void h08_doubleQuoted_unterminated() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("\"unterminated", String.class));
	}

	@Test void h09_singleQuoted_escapedQuote() throws Exception {
		assertEquals("it's", YamlParser.DEFAULT.parse("'it''s'", String.class));
	}
	...
	@Test void h13_singleQuoted_asMappingKey() throws Exception {
		...
		JsonMap m = YamlParser.DEFAULT.parse("'foo': bar", JsonMap.class);
		assertEquals("bar", m.getString("foo"));
	}
	...
	@Test void i09_blockScalarInvalidIndicator() {
		...
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("key: |@\n  bad", JsonMap.class));
	}

	@Test void i10_blockScalarTopLevel() throws Exception {
		String yaml = "|\n  hello\n  world";
		String s = YamlParser.DEFAULT.parse(yaml, String.class);
		assertEquals("hello\nworld\n", s);
	}
	...
	@Test void j01_parseBeanBlock() throws Exception {
		...
		var b = YamlParser.DEFAULT.parse(yaml, SimpleBean.class);
	...
	@Test void j04_parseBeanWithUnknownProperty() throws Exception {
		...
		String yaml = "name: John\nage: 30\nunknown: foo";
		var b = p.parse(yaml, SimpleBean.class);
		assertEquals("John", b.name);
	}
	...
	@Test void j06_parseBeanFlowMissingValue() {
		assertThrows(ParseException.class, () ->
			YamlParser.DEFAULT.parse("{name: John, age", SimpleBean.class));
	}
	...
	@Test void j07_parseNestedBean() throws Exception {
		...
		var b = YamlParser.DEFAULT.parse(yaml, NestedBean.class);
	...
	@Test void k03_parseListOfMaps() throws Exception {
		var p = YamlParser.DEFAULT;
		String yaml = "- a: 1\n- a: 2";
		JsonList l = p.parse(yaml, JsonList.class);
		assertEquals(2, l.size());
	}
	...
	@Test void k04_parseMapOfList() throws Exception {
		var p = YamlParser.DEFAULT;
		String yaml = "list:\n  - a\n  - b";
		JsonMap m = p.parse(yaml, JsonMap.class);
	...
	@Test void l01_parseChar() throws Exception {
		assertEquals(Character.valueOf('x'), YamlParser.DEFAULT.parse("x", Character.class));
	}

	@Test void l02_parseLong() throws Exception {
		assertEquals(Long.valueOf(123L), YamlParser.DEFAULT.parse("123", Long.class));
	}

	@Test void l03_parseFloat() throws Exception {
		assertEquals(Float.valueOf(1.5f), YamlParser.DEFAULT.parse("1.5", Float.class));
	}

	@Test void l04_parseBooleanString() throws Exception {
		// Plain scalar 'true' → boolean type
		assertEquals(Boolean.TRUE, YamlParser.DEFAULT.parse("true", Boolean.class));
	}
	...
	@Test void l06_parseStringFromQuoted_asObject() throws Exception {
		...
		assertEquals("true", YamlParser.DEFAULT.parse("\"true\"", Object.class));
	}
	...
	@Test void m02_plainScalarWithEmbeddedSpaces() throws Exception {
		assertEquals("hello world", YamlParser.DEFAULT.parse("hello world", String.class));
	}

	@Test void m03_plainScalarBeforeFlowComma() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("[hello world, foo]", JsonList.class);
		assertEquals("hello world", l.getString(0));
	}

	@Test void m04_plainScalarBeforeCloseBrace() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{a: hello}", JsonMap.class);
		assertEquals("hello", m.getString("a"));
	}

	@Test void m05_plainScalarBeforeCloseBracket() throws Exception {
		JsonList l = YamlParser.DEFAULT.parse("[hello]", JsonList.class);
	...
	@Test void m06_plainScalarSpaceBeforeComment() throws Exception {
		...
		assertEquals("hello", YamlParser.DEFAULT.parse("hello # comment", String.class));
	}

	@Test void m07_plainScalarColonInsideValue() throws Exception {
		// "a:b" with no space after ':' is part of scalar.
		assertEquals("a:b", YamlParser.DEFAULT.parse("a:b", String.class));
	}
	...
	@Test void n01_roundTripComplexMap() throws Exception {
		...
		String yaml = s.serialize(outer);
		JsonMap parsed = p.parse(yaml, JsonMap.class);
	...
	@Test void n02_largeNumberAsLong() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse("9223372036854775000", Object.class);
	...
	@Test void n03_tooLargeNumberFallsBackToString() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse("99999999999999999999999", Object.class);
	...
	@Test void n05_singleDashAlone() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse("-", Object.class);
		assertEquals("-", v);
	}
	...
	@Test void n07_intoCollectionWithBlock() throws Exception {
		// doParseIntoCollection block branch (no '[').
		var l = new ArrayList<Integer>();
		YamlParser.DEFAULT.parseIntoCollection("- 1\n- 2\n- 3", l, Integer.class);
		assertEquals(3, l.size());
		assertEquals(Integer.valueOf(1), l.get(0));
	}

	@Test void n08_intoCollectionWithFlow() throws Exception {
		// doParseIntoCollection flow branch ('[').
		var l = new ArrayList<Integer>();
		YamlParser.DEFAULT.parseIntoCollection("[1, 2, 3]", l, Integer.class);
		assertEquals(3, l.size());
	}
	...
	@Test void n10_intoMapWithFlow() throws Exception {
		var m = new LinkedHashMap<String,Integer>();
		YamlParser.DEFAULT.parseIntoMap("{a: 1, b: 2}", m, String.class, Integer.class);
		assertEquals(Integer.valueOf(1), m.get("a"));
	}
	...
	@Test void n12_emptyFlowMappingAsBean() throws Exception {
		var b = YamlParser.DEFAULT.parse("{}", SimpleBean.class);
		assertNull(b.name);
	...
	@Test void o01_parseFlowMappingIntoLinkedHashMap() throws Exception {
		...
		LinkedHashMap<String,Object> m = YamlParser.DEFAULT.parse("{a: 1, b: 2}", LinkedHashMap.class, String.class, Object.class);
		assertEquals(2, m.size());
		assertNotNull(m.get("a"));
	}
	...
	@Test void o07_parseFlowMappingAsArray() {
		...
		assertDoesNotThrow(() -> {
			try {
				YamlParser.DEFAULT.parse("{}", String[].class);
	...
	@Test void q01_convertToType_charSequence() throws Exception {
		...
		assertEquals("hello", YamlParser.DEFAULT.parse("hello   ", CharSequence.class));
	}
	...
	@Test void q04_convertToType_localDate() throws Exception {
		var d = YamlParser.DEFAULT.parse("'2023-01-15'", java.time.LocalDate.class);
		assertNotNull(d);
	}

	@Test void q05_convertToType_duration() throws Exception {
		var d = YamlParser.DEFAULT.parse("PT1H", java.time.Duration.class);
		assertEquals(java.time.Duration.ofHours(1), d);
	}

	@Test void q06_convertToType_period() throws Exception {
		var p = YamlParser.DEFAULT.parse("P1Y2M3D", java.time.Period.class);
	...
	@Test void q08_convertToType_canCreateFromString() throws Exception {
		...
		var f = YamlParser.DEFAULT.parse("'/tmp/file'", java.io.File.class);
		assertNotNull(f);
	...
	@Test void r01_plainKey_intoTypedMap() throws Exception {
		...
		Map<String,Integer> m = YamlParser.DEFAULT.parse("first: 100\nsecond: 200", Map.class, String.class, Integer.class);
	...
	@Test void r03_plainKey_trueInBooleanType() throws Exception {
		...
		var v = YamlParser.DEFAULT.parse("true", String.class);
		assertEquals("true", v);
	}
	...
	@Test void s02_blockMappingExitOnDashSibling() {
		...
		assertDoesNotThrow(() -> {
			try {
				YamlParser.DEFAULT.parse(yaml, JsonMap.class);
	...
	@Test void s04_blockSequenceDashWithoutSpace() throws Exception {
		...
		Object v = YamlParser.DEFAULT.parse("-foo", Object.class);
	...
	@Test void u03_blockSeqInsideFlowMap() {
		...
		assertDoesNotThrow(() -> {
			try {
				YamlParser.DEFAULT.parse("{k: [a, b]}", JsonMap.class);
			} catch (ParseException expected) { /* OK */ }
		});
	}
	...
	@Test void u04_emptyValueInFlowMap() {
		...
		assertDoesNotThrow(() -> {
			try {
				YamlParser.DEFAULT.parse("{k: v, k2: v2}", JsonMap.class);
			} catch (ParseException expected) { /* OK */ }
		});
	}
	...
	@Test void v01_beanWithBuilder_roundTrip() throws Exception {
		...
		String yaml = s.serialize(b);
		var b2 = p.parse(yaml, SimpleBean.class);
	...
	@Test void x03_parseBeanWithList() throws Exception {
		...
		var b = YamlParser.DEFAULT.parse(yaml, BeanWithList.class);
	...
	@Test void x05_parseBeanWithMap() throws Exception {
		String yaml = "name: foo\ncounts:\n  a: 1\n  b: 2";
		var b = YamlParser.DEFAULT.parse(yaml, BeanWithMap.class);
	...
	@Test void x07_parseBeanWithArray() throws Exception {
		...
		String yaml = s.serialize(arr);
		SimpleBean[] parsed = p.parse(yaml, SimpleBean[].class);
	...
	@Test void x08_parseFlowMappingArrayCast() {
		...
		assertDoesNotThrow(() -> {
			try {
				YamlParser.DEFAULT.parse("{0: a, 1: b}", String[].class);
			} catch (ParseException expected) { /* OK */ }
		});
	}
	...
	@Test void y01_documentStartTwoMarkers() throws Exception {
		...
		String yaml = "---\nhello";
		assertEquals("hello", YamlParser.DEFAULT.parse(yaml, String.class));
	}
	...
	@Test void y02_documentEndAfterValue() throws Exception {
		...
		String yaml = "hello\n...";
		var v = YamlParser.DEFAULT.parse(yaml, Object.class);
		assertNotNull(v);
	}
	...
	@Test void aa01_flowKeyContainingDigits() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{key123: value}", JsonMap.class);
		assertEquals("value", m.getString("key123"));
	}

	@Test void aa02_flowKeyHyphenated() throws Exception {
		JsonMap m = YamlParser.DEFAULT.parse("{my-key: value}", JsonMap.class);
	...
	@Test void bb01_charFromQuoted() throws Exception {
		...
		assertEquals(Character.valueOf('A'), YamlParser.DEFAULT.parse("\"A\"", Character.class));
	}
	...
	@Test void dd01_quotedKeyAsObject() throws Exception {
		...
		Object o = YamlParser.DEFAULT.parse("'foo': bar", Object.class);
		assertTrue(o instanceof Map);
	...
	@Test void dd04_quotedKeyIntoTypedMap() throws Exception {
		...
		Map<String,Integer> m = YamlParser.DEFAULT.parse("'foo': 100\nbar: 200", Map.class, String.class, Integer.class);
	...
	@Test void ee01_beanTypePropertyDispatch() throws Exception {
		...
		Object out = p.parse(yaml, Object.class);
		assertNotNull(out);
		assertInstanceOf(Map.class, out);
	}

	//------------------------------------------------------------------------------------------------------------------
	// ff0x — null reader path & extreme edge cases on doParse.
	//------------------------------------------------------------------------------------------------------------------

	@Test void ff01_nullInput() throws Exception {
		// parse(null, ...) → doParse → pipe.getParserReader() returns null reader → returns null.
		// Test this via Marshaller for Object class.
		assertNull(YamlParser.DEFAULT.parse((String)null, Object.class));
	}
