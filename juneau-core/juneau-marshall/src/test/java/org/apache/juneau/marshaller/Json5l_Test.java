...
class Json5l_Test extends TestBase {
	...
	@Test void a01_of() throws Exception {
		...
		assertEquals("\"foo\"", Json5l.of(a, stringWriter()).toString().trim());
	...
	@Test void a02_to() throws Exception {
		...
		m = (Map<String,String>) Json5l.to(stringReader(b), Map.class, String.class, String.class);
		assertEquals("bar", m.get("foo"));
	...
	@Test void a04_defaultInstance() throws Exception {
		...
		var b = (List<JsonMap>) Json5l.DEFAULT.read(json5l, List.class, JsonMap.class);
