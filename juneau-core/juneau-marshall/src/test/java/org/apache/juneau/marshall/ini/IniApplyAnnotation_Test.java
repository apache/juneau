...
class IniApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = IniApplyAnnotation.create(String.class).build();
		assertFalse(IniApplyAnnotation.empty(a));
	}

	@Test void a04_create_and_build() {
		var a = IniApplyAnnotation.create("MyClass").build();
