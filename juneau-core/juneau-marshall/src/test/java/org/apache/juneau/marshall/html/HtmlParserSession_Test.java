...
class HtmlParserSession_Test extends TestBase {
	...
	@Test void a01_emptyCollection_noResults() throws Exception {
		...
		var html = SER.serialize(list);
		var result = (List<String>) PAR.parse(html, List.class, String.class);
	...
	@Test void a02_pTagNoResults() throws Exception {
		...
		var r = PAR.parse(html, Object.class);
		assertNull(r);
	}
	...
	@Test void b01_tableWithArrayType_intoCollection() throws Exception {
		...
		var html = SER.serialize(list);
		var result = (List<AB>) PAR.parse(html, List.class, AB.class);
	...
	@Test void b02_tableWithArrayType_intoArray() throws Exception {
		...
		var list = List.of(new AB("x", "y"), new AB("p", "q"));
		var html = SER.serialize(list);
		var result = PAR.parse(html, AB[].class);
	...
	@Test void b04_tableWithObjectType_intoMap() throws Exception {
		...
		map.put("k1", "v1");
		map.put("k2", "v2");
		var html = SER.serialize(map);
		var result = (Map<String, String>) PAR.parse(html, LinkedHashMap.class, String.class, String.class);
	...
	@Test void c01_ulIntoStringList() throws Exception {
		...
		var html = SER.serialize(list);
		var result = (List) PAR.parse(html, List.class, String.class);
	...
	@Test void c02_ulIntoStringArray() throws Exception {
		...
		var html = SER.serialize(list);
		var result = PAR.parse(html, String[].class);
	...
	@Test void c03_ulIntoLinkedList() throws Exception {
		...
		var html = SER.serialize(list);
		LinkedList<String> result = PAR.parse(html, LinkedList.class, String.class);
		assertEquals(2, result.size());
	}
	...
	@Test void d02_temporalRootValue() throws Exception {
		...
		var html = SER.serialize(Instant.EPOCH);
		var result = PAR.parse(html, Instant.class);
		assertNotNull(result);
	}

	@Test void d03_durationRootValue() throws Exception {
		// sType.isDuration() at line 262 via <string> tag parsing
		var html = SER.serialize(Duration.ofSeconds(42));
		var result = PAR.parse(html, Duration.class);
	...
	@Test void d04_periodRootValue() throws Exception {
		...
		var html = SER.serialize(Period.of(1, 2, 3));
		var result = PAR.parse(html, Period.class);
	...
	@Test void f01_nullTagInList() throws Exception {
		// tag == NULL at line 317 in parseAnything → null element in list
	...
	@Test void g01_tableWithNullRow() throws Exception {
		// In parseTableIntoCollection, a NULL tag in a row → m = null at line 558
	...
	@Test void h01_optionalPresentInBean() throws Exception {
		...
		var html = SER.serialize("test value");
		Optional<String> result = PAR.parse(html, Optional.class, String.class);
	...
	@Test void i01_numberTagIntoNumber() throws Exception {
		...
		var html = SER.serialize(42);
		var result = PAR.parse(html, Integer.class);
		assertEquals(42, result);
	}

	@Test void i02_booleanTag() throws Exception {
		// tag == BOOLEAN, sType.isBoolean() at line 305
		var html = SER.serialize(true);
		var result = PAR.parse(html, Boolean.class);
		assertTrue(result);
	}

	@Test void i03_numberAsObject() throws Exception {
		// tag == NUMBER, sType.isObject() at line 295
		var html = SER.serialize(3.14);
		var result = PAR.parse(html, Object.class);
		assertNotNull(result);
	}
	...
	@Test void j01_unknownBeanPropInTableRow() throws Exception {
		// e == null at line 563 → skip value (parseAnything(object(),...))
		...
		var result = (List<BeanWithKnownProps>) p.parse(html, List.class, BeanWithKnownProps.class);
	...
	@Test void k01_anchorTagInList() throws Exception {
		// tag == A at line 321 in parseAnything → calls parseAnchor
