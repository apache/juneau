...
class HttpPartSchema_Validation_Test extends TestBase {
	...
	@Test void d03_getProperty_with_properties() {
	...
	@Test void d04_getProperty_falls_back_to_additionalProperties() {
	...
	@Test void d05_getProperty_no_properties_no_additional() {
		var s = HttpPartSchema.create().tObject().build();
		assertNull(s.getProperty("anyKey"));
	}

	@Test void d06_hasProperties() {
	...
	@Test void i02_builder_format_empty_ignored() {
	...
	@Test void i03_builder_format_null_ignored() {
	...
	@Test void i05_builder_type_empty_ignored() {
	...
	@Test void i08_builder_pattern_empty_ignored() {
	...
	@Test void j01_builder_parser_serializer_void_ignored() {
	...
	@Test void j02_builder_parser_serializer_set() {
	...
	@Test void k04_static_tArray_with_items() {
		var inner = HttpPartSchema.create().tString();
		var s = HttpPartSchema.tArray(inner).build();
		assertNotNull(s.getItems());
	}

	@Test void k05_static_tArrayXxx_with_items() {
		var inner = HttpPartSchema.create().tString();
	...
	@Test void l01_enum_empty_handling() {
	...
	@Test void m20_validation_array_of_objects_uon_ok() {
	...
	@Test void o02_toString_with_properties() {
	...
	@Test void p01_getFormat_classInfo_double() {
	...
	@Test void p12_getType_classInfo_map() {
		var s = HttpPartSchema.create().build();
	...
	@Test void p13_getType_classInfo_explicit_overrides() {
		var s = HttpPartSchema.create().tString().build();
		var ci = org.apache.juneau.commons.reflect.ClassInfo.of(Integer.class);
		// Explicit type wins
		assertEquals(HttpPartDataType.STRING, s.getType(ci));
