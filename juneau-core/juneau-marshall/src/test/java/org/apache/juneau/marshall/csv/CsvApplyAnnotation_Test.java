...
class CsvApplyAnnotation_Test extends TestBase {
	...
	@Test void a03_empty_nonDefault() {
		var a = CsvApplyAnnotation.create(String.class).build();
		assertFalse(CsvApplyAnnotation.empty(a));
	}
	...
	@Test void b05_applier_emptyOn_returnsEarly() {
		...
		var applier = new CsvApplyAnnotation.Applier(vr);
		var b = MarshallingContext.DEFAULT.copy();
		var a = CsvApplyAnnotation.DEFAULT;
