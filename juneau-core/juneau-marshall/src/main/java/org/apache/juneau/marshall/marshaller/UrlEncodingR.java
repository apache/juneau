...
/**
 * A {@link UrlEncoding} variant that produces <b>readable</b> (whitespace-padded) URL-encoded output.
 *
 * <p>
 * 	This is the first-class facade form of the readable URL-encoding variant.  It pairs
 * 	{@link UrlEncodingSerializer#DEFAULT_READABLE} with {@link UrlEncodingParser#DEFAULT} and exposes the
 * 	full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>urlEncoding</jv> = UrlEncodingR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = UrlEncodingR.<jsm>to</jsm>(<jv>urlEncoding</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		readable {@link #DEFAULT} rather than the {@link UrlEncoding#DEFAULT}.
 * </ul>
 *
...
public class UrlEncodingR extends UrlEncoding {

	/** Default reusable instance, readable format. */
	public static final UrlEncodingR DEFAULT = new UrlEncodingR();
	 ...
	 *
	 * <p>
	 * Uses {@link UrlEncodingSerializer#DEFAULT_READABLE} and {@link UrlEncodingParser#DEFAULT}.
	 */
	public UrlEncodingR() {
		super(UrlEncodingSerializer.DEFAULT_READABLE, UrlEncodingParser.DEFAULT);
	}
}
