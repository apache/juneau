...
/**
 * An {@link Html} variant that produces <b>readable</b> (indented, multi-line) output with attributes
 * quoted using single quotes.
 *
 * <p>
 * 	This is the first-class facade form of the single-quote readable HTML variant.  It pairs
 * 	{@link HtmlSerializer#DEFAULT_SQ_READABLE} with {@link HtmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>html</jv> = HtmlSqR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = HtmlSqR.<jsm>to</jsm>(<jv>html</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		single-quote readable {@link #DEFAULT} rather than the {@link Html#DEFAULT}.
 * </ul>
 *
...
public class HtmlSqR extends Html {

	/** Default reusable instance, single-quote readable format. */
	public static final HtmlSqR DEFAULT = new HtmlSqR();
	 ...
	 *
	 * <p>
	 * Uses {@link HtmlSerializer#DEFAULT_SQ_READABLE} and {@link HtmlParser#DEFAULT}.
	 */
	public HtmlSqR() {
		super(HtmlSerializer.DEFAULT_SQ_READABLE, HtmlParser.DEFAULT);
	}
}
