...
public class MarshalledFilter implements BeanFilter {
	...
	protected MarshalledFilter(Builder builder) {
		...
		this.properties = u(cp(builder.properties));
		this.excludeProperties = u(cp(builder.excludeProperties));
		this.readOnlyProperties = u(cp(builder.readOnlyProperties));
		this.writeOnlyProperties = u(cp(builder.writeOnlyProperties));
