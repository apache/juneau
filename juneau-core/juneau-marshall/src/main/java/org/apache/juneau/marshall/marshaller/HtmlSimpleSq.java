...
/**
 * An {@link Html} variant that produces output with single-quoted attributes and JSON type
 * hint tags disabled (a "simple" flavor of the single-quote variant).
 *
 * <p>
 * 	This is the first-class facade form of the simple single-quote HTML variant.  It pairs
 * 	{@link HtmlSerializer#DEFAULT_SIMPLE_SQ} with {@link HtmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>html</jv> = HtmlSimpleSq.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = HtmlSimpleSq.<jsm>to</jsm>(<jv>html</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		simple single-quote {@link #DEFAULT} rather than the {@link Html#DEFAULT}.
 * </ul>
 *
...
public class HtmlSimpleSq extends Html {

	/** Default reusable instance, simple single-quote format. */
	public static final HtmlSimpleSq DEFAULT = new HtmlSimpleSq();
	 ...
	 *
	 * <p>
	 * Uses {@link HtmlSerializer#DEFAULT_SIMPLE_SQ} and {@link HtmlParser#DEFAULT}.
	 */
	public HtmlSimpleSq() {
		super(HtmlSerializer.DEFAULT_SIMPLE_SQ, HtmlParser.DEFAULT);
	}
}
