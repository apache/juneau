...
/**
 * Annotation for specifying config properties defined in {@link ProtobufSerializer} and {@link ProtobufParser}.
 *
 * <p>
...
@Retention(RUNTIME)
@Inherited
@ContextApply({ ProtobufConfigAnnotation.SerializerApply.class, ProtobufConfigAnnotation.ParserApply.class })
public @interface ProtobufConfig {
	 ...
	 * (enum name-vs-ordinal is controlled by the explicit {@link Protobuf#type()} option instead).
	 *
	 * <ul class='values'>
	 * 	<li><js>"true"</js>
	 * 	<li><js>"false"</js> (default)
