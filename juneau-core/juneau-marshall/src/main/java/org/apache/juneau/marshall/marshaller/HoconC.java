...
/**
 * A {@link Hocon} variant that produces <b>compact</b> (single-line) HOCON output.
 *
 * <p>
 * 	This is the first-class facade form of the compact HOCON variant.  It pairs
 * 	{@link HoconSerializer#DEFAULT_COMPACT} with {@link HoconParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>hocon</jv> = HoconC.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = HoconC.<jsm>to</jsm>(<jv>hocon</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		compact {@link #DEFAULT} rather than the {@link Hocon#DEFAULT}.
 * </ul>
 *
...
public class HoconC extends Hocon {

	/** Default reusable instance, compact format. */
	public static final HoconC DEFAULT = new HoconC();
	 ...
	 *
	 * <p>
	 * Uses {@link HoconSerializer#DEFAULT_COMPACT} and {@link HoconParser#DEFAULT}.
	 */
	public HoconC() {
		super(HoconSerializer.DEFAULT_COMPACT, HoconParser.DEFAULT);
	}
}
