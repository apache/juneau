...
/**
 * Dynamically applies a {@link Bson @Bson} annotation to specified classes, methods, or fields.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link Bson @Bson} to be a pure data annotation
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(BsonApply.Array.class)
@ContextApply(BsonApplyAnnotation.Applier.class)
public @interface BsonApply {

	/**
	 * The {@link Bson @Bson} annotation to apply.
	 *
	...
	/**
	 * A collection of {@link BsonApply @BsonApply annotations}.
	 */
	@Documented
	@Target({ TYPE, METHOD })
	@Retention(RUNTIME)
