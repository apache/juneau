...
/**
 * Annotation for specifying config properties defined in {@link YamlSerializer} and {@link YamlParser}.
 *
 * <p>
...
@Retention(RUNTIME)
@Inherited
@ContextApply({ YamlConfigAnnotation.SerializerApply.class, YamlConfigAnnotation.ParserApply.class })
public @interface YamlConfig {
	 ...
	 * 	<li class='jm'>{@link org.apache.juneau.yaml.YamlSerializer.Builder#addBeanTypesYaml()}
	 * </ul>
	 *
