...
public @interface HtmlDocConfig {
	 ...
	 * 		Format: HTML
	 * 	<li class='note'>
	 * 		Supports <a class="doclink" href="../../../../../index.html#juneau-rest-server.jrs.SvlVariables">SVL Variables</a> (e.g. <js>"$L{my.localized.variable}"</js>).
	 * 	<li class='note'>
	 ...
	 * 	<li class='note'>
	 * 		Supports <a class="doclink" href="../../../../../index.html#juneau-marshall.jm.MarshallingUris">URIs</a> (e.g. <js>"servlet:/..."</js>, <js>"request:/..."</js>).
	 * 	<li class='note'>
	 * 		On methods, this value is inherited from the <ja>@HtmlDocConfig</ja> annotation on the servlet/resource class.
	 * 	<li class='note'>
	 * 		On servlet/resource classes, this value is inherited from the <ja>@HtmlDocConfig</ja> annotation on the
