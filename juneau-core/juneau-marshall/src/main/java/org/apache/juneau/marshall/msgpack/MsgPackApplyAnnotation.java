...
/**
 * Utility classes and methods for the {@link MsgPackApply @MsgPackApply} annotation.
 *
 */
public class MsgPackApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private MsgPackApplyAnnotation() {}

	/**
	 * Applies targeted {@link MsgPackApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<MsgPackApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(MsgPackApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<MsgPackApply> ai, Context.Builder b) {
			MsgPackApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		MsgPack value = MsgPackAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(MsgPackApply.class);
		}

		/**
		 * Sets the {@link MsgPackApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(MsgPack value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link MsgPackApply @MsgPackApply} object initialized with this builder.
		 *
		 * @return A new {@link MsgPackApply} object.
		 */
		public MsgPackApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements MsgPackApply {

		private final MsgPack value;

		Object(MsgPackApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final MsgPackApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(MsgPackApply a) {
