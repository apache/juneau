...
/**
 * An {@link Xml} variant that emits XML <b>namespaces</b> (the {@link Xml#DEFAULT} form omits them).
 *
 * <p>
 * 	This is the first-class facade form of the namespace-aware XML variant.  It pairs
 * 	{@link XmlSerializer#DEFAULT_NS} with {@link XmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>xml</jv> = XmlNs.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = XmlNs.<jsm>to</jsm>(<jv>xml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		namespace-aware {@link #DEFAULT} rather than the {@link Xml#DEFAULT}.
 * </ul>
 *
...
public class XmlNs extends Xml {

	/** Default reusable instance, namespace-aware format. */
	public static final XmlNs DEFAULT = new XmlNs();
	 ...
	 *
	 * <p>
	 * Uses {@link XmlSerializer#DEFAULT_NS} and {@link XmlParser#DEFAULT}.
	 */
	public XmlNs() {
		super(XmlSerializer.DEFAULT_NS, XmlParser.DEFAULT);
	}
}
