...
/**
 * An {@link Xml} variant that produces <b>readable</b> (indented, multi-line) output with attributes
 * quoted using single quotes.
 *
 * <p>
 * 	This is the first-class facade form of the single-quote readable XML variant.  It pairs
 * 	{@link XmlSerializer#DEFAULT_SQ_READABLE} with {@link XmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>xml</jv> = XmlSqR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = XmlSqR.<jsm>to</jsm>(<jv>xml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		single-quote readable {@link #DEFAULT} rather than the {@link Xml#DEFAULT}.
 * </ul>
 *
...
public class XmlSqR extends Xml {

	/** Default reusable instance, single-quote readable format. */
	public static final XmlSqR DEFAULT = new XmlSqR();
	 ...
	 *
	 * <p>
	 * Uses {@link XmlSerializer#DEFAULT_SQ_READABLE} and {@link XmlParser#DEFAULT}.
	 */
	public XmlSqR() {
		super(XmlSerializer.DEFAULT_SQ_READABLE, XmlParser.DEFAULT);
	}
}
