...
/**
 * Dynamically applies a {@link Cbor @Cbor} annotation to specified classes, methods, or fields.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link Cbor @Cbor} to be a pure data annotation
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(CborApply.Array.class)
@ContextApply(CborApplyAnnotation.Applier.class)
public @interface CborApply {

	/**
	 * The {@link Cbor @Cbor} annotation to apply.
	 *
	...
	/**
	 * A collection of {@link CborApply @CborApply annotations}.
	 */
	@Documented
	@Target({ TYPE, METHOD })
	@Retention(RUNTIME)
