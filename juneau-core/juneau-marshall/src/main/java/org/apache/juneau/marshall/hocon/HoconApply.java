...
/**
 * Dynamically applies a {@link Hocon @Hocon} annotation to specified classes, methods, or fields.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link Hocon @Hocon} to be a pure data annotation
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(HoconApply.Array.class)
@ContextApply(HoconApplyAnnotation.Applier.class)
public @interface HoconApply {

	/**
	 * The {@link Hocon @Hocon} annotation to apply.
	 *
	...
	/**
	 * A collection of {@link HoconApply @HoconApply annotations}.
	 */
	@Documented
	@Target({ TYPE, METHOD })
	@Retention(RUNTIME)
