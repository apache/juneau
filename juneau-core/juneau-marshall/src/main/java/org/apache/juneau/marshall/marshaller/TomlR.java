...
/**
 * A {@link Toml} variant that produces <b>readable</b> (whitespace-padded) TOML output.
 *
 * <p>
 * 	This is the first-class facade form of the readable TOML variant.  It pairs
 * 	{@link TomlSerializer#DEFAULT_READABLE} with {@link TomlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>toml</jv> = TomlR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = TomlR.<jsm>to</jsm>(<jv>toml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Toml} so that every shortcut is bound to this class's
 * 		readable {@link #DEFAULT} rather than the {@link Toml#DEFAULT}.
 * </ul>
 *
...
public class TomlR extends Toml {

	/** Default reusable instance, readable format. */
	public static final TomlR DEFAULT = new TomlR();
	 ...
	 *
	 * <p>
	 * Uses {@link TomlSerializer#DEFAULT_READABLE} and {@link TomlParser#DEFAULT}.
	 */
	public TomlR() {
		super(TomlSerializer.DEFAULT_READABLE, TomlParser.DEFAULT);
	}
}
