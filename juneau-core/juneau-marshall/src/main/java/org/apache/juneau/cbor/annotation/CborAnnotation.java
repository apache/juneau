...
public class CborAnnotation {
	...
	/**
	 * Applies targeted {@link Cbor} annotations to a {@link org.apache.juneau.Context.Builder}.
	 */
	public static class Apply extends AnnotationApplier<Cbor,Context.Builder> {
		...
		public Apply(VarResolverSession vr) {
			super(Cbor.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<Cbor> ai, Context.Builder b) {
			Cbor a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		/**
		 * Instantiates a new {@link Cbor @Cbor} object initialized with this builder.
		 *
		 * @return A new {@link Cbor @Cbor} object.
		 */
		public Cbor build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements Cbor {
		...
		Object(CborAnnotation.Builder b) {
			super(b);
	...
	/** Default value */
	public static final Cbor DEFAULT = create().build();
	 ...
	 */
	public static Cbor copy(Cbor a, VarResolverSession r) {
