...
/**
 * A pairing of a {@link UrlEncodingSerializer} and {@link UrlEncodingParser} into a single class with convenience to/of methods.
 *
 * <p>
 ...
 * 	MyPojo <jv>myPojo</jv> = <jv>urlEncoding</jv>.to(<jv>string</jv>, MyPojo.<jk>class</jk>);
 * 	String <jv>string</jv> = <jv>urlEncoding</jv>.of(<jv>myPojo</jv>);
 * </p>
 * <p class='bjava'>
 *	<jc>// Using DEFAULT instance.</jc>
 * 	MyPojo <jv>myPojo</jv> = UrlEncoding.<jsf>DEFAULT</jsf>.to(<jv>string</jv>, MyPojo.<jk>class</jk>);
 * 	String <jv>string</jv> = UrlEncoding.<jsf>DEFAULT</jsf>.of(<jv>myPojo</jv>);
 * </p>
 *
