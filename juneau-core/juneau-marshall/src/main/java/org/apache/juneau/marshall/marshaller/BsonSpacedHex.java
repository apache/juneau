...
/**
 * A {@link Bson} variant that represents binary values as <b>spaced hexadecimal</b> text instead of
 * raw BSON bytes.
 *
 * <p>
 * 	This is the first-class facade form of the spaced-hex BSON variant.  It pairs
 * 	{@link BsonSerializer#DEFAULT_SPACED_HEX} with {@link BsonParser#DEFAULT_SPACED_HEX} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = BsonSpacedHex.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = BsonSpacedHex.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Bson} so that every shortcut is bound to this class's
 * 		spaced-hex {@link #DEFAULT} rather than the {@link Bson#DEFAULT}.
 * </ul>
 *
...
public class BsonSpacedHex extends Bson {

	/** Default reusable instance, spaced-hex format. */
	public static final BsonSpacedHex DEFAULT = new BsonSpacedHex();
	 ...
	 *
	 * <p>
	 * Uses {@link BsonSerializer#DEFAULT_SPACED_HEX} and {@link BsonParser#DEFAULT_SPACED_HEX}.
	 */
	public BsonSpacedHex() {
		super(BsonSerializer.DEFAULT_SPACED_HEX, BsonParser.DEFAULT_SPACED_HEX);
	}
}
