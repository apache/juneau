 ...
 */
@SuppressWarnings({
	"java:S2160" // Inner Object inherits equals/hashCode from AppliedOnClassAnnotationObject; overriding would break annotation comparison
})
public class ProtoAnnotation {
	...
	/**
	 * Applies targeted {@link Proto} annotations to a {@link org.apache.juneau.Context.Builder}.
	 */
	public static class Apply extends AnnotationApplier<Proto,Context.Builder> {
		...
		public Apply(VarResolverSession vr) {
			super(Proto.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<Proto> ai, Context.Builder b) {
			var a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		/**
		 * Sets the comment property on this annotation.
		 *
	...
	private static class Object extends AppliedOnClassAnnotationObject implements Proto {
	 ...
	 */
	public static Proto copy(Proto a, VarResolverSession r) {
		// @formatter:off
		return create()
			.comment(r.resolve(a.comment()))
