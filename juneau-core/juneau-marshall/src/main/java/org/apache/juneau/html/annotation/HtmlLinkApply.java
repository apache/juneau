...
/**
 * Dynamically applies a {@link HtmlLink @HtmlLink} annotation to specified classes.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link HtmlLink @HtmlLink} to be a pure data annotation
 * without marshall-specific application machinery.
 *
 * <h5 class='section'>Example:</h5>
 * <p class='bjava'>
 * 	<ja>@HtmlLinkApply</ja>(on=<js>"com.example.Foo"</js>, value=<ja>@HtmlLink</ja>(nameProperty=<js>"a"</js>, uriProperty=<js>"b"</js>))
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(HtmlLinkApply.Array.class)
@ContextApply(HtmlLinkApplyAnnotation.Applier.class)
public @interface HtmlLinkApply {

	/**
	 * The {@link HtmlLink @HtmlLink} annotation to apply.
	 *
	...
	/**
	 * A collection of {@link HtmlLinkApply @HtmlLinkApply annotations}.
	 */
	@Documented
	@Target({ TYPE, METHOD })
	@Retention(RUNTIME)
