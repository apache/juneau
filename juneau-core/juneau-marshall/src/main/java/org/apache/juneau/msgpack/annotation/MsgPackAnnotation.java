...
public class MsgPackAnnotation {
	 ...
	 */
	public static class Apply extends AnnotationApplier<MsgPack,ContextPropertiesBuilder> {
		...
		@Override
		public void apply(AnnotationInfo<MsgPack> ai, ContextPropertiesBuilder b) {
