...
/**
 * A {@link Prototext} variant that produces <b>readable</b> (whitespace-padded) Protobuf Text Format output.
 *
 * <p>
 * 	This is the first-class facade form of the readable Prototext variant.  It pairs
 * 	{@link PrototextSerializer#DEFAULT_READABLE} with {@link PrototextParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>proto</jv> = PrototextR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = PrototextR.<jsm>to</jsm>(<jv>proto</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Prototext} so that every shortcut is bound to this class's
 * 		readable {@link #DEFAULT} rather than the {@link Prototext#DEFAULT}.
 * </ul>
 *
...
public class PrototextR extends Prototext {

	/** Default reusable instance, readable format. */
	public static final PrototextR DEFAULT = new PrototextR();
	 ...
	 *
	 * <p>
	 * Uses {@link PrototextSerializer#DEFAULT_READABLE} and {@link PrototextParser#DEFAULT}.
	 */
	public PrototextR() {
		super(PrototextSerializer.DEFAULT_READABLE, PrototextParser.DEFAULT);
	}
}
