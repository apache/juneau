...
/**
 * A {@link Bson} variant that represents binary values as <b>Base64</b> text instead of raw BSON bytes.
 *
 * <p>
 * 	This is the first-class facade form of the Base64 BSON variant.  It pairs
 * 	{@link BsonSerializer#DEFAULT_BASE64} with {@link BsonParser#DEFAULT_BASE64} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = BsonBase64.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = BsonBase64.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		Base64 {@link #DEFAULT} rather than the {@link Bson#DEFAULT}.
 * </ul>
 *
...
public class BsonBase64 extends Bson {

	/** Default reusable instance, Base64 format. */
	public static final BsonBase64 DEFAULT = new BsonBase64();
	 ...
	 *
	 * <p>
	 * Uses {@link BsonSerializer#DEFAULT_BASE64} and {@link BsonParser#DEFAULT_BASE64}.
	 */
	public BsonBase64() {
		super(BsonSerializer.DEFAULT_BASE64, BsonParser.DEFAULT_BASE64);
	}
}
