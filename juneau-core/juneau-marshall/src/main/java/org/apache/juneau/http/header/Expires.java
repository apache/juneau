...
public class Expires extends BasicDateHeader {
	 ...
	 * 	</ul>
	 * @return A new {@link Expires} object, or <jk>null</jk> if the value was null.
	 */
	public static Expires of(Object value) {
		if (value == null)
			return null;
	 ...
	 * @return A new {@link Expires} object, or <jk>null</jk> if the value was null.
	 */
	public static Expires of(Supplier<?> value) {
		if (value == null)
			return null;
		return new Expires(value);
	}
