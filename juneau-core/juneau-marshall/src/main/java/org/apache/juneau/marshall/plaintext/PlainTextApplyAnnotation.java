...
/**
 * Utility classes and methods for the {@link PlainTextApply @PlainTextApply} annotation.
 *
 */
public class PlainTextApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private PlainTextApplyAnnotation() {}

	/**
	 * Applies targeted {@link PlainTextApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<PlainTextApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(PlainTextApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<PlainTextApply> ai, Context.Builder b) {
			PlainTextApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		PlainText value = PlainTextAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(PlainTextApply.class);
		}

		/**
		 * Sets the {@link PlainTextApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(PlainText value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link PlainTextApply @PlainTextApply} object initialized with this builder.
		 *
		 * @return A new {@link PlainTextApply} object.
		 */
		public PlainTextApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements PlainTextApply {

		private final PlainText value;

		Object(PlainTextApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final PlainTextApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(PlainTextApply a) {
