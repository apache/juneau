...
/**
 * A concrete implementation of the {@link HasFormData} annotation.
 */
public class HasFormDataAnnotation implements HasFormData {
	 ...
	 */
	public HasFormDataAnnotation name(String value) {
		this.name = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public HasFormDataAnnotation n(String value) {
		this.n = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public HasFormDataAnnotation value(String value) {
		this.value = value;
		return this;
	}
}
