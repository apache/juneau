...
/**
 * A {@link MsgPack} variant that represents binary values as <b>Base64</b> text instead of raw
 * MessagePack bytes.
 *
 * <p>
 * 	This is the first-class facade form of the Base64 MessagePack variant.  It pairs
 * 	{@link MsgPackSerializer#DEFAULT_BASE64} with {@link MsgPackParser#DEFAULT_BASE64} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = MsgPackBase64.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = MsgPackBase64.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		Base64 {@link #DEFAULT} rather than the {@link MsgPack#DEFAULT}.
 * </ul>
 *
...
public class MsgPackBase64 extends MsgPack {

	/** Default reusable instance, Base64 format. */
	public static final MsgPackBase64 DEFAULT = new MsgPackBase64();
	 ...
	 *
	 * <p>
	 * Uses {@link MsgPackSerializer#DEFAULT_BASE64} and {@link MsgPackParser#DEFAULT_BASE64}.
	 */
	public MsgPackBase64() {
		super(MsgPackSerializer.DEFAULT_BASE64, MsgPackParser.DEFAULT_BASE64);
	}
}
