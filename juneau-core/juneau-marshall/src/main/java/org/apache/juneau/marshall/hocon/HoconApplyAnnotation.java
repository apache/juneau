...
/**
 * Utility classes and methods for the {@link HoconApply @HoconApply} annotation.
 *
 */
public class HoconApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private HoconApplyAnnotation() {}

	/**
	 * Applies targeted {@link HoconApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<HoconApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(HoconApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<HoconApply> ai, Context.Builder b) {
			HoconApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Hocon value = HoconAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(HoconApply.class);
		}

		/**
		 * Sets the {@link HoconApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Hocon value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link HoconApply @HoconApply} object initialized with this builder.
		 *
		 * @return A new {@link HoconApply} object.
		 */
		public HoconApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements HoconApply {

		private final Hocon value;

		Object(HoconApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final HoconApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(HoconApply a) {
