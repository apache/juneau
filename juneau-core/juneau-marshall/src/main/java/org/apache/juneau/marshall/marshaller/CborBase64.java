...
/**
 * A {@link Cbor} variant that represents binary values as <b>Base64</b> text instead of raw CBOR bytes.
 *
 * <p>
 * 	This is the first-class facade form of the Base64 CBOR variant.  It pairs
 * 	{@link CborSerializer#DEFAULT_BASE64} with {@link CborParser#DEFAULT_BASE64} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = CborBase64.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = CborBase64.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Cbor} so that every shortcut is bound to this class's
 * 		Base64 {@link #DEFAULT} rather than the {@link Cbor#DEFAULT}.
 * </ul>
 *
...
public class CborBase64 extends Cbor {

	/** Default reusable instance, Base64 format. */
	public static final CborBase64 DEFAULT = new CborBase64();
	 ...
	 *
	 * <p>
	 * Uses {@link CborSerializer#DEFAULT_BASE64} and {@link CborParser#DEFAULT_BASE64}.
	 */
	public CborBase64() {
		super(CborSerializer.DEFAULT_BASE64, CborParser.DEFAULT_BASE64);
	}
}
