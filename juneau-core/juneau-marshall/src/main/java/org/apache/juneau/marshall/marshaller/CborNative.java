...
/**
 * A {@link Cbor} variant whose parser is in <b>native mode</b>, exposing low-level CBOR tag and
 * type information in the token stream instead of normalizing it away.
 *
 * <p>
 * 	This is the first-class facade form of the native-mode CBOR variant.  It pairs the default
 * 	{@link CborSerializer#DEFAULT} with {@link CborParser#DEFAULT_NATIVE} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = CborNative.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = CborNative.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		native-mode {@link #DEFAULT} rather than the {@link Cbor#DEFAULT}.
 * </ul>
 *
...
public class CborNative extends Cbor {

	/** Default reusable instance, native-mode parsing. */
	public static final CborNative DEFAULT = new CborNative();
	 ...
	 *
	 * <p>
	 * Uses {@link CborSerializer#DEFAULT} and {@link CborParser#DEFAULT_NATIVE}.
	 */
	public CborNative() {
		super(CborSerializer.DEFAULT, CborParser.DEFAULT_NATIVE);
	}
}
