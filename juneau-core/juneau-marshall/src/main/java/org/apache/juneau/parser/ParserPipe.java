...
public final class ParserPipe implements Closeable {
	...
	public InputStream getInputStream() throws IOException {
		...
		if (input instanceof InputStream) {
			...
			throw ioException("Cannot convert object of type {0} to an InputStream.", className(input));
		}
	 ...
	 *
	 * <p>
	 * This method only returns a value if {@link ContextBuilder#debug()} is enabled.
	 *
