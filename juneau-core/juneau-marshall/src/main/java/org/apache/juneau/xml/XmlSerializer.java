...
public class XmlSerializer extends WriterSerializer implements XmlMetaProvider {
	...
	public abstract static class Builder<SELF extends Builder<SELF>> extends WriterSerializer.Builder<SELF> {
		 ...
		 * @return This object.
		 */
		public SELF addBeanTypesXml(boolean value) {
		 ...
		 * @return This object.
		 */
		public SELF addNamespaceUrisToRoot() {
		 ...
		 * @return This object.
		 */
		public SELF defaultNamespace(Namespace value) {
		 ...
		 * @return This object.
		 */
		public SELF disableJsonTags(boolean value) {
	...
	/**
	 * Concrete default builder leaf for the non-subclassed {@link XmlSerializer#create()} / {@link XmlSerializer#copy()} path.
	 */
	public static final class DefaultBuilder extends Builder<DefaultBuilder> {

		DefaultBuilder() {}

		DefaultBuilder(XmlSerializer copyFrom) {
			super(copyFrom);
		}
