...
/**
 * Utility classes and methods for the {@link XmlApply @XmlApply} annotation.
 *
 */
public class XmlApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private XmlApplyAnnotation() {}

	/**
	 * Applies targeted {@link XmlApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<XmlApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(XmlApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<XmlApply> ai, Context.Builder b) {
			XmlApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Xml value = XmlAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(XmlApply.class);
		}

		/**
		 * Sets the {@link XmlApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Xml value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link XmlApply @XmlApply} object initialized with this builder.
		 *
		 * @return A new {@link XmlApply} object.
		 */
		public XmlApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements XmlApply {

		private final Xml value;

		Object(XmlApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final XmlApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(XmlApply a) {
