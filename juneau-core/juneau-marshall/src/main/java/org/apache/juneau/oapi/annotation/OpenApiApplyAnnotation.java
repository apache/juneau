...
/**
 * Utility classes and methods for the {@link OpenApiApply @OpenApiApply} annotation.
 *
 */
public class OpenApiApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private OpenApiApplyAnnotation() {}
	...
	public static class Applier extends AnnotationApplier<OpenApiApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(OpenApiApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<OpenApiApply> ai, Context.Builder b) {
			OpenApiApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		OpenApi value = OpenApiAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(OpenApiApply.class);
		}

		/**
		 * Sets the {@link OpenApiApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(OpenApi value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link OpenApiApply @OpenApiApply} object initialized with this builder.
		 *
		 * @return A new {@link OpenApiApply} object.
		 */
		public OpenApiApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements OpenApiApply {

		private final OpenApi value;

		Object(OpenApiApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final OpenApiApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(OpenApiApply a) {
