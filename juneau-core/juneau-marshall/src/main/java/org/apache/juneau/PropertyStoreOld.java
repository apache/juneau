...
/**
 */
public final class PropertyStoreOld {
//
...
//	 */
//	private PropertyStoreOld(PropertyStore copyFrom) {
//		copyFrom(copyFrom);
//	}
//
//	/**
...
//			if (name.endsWith(".ss") || name.endsWith(".sb") || name.endsWith(".si") || name.endsWith(".sc") || name.endsWith(".so"))
//				return new SetProperty(name, value);
//			else if (name.endsWith(".ls") || name.endsWith(".lb") || name.endsWith(".li") || name.endsWith(".lc") || name.endsWith(".lo"))
//				return new ListProperty(name, value);
//			else if (name.endsWith(".ms") || name.endsWith(".mb") || name.endsWith(".mi") || name.endsWith(".mc") || name.endsWith(".mo"))
