...
public class ResponseBodyAnnotation {
	 ...
	 */
	public static class Applier extends AnnotationApplier<ResponseBody,BeanContextBuilder> {
		...
		@Override
		public void apply(AnnotationInfo<ResponseBody> ai, BeanContextBuilder b) {
