...
/**
 * A {@link Hocon} variant that produces readable HOCON output with the <b>root braces</b> retained
 * (the {@link Hocon#DEFAULT} form omits them).
 *
 * <p>
 * 	This is the first-class facade form of the root-braces HOCON variant.  It pairs
 * 	{@link HoconSerializer#DEFAULT_BRACES} with {@link HoconParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>hocon</jv> = HoconBraces.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = HoconBraces.<jsm>to</jsm>(<jv>hocon</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Hocon} so that every shortcut is bound to this class's
 * 		root-braces {@link #DEFAULT} rather than the {@link Hocon#DEFAULT}.
 * </ul>
 *
...
public class HoconBraces extends Hocon {

	/** Default reusable instance, root braces retained. */
	public static final HoconBraces DEFAULT = new HoconBraces();
	 ...
	 *
	 * <p>
	 * Uses {@link HoconSerializer#DEFAULT_BRACES} and {@link HoconParser#DEFAULT}.
	 */
	public HoconBraces() {
		super(HoconSerializer.DEFAULT_BRACES, HoconParser.DEFAULT);
	}
}
