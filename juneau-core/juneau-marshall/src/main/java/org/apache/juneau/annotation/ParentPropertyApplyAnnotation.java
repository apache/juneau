...
/**
 * Utility classes and methods for the {@link ParentPropertyApply @ParentPropertyApply} annotation.
 *
 */
public class ParentPropertyApplyAnnotation {
	...
	/**
	 * Applies targeted {@link ParentPropertyApply} annotations to a {@link org.apache.juneau.Context.Builder}.
	 *
	 * <p>
	...
	public static class Applier extends AnnotationApplier<ParentPropertyApply,Context.Builder> {
		...
		@Override
		public void apply(AnnotationInfo<ParentPropertyApply> ai, Context.Builder b) {
			ParentPropertyApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderMF {
		...
		ParentProperty value = ParentPropertyAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(ParentPropertyApply.class);
		}

		/**
		 * Sets the {@link ParentPropertyApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(ParentProperty value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link ParentPropertyApply @ParentPropertyApply} object initialized with this builder.
		 *
		 * @return A new {@link ParentPropertyApply} object.
		 */
		public ParentPropertyApply build() {
	...
	private static class Object extends AppliedAnnotationObject implements ParentPropertyApply {

		private final ParentProperty value;

		Object(ParentPropertyApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final ParentPropertyApply DEFAULT = create().build();
