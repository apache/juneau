...
/**
 * Dynamically applies a {@link Ini @Ini} annotation to specified classes, methods, or fields.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link Ini @Ini} to be a pure data annotation
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(IniApply.Array.class)
@ContextApply(IniApplyAnnotation.Applier.class)
public @interface IniApply {

	/**
	 * The {@link Ini @Ini} annotation to apply.
	 *
	...
	/**
	 * A collection of {@link IniApply @IniApply annotations}.
	 */
	@Documented
	@Target({ TYPE, METHOD })
	@Retention(RUNTIME)
