 ...
 *
 * <p>
 * Because {@link BeanConfig @BeanConfig} cannot carry a {@link ContextApply @ContextApply}
 * meta-annotation (that annotation lives in {@code juneau-marshall} and cannot be referenced
 * from {@code juneau-commons}), {@link AnnotationWorkList} special-cases the
 * {@link BeanConfig} annotation type and instantiates this {@link Applier} directly.
 */
public class BeanConfigAnnotation {
	...
	/**
	 * Applies {@link BeanConfig} annotations to a {@link org.apache.juneau.MarshallingContext.Builder}.
	 */
	public static class Applier extends AnnotationApplier<BeanConfig,MarshallingContext.Builder> {
		...
		@Override
		public void apply(AnnotationInfo<BeanConfig> ai, MarshallingContext.Builder b) {
