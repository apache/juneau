...
/**
 * A {@link MsgPack} variant whose parser is in <b>native mode</b>, exposing low-level MessagePack
 * extension type information in the token stream instead of normalizing it away.
 *
 * <p>
 * 	This is the first-class facade form of the native-mode MessagePack variant.  It pairs the default
 * 	{@link MsgPackSerializer#DEFAULT} with {@link MsgPackParser#DEFAULT_NATIVE} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = MsgPackNative.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = MsgPackNative.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		native-mode {@link #DEFAULT} rather than the {@link MsgPack#DEFAULT}.
 * </ul>
 *
...
public class MsgPackNative extends MsgPack {

	/** Default reusable instance, native-mode parsing. */
	public static final MsgPackNative DEFAULT = new MsgPackNative();
	 ...
	 *
	 * <p>
	 * Uses {@link MsgPackSerializer#DEFAULT} and {@link MsgPackParser#DEFAULT_NATIVE}.
	 */
	public MsgPackNative() {
		super(MsgPackSerializer.DEFAULT, MsgPackParser.DEFAULT_NATIVE);
	}
}
