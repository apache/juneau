...
/**
 * Utility classes and methods for the {@link SwapApply @SwapApply} annotation.
 *
 */
public class SwapApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private SwapApplyAnnotation() {}

	/**
	 * Applies targeted {@link SwapApply} annotations to a {@link org.apache.juneau.Context.Builder}.
	 *
	 * <p>
	 * Passes the {@link SwapApply @SwapApply} annotation through to the builder's annotation list.
	...
	public static class Applier extends AnnotationApplier<SwapApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(SwapApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<SwapApply> ai, Context.Builder b) {
			SwapApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Swap value = SwapAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(SwapApply.class);
		}

		/**
		 * Sets the {@link SwapApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Swap value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link SwapApply @SwapApply} object initialized with this builder.
		 *
		 * @return A new {@link SwapApply} object.
		 */
		public SwapApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements SwapApply {

		private final Swap value;

		Object(SwapApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final SwapApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(SwapApply a) {
