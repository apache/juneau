...
/**
 * A {@link UrlEncoding} variant that leaves value parts in <b>plain text</b> (not UON-encoded) in its output.
 *
 * <p>
 * 	This is the first-class facade form of the plain-text URL-encoding variant.  It pairs
 * 	{@link UrlEncodingSerializer#DEFAULT_PLAINTEXT} with {@link UrlEncodingParser#DEFAULT} and exposes the
 * 	full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>urlEncoding</jv> = UrlEncodingPlain.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = UrlEncodingPlain.<jsm>to</jsm>(<jv>urlEncoding</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link UrlEncoding} so that every shortcut is bound to this class's
 * 		plain-text {@link #DEFAULT} rather than the {@link UrlEncoding#DEFAULT}.
 * </ul>
 *
...
public class UrlEncodingPlain extends UrlEncoding {

	/** Default reusable instance, plain-text format. */
	public static final UrlEncodingPlain DEFAULT = new UrlEncodingPlain();
	 ...
	 *
	 * <p>
	 * Uses {@link UrlEncodingSerializer#DEFAULT_PLAINTEXT} and {@link UrlEncodingParser#DEFAULT}.
	 */
	public UrlEncodingPlain() {
		super(UrlEncodingSerializer.DEFAULT_PLAINTEXT, UrlEncodingParser.DEFAULT);
	}
}
