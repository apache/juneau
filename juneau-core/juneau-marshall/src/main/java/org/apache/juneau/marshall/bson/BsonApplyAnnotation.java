...
/**
 * Utility classes and methods for the {@link BsonApply @BsonApply} annotation.
 *
 */
public class BsonApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private BsonApplyAnnotation() {}

	/**
	 * Applies targeted {@link BsonApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<BsonApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(BsonApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<BsonApply> ai, Context.Builder b) {
			BsonApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Bson value = BsonAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(BsonApply.class);
		}

		/**
		 * Sets the {@link BsonApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Bson value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link BsonApply @BsonApply} object initialized with this builder.
		 *
		 * @return A new {@link BsonApply} object.
		 */
		public BsonApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements BsonApply {

		private final Bson value;

		Object(BsonApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final BsonApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(BsonApply a) {
