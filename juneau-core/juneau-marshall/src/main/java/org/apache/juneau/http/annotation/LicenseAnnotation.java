...
/**
 * A concrete implementation of the {@link License} annotation.
 */
public class LicenseAnnotation implements License {
	 ...
	 */
	public LicenseAnnotation name(String value) {
		this.name = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public LicenseAnnotation url(String value) {
		this.url = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public LicenseAnnotation value(String[] value) {
		this.value = value;
		return this;
	}
}
