...
/**
 * An {@link Xml} variant that emits XML namespaces with attributes quoted using <b>single quotes</b>.
 *
 * <p>
 * 	This is the first-class facade form of the namespace-aware single-quote XML variant.  It pairs
 * 	{@link XmlSerializer#DEFAULT_NS_SQ} with {@link XmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>xml</jv> = XmlNsSq.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = XmlNsSq.<jsm>to</jsm>(<jv>xml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		namespace-aware single-quote {@link #DEFAULT} rather than the {@link Xml#DEFAULT}.
 * </ul>
 *
...
public class XmlNsSq extends Xml {

	/** Default reusable instance, namespace-aware single-quote format. */
	public static final XmlNsSq DEFAULT = new XmlNsSq();
	 ...
	 *
	 * <p>
	 * Uses {@link XmlSerializer#DEFAULT_NS_SQ} and {@link XmlParser#DEFAULT}.
	 */
	public XmlNsSq() {
		super(XmlSerializer.DEFAULT_NS_SQ, XmlParser.DEFAULT);
	}
}
