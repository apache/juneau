...
/**
 * Dynamically applies a {@link SoapXml @SoapXml} annotation to specified classes, methods, or fields.
 *
 * <p>
 * This annotation separates the <b>targeting</b> concern ({@link #on()}/{@link #onClass()}) from the
 * <b>content</b> concern ({@link #value()}), enabling {@link SoapXml @SoapXml} to be a pure data annotation
...
@Target({ TYPE, METHOD })
@Retention(RUNTIME)
@Repeatable(SoapXmlApply.Array.class)
@ContextApply(SoapXmlApplyAnnotation.Applier.class)
public @interface SoapXmlApply {
