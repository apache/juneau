...
/**
 * Dynamically applies a {@link BeanIgnore @BeanIgnore} annotation to specified classes, methods, fields, or constructors.
 *
 * <p>
 ...
 * <p class='bjava'>
 * 	<ja>@BeanIgnoreApply</ja>(on=<js>"com.example.Foo.bar"</js>, value=<ja>@BeanIgnore</ja>())
