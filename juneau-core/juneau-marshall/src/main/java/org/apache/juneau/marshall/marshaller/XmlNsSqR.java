...
/**
 * An {@link Xml} variant that produces <b>readable</b> (indented, multi-line) output with XML
 * namespaces and attributes quoted using single quotes.
 *
 * <p>
 * 	This is the first-class facade form of the namespace-aware single-quote readable XML variant.  It pairs
 * 	{@link XmlSerializer#DEFAULT_NS_SQ_READABLE} with {@link XmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>xml</jv> = XmlNsSqR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = XmlNsSqR.<jsm>to</jsm>(<jv>xml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Xml} so that every shortcut is bound to this class's
 * 		namespace-aware single-quote readable {@link #DEFAULT} rather than the {@link Xml#DEFAULT}.
 * </ul>
 *
...
public class XmlNsSqR extends Xml {

	/** Default reusable instance, namespace-aware single-quote readable format. */
	public static final XmlNsSqR DEFAULT = new XmlNsSqR();
	 ...
	 *
	 * <p>
	 * Uses {@link XmlSerializer#DEFAULT_NS_SQ_READABLE} and {@link XmlParser#DEFAULT}.
	 */
	public XmlNsSqR() {
		super(XmlSerializer.DEFAULT_NS_SQ_READABLE, XmlParser.DEFAULT);
	}
}
