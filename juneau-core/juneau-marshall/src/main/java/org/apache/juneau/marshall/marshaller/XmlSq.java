...
/**
 * An {@link Xml} variant that produces output with attributes quoted using <b>single quotes</b>
 * instead of double quotes.
 *
 * <p>
 * 	This is the first-class facade form of the single-quote XML variant.  It pairs
 * 	{@link XmlSerializer#DEFAULT_SQ} with {@link XmlParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>xml</jv> = XmlSq.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = XmlSq.<jsm>to</jsm>(<jv>xml</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		single-quote {@link #DEFAULT} rather than the {@link Xml#DEFAULT}.
 * </ul>
 *
...
public class XmlSq extends Xml {

	/** Default reusable instance, single-quote format. */
	public static final XmlSq DEFAULT = new XmlSq();
	 ...
	 *
	 * <p>
	 * Uses {@link XmlSerializer#DEFAULT_SQ} and {@link XmlParser#DEFAULT}.
	 */
	public XmlSq() {
		super(XmlSerializer.DEFAULT_SQ, XmlParser.DEFAULT);
	}
}
