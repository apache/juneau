...
public class SseParser extends ReaderParser implements RecordReadable {
	 ...
	 *
	 * <p>
	 * The real implementation lives on {@link SseParserSession#readRecords(Object)}.  Callers
	 * that need request-derived configuration (locale, timezone, schema, swaps) should call
	 * {@link #createSession()} and invoke {@link SseParserSession#readRecords(Object)} on the
