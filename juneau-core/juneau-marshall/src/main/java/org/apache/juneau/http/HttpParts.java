...
public class HttpParts {
	...
	private static final Function<ClassMeta<?>,String> HEADER_NAME_FUNCTION = x -> {
		...
		x.getAnnotations(org.apache.juneau.http.annotation.Header.class, y -> isNotEmpty(y.value()), y -> n.set(y.value()));
		x.getAnnotations(org.apache.juneau.http.annotation.Header.class, y -> isNotEmpty(y.name()), y -> n.set(y.name()));
		return n.orElse(null);
	};

	private static final Function<ClassMeta<?>,String> QUERY_NAME_FUNCTION = x -> {
		Value<String> n = Value.empty();
		x.getAnnotations(org.apache.juneau.http.annotation.Query.class, y -> isNotEmpty(y.value()), y -> n.set(y.value()));
		x.getAnnotations(org.apache.juneau.http.annotation.Query.class, y -> isNotEmpty(y.name()), y -> n.set(y.name()));
		return n.orElse(null);
	};

	private static final Function<ClassMeta<?>,String> FORMDATA_NAME_FUNCTION = x -> {
		Value<String> n = Value.empty();
		x.getAnnotations(org.apache.juneau.http.annotation.FormData.class, y -> isNotEmpty(y.value()), y -> n.set(y.value()));
		x.getAnnotations(org.apache.juneau.http.annotation.FormData.class, y -> isNotEmpty(y.name()), y -> n.set(y.name()));
		return n.orElse(null);
	};

	private static final Function<ClassMeta<?>,String> PATH_NAME_FUNCTION = x -> {
		Value<String> n = Value.empty();
		x.getAnnotations(org.apache.juneau.http.annotation.Path.class, y -> isNotEmpty(y.value()), y -> n.set(y.value()));
		x.getAnnotations(org.apache.juneau.http.annotation.Path.class, y -> isNotEmpty(y.name()), y -> n.set(y.name()));
		return n.orElse(null);
	};
