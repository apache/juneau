...
/**
 * Utility classes and methods for the {@link BeanTypeApply @BeanTypeApply} annotation.
 *
 */
public class BeanTypeApplyAnnotation {
	...
	/**
	 * Applies targeted {@link BeanTypeApply} annotations to a {@link org.apache.juneau.Context.Builder}.
	 *
	 * <p>
	...
	public static class Applier extends AnnotationApplier<BeanTypeApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(BeanTypeApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<BeanTypeApply> ai, Context.Builder b) {
			BeanTypeApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		BeanType value = BeanTypeAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(BeanTypeApply.class);
		}

		/**
		 * Sets the {@link BeanTypeApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(BeanType value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link BeanTypeApply @BeanTypeApply} object initialized with this builder.
		 *
		 * @return A new {@link BeanTypeApply} object.
		 */
		public BeanTypeApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements BeanTypeApply {

		private final BeanType value;

		Object(BeanTypeApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final BeanTypeApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(BeanTypeApply a) {
