...
/**
 * A {@link Uon} variant that percent-<b>encodes</b> reserved/URL-unsafe characters in its UON output.
 *
 * <p>
 * 	This is the first-class facade form of the encoding UON variant.  It pairs
 * 	{@link UonSerializer#DEFAULT_ENCODING} with {@link UonParser#DEFAULT_DECODING} (which decodes the
 * 	percent-encoded characters back) and exposes the full static shortcut surface bound to its own
 * 	{@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>uon</jv> = UonE.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = UonE.<jsm>to</jsm>(<jv>uon</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		encoding {@link #DEFAULT} rather than the {@link Uon#DEFAULT}.
 * </ul>
 *
...
public class UonE extends Uon {

	/** Default reusable instance, encoding format. */
	public static final UonE DEFAULT = new UonE();
	 ...
	 *
	 * <p>
	 * Uses {@link UonSerializer#DEFAULT_ENCODING} and {@link UonParser#DEFAULT_DECODING}.
	 */
	public UonE() {
		super(UonSerializer.DEFAULT_ENCODING, UonParser.DEFAULT_DECODING);
	}
}
