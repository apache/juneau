 ...
 * convenience read/write methods for document-mode Markdown (headings + tables).
 *
 * <p>
...
public class MarkdownDoc extends CharMarshaller {
	...
	/**
	 * Serializes a Java object to a Markdown document string.
	 *
	 * <p>
	...
	/**
	 * Serializes a Java object to a Markdown document output.
	 *
	 * <p>
	...
	/**
	 * Parses a Markdown document input to the specified Java type.
	 *
	 * <p>
	...
	/**
	 * Parses a Markdown document string to the specified Java type.
	 *
	 * <p>
	 * A shortcut for calling <c><jsf>DEFAULT</jsf>.read(<jv>input</jv>, <jv>type</jv>)</c>.
	 *
