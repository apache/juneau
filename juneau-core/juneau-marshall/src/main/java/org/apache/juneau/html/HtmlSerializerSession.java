...
public class HtmlSerializerSession extends XmlSerializerSession {
	...
	public boolean isHtmlMode() { return true; }
	...
	protected final HtmlWriter getHtmlWriter(SerializerPipe out) throws IOException {
		...
		HtmlWriter w = new HtmlWriter(out.getWriter(), isUseWhitespace(), getMaxIndent(), isTrimStrings(), getQuoteChar(), getUriResolver());
		out.setWriter(w);
		return w;
	}
