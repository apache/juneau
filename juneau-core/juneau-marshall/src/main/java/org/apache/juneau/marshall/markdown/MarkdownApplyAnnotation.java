...
/**
 * Utility classes and methods for the {@link MarkdownApply @MarkdownApply} annotation.
 *
 */
public class MarkdownApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private MarkdownApplyAnnotation() {}

	/**
	 * Applies targeted {@link MarkdownApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 */
	@SuppressWarnings({
	...
	public static class Applier extends AnnotationApplier<MarkdownApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(MarkdownApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<MarkdownApply> ai, Context.Builder b) {
			MarkdownApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Markdown value = MarkdownAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(MarkdownApply.class);
		}

		/**
		 * Sets the {@link MarkdownApply#value()} property on this annotation.
		 *
		...
		/**
		 * Instantiates a new {@link MarkdownApply @MarkdownApply} object initialized with this builder.
		 *
		 * @return A new {@link MarkdownApply} object.
		 */
		public MarkdownApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements MarkdownApply {

		private final Markdown value;

		Object(MarkdownApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final MarkdownApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(MarkdownApply a) {
