...
/**
 * A {@link UrlEncoding} variant that <b>expands</b> array/collection-valued properties into multiple
 * repeated key/value parameter pairs instead of a single UON-encoded array value.
 *
 * <p>
 * 	This is the first-class facade form of the expanded-params URL-encoding variant.  It pairs
 * 	{@link UrlEncodingSerializer#DEFAULT_EXPANDED} with {@link UrlEncodingParser#DEFAULT} and exposes the
 * 	full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>urlEncoding</jv> = UrlEncodingExpanded.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = UrlEncodingExpanded.<jsm>to</jsm>(<jv>urlEncoding</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		expanded {@link #DEFAULT} rather than the {@link UrlEncoding#DEFAULT}.
 * </ul>
 *
...
public class UrlEncodingExpanded extends UrlEncoding {

	/** Default reusable instance, expanded-params format. */
	public static final UrlEncodingExpanded DEFAULT = new UrlEncodingExpanded();
	 ...
	 *
	 * <p>
	 * Uses {@link UrlEncodingSerializer#DEFAULT_EXPANDED} and {@link UrlEncodingParser#DEFAULT}.
	 */
	public UrlEncodingExpanded() {
		super(UrlEncodingSerializer.DEFAULT_EXPANDED, UrlEncodingParser.DEFAULT);
	}
}
