...
/**
 * A pairing of a {@link XmlSerializer} and {@link XmlParser} into a single class with convenience to/of methods.
 *
 * <p>
 ...
 * 	MyPojo <jv>myPojo</jv> = Xml.<jsm>to</jsm>(<jv>string</jv>, MyPojo.<jk>class</jk>);
 * 	String <jv>string</jv> = Xml.<jsm>of</jsm>(<jv>myPojo</jv>);
 * </p>
 *
