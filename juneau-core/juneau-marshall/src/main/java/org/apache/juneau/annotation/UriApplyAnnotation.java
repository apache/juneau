...
/**
 * Utility classes and methods for the {@link UriApply @UriApply} annotation.
 *
 */
public class UriApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private UriApplyAnnotation() {}

	/**
	 * Applies targeted {@link UriApply} annotations to a {@link org.apache.juneau.Context.Builder}.
	 *
	 * <p>
	 * Passes the {@link UriApply @UriApply} annotation through to the builder's annotation list.
	...
	public static class Applier extends AnnotationApplier<UriApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(UriApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<UriApply> ai, Context.Builder b) {
			UriApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Uri value = UriAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(UriApply.class);
		}

		/**
		 * Sets the {@link UriApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Uri value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link UriApply @UriApply} object initialized with this builder.
		 *
		 * @return A new {@link UriApply} object.
		 */
		public UriApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements UriApply {

		private final Uri value;

		Object(UriApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final UriApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(UriApply a) {
