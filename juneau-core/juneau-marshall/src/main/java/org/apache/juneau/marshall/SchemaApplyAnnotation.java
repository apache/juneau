...
/**
 * Utility classes and methods for the {@link SchemaApply @SchemaApply} annotation.
 *
 */
public class SchemaApplyAnnotation {
	...
	/**
	 * Applies targeted {@link SchemaApply} annotations to a {@link org.apache.juneau.marshall.Context.Builder}.
	 *
	 * <p>
	 * Passes the {@link SchemaApply @SchemaApply} annotation through to the builder's annotation list.
	...
	public static class Applier extends AnnotationApplier<SchemaApply,Context.Builder> {
		...
		@Override
		public void apply(AnnotationInfo<SchemaApply> ai, Context.Builder b) {
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		/**
		 * Sets the {@link SchemaApply#value()} property on this annotation.
		 *
		...
		/**
		 * Instantiates a new {@link SchemaApply @SchemaApply} object initialized with this builder.
		 *
	...
	private static class Object extends AppliedOnClassAnnotationObject implements SchemaApply {
