 ...
 * </ul>
 */
public class HasQueryBuilder extends AnnotationBuilder {
	 ...
	 */
	public static HasQueryBuilder create() {
		return new HasQueryBuilder();
	}
	 ...
	 */
	public HasQueryBuilder n(String value) {
		this.n = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public HasQueryBuilder name(String value) {
		this.name = value;
		return this;
	}
	 ...
	 * @return This object (for method chaining).
	 */
	public HasQueryBuilder value(String value) {
		this.value = value;
		return this;
	}
