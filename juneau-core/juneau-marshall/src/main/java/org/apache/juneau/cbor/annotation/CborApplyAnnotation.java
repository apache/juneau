...
/**
 * Utility classes and methods for the {@link CborApply @CborApply} annotation.
 *
 */
public class CborApplyAnnotation {

	/**
	 * Prevents instantiation.
	 */
	private CborApplyAnnotation() {}
	...
	public static class Applier extends AnnotationApplier<CborApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(CborApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<CborApply> ai, Context.Builder b) {
			CborApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Cbor value = CborAnnotation.DEFAULT;

		/**
		 * Constructor.
		 */
		protected Builder() {
			super(CborApply.class);
		}

		/**
		 * Sets the {@link CborApply#value()} property on this annotation.
		 *
		 * @param value The new value for this property.
		 * @return This object.
		 */
		public Builder value(Cbor value) {
			this.value = value;
			return this;
		}
		...
		/**
		 * Instantiates a new {@link CborApply @CborApply} object initialized with this builder.
		 *
		 * @return A new {@link CborApply} object.
		 */
		public CborApply build() {
	...
	private static class Object extends AppliedOnClassAnnotationObject implements CborApply {

		private final Cbor value;

		Object(CborApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	/** Default value */
	public static final CborApply DEFAULT = create().build();
	 ...
	 */
	public static boolean empty(CborApply a) {
