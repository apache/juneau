...
/**
 * A {@link Json} variant that produces <b>readable</b> (indented, multi-line) JSON output.
 *
 * <p>
 * 	This is the first-class facade form of the readable JSON variant.  It pairs
 * 	{@link JsonSerializer#DEFAULT_READABLE} with {@link JsonParser#DEFAULT} and exposes the full
 * 	static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	String <jv>json</jv> = JsonR.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = JsonR.<jsm>to</jsm>(<jv>json</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 * <h5 class='section'>Notes:</h5><ul>
 * 	<li class='note'>Because Java <i>hides</i> (does not override) static members, this class redeclares the
 * 		entire static shortcut surface of {@link Json} so that every shortcut is bound to this class's
 * 		readable {@link #DEFAULT} rather than the compact {@link Json#DEFAULT}.
 * </ul>
 *
...
public class JsonR extends Json {
	 ...
	 */
	public static final JsonR DEFAULT = new JsonR();
	 ...
	 *
	 * <p>
	 * Uses {@link JsonSerializer#DEFAULT_READABLE} and {@link JsonParser#DEFAULT}.
	 */
	public JsonR() {
		super(JsonSerializer.DEFAULT_READABLE, JsonParser.DEFAULT);
	}
}
