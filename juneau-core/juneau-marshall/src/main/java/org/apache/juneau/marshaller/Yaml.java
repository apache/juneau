...
public class Yaml extends CharMarshaller {
	...
	/**
	 * Serializes a Java object to a YAML output.
	 *
	 * <p>
	...
	/**
	 * Parses a YAML input object to the specified Java type.
	 *
	 * <p>
	...
	/**
	 * Parses a YAML input string to the specified type.
	 *
	 * <p>
	 * A shortcut for calling <c><jsf>DEFAULT</jsf>.read(<jv>input</jv>, <jv>type</jv>)</c>.
	 *
	...
	/**
	 * Parses a YAML input string to the specified Java type.
	 *
	 * <p>
	 * A shortcut for calling <c><jsf>DEFAULT</jsf>.read(<jv>input</jv>, <jv>type</jv>, <jv>args</jv>)</c>.
	 *
