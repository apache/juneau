...
/**
 * Utility classes and methods for the {@link CsvApply @CsvApply} annotation.
 *
 */
public class CsvApplyAnnotation {
	...
	public static class Applier extends AnnotationApplier<CsvApply,Context.Builder> {
		...
		public Applier(VarResolverSession vr) {
			super(CsvApply.class, Context.Builder.class, vr);
		}

		@Override
		public void apply(AnnotationInfo<CsvApply> ai, Context.Builder b) {
			CsvApply a = ai.inner();
	...
	public static class Builder extends AppliedAnnotationObject.BuilderTMF {
		...
		Csv value = CsvAnnotation.DEFAULT;

		protected Builder() {
			super(CsvApply.class);
		}

		public Builder value(Csv value) {
			this.value = value;
			return this;
		}
	...
	private static class Object extends AppliedOnClassAnnotationObject implements CsvApply {

		private final Csv value;

		Object(CsvApplyAnnotation.Builder b) {
			super(b);
			value = b.value;
		}
	...
	public static boolean empty(CsvApply a) {
