...
/**
 * A {@link Cbor} variant that represents binary values as <b>spaced hexadecimal</b> text instead of
 * raw CBOR bytes.
 *
 * <p>
 * 	This is the first-class facade form of the spaced-hex CBOR variant.  It pairs
 * 	{@link CborSerializer#DEFAULT_SPACED_HEX} with {@link CborParser#DEFAULT_SPACED_HEX} and exposes
 * 	the full static shortcut surface bound to its own {@link #DEFAULT} instance.
 *
 * <h5 class='figure'>Examples:</h5>
 * <p class='bjava'>
 *	<jc>// Using static shortcuts.</jc>
 * 	<jk>byte</jk>[] <jv>bytes</jv> = CborSpacedHex.<jsm>of</jsm>(<jv>myPojo</jv>);
 * 	MyPojo <jv>myPojo</jv> = CborSpacedHex.<jsm>to</jsm>(<jv>bytes</jv>, MyPojo.<jk>class</jk>);
 * </p>
 *
 ...
 * 		spaced-hex {@link #DEFAULT} rather than the {@link Cbor#DEFAULT}.
 * </ul>
 *
...
public class CborSpacedHex extends Cbor {
	...
	public static final CborSpacedHex DEFAULT = new CborSpacedHex();
	 ...
	 *
	 * <p>
	 * Uses {@link CborSerializer#DEFAULT_SPACED_HEX} and {@link CborParser#DEFAULT_SPACED_HEX}.
	 */
	public CborSpacedHex() {
		super(CborSerializer.DEFAULT_SPACED_HEX, CborParser.DEFAULT_SPACED_HEX);
	}
}
