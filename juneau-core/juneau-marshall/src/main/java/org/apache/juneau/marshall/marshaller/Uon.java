...
/**
 * A pairing of a {@link UonSerializer} and {@link UonParser} into a single class with convenience to/of methods.
 *
 * <p>
 ...
 * 	MyPojo <jv>myPojo</jv> = Uon.<jsm>to</jsm>(<jv>string</jv>, MyPojo.<jk>class</jk>);
 * 	String <jv>string</jv> = Uon.<jsm>of</jsm>(<jv>myPojo</jv>);
 * </p>
 *
