 ...
 * <ul>
 * 	<li>{@link #doWrite(SerializerPipe, Object)}
 * </ul>
 *
...
public class OutputStreamSerializerSession extends SerializerSession {
	...
	public final String writeToString(Object o) throws SerializeException {
		...
		// cell encoding.
		return BinaryFormat.HEX.format(write(o));
	}
	 ...
	 * @return
	 * 	The format to use for the {@link #writeToString(Object)} method on stream-based serializers when converting byte arrays to strings.
	 */
	 ...
	 * {@link BinaryFormat} dispatch in {@link org.apache.juneau.marshall.swaps.BinarySwap} and the variant
	 ...
	 * (e.g. {@link org.apache.juneau.marshall.parquet.ParquetSerializerSession} and the binary RDF
