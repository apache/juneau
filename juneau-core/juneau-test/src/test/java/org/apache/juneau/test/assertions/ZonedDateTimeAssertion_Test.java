...
class ZonedDateTimeAssertion_Test extends TestBase {
	...
	@Test void ba01a_asString() {
		var x = MID1;
		var nil = nullObject(ZonedDateTime.class);
	...
	@Test void cc02_isAfter() {
		...
		var assertion16 = test(x1);
		assertThrows(IllegalArgumentException.class, ()->assertion16.isAfter(nil), "Argument 'value' cannot be null.");
		var assertion17 = test(nil);
		assertThrown(()->assertion17.isAfter(x2)).asMessage().isContains("Value was null.");
	}
	...
	@Test void cc04_isBefore() {
		...
		var assertion18 = test(x1);
		assertThrows(IllegalArgumentException.class, ()->assertion18.isBefore(nil), "Argument 'value' cannot be null.");
		var assertion19 = test(nil);
		assertThrown(()->assertion19.isBefore(x2)).asMessage().isContains("Value was null.");
	}
