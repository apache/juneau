...
class AnyAssertion_Test extends TestBase {
	...
	@Test void bb23_asBean_wType() {
		...
		assertThrown(()->test(x2).asBean(A2.class)).asMessage().asOneLine().is("Object was not type 'org.apache.juneau.test.assertions.AnyAssertion_Test$A2'.  Actual='java.lang.String'.");
