...
@SuppressWarnings({
	...
	"java:S2143" // Public assertion API is built on java.util.Date by design (signatures take/return Date, extends FluentComparableAssertion<Date,R>); cannot swap to java.time without breaking the assertion API.
})
