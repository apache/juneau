 ...
 * 	<jsm>assertVersion</jsm>(<jv>myVersion</jv>).asMajor().isGreaterThan(2);
 * </p>
 *
 *
 ...
 * 	<ul class='javatreec'>
 * 		<li class='jm'>{@link FluentVersionAssertion#asPart(int) asPart(int)}
 * 		<li class='jm'>{@link FluentVersionAssertion#asMajor() asMajor()}
 * 		<li class='jm'>{@link FluentVersionAssertion#asMinor() asMinor()}
 * 		<li class='jm'>{@link FluentVersionAssertion#asMaintenance() asMaintenance()}
 * 	</ul>
 * 	<li class='jc'>{@link FluentObjectAssertion}
 * 	<ul class='javatreec'>
 ...
 */
@SuppressWarnings({
	"java:S110" // Inheritance depth acceptable for VersionAssertion hierarchy
})
public class VersionAssertion extends FluentVersionAssertion<VersionAssertion> {
	...
	@Override /* Overridden from Assertion */
	public VersionAssertion setThrowable(Class<? extends RuntimeException> value) {
