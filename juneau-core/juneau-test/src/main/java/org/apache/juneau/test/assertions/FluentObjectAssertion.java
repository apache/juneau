 ...
 * 		<li class='jm'>{@link FluentObjectAssertion#isSameSerializedAs(Object, ThrowingFunction) isSameSerializedAs(Object, ThrowingFunction)}
...
public class FluentObjectAssertion<T,R> extends FluentAssertion<R> {
	 ...
	 * </p>
	 *
	 * @param function The conversion function.  May throw a checked exception.
	 * @return A new fluent string assertion.
	 */
	public FluentStringAssertion<R> asString(ThrowingFunction<? super T,String> function) {
	 ...
	 * @return This object.
	 */
	public FluentObjectAssertion<T,R> asTransformed(UnaryOperator<T> function) {
	...
	/**
	 * Asserts that the specified object is the same as this object after converting both to strings using the specified function.
	 *
	 * <h5 class='section'>Example:</h5>
	 * <p class='bjava'>
	 * 	<jsm>assertObject</jsm>(<jv>myPojo</jv>).isSameSerializedAs(<jv>other</jv>, <jv>x</jv> -&gt; <jv>x</jv>.toString());
	 * </p>
	 *
	 * @param o The object to compare against.
	 * @param function The function to use to serialize the objects.  May throw a checked exception.
	 * @return The fluent return object.
	 * @throws AssertionError If assertion failed.
	 */
	@SuppressWarnings({
		"unchecked" // Comparison function is applied to both the typed value and the untyped comparison object.
	})
	public R isSameSerializedAs(Object o, ThrowingFunction<? super T,String> function) {
		var s1 = function.apply(value);
		var s2 = function.apply((T)o);
		if (neq(s1, s2))
