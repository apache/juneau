...
public class PropertyNotFoundException extends RuntimeException {
	...
	public PropertyNotFoundException(String propertyName, Class<?> objectType) {
		super(String.format("Property '%s' not found on object of type %s", propertyName, cns(objectType)));
	}
	...
	public PropertyNotFoundException(String propertyName, Class<?> objectType, Throwable cause) {
		super(String.format("Property '%s' not found on object of type %s", propertyName, cns(objectType)), cause);
	}
