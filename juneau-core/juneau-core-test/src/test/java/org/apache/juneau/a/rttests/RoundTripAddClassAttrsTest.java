	...
	public static Collection<Object[]> getPairs() {
		return Arrays.asList(new Object[][] {
			{ /* 0 */
				...
				JsonSerializer.create().addBeanTypes(true).addRootType(),
