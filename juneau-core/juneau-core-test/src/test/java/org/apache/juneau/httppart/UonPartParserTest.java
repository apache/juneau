...
public class UonPartParserTest {
	...
	public void testBasic() throws Exception {
		...
		t = " @( ) ";
		l = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(List.class));
		assertTrue(l.isEmpty());
		...
		assertTrue(l.isEmpty());
		t = "@(@())";
		l = (List)p.parse(HttpPartType.HEADER, t, bs.getClassMeta(LinkedList.class, List.class));
		assertTrue(l.size() == 1);
		l = (List)l.get(0);
		assertTrue(l.isEmpty());
		...
		t = "@('')";
		l = (List)p.parse(HttpPartType.HEADER, t, bs.getClassMeta(List.class, String.class));
		assertTrue(l.size() == 1);
		assertEquals("", l.get(0));
		...
		t = "@('','','')";
		l = (List)p.parse(HttpPartType.HEADER, t, bs.getClassMeta(List.class, Object.class));
		assertTrue(l.size() == 3);
		assertEquals("", l.get(0));
		assertEquals("", l.get(1));
		assertEquals("", l.get(2));
		...
		b = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(Boolean.class));
		assertEquals(Boolean.FALSE, b);
		t = "false";
		b = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(Boolean.class));
		assertEquals(Boolean.FALSE, b);
		...
		i = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(Integer.class));
		assertEquals(123, i.intValue());
		d = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(Double.class));
		assertEquals(123, d.intValue());
		f = p.parse(HttpPartType.HEADER, t, bs.getClassMeta(Float.class));
		...
		// Top level
		t = "x;/?:@-_.!*'";
		assertEquals("x;/?:@-_.!*'", p.parse(HttpPartType.HEADER, t, bs.object()));

		// Encoded chars
		// Top level
		t = "x{}|\\^[]`<>#%\"&+";
		assertEquals("x{}|\\^[]`<>#%\"&+", p.parse(HttpPartType.HEADER, t, bs.object()));
		t = "x%7B%7D%7C%5C%5E%5B%5D%60%3C%3E%23%25%22%26%2B";
		assertEquals("x%7B%7D%7C%5C%5E%5B%5D%60%3C%3E%23%25%22%26%2B", p.parse(HttpPartType.HEADER, t, bs.object()));
		assertEquals("x%7B%7D%7C%5C%5E%5B%5D%60%3C%3E%23%25%22%26%2B", p.parse(HttpPartType.HEADER, t, bs.string()));
		...
		assertEquals("x=", p.parse(HttpPartType.HEADER, t, bs.object()));
		t = "'x%3D'";
		assertEquals("x%3D", p.parse(HttpPartType.HEADER, t, bs.object()));
		...
		// Top level
		t = "'%0A'";
		assertEquals("%0A", p.parse(HttpPartType.HEADER, t, bs.object()));
		t = "'\n'";
	...
	public void testUnicodeChars() throws Exception {
		...
		assertEquals("¢", p.parse(HttpPartType.HEADER, t, bs.string()));
		t = "%C2%A2";
		assertEquals("%C2%A2", p.parse(HttpPartType.HEADER, t, bs.object()));
		assertEquals("%C2%A2", p.parse(HttpPartType.HEADER, t, bs.string()));
		...
		assertEquals("€", p.parse(HttpPartType.HEADER, t, bs.string()));
		t = "%E2%82%AC";
		assertEquals("%E2%82%AC", p.parse(HttpPartType.HEADER, t, bs.object()));
		assertEquals("%E2%82%AC", p.parse(HttpPartType.HEADER, t, bs.string()));
		...
		t = "%F0%A4%AD%A2";
		assertEquals("%F0%A4%AD%A2", p.parse(HttpPartType.HEADER, t, bs.object()));
		assertEquals("%F0%A4%AD%A2", p.parse(HttpPartType.HEADER, t, bs.string()));
	}
