...
public class CommonTest {
	...
	public void testRecursion() throws Exception {
		...
		s.detectRecursions();
		assertThrown(()->{return s.build().serialize(r1);}).contains("[0] <noname>:org.apache.juneau.xml.CommonTest$R1", "->[1] r2:org.apache.juneau.xml.CommonTest$R2", "->[2] r3:org.apache.juneau.xml.CommonTest$R3", "->[3] r1:org.apache.juneau.xml.CommonTest$R1");
