...
import static org.apache.juneau.http.header.BasicIntegerHeader.*;
...
public class BasicIntegerHeader_Test {
	...
	public void a01_basic() throws Exception {
		...
		c.get().header(of(HEADER,""+Long.MAX_VALUE)).run().assertBody().is(""+Integer.MAX_VALUE);
		c.get().header(of(HEADER,()->""+Long.MAX_VALUE)).run().assertBody().is(""+Integer.MAX_VALUE);
	...
	public void a02_assertInteger() throws Exception {
		of(HEADER,1).assertInteger().is(1);
	}
