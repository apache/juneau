 ...
 * 	FormatString <jv>fmt</jv> = FormatString.<jsm>of</jsm>(<js>"Hello {0}, you have %d items"</js>);
 ...
 * 	FormatString <jv>fmt2</jv> = FormatString.<jsm>of</jsm>(<js>"User {0} has %s and {1} items"</js>);
 ...
 * 	FormatString <jv>fmt3</jv> = FormatString.<jsm>of</jsm>(<js>"%1$s loves %2$s, and {0} also loves %3$s"</js>);
...
public final class FormatString {
	...
	private static final Cache<String,FormatString> CACHE = Cache.of(String.class, FormatString.class).maxSize(1000).weak().build();
	 ...
	 *
	 * <p>
	 * This is a convenience method that creates a FormatString instance and formats it.
	 ...
	 *
	 * <p>
	 * This method uses a thread-safe cache to avoid recreating FormatString instances for the same pattern.
	...
	public boolean equals(Object o) {
		return o instanceof FormatString o2 && eq(this, o2, (x, y) -> eq(x.pattern, y.pattern));
	}
