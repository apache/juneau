 ...
 * 	Concurrent5KeyHashMap&lt;String,String,String,String,String,ResultSet&gt; <jv>queryCache</jv> =
 * 		<jk>new</jk> Concurrent5KeyHashMap&lt;&gt;();
 *
 ...
 * 	Concurrent5KeyHashMap&lt;String,String,String,String,String,ResultSet&gt; <jv>cache</jv> =
 * 		<jk>new</jk> Concurrent5KeyHashMap&lt;&gt;(<jk>false</jk>, (env, db, schema, table, op) -&gt;
 ...
 * 	Concurrent5KeyHashMap&lt;String,String,String,String,String,ResultSet&gt; <jv>cache</jv> =
 * 		<jk>new</jk> Concurrent5KeyHashMap&lt;&gt;(<jk>true</jk>, (env, db, schema, table, op) -&gt;
 * 			queryService.execute(env, db, schema, table, op)
 * 		);
 *
 ...
 * @serial exclude
 */
public class Concurrent5KeyHashMap<K1,K2,K3,K4,K5,V> extends ConcurrentHashMap<Tuple5<K1,K2,K3,K4,K5>,V> {
	...
	/**
	 * Constructs a new Concurrent5KeyHashMap with caching enabled and no supplier.
	 */
	public Concurrent5KeyHashMap() {
		this(false, null);
	}

	/**
	 * Constructs a new Concurrent5KeyHashMap with optional caching and supplier.
	 *
	 ...
	 */
	public Concurrent5KeyHashMap(boolean disabled, Function5<K1,K2,K3,K4,K5,V> supplier) {
	...
	public V get(K1 key1, K2 key2, K3 key3, K4 key4, K5 key5) {
		if (disabled)
			return (supplier == null ? null : supplier.apply(key1, key2, key3, key4, key5));
		var key = Tuple5.of(key1, key2, key3, key4, key5);
		var v = super.get(key);
		if (v == null && supplier != null) {
			v = supplier.apply(key1, key2, key3, key4, key5);
			super.put(key, v);
		}
		return v;
	}
