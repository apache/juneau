 ...
 * 	<li><b>Content-Based Keys:</b> Keys use content-based equality via {@link Tuple2}
 ...
 * this class properly handles arrays using content-based comparison via {@link Tuple2}:
 *
 * <p class='bjava'>
 * 	<jc>// Arrays work correctly as key components</jc>
 * 	ConcurrentHashMap2Key&lt;String,int[],Result&gt; <jv>map</jv> = <jk>new</jk> ConcurrentHashMap2Key&lt;&gt;();
 * 	<jv>map</jv>.put(<js>"key"</js>, <jk>new</jk> <jk>int</jk>[]{1,2,3}, <jv>result1</jv>);
 * 	Result <jv>r</jv> = <jv>map</jv>.get(<js>"key"</js>, <jk>new</jk> <jk>int</jk>[]{1,2,3});  <jc>// Returns result1</jc>
 * </p>
 *
 ...
 * consistent hashing based on array contents rather than identity. Keys are considered equal if both components
