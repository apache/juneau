...
class PetFreemarkerViewResource_Test extends TestBase {

	private static final MockRestClient CLIENT = MockRestClient.buildLax(PetFreemarkerViewResource.class);
	...
	@Test void a01_viewPet_rendersTemplateWithPetName() throws Exception {
		CLIENT.get("/pets/1/view")
			...
			.assertContent().asString().isContains("Rendered via FreeMarker.");
	}
