...
of namespaces to the serializer to avoid this scanning step using <a href="/site/apidocs/org/apache/juneau/xml/XmlSerializer.Builder.html#disableAutoDetectNamespaces()" target="_blank">XmlSerializer.Builder.disableAutoDetectNamespaces()</a>.
