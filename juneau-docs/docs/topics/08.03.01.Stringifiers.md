...
try {
    assertBean(order, "total,customer", "$99.99,{John Smith <joh***@example.com>}");
} finally {
...
- [juneau-bct Basics](JuneauBctBasics) - Main BCT documentation
- [Customization](Customization) - Configuration via @BctConfig and BctConfiguration
  ...
  - [Swappers](Swappers) - Transforming objects before processing
