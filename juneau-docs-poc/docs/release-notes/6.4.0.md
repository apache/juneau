...
Serializers now serialize the contents of [Readers]({{API_DOCS}}/java/io/Reader.html) and [InputStreams]({{API_DOCS}}/java/io/InputStream.html)
...
~~DateSwap~~.
New annotation [anchorText()]({{API_DOCS}}/org/apache/juneau/html/annotation/Html.html#anchorText).
...
Fixed bug where [getMediaType()]({{API_DOCS}}/org/apache/juneau/BeanSession.html#getMediaType()) wasn't returning a value.
...
[children()]({{API_DOCS}}/org/apache/juneau/dto/html5/HtmlElementMixed.html#children(Object...)) can now take in collections
of objects.
...
get converted to HTML using [DEFAULT()]({{API_DOCS}}/org/apache/juneau/html/HtmlSerializer.html#DEFAULT).
