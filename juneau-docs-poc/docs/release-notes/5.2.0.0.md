...
New [@NameProperty]({{API_DOCS}}/org/apache/juneau/annotation/NameProperty.html) and [@ParentProperty]({{API_DOCS}}/org/apache/juneau/annotation/ParentProperty.html)
...
[HtmlDocSerializer]({{API_DOCS}}/org/apache/juneau/html/HtmlDocSerializer.html) specifies the default CSS location as `/servletPath/style.css` instead of `/servletPath/htdocs/juneau.css`.  
This coincides with enhancements made in the server code for specifying styles.
[HtmlDocSerializer]({{API_DOCS}}/org/apache/juneau/html/HtmlDocSerializer.html) wraps output in two div tags instead of one (e.g. `...`).
...
New [createTempFile()]({{API_DOCS}}/org/apache/juneau/internal/FileUtils.html#createTempFile(String)) method.
...
New methods on [RestClient]({{API_DOCS}}/org/apache/juneau/rest/client/RestClient.html):
...
New passthrough methods on [RestClient]({{API_DOCS}}/org/apache/juneau/rest/client/RestClient.html) defined on `HttpClientBuilder`:
...
New methods in [RestRequest]({{API_DOCS}}/org/apache/juneau/rest/RestRequest.html):
...
Changes in [RestResponse]({{API_DOCS}}/org/apache/juneau/rest/RestResponse.html):
...
New [Microservice]({{API_DOCS}}/org/apache/juneau/microservice/Microservice.html) class that serves as a generic
