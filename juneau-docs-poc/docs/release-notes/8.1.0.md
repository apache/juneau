...
<tree>
<node-0><java-method>`public Map toMap()` -  Can be any type of map with string keys and object vals.</java-method></node-0>
<node-0><java-method>`public ObjectMap toMap()`</java-method></node-0>
<node-0><java-method>`public Map toMap(BeanSession bs)` -  Can be any type of map with string keys and object vals.</java-method></node-0>
<node-0><java-method>`public ObjectMap toMap(BeanSession bs)`</java-method></node-0>
<node-0><java-method>`public static T fromMap(Map m)` -  Can be any type of map with string keys and object vals.</java-method></node-0>
<node-0><java-method>`public static T fromMap(ObjectMap m)`</java-method></node-0>
<node-0><java-method>`public static T fromMap(BeanSession bs, Map m)` -  Can be any type of map with string keys and object vals.</java-method></node-0>
...
<tree>
<node-0><java-class>~~TemporalSwap~~ - For all Java 8 temporal types (e.g. [ZonedDateTime]({{API_DOCS}}/java/time/ZonedDateTime.html))</java-class></node-0>
<node-0><java-class>~~TemporalDateSwap~~ - For [Date]({{API_DOCS}}/java/util/Date.html)</java-class></node-0>
<node-0><java-class>~~TemporalCalendarSwap~~ - For [Calendar]({{API_DOCS}}/java/util/Calendar.html)</java-class></node-0>
</tree>
...
<tree>
<node-0><java-field>~~ConfigFileStore.FILESTORE_extensions~~</java-field></node-0>
</tree>
...
<node-0><java-annotation>~~JsoConfig JsoConfig~~</java-annotation></node-0>
...
<tree>
<node-0><java-abstract-class>~~BasicRest~~ - Non-servlet equivalent to ~~BasicRestServlet~~</java-abstract-class></node-0>
<node-0><java-abstract-class>~~BasicRestGroup~~ - Non-servlet equivalent to ~~BasicRestServletGroup~~</java-abstract-class></node-0>
<node-0><java-abstract-class>~~BasicRestJena~~ - Non-servlet equivalent to ~~BasicRestServletJena~~</java-abstract-class></node-0>
<node-0><java-abstract-class>~~BasicRestJenaGroup~~ - Non-servlet equivalent to ~~BasicRestServletJenaGroup~~</java-abstract-class></node-0>
</tree>
