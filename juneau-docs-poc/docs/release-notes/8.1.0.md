...
<tree>
<java-abstract-class>~~BasicRest~~ - Non-servlet equivalent to ~~BasicRestServlet~~</java-abstract-class>
<java-abstract-class>~~BasicRestGroup~~ - Non-servlet equivalent to ~~BasicRestServletGroup~~</java-abstract-class>
<java-abstract-class>~~BasicRestJena~~ - Non-servlet equivalent to ~~BasicRestServletJena~~</java-abstract-class>
<java-abstract-class>~~BasicRestJenaGroup~~ - Non-servlet equivalent to ~~BasicRestServletJenaGroup~~</java-abstract-class>
</tree>
