...
- New package: [org.apache.juneau.http](API_DOCS/org/apache/juneau/http.html).
...
- Significant new functionality introduced to the HTML serializer.
  ...
  - New interface [HtmlDocTemplate](API_DOCS/org/apache/juneau/html/HtmlDocTemplate.html) that allows full
    control over rendering of HTML produced by [HtmlDocSerializer](API_DOCS/org/apache/juneau/html/HtmlDocSerializer.html).
...
- The [RestRequest](API_DOCS/org/apache/juneau/rest/RestRequest.html) class functionality has been broken up
...
- The un-annotated parameter types that can be passed in through REST Java methods has been significantly expanded.
  ...
  - [HttpMethod](API_DOCS/org/apache/juneau/http/HttpMethod.html) - The method name matched (when using
    `@RestMethod(name="*")`)
