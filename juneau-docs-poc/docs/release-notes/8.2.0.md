...
regardless of it's visibility if the [@Bean]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html) annotation is on the class.
...
annotations of the class itself.  For example, the following methods override the [@Bean]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html) 
annotations on classes:

<tree>
<node-0><java-class>[Builder]({{API_DOCS}}/org/apache/juneau/BeanContext/Builder.html)</java-class></node-0>
<node-1><javac-method>~~Builder.bpi(Class,String) bpi(Class,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpi(String,String) bpi(String,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpx(Class,String) bpx(Class,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpx(String,String) bpx(String,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpro(Class,String) bpro(Class,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpro(String,String) bpro(String,String)~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpwo(Class,String) bpwo(Class,String~~</javac-method></node-1>
<node-1><javac-method>~~Builder.bpwo(String,String) bpwo(String,String~~</javac-method></node-1>
</tree>
...
For example, the [link()]({{API_DOCS}}/org/apache/juneau/html/annotation/Html.html#link()) can now reference hidden properties:
...
The general rule for the [BeanMap]({{API_DOCS}}/org/apache/juneau/BeanMap.html) class is that `get()`,`put()`, and `containsKey()`
...
[noTableHeaders()]({{API_DOCS}}/org/apache/juneau/html/annotation/Html.html#noTableHeaders) now can be applied to collections of beans.
New [asideFloat()]({{API_DOCS}}/org/apache/juneau/html/annotation/HtmlDocConfig.html#asideFloat()) setting so that you can position the contents of the aside section on the page.
...
New [collections]({{API_DOCS}}/org/apache/juneau/collections.html) package containing various convenience fluent-style collection classes:
~~AList~~
~~ASet~~
~~ASortedSet~~
~~AMap~~
...
All classes in the [response]({{API_DOCS}}/org/apache/juneau/http/response.html) and ~~exception~~ now have `header(String,Object)`
...
class.
[Rest]({{API_DOCS}}/org/apache/juneau/rest/annotation/Rest.html)-annotated classes can now implement the following interfaces directly instead of having
...
[version]({{API_DOCS}}/org/apache/juneau/http/remote/Remote.html#version) - Adds a client version header to all requests.
