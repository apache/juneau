...
the ~~PropertyStore~~/[Context]({{API_DOCS}}/org/apache/juneau/Context.html)/~~Session~~ paradigm previously used in the
serializer and parser APIs.
...
- Improvements to XML serialization support.
  - New supported XML formats:
    - [XmlFormat.ATTRS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ATTRS) format can now be applied to bean classes to have all bean properties serialized as attributes instead of elements by default.
    - [XmlFormat.ELEMENT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ELEMENT) format can now be applied to bean properties to override the [XmlFormat.ATTRS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ATTRS) setting above on specific bean properties.
    - New [XmlFormat.ELEMENTS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ELEMENTS) format can be applied to a bean property of type array/Collection to represent the child elements.
    - New [XmlFormat.MIXED]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#MIXED) format can be applied to a bean property of type array/Collection to represent mixed content (text + child elements).
    - New [XmlFormat.MIXED_PWS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#MIXED_PWS) format. Identical to `MIXED` except preserves whitespace.
    - New [XmlFormat.TEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT) format can be applied to a bean property of a single object to represent a text node as a child.
    - New [XmlFormat.TEXT_PWS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT_PWS) format. Identical to `TEXT` except preserves whitespace.
    - New [XmlFormat.XMLTEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#XMLTEXT) format that's identical to [XmlFormat.TEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT) except XML content is not escaped and serialized directly as the child content. The parser will reconvert this to the original XML text during parsing.
  ...
  - Reworked and simplified the default XML serializers. The [XmlSerializer.DEFAULT]({{API_DOCS}}/org/apache/juneau/xml/XmlSerializer.html#DEFAULT) serializer now has namespaces disabled, and [XmlSerializer.DEFAULT_NS]({{API_DOCS}}/org/apache/juneau/xml/XmlSerializer.html#DEFAULT_NS) has namespaces enabled. The 'XML-JSON' serializers have been eliminated.
...
- ~~SerializerContext~~ and ~~ParserContext~~ now extend directly from [BeanContext]({{API_DOCS}}/org/apache/juneau/BeanContext.html).

- [SerializerSession]({{API_DOCS}}/org/apache/juneau/serializer/SerializerSession.html) and [ParserSession]({{API_DOCS}}/org/apache/juneau/parser/ParserSession.html) now extend directly from [BeanSession]({{API_DOCS}}/org/apache/juneau/BeanSession.html).
...
- Improvements to Parser class:
  - Simplified the parse methods (e.g. `parseMap()`, `parseCollection()`) by replacing them with two simple methods:
    - [Parser.parse(Object,Class)]({{API_DOCS}}/org/apache/juneau/parser/Parser.html#parse(Object,Class)) - Normal method.
    - [Parser.parse(Object,Type,Type...)]({{API_DOCS}}/org/apache/juneau/parser/Parser.html#parse(Object,Type,Type...)) - Method for parsing into parameterized maps and collections.
...
- Session-level media type now available through [BeanSession.getMediaType()]({{API_DOCS}}/org/apache/juneau/BeanSession.html#getMediaType()) method.
...
- Several new [Calendar]({{API_DOCS}}/java/util/Calendar.html) and [Date]({{API_DOCS}}/java/util/Date.html) swaps:
  ...
  - ~~DateFull~~, ~~DateFull~~ - To [DateFormat.FULL]({{API_DOCS}}/java/text/DateFormat.html#FULL) date strings.
  - ~~DateLong~~, ~~DateLong~~ - To [DateFormat.LONG]({{API_DOCS}}/java/text/DateFormat.html#LONG) date strings.
  - ~~DateMedium~~, ~~DateMedium~~ - To [DateFormat.MEDIUM]({{API_DOCS}}/java/text/DateFormat.html#MEDIUM) date strings.
  - ~~DateShort~~, ~~DateShort~~ - To [DateFormat.SHORT]({{API_DOCS}}/java/text/DateFormat.html#SHORT) date strings.
  - ~~TimeFull~~, ~~TimeFull~~ - To [DateFormat.FULL]({{API_DOCS}}/java/text/DateFormat.html#FULL) time strings.
  - ~~TimeLong~~, ~~TimeLong~~ - To [DateFormat.LONG]({{API_DOCS}}/java/text/DateFormat.html#LONG) time strings.
  - ~~TimeMedium~~, ~~TimeMedium~~ - To [DateFormat.MEDIUM]({{API_DOCS}}/java/text/DateFormat.html#MEDIUM) time strings.
  - ~~TimeShort~~, ~~TimeShort~~ - To [DateFormat.SHORT]({{API_DOCS}}/java/text/DateFormat.html#SHORT) time strings.
  - ~~DateTimeFull~~, ~~DateTimeFull~~ - To [DateFormat.FULL]({{API_DOCS}}/java/text/DateFormat.html#FULL) date-time strings.
  - ~~DateTimeLong~~, ~~DateTimeLong~~ - To [DateFormat.LONG]({{API_DOCS}}/java/text/DateFormat.html#LONG) date-time strings.
  - ~~DateTimeMedium~~, ~~DateTimeMedium~~ - To [DateFormat.MEDIUM]({{API_DOCS}}/java/text/DateFormat.html#MEDIUM) date-time strings.
  - ~~DateTimeShort~~, ~~DateTimeShort~~ - To [DateFormat.SHORT]({{API_DOCS}}/java/text/DateFormat.html#SHORT) date-time strings.
...
- General improvements to Bean Dictionary support.
  - New [BeanDictionaryList]({{API_DOCS}}/org/apache/juneau/BeanDictionaryList.html) class can be used for defining reusable sets of bean dictionaries consisting of classes annotated with [@Bean(typeName)]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html#typeName()).
  - New [BeanDictionaryMap]({{API_DOCS}}/org/apache/juneau/BeanDictionaryMap.html) class can be used for defining reusable sets of bean dictionaries consisting of classes not annotated with [@Bean(typeName)]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html#typeName()).
...
- New [WriterSerializer.println(Object)]({{API_DOCS}}/org/apache/juneau/serializer/WriterSerializer.html#println(Object)) method. Useful for debugging purposes.

- New [BeanContext.getClassMeta(Type,Type...)]({{API_DOCS}}/org/apache/juneau/BeanContext.html#getClassMeta(Type,Type...)) and [BeanSession.getClassMeta(Type,Type...)]({{API_DOCS}}/org/apache/juneau/BeanSession.html#getClassMeta(Type,Type...)) methods for retrieving Map and Collection class metas.
...
- Modified the UON specification to work with mixed content.
  ...
  - Eliminated the `UonParser.DEFAULT_WS_AWARE` and `UrlEncodingParser.DEFAULT_WS_AWARE` parsers. The normal [UonParser.DEFAULT]({{API_DOCS}}/org/apache/juneau/uon/UonParser.html#DEFAULT) and [UrlEncodingParser.DEFAULT]({{API_DOCS}}/org/apache/juneau/urlencoding/UrlEncodingParser.html#DEFAULT) parsers will now handle whitespace.
...
- Added new ~~OutputStreamSerializer.serializeToHex(Object)~~ method.
  ...
  Equivalently, the [InputStreamParser.parse(Object,Class)]({{API_DOCS}}/org/apache/juneau/parser/InputStreamParser.html#parse(Object,Class)) method can now read the output from this method.
...
- [RestRequest]({{API_DOCS}}/oajr/RestRequest.html) now passes locale and timezone to serializers/parsers/transforms.

- ~~RestRequest.getTimeZone()~~ method.

- Standardized the following methods in [RestRequest]({{API_DOCS}}/oajr/RestRequest.html) to remove dependency on `ClassMeta` objects and eliminate the need for casts:
