...
In particular, this release cleans up the [BeanContext]({{API_DOCS}}/org/apache/juneau/BeanContext.html) API to
match the  ~~PropertyStore~~/[Context]({{API_DOCS}}/org/apache/juneau/Context.html)/ ~~Session~~ paradigm previously
...
- Improvements to XML serialization support.
  ...
  - New supported XML formats:
    ...
    - [XmlFormat.ATTRS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ATTRS) format can now be
      applied to bean classes to have all bean properties serialized as attributes instead of elements by default.
    - [XmlFormat.ELEMENT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ELEMENT) format can now be
      applied to bean properties to override the [XmlFormat.ATTRS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ATTRS) setting above on specific bean properties.
    - New [XmlFormat.ELEMENTS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#ELEMENTS) format can be
      applied to a bean property of type array/Collection to represent the child elements.
    - New [XmlFormat.MIXED]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#MIXED) format can be
      applied to a bean property of type array/Collection to represent mixed content (text + child elements).
    - New [XmlFormat.MIXED_PWS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#MIXED_PWS) format.
      Identical to `MIXED` except preserves whitespace.
    - New [XmlFormat.TEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT) format can be applied
      to a bean property of a single object to represent a text node as a child.
    - New [XmlFormat.TEXT_PWS]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT_PWS) format.
      Identical to `TEXT` except preserves whitespace.
    - New [XmlFormat.XMLTEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#XMLTEXT) format that's
      identical to [XmlFormat.TEXT]({{API_DOCS}}/org/apache/juneau/xml/annotation/XmlFormat.html#TEXT) except XML
  ...
  - Reworked and simplified the default XML serializers.
    The [XmlSerializer.DEFAULT]({{API_DOCS}}/org/apache/juneau/xml/XmlSerializer.html#DEFAULT) serializer now has
    namespaces disabled, and [XmlSerializer.DEFAULT_NS]({{API_DOCS}}/org/apache/juneau/xml/XmlSerializer.html#DEFAULT_NS) has namespaces enabled.
...
- Improvements to Parser class:
  ...
  - Simplified the parse methods (e.g. `parseMap()`, `parseCollection()`) by replacing them with two simple methods:
    ...
    - [Parser.parse(Object,Class)]({{API_DOCS}}/org/apache/juneau/parser/Parser.html#parse(Object,Class)) - Normal
      method.
...
- Several new [Calendar]({{API_DOCS}}/java/util/Calendar.html) and [Date]({{API_DOCS}}/java/util/Date.html) swaps:
  ...
  -  ~~DateMedium~~,  ~~DateMedium~~ - To [DateFormat.MEDIUM]({{API_DOCS}}/java/text/DateFormat.html#MEDIUM) date
    strings.
  ...
  -  ~~TimeMedium~~,  ~~TimeMedium~~ - To [DateFormat.MEDIUM]({{API_DOCS}}/java/text/DateFormat.html#MEDIUM) time
    strings.
  -  ~~TimeShort~~,  ~~TimeShort~~ - To [DateFormat.SHORT]({{API_DOCS}}/java/text/DateFormat.html#SHORT) time strings.
  -  ~~DateTimeFull~~,  ~~DateTimeFull~~ - To [DateFormat.FULL]({{API_DOCS}}/java/text/DateFormat.html#FULL) date-time
    strings.
  -  ~~DateTimeLong~~,  ~~DateTimeLong~~ - To [DateFormat.LONG]({{API_DOCS}}/java/text/DateFormat.html#LONG) date-time
    strings.
...
- General improvements to Bean Dictionary support.
  ...
  - New [BeanDictionaryList]({{API_DOCS}}/org/apache/juneau/BeanDictionaryList.html) class can be used for defining
    reusable sets of bean dictionaries consisting of classes annotated with [@Bean(typeName)]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html#typeName()).
  - New [BeanDictionaryMap]({{API_DOCS}}/org/apache/juneau/BeanDictionaryMap.html) class can be used for defining
    reusable sets of bean dictionaries consisting of classes not annotated with [@Bean(typeName)]({{API_DOCS}}/org/apache/juneau/annotation/Bean.html#typeName()).
...
- New [WriterSerializer.println(Object)]({{API_DOCS}}/org/apache/juneau/serializer/WriterSerializer.html#println(Object)) method.
...
- Modified the UON specification to work with mixed content.
  ...
  - Eliminated the `UonParser.DEFAULT_WS_AWARE` and `UrlEncodingParser.DEFAULT_WS_AWARE` parsers.
    The normal [UonParser.DEFAULT]({{API_DOCS}}/org/apache/juneau/uon/UonParser.html#DEFAULT) and [UrlEncodingParser.DEFAULT]({{API_DOCS}}/org/apache/juneau/urlencoding/UrlEncodingParser.html#DEFAULT) parsers will now handle whitespace.
...
- [RestRequest]({{API_DOCS}}/org/apache/juneau/rest/RestRequest.html) now passes locale and timezone to
  serializers/parsers/transforms.

- ~~RestRequest.getTimeZone()~~ method.

- Standardized the following methods in [RestRequest]({{API_DOCS}}/org/apache/juneau/rest/RestRequest.html) to remove
