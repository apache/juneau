...
<tree>
<node-0><java-class>[ImageSerializer]({{API_DOCS}}/org/apache/juneau/examples/serializer/ImageSerializer.html) - Example of a custom serializer.</java-class></node-0>
<node-0><java-class>[ImageParser]({{API_DOCS}}/org/apache/juneau/examples/parser/ImageParser.html) - Example of a custom parser.</java-class></node-0>
</tree>
