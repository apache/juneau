...
The [serializedHeader]({{API_DOCS}}/org/apache/juneau/http/HttpHeaders.html#serializedHeader(String,Object)) methods allows for headers serialized using schema-based serializers such as the OpenAPI serializer.
...
The [serializedPart]({{API_DOCS}}/org/apache/juneau/http/HttpParts.html#serializedPart(String,Object)) methods allows for parts serialized using schema-based serializers such as the OpenAPI serializer.
