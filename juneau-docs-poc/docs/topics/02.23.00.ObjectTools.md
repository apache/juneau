...
The [org.apache.juneau.objecttools]({{API_DOCS}}/org/apache/juneau/objecttools.html) package defines convenience utility classes for accessing and manipulating POJOs.
...
- [Maps]({{API_DOCS}}/java/util/Map.html) and Java beans representing JSON objects.
...
The [ObjectIntrospector]({{API_DOCS}}/org/apache/juneau/objecttools/ObjectIntrospector.html) class is used to invoke methods on `Objects\` using arguments in serialized form.
