...
Additional parameter types can be defined via the annotation [Rest#responseProcessors()]({{API_DOCS}}/org/apache/juneau/rest/annotation/Rest.html#responseProcessors()) or by calling \{@link oajr.RestContext.Builder#responseProcessors(Class...)\}.
:::
