...
<node-6><java-class>[OpenApiSerializer.Builder](../apidocs/org/apache/juneau/oapi/OpenApiSerializer/Builder.html)</java-class></node-6>
</tree>
...
`date date-time`
<tree>
<node-0><java-class>[Calendar](../apidocs/java/util/Calendar.html) (default)</java-class></node-0>
<node-0><java-class>[Date](../apidocs/java/util/Date.html)</java-class></node-0>
</tree>
