...
Once a config file has been associated with a REST resource, it can be accessed through the [Builder.getConfig()]({{API_DOCS}}/org/apache/juneau/rest/RestContext/Builder.html#getConfig()) method.
