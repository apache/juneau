...
- [Header]({{API_DOCS}}/org/apache/juneau/http/annotation/Header.html)
- [name]({{API_DOCS}}/org/apache/juneau/http/annotation/Header.html#name()) - Header name.
- [serializer]({{API_DOCS}}/org/apache/juneau/http/annotation/Header.html#serializer()) - Override the part serializer.
