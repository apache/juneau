...
<node-5><java-class>[OpenApiParser.Builder](../apidocs/org/apache/juneau/oapi/OpenApiParser/Builder.html)</java-class></node-5>
</tree>
...
<node-0><java-class>[GregorianCalendar](../apidocs/java/util/GregorianCalendar.html)</java-class></node-0>
</tree>
