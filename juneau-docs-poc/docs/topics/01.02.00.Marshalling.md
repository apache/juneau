...
The [JsonMap](../apidocs/org/apache/juneau/collections/JsonMap.html) and [JsonList](../apidocs/org/apache/juneau/collections/JsonList.html) collections classes allow you to programmatically build generic JSON data structures.
...
[SerializerSet](../apidocs/org/apache/juneau/serializer/SerializerSet.html) and [ParserSet](../apidocs/org/apache/juneau/parser/ParserSet.html) classes allow serializers and parsers to be retrieved by W3C-compliant HTTP Accept and Content-Type values:
