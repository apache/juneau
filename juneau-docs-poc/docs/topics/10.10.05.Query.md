...
- [Query]({{API_DOCS}}/org/apache/juneau/http/annotation/Query.html)
- [name]({{API_DOCS}}/org/apache/juneau/http/annotation/Query.html#name()) - Query parameter name.
- [serializer]({{API_DOCS}}/org/apache/juneau/http/annotation/Query.html#serializer())  - Override the part serializer.
