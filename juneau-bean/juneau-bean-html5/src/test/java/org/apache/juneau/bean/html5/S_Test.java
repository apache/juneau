...
class S_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		S x1 = new S("a1", strong("a2"));
		assertString("<s>a1<strong>a2</strong></s>", x1);
