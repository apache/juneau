...
class Html5Template_ComboRoundTripTest extends ComboRoundTripTest_Base {
	...
	@Marshalled(dictionary=HtmlBeanDictionary.class)
	public static class FormTemplate {
		...
		public FormTemplate(Form f) {
			...
			value1 = f.getChild(Input.class, 0).getAttr(int.class, "value");
			value2 = f.getChild(Input.class, 1).getAttr(boolean.class, "value");
		}
