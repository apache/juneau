...
class H2_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		var x1 = new H2("a1", strong("a2"));
		assertString("<h2>a1<strong>a2</strong></h2>", x1);
