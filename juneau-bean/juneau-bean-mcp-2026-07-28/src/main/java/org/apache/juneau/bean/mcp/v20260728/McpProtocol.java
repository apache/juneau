...
/**
 * MCP protocol version strings carried in per-request {@code _meta} and {@code server/discover}.
 */
@SuppressWarnings({
	"java:S115" // Constant names encode protocol version dates verbatim (e.g., VERSION_2026_07_28).
})
