	...
	@Nested class C_extraProperties extends TestBase {
		...
		@Test void c09_getTypes() {
			assertMapped(
				...
				"Boolean,String,String,String,UnmodifiableSet,String,UnmodifiableMap,Boolean,Boolean,String,String,Items,Integer,Integer,Integer,Integer,Integer,Integer,Integer,String,String,Boolean,SchemaInfo,String,Boolean,String,<null>"
			);
		}

		@Test void c10_nullPropertyValue() {
			var parameterInfo = bean();
			assertThrows(IllegalArgumentException.class, ()->parameterInfo.get(null));
			assertThrows(IllegalArgumentException.class, ()->parameterInfo.get(null, String.class));
			assertThrows(IllegalArgumentException.class, ()->parameterInfo.set(null, "a"));
		}
	}
