...
class OAuthFlows_Test extends TestBase {
	...
	@Nested class C_extraProperties extends TestBase {
		...
		@Test void c10_nullPropertyValue() {
			var oauthFlows = bean();
			assertThrows(IllegalArgumentException.class, ()->oauthFlows.get(null));
			assertThrows(IllegalArgumentException.class, ()->oauthFlows.get(null, String.class));
			assertThrows(IllegalArgumentException.class, ()->oauthFlows.set(null, "a"));
		}
	}
