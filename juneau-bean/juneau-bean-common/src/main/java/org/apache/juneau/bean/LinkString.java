...
public class LinkString implements Comparable<LinkString> {
	 ...
	 * Constructor.
	 *
	 * @param name Corresponds to the text inside of the <xt>&lt;A&gt;</xt> element.  Can be <jk>null</jk> to leave the property unset.
	...
	public LinkString setUri(String value, Object...args) {
		for (var i = 0; i < args.length; i++)
			try {
				args[i] = OpenApiSerializer.DEFAULT.getSession().write(HttpPartType.PATH, null, args[i]);
