 ...
 * <a href="https://datatracker.ietf.org/doc/html/rfc6902#section-4.6">RFC 6902 &#167; 4.6</a>.
 *
 * <p>
 * Tests that the value at {@link #getPath() path} equals {@link #getValue() value}.
 */
@Marshalled(typeName = "test")
public class TestOp extends JsonPatchOperation {
	 ...
	 * @return This object.
	 */
	public TestOp setValue(Object value) {
		this.value = value;
		return this;
	}
}
