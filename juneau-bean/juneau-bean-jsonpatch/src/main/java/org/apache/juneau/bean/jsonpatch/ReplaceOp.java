...
/**
 * The JSON Patch {@code "replace"} operation per
 * <a href="https://datatracker.ietf.org/doc/html/rfc6902#section-4.3">RFC 6902 &#167; 4.3</a>.
 *
 * <p>
 * Replaces the value at {@link #getPath() path} with {@link #getValue() value}.
 */
@Marshalled(typeName = "replace")
public class ReplaceOp extends JsonPatchOperation {
	 ...
	 * @param value The replacement value.  Can be <jk>null</jk> to leave the property unset.
	 */
