...
public class ReaderObject_ComboSerializeTest extends ComboSerializeTest_Base {
	...
	private static final ComboSerialize_Tester<?>[] TESTERS = {
		...
		tester(2, "SimpleInputStream", ()->inputStream("foobar"))
			...
			.msgPackT("666F6F626172")
			.build(),
		tester(3, "BeanWithReaderField", ()->new BeanWithReaderField().init())
			.json("{\"f\":fv}")
			.jsonT("{\"f\":fv}")
			.jsonR("{\n\t\"f\": fv\n}")
			.json5("{f:fv}")
			...
			.msgPackT("81A1666676")
			.build(),
		tester(4, "BeanWithReader1dField", ()->new BeanWithReader1dField().init())
			.json("{\"f\":[fv1,fv2,null]}")
			.jsonT("{\"f\":[fv1,fv2,null]}")
			.jsonR("{\n\t\"f\": [\n\t\tfv1,\n\t\tfv2,\n\t\tnull\n\t]\n}")
			.json5("{f:[fv1,fv2,null]}")
			.json5T("{f:[fv1,fv2,null]}")
			.json5R("{\n\tf: [\n\t\tfv1,\n\t\tfv2,\n\t\tnull\n\t]\n}")
			...
			.build(),
		tester(5, "BeanWithReaderNullField", ()->new BeanWithReaderNullField().init())
			.json("{\"f\":null}")
			.jsonT("{\"f\":null}")
			.jsonR("{\n\t\"f\": null\n}")
			.json5("{f:null}")
			...
			.msgPackT("81A166C0")
			.build(),
		tester(6, "BeanWithReaderListField", ()->new BeanWithReaderListField().init())
			.json("{\"f\":[fv1,fv2,null]}")
			.jsonT("{\"f\":[fv1,fv2,null]}")
			.jsonR("{\n\t\"f\": [\n\t\tfv1,\n\t\tfv2,\n\t\tnull\n\t]\n}")
			.json5("{f:[fv1,fv2,null]}")
			...
			.msgPackT("81A16693667631667632C0")
			.build(),
		tester(7, "BeanWithReaderMapField", ()->new BeanWithReaderMapField().init())
			.json("{\"f\":{\"foo\":fv1,\"bar\":null,null:fv2}}")
			.jsonT("{\"f\":{\"foo\":fv1,\"bar\":null,null:fv2}}")
			.jsonR("{\n\t\"f\": {\n\t\t\"foo\": fv1,\n\t\t\"bar\": null,\n\t\tnull: fv2\n\t}\n}")
			.json5("{f:{foo:fv1,bar:null,null:fv2}}")
			.json5T("{f:{foo:fv1,bar:null,null:fv2}}")
			.json5R("{\n\tf: {\n\t\tfoo: fv1,\n\t\tbar: null,\n\t\tnull: fv2\n\t}\n}")
			...
			.build(),
		tester(8, "BeanWithReaderBeanListField", ()->new BeanWithReaderBeanListField().init())
			...
			.jsonR("{\n\t\"f\": [\n\t\t{\n\t\t\t\"f1\": f1v,\n\t\t\t\"f2\": [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f3\": null,\n\t\t\t\"f4\": [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f5\": {\n\t\t\t\t\"foo\": f5v1,\n\t\t\t\t\"bar\": null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t},\n\t\tnull\n\t]\n}")
			.json5("{f:[{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}},null]}")
			.json5T("{f:[{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}},null]}")
			.json5R("{\n\tf: [\n\t\t{\n\t\t\tf1: f1v,\n\t\t\tf2: [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: f5v1,\n\t\t\t\tbar: null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t},\n\t\tnull\n\t]\n}")
			...
			.msgPackT("81A1669285A26631663176A26632936632763166327632C0A26633C0A26634936634763166347632C0A2663583A3666F6F66357631A3626172C0C066357632C0")
			.build(),
		tester(9, "BeanWithReaderBeanMapField", ()->new BeanWithReaderBeanMapField().init())
			...
			.jsonR("{\n\t\"f\": {\n\t\t\"foo\": {\n\t\t\t\"f1\": f1v,\n\t\t\t\"f2\": [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f3\": null,\n\t\t\t\"f4\": [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f5\": {\n\t\t\t\t\"foo\": f5v1,\n\t\t\t\t\"bar\": null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t},\n\t\t\"bar\": null,\n\t\tnull: {\n\t\t\t\"f1\": f1v,\n\t\t\t\"f2\": [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f3\": null,\n\t\t\t\"f4\": [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\t\"f5\": {\n\t\t\t\t\"foo\": f5v1,\n\t\t\t\t\"bar\": null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t}\n\t}\n}")
			.json5("{f:{foo:{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}},bar:null,null:{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}}}}")
			.json5T("{f:{foo:{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}},bar:null,null:{f1:f1v,f2:[f2v1,f2v2,null],f3:null,f4:[f4v1,f4v2,null],f5:{foo:f5v1,bar:null,null:f5v2}}}}")
			.json5R("{\n\tf: {\n\t\tfoo: {\n\t\t\tf1: f1v,\n\t\t\tf2: [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: f5v1,\n\t\t\t\tbar: null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t},\n\t\tbar: null,\n\t\tnull: {\n\t\t\tf1: f1v,\n\t\t\tf2: [\n\t\t\t\tf2v1,\n\t\t\t\tf2v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf3: null,\n\t\t\tf4: [\n\t\t\t\tf4v1,\n\t\t\t\tf4v2,\n\t\t\t\tnull\n\t\t\t],\n\t\t\tf5: {\n\t\t\t\tfoo: f5v1,\n\t\t\t\tbar: null,\n\t\t\t\tnull: f5v2\n\t\t\t}\n\t\t}\n\t}\n}")
