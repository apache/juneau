...
/**
 * Coverage tests for {@link SerializerSession} targeting the gap-areas listed in TODO-155 (E7):
...
class SerializerSession_Test extends TestBase {
	...
	@Test void i01_listener_beanGetterException_ignored_doesNotThrow() throws Exception {
		...
		// the listener is NOT invoked. This documents the current behavior (production observation for TODO-156).
	...
	@Test void q01_swap_nullSwapReturnsObject() throws Exception {
		...
		var method = SerializerSession.class.getDeclaredMethod("swap", org.apache.juneau.swap.ObjectSwap.class, Object.class);
		method.setAccessible(true);
	...
	@Test void z02_getExpectedRootType_optional() throws Exception {
		...
		var method = SerializerSession.class.getDeclaredMethod("getExpectedRootType", Object.class);
		method.setAccessible(true);
		var result = method.invoke(s, Optional.of("hello"));
		assertNotNull(result);
	}
