...
class PreconditionRequired_Test extends TestBase {
	...
	@Test void a02_nullCause() {
		var x = new PreconditionRequired((Throwable)null);
		assertEquals(PreconditionRequired.REASON_PHRASE, x.getMessage());
	}
}