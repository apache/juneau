...
class Vary_Test extends SimpleTestBase {
	...
	@Test void a01_basic() throws Exception {
		...
		c.get().header(vary((Supplier<String>)null)).run().assertContent().isEmpty();
		c.get().header(vary(()->null)).run().assertContent().isEmpty();
	}
