...
import static org.apache.juneau.http.classic.response.NotExtended.*;
...
class NotExtended_Test extends TestBase {
	...
	@Test void a02_nullCause() {
		var x = new NotExtended((Throwable)null);
		assertEquals(NotExtended.REASON_PHRASE, x.getMessage());
	}
}