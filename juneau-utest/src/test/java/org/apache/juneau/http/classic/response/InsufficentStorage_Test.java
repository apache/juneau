...
import static org.apache.juneau.http.classic.response.InsufficientStorage.*;
...
class InsufficentStorage_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws InsufficientStorage {
			throw new InsufficientStorage();
		}
		@RestGet
		public void f2() throws InsufficientStorage {
			throw new InsufficientStorage("foo {0}", "bar");
		}
		@RestGet
		public void f3() throws InsufficientStorage {
			throw new InsufficientStorage(new RuntimeException("baz"));
		}
		@RestGet
		public void f4() throws InsufficientStorage {
