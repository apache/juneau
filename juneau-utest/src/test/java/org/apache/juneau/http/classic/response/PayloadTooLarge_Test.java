...
import static org.apache.juneau.http.classic.response.PayloadTooLarge.*;
...
class PayloadTooLarge_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws PayloadTooLarge {
	...
	@Test void a02_nullCause() {
		var x = new PayloadTooLarge((Throwable)null);
		assertEquals(PayloadTooLarge.REASON_PHRASE, x.getMessage());
	}
}