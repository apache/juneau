...
import static org.apache.juneau.http.classic.response.NetworkAuthenticationRequired.*;
...
class NetworkAuthenticationRequired_Test extends TestBase {
	...
	@Test void a02_nullCause() {
		var x = new NetworkAuthenticationRequired((Throwable)null);
		assertEquals(NetworkAuthenticationRequired.REASON_PHRASE, x.getMessage());
	}
}