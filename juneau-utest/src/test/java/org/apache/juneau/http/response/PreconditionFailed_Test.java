...
class PreconditionFailed_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws PreconditionFailed {
		...
		public void f5() throws PreconditionFailed {
			throw preconditionFailed().setHeader2("Foo", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new PreconditionFailed((Throwable)null);
		assertEquals(PreconditionFailed.REASON_PHRASE, x.getMessage());
	}
}