...
class Remote_CommonInterfaces_Test extends SimpleTestBase {
	...
	@Test void e01_predefinedExceptions() {
		...
		assertThrows(BadRequest.class, x::badRequest, BadRequest.REASON_PHRASE);
		assertThrows(Conflict.class, x::conflict, Conflict.REASON_PHRASE);
		assertThrows(ExpectationFailed.class, x::expectationFailed, ExpectationFailed.REASON_PHRASE);
		assertThrows(FailedDependency.class, x::failedDependency, FailedDependency.REASON_PHRASE);
		assertThrows(Forbidden.class, x::forbidden, Forbidden.REASON_PHRASE);
		assertThrows(Gone.class, x::gone, Gone.REASON_PHRASE);
		assertThrows(HttpVersionNotSupported.class, x::httpVersionNotSupported, HttpVersionNotSupported.REASON_PHRASE);
		assertThrows(InsufficientStorage.class, x::insufficientStorage, InsufficientStorage.REASON_PHRASE);
		assertThrows(InternalServerError.class, x::internalServerError, InternalServerError.REASON_PHRASE);
		assertThrows(LengthRequired.class, x::lengthRequired, LengthRequired.REASON_PHRASE);
		assertThrows(Locked.class, x::locked, Locked.REASON_PHRASE);
		assertThrows(LoopDetected.class, x::loopDetected, LoopDetected.REASON_PHRASE);
		assertThrows(MethodNotAllowed.class, x::methodNotAllowed, MethodNotAllowed.REASON_PHRASE);
		assertThrows(MisdirectedRequest.class, x::misdirectedRequest, MisdirectedRequest.REASON_PHRASE);
		assertThrows(NetworkAuthenticationRequired.class, x::networkAuthenticationRequired, NetworkAuthenticationRequired.REASON_PHRASE);
		assertThrows(NotAcceptable.class, x::notAcceptable, NotAcceptable.REASON_PHRASE);
		assertThrows(NotExtended.class, x::notExtended, NotExtended.REASON_PHRASE);
		assertThrows(NotFound.class, x::notFound, NotFound.REASON_PHRASE);
		assertThrows(NotImplemented.class, x::notImplemented, NotImplemented.REASON_PHRASE);
		assertThrows(PayloadTooLarge.class, x::payloadTooLarge, PayloadTooLarge.REASON_PHRASE);
		assertThrows(PreconditionFailed.class, x::preconditionFailed, PreconditionFailed.REASON_PHRASE);
		assertThrows(PreconditionRequired.class, x::preconditionRequired, PreconditionRequired.REASON_PHRASE);
		assertThrows(RangeNotSatisfiable.class, x::rangeNotSatisfiable, RangeNotSatisfiable.REASON_PHRASE);
		assertThrows(RequestHeaderFieldsTooLarge.class, x::requestHeaderFieldsTooLarge, RequestHeaderFieldsTooLarge.REASON_PHRASE);
		assertThrows(ServiceUnavailable.class, x::serviceUnavailable, ServiceUnavailable.REASON_PHRASE);
		assertThrows(TooManyRequests.class, x::tooManyRequests, TooManyRequests.REASON_PHRASE);
		assertThrows(Unauthorized.class, x::unauthorized, Unauthorized.REASON_PHRASE);
		assertThrows(UnavailableForLegalReasons.class, x::unavailableForLegalReasons, UnavailableForLegalReasons.REASON_PHRASE);
		assertThrows(UnprocessableEntity.class, x::unprocessableEntity, UnprocessableEntity.REASON_PHRASE);
		assertThrows(UnsupportedMediaType.class, x::unsupportedMediaType, UnsupportedMediaType.REASON_PHRASE);
		assertThrows(UpgradeRequired.class, x::upgradeRequired, UpgradeRequired.REASON_PHRASE);
		assertThrows(UriTooLong.class, x::uriTooLong, UriTooLong.REASON_PHRASE);
		assertThrows(VariantAlsoNegotiates.class, x::variantAlsoNegotiates, VariantAlsoNegotiates.REASON_PHRASE);
	}
	...
	@Test void e02_predefinedExceptions_customMessages() {
		...
		assertThrows(BadRequest.class, x::badRequest, "foo");
		assertThrows(Conflict.class, x::conflict, "foo");
		assertThrows(ExpectationFailed.class, x::expectationFailed, "foo");
		assertThrows(FailedDependency.class, x::failedDependency, "foo");
		assertThrows(Forbidden.class, x::forbidden, "foo");
		assertThrows(Gone.class, x::gone, "foo");
		assertThrows(HttpVersionNotSupported.class, x::httpVersionNotSupported, "foo");
		assertThrows(InsufficientStorage.class, x::insufficientStorage, "foo");
		assertThrows(InternalServerError.class, x::internalServerError, "foo");
		assertThrows(LengthRequired.class, x::lengthRequired, "foo");
		assertThrows(Locked.class, x::locked, "foo");
		assertThrows(LoopDetected.class, x::loopDetected, "foo");
		assertThrows(MethodNotAllowed.class, x::methodNotAllowed, "foo");
		assertThrows(MisdirectedRequest.class, x::misdirectedRequest, "foo");
		assertThrows(NetworkAuthenticationRequired.class, x::networkAuthenticationRequired, "foo");
		assertThrows(NotAcceptable.class, x::notAcceptable, "foo");
		assertThrows(NotExtended.class, x::notExtended, "foo");
		assertThrows(NotFound.class, x::notFound, "foo");
		assertThrows(NotImplemented.class, x::notImplemented, "foo");
		assertThrows(PayloadTooLarge.class, x::payloadTooLarge, "foo");
		assertThrows(PreconditionFailed.class, x::preconditionFailed, "foo");
		assertThrows(PreconditionRequired.class, x::preconditionRequired, "foo");
		assertThrows(RangeNotSatisfiable.class, x::rangeNotSatisfiable, "foo");
		assertThrows(RequestHeaderFieldsTooLarge.class, x::requestHeaderFieldsTooLarge, "foo");
		assertThrows(ServiceUnavailable.class, x::serviceUnavailable, "foo");
		assertThrows(TooManyRequests.class, x::tooManyRequests, "foo");
		assertThrows(Unauthorized.class, x::unauthorized, "foo");
		assertThrows(UnavailableForLegalReasons.class, x::unavailableForLegalReasons, "foo");
		assertThrows(UnprocessableEntity.class, x::unprocessableEntity, "foo");
		assertThrows(UnsupportedMediaType.class, x::unsupportedMediaType, "foo");
		assertThrows(UpgradeRequired.class, x::upgradeRequired, "foo");
		assertThrows(UriTooLong.class, x::uriTooLong, "foo");
		assertThrows(VariantAlsoNegotiates.class, x::variantAlsoNegotiates, "foo");
	}
