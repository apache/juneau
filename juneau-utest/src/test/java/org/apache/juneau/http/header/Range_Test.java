...
class Range_Test extends SimpleTestBase {
	...
	@Test void a01_basic() throws Exception {
		...
		c.get().header(range((Supplier<String>)null)).run().assertContent().isEmpty();
		c.get().header(range(()->null)).run().assertContent().isEmpty();
	}
