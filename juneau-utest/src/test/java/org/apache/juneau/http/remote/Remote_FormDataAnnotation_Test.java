...
public class Remote_FormDataAnnotation_Test {
	...
	public void b01_default_allowEmptyValue() throws Exception {
		...
		assertThrown(()->x.postX1("")).messages().contains("Empty value not allowed.");
		assertEquals("{x:'foo'}",x.postX2(null));
		assertEquals("{x:''}",x.postX2(""));
		assertEquals("{x:''}",x.postX3(null));
		assertThrown(()->x.postX3("")).messages().contains("Empty value not allowed.");
	...
	public void d01_min_max_emin_emax() throws Exception {
		...
		assertThrown(()->x.postX1(0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX1(11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX2(1));
		assertEquals("{x:'10'}",x.postX2(10));
		assertThrown(()->x.postX2(0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX2(11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX3(2));
		assertEquals("{x:'9'}",x.postX3(9));
		assertThrown(()->x.postX3(1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX3(10)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX5((short)1));
		assertEquals("{x:'10'}",x.postX5((short)10));
		assertThrown(()->x.postX5((short)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX5((short)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX6((short)1));
		assertEquals("{x:'10'}",x.postX6((short)10));
		assertThrown(()->x.postX6((short)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX6((short)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX7((short)2));
		assertEquals("{x:'9'}",x.postX7((short)9));
		assertThrown(()->x.postX7((short)1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX7((short)10)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX8(1l));
		assertEquals("{x:'10'}",x.postX8(10l));
		assertThrown(()->x.postX8(0l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX8(11l)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX9(1l));
		assertEquals("{x:'10'}",x.postX9(10l));
		assertThrown(()->x.postX9(0l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX9(11l)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX10(2l));
		assertEquals("{x:'9'}",x.postX10(9l));
		assertThrown(()->x.postX10(1l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX10(10l)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.0'}",x.postX11(1f));
		assertEquals("{x:'10.0'}",x.postX11(10f));
		assertThrown(()->x.postX11(0.9f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX11(10.1f)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.0'}",x.postX12(1f));
		assertEquals("{x:'10.0'}",x.postX12(10f));
		assertThrown(()->x.postX12(0.9f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX12(10.1f)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.1'}",x.postX13(1.1f));
		assertEquals("{x:'9.9'}",x.postX13(9.9f));
		assertThrown(()->x.postX13(1f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX13(10f)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.0'}",x.postX14(1d));
		assertEquals("{x:'10.0'}",x.postX14(10d));
		assertThrown(()->x.postX14(0.9d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX14(10.1d)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.0'}",x.postX15(1d));
		assertEquals("{x:'10.0'}",x.postX15(10d));
		assertThrown(()->x.postX15(0.9d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX15(10.1d)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1.1'}",x.postX16(1.1d));
		assertEquals("{x:'9.9'}",x.postX16(9.9d));
		assertThrown(()->x.postX16(1d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX16(10d)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX17((byte)1));
		assertEquals("{x:'10'}",x.postX17((byte)10));
		assertThrown(()->x.postX17((byte)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX17((byte)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX18((byte)1));
		assertEquals("{x:'10'}",x.postX18((byte)10));
		assertThrown(()->x.postX18((byte)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX18((byte)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX19((byte)2));
		assertEquals("{x:'9'}",x.postX19((byte)9));
		assertThrown(()->x.postX19((byte)1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX19((byte)10)).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX20(new AtomicInteger(1)));
		assertEquals("{x:'10'}",x.postX20(new AtomicInteger(10)));
		assertThrown(()->x.postX20(new AtomicInteger(0))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX20(new AtomicInteger(11))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX21(new AtomicInteger(1)));
		assertEquals("{x:'10'}",x.postX21(new AtomicInteger(10)));
		assertThrown(()->x.postX21(new AtomicInteger(0))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX21(new AtomicInteger(11))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX22(new AtomicInteger(2)));
		assertEquals("{x:'9'}",x.postX22(new AtomicInteger(9)));
		assertThrown(()->x.postX22(new AtomicInteger(1))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX22(new AtomicInteger(10))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX23(new BigDecimal(1)));
		assertEquals("{x:'10'}",x.postX23(new BigDecimal(10)));
		assertThrown(()->x.postX23(new BigDecimal(0))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX23(new BigDecimal(11))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX24(new BigDecimal(1)));
		assertEquals("{x:'10'}",x.postX24(new BigDecimal(10)));
		assertThrown(()->x.postX24(new BigDecimal(0))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX24(new BigDecimal(11))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'2'}",x.postX25(new BigDecimal(2)));
		assertEquals("{x:'9'}",x.postX25(new BigDecimal(9)));
		assertThrown(()->x.postX25(new BigDecimal(1))).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX25(new BigDecimal(10))).messages().contains("Maximum value exceeded.");
		assertEquals("{x:'1'}",x.postX26(1));
		assertEquals("{x:'10'}",x.postX26(10));
		assertThrown(()->x.postX26(0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX26(11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX26(null));
		assertEquals("{x:'1'}",x.postX27(1));
		assertEquals("{x:'10'}",x.postX27(10));
		assertThrown(()->x.postX27(0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX27(11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX27(null));
		assertEquals("{x:'2'}",x.postX28(2));
		assertEquals("{x:'9'}",x.postX28(9));
		assertThrown(()->x.postX28(1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX28(10)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX28(null));
		assertEquals("{x:'1'}",x.postX29((short)1));
		assertEquals("{x:'10'}",x.postX29((short)10));
		assertThrown(()->x.postX29((short)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX29((short)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX29(null));
		assertEquals("{x:'1'}",x.postX30((short)1));
		assertEquals("{x:'10'}",x.postX30((short)10));
		assertThrown(()->x.postX30((short)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX30((short)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX30(null));
		assertEquals("{x:'2'}",x.postX31((short)2));
		assertEquals("{x:'9'}",x.postX31((short)9));
		assertThrown(()->x.postX31((short)1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX31((short)10)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX31(null));
		assertEquals("{x:'1'}",x.postX32(1l));
		assertEquals("{x:'10'}",x.postX32(10l));
		assertThrown(()->x.postX32(0l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX32(11l)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX32(null));
		assertEquals("{x:'1'}",x.postX33(1l));
		assertEquals("{x:'10'}",x.postX33(10l));
		assertThrown(()->x.postX33(0l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX33(11l)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX33(null));
		assertEquals("{x:'2'}",x.postX34(2l));
		assertEquals("{x:'9'}",x.postX34(9l));
		assertThrown(()->x.postX34(1l)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX34(10l)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX34(null));
		assertEquals("{x:'1.0'}",x.postX35(1f));
		assertEquals("{x:'10.0'}",x.postX35(10f));
		assertThrown(()->x.postX35(0.9f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX35(10.1f)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX35(null));
		assertEquals("{x:'1.0'}",x.postX36(1f));
		assertEquals("{x:'10.0'}",x.postX36(10f));
		assertThrown(()->x.postX36(0.9f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX36(10.1f)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX36(null));
		assertEquals("{x:'1.1'}",x.postX37(1.1f));
		assertEquals("{x:'9.9'}",x.postX37(9.9f));
		assertThrown(()->x.postX37(1f)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX37(10f)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX37(null));
		assertEquals("{x:'1.0'}",x.postX38(1d));
		assertEquals("{x:'10.0'}",x.postX38(10d));
		assertThrown(()->x.postX38(0.9d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX38(10.1d)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX38(null));
		assertEquals("{x:'1.0'}",x.postX39(1d));
		assertEquals("{x:'10.0'}",x.postX39(10d));
		assertThrown(()->x.postX39(0.9d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX39(10.1d)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX39(null));
		assertEquals("{x:'1.1'}",x.postX40(1.1d));
		assertEquals("{x:'9.9'}",x.postX40(9.9d));
		assertThrown(()->x.postX40(1d)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX40(10d)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX40(null));
		assertEquals("{x:'1'}",x.postX41((byte)1));
		assertEquals("{x:'10'}",x.postX41((byte)10));
		assertThrown(()->x.postX41((byte)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX41((byte)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX41(null));
		assertEquals("{x:'1'}",x.postX42((byte)1));
		assertEquals("{x:'10'}",x.postX42((byte)10));
		assertThrown(()->x.postX42((byte)0)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX42((byte)11)).messages().contains("Maximum value exceeded.");
		assertEquals("{}",x.postX42(null));
		assertEquals("{x:'2'}",x.postX43((byte)2));
		assertEquals("{x:'9'}",x.postX43((byte)9));
		assertThrown(()->x.postX43((byte)1)).messages().contains("Minimum value not met.");
		assertThrown(()->x.postX43((byte)10)).messages().contains("Maximum value exceeded.");
	...
	public void e01_mini_maxi_ui() throws Exception {
		...
		assertThrown(()->x.postX1()).messages().contains("Minimum number of items not met.");
		assertThrown(()->x.postX1("1","2","3")).messages().contains("Maximum number of items exceeded.");
		assertEquals("{x:null}",x.postX1((String)null));
		assertEquals("{x:'1'}",x.postX2(new String[]{"1"}));
		assertEquals("{x:'1|2'}",x.postX2(new String[]{"1","2"}));
		assertThrown(()->x.postX2(new String[]{})).messages().contains("Minimum number of items not met.");
		assertThrown(()->x.postX2(new String[]{"1","2","3"})).messages().contains("Maximum number of items exceeded.");
		...
		assertThrown(()->x.postX5("1","1")).messages().contains("Duplicate items not allowed.");
		assertEquals("{x:'1|2'}",x.postX6(new String[]{"1","2"}));
		assertThrown(()->x.postX6(new String[]{"1","1"})).messages().contains("Duplicate items not allowed.");
	}
	...
	public void f01_minl_maxl_enum_pattern() throws Exception {
		...
		assertThrown(()->x.postX1("1")).messages().contains("Minimum length of value not met.");
		assertThrown(()->x.postX1("1234")).messages().contains("Maximum length of value exceeded.");
		assertEquals("{}",x.postX1(null));
		assertEquals("{x:'12|34'}",x.postX2("12","34"));
		assertEquals("{x:'123|456'}",x.postX2("123","456"));
		assertThrown(()->x.postX2("1","2")).messages().contains("Minimum length of value not met.");
		assertThrown(()->x.postX2("1234","5678")).messages().contains("Maximum length of value exceeded.");
		assertEquals("{x:'12|null'}",x.postX2("12",null));
		assertEquals("{x:'foo'}",x.postX3("foo"));
		assertThrown(()->x.postX3("bar")).messages().contains("Value does not match one of the expected values.  Must be one of the following:  foo");
		assertEquals("{}",x.postX3(null));
		assertEquals("{x:'foo'}",x.postX4("foo"));
		assertThrown(()->x.postX4("bar")).messages().contains("Value does not match one of the expected values.  Must be one of the following:  foo");
		assertEquals("{x:null}",x.postX4((String)null));
		assertEquals("{x:'foo123'}",x.postX5("foo123"));
		assertThrown(()->x.postX5("bar")).messages().contains("Value does not match expected pattern.  Must match pattern: foo\\d{1,3}");
		assertEquals("{}",x.postX5(null));
		assertEquals("{x:'foo123'}",x.postX6("foo123"));
		assertThrown(()->x.postX6("foo")).messages().contains("Value does not match expected pattern.  Must match pattern: foo\\d{1,3}");
	...
	public void g01_multipleOf() throws Exception {
		...
		assertThrown(()->x.postX1(5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX2((short)4));
		assertThrown(()->x.postX2((short)5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX3(4));
		assertThrown(()->x.postX3(5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4.0'}",x.postX4(4));
		assertThrown(()->x.postX4(5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4.0'}",x.postX5(4));
		assertThrown(()->x.postX5(5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX6((byte)4));
		assertThrown(()->x.postX6((byte)5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX7(new AtomicInteger(4)));
		assertThrown(()->x.postX7(new AtomicInteger(5))).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX8(new BigDecimal(4)));
		assertThrown(()->x.postX8(new BigDecimal(5))).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX9(4));
		assertThrown(()->x.postX9(5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX10((short)4));
		assertThrown(()->x.postX10((short)5)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX11(4l));
		assertThrown(()->x.postX11(5l)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4.0'}",x.postX12(4f));
		assertThrown(()->x.postX12(5f)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4.0'}",x.postX13(4d));
		assertThrown(()->x.postX13(5d)).messages().contains("Multiple-of not met.");
		assertEquals("{x:'4'}",x.postX14((byte)4));
		assertThrown(()->x.postX14((byte)5)).messages().contains("Multiple-of not met.");
	}
	...
	public void h01_required() throws Exception {
		...
		assertThrown(()->x.postX3(null)).messages().contains("Required value not provided.");
	}
