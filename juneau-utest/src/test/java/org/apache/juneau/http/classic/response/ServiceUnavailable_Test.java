...
import static org.apache.juneau.http.classic.response.ServiceUnavailable.*;
...
class ServiceUnavailable_Test extends TestBase {
	...
	@Test void a02_nullCause() {
		var x = new ServiceUnavailable((Throwable)null);
		assertEquals(ServiceUnavailable.REASON_PHRASE, x.getMessage());
	}
}