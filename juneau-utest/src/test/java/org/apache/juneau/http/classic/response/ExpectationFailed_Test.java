...
import static org.apache.juneau.http.classic.response.ExpectationFailed.*;
...
class ExpectationFailed_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws ExpectationFailed {
	...
	@Test void a02_nullCause() {
		var x = new ExpectationFailed((Throwable)null);
		assertEquals(ExpectationFailed.REASON_PHRASE, x.getMessage());
	}
}