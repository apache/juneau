 ...
 * 	<li>JSON5 default-parser constructors and {@code ofJson5} factories work.
...
class Json5Map_Test extends TestBase {
	...
	@Test void a03_factoryOfJson5() throws Exception {
		var m = Json5Map.ofJson5("{a:1,b:'two'}");
		assertNotNull(m);
	...
	@Test void a04_factoryOfJson5NullInput() throws Exception {
		assertNull(Json5Map.ofJson5((CharSequence)null));
	}
	...
	@Test void a21_roundTripJson5() throws Exception {
		...
		var parsed = Json5Map.ofJson5(serialized);
