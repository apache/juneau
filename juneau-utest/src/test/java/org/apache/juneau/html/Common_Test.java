...
class Common_Test extends TestBase {
	...
	public static class E1 {
		...
		@MarshalledProp(properties="f1") public Map<String,Integer> x2 = m("f1",3,"f2",4);
		@MarshalledProp(properties="f1") public E2[] x3 = {new E2()};
		@MarshalledProp(properties="f1") public List<E2> x4 = l(new E2());
		@MarshalledProp(properties="f1") public JsonMap[] x5 = {JsonMap.of("f1",5,"f2",6)};
		@MarshalledProp(properties="f1") public List<JsonMap> x6 = l(JsonMap.of("f1",7,"f2",8));
	}
	...
	@Test void a08_recursion() throws Exception {
		...
		s.detectRecursions();
		assertThrowsWithMessage(Exception.class, l("[0] <noname>:org.apache.juneau.html.Common_Test$R1", "->[1] r2:org.apache.juneau.html.Common_Test$R2", "->[2] r3:org.apache.juneau.html.Common_Test$R3", "->[3] r1:org.apache.juneau.html.Common_Test$R1"), ()->s.build().serialize(r1));
