...
class HtmlDocConfigAnnotation_Test extends TestBase {
	...
	@Test void inheritance1() {
		var al = AnnotationWorkList.of(sr, rstream(d1.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
	...
	@Test void inheritance2() {
		var al = AnnotationWorkList.of(sr, rstream(d2.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
	...
	@Test void inheritance3() {
		var al = AnnotationWorkList.of(sr, rstream(d3.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
	...
	@Test void inheritance4() {
		var al = AnnotationWorkList.of(sr, rstream(d4.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("", x.getAside());
		check("", x.getFooter());
		check("", x.getHead());
	...
	@Test void widgets_basic() {
		var al = AnnotationWorkList.of(sr, rstream(e.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
	...
	@Test void e01_rankedAnnotations_f1() {
		var al = AnnotationWorkList.of(sr, rstream(f1.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("f1", x.getAside());
	}

	@Test void e02_rankedAnnotations_f2() {
		var al = AnnotationWorkList.of(sr, rstream(f2.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("f1", x.getAside());
	}

	@Test void e03_rankedAnnotations_f3() {
		var al = AnnotationWorkList.of(sr, rstream(f3.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("f3", x.getAside());
	}

	@Test void e04_rankedAnnotations_f4() {
		var al = AnnotationWorkList.of(sr, rstream(f4.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("f3", x.getAside());
	}

	@Test void e05_rankedAnnotations_f5() {
		var al = AnnotationWorkList.of(sr, rstream(f5.getAnnotations()).map(ai -> (AnnotationInfo<?>)ai));
		var x = HtmlDocSerializer.create().apply(al).build().getSession();
		check("f5", x.getAside());
	}
}