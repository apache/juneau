...
class BasicXml_Test extends TestBase {
	...
	void a01_serializeNormal(Input input) {
		try {
			...
			assertEquals(input.e1, r, mfs("{0} serialize-normal failed", input.label));
	...
	void a02_parseNormal(Input input) {
		try {
			...
			r = s1.serialize(o);
			assertEquals(input.e1, r, mfs("{0} parse-normal failed", input.label));
		} catch (AssertionError e) {
			throw e;
		} catch (Throwable e) {
			throw new RuntimeException(input.label + " test failed", e);
	...
	void a03_serializeReadable(Input input) {
		try {
			...
			assertEquals(input.e2, r, mfs("{0} serialize-readable failed", input.label));
		} catch (AssertionError e) {
			throw e;
		} catch (Throwable e) {
			throw new RuntimeException(input.label + " test failed", e);
	...
	void a04_parseReadable(Input input) {
		try {
			...
			var o = parser.parse(r, c);
			r = s2.serialize(o);
			assertEquals(input.e2, r, mfs("{0} parse-readable failed", input.label));
		} catch (AssertionError e) {
			throw e;
		} catch (Throwable e) {
			throw new RuntimeException(input.label + " test failed", e);
	...
	void a05_serializeNsEnabled(Input input) {
		try {
			...
			assertEquals(input.e3, r, mfs("{0} serialize-ns-enabled failed", input.label));
		} catch (AssertionError e) {
			throw e;
		} catch (Throwable e) {
			throw new RuntimeException(input.label + " test failed", e);
	...
	void a06_parseNsEnabled(Input input) {
		try {
			...
			var o = parser.parse(r, c);
			r = s3.serialize(o);
			assertEquals(input.e3, r, mfs("{0} parse-ns-enabled failed", input.label));
		} catch (AssertionError e) {
			throw e;
		} catch (Throwable e) {
			throw new RuntimeException(input.label + " test failed", e);
