...
class Cache4_Test extends TestBase {
	...
	void d03_containsValue_nullValue() {
		...
		var x2 = Cache4.of(String.class, String.class, String.class, Integer.class, String.class).build();
	...
	void f03_threadLocal_multipleKeys() {
		...
		// Verify all cached
		assertEquals("en:US:formal:1", x.get("en", "US", "formal", 1));
		assertEquals("fr:FR:informal:2", x.get("fr", "FR", "informal", 2));
		assertEquals("de:DE:formal:3", x.get("de", "DE", "formal", 3));
		assertEquals(3, x.getCacheHits());
	}
