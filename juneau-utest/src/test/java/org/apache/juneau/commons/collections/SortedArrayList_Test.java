...
class SortedArrayList_Test extends TestBase {
	...
	void a02_naturalOrdering_integers() {
		var list = new SortedArrayList<Integer>();
		list.add(5);
		list.add(2);
		list.add(8);
		list.add(1);
	...
	void b01_customComparator_stringLength() {
		var list = new SortedArrayList<>(Comparator.comparing(String::length));
		list.add("ccc");
		list.add("a");
		list.add("bb");
	...
	void b02_customComparator_reverseOrder() {
		List<Integer> list = new SortedArrayList<>(Comparator.reverseOrder());
		list.add(1);
		list.add(5);
		list.add(3);
	...
	void c02_constructor_withComparator() {
		...
		var list = new SortedArrayList<>(comparator);
		assertTrue(list.isEmpty());
		assertSame(comparator, list.comparator());
	}

	@Test
	void c03_constructor_withInitialCapacity() {
		var list = new SortedArrayList<String>(10);
		assertTrue(list.isEmpty());
		list.add("a");
		assertSize(1, list);
	}
	...
	@Test
	void c04_constructor_withComparatorAndCapacity() {
		var comparator = Comparator.comparing(String::length);
		var list = new SortedArrayList<>(comparator, 10);
		assertTrue(list.isEmpty());
		assertSame(comparator, list.comparator());
	}

	@Test
	void c05_constructor_withCollection() {
		var source = List.of("c", "a", "b");
		var list = new SortedArrayList<>(source);

		assertList(list, "a", "b", "c");
	}

	@Test
	void c06_constructor_withCollectionAndComparator() {
		var source = List.of("ccc", "a", "bb");
		var list = new SortedArrayList<>(Comparator.comparing(String::length), source);
	...
	@Test
	void l01_toString_empty() {
		var list = new SortedArrayList<String>();
		assertEquals("[]", list.toString());
	}

	@Test
	void l02_toString_singleElement() {
		var list = new SortedArrayList<String>();
		list.add("a");
	...
	@Test
	void l03_toString_multipleElements() {
		var list = new SortedArrayList<String>();
		list.add("c");
		list.add("a");
		list.add("b");
	...
	@Test
	void l04_toString_withDuplicates() {
		var list = new SortedArrayList<String>();
		list.add("c");
		list.add("a");
		list.add("b");
	...
	@Test
	void l05_toString_withNull() {
		List<String> list = new SortedArrayList<>(Comparator.nullsFirst(Comparator.naturalOrder()));
		list.add("b");
		list.add(null);
		list.add("a");
	...
	@Test
	void m01_hashCode_empty() {
		var list1 = new SortedArrayList<String>();
		var list2 = new SortedArrayList<String>();
		assertEquals(list1.hashCode(), list2.hashCode());
	}

	@Test
	void m02_hashCode_sameElements() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("b");
		list1.add("c");
	...
	@Test
	void m03_hashCode_differentElements() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("b");
	...
	@Test
	void m04_hashCode_equalsContract() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("b");
		list1.add("c");
	...
	@Test
	void m05_hashCode_withDuplicates() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("a");
		list1.add("b");
	...
	@Test
	void n04_equals_differentElements() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("b");
	...
	@Test
	void n05_equals_differentSizes() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("b");
	...
	@Test
	void n06_equals_withDuplicates() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("a");
		list1.add("b");
	...
	@Test
	void n07_equals_differentDuplicateCounts() {
		var list1 = new SortedArrayList<String>();
		list1.add("a");
		list1.add("a");
		list1.add("b");
	...
	@Test
	void n08_equals_withArrayList() {
		var sortedList = new SortedArrayList<String>();
		sortedList.add("a");
		sortedList.add("b");
		sortedList.add("c");
	...
	@Test
	void n09_equals_withLinkedList() {
		var sortedList = new SortedArrayList<String>();
		sortedList.add("a");
		sortedList.add("b");
		sortedList.add("c");
	...
	@Test
	void n11_equals_differentComparators() {
		// Two lists with different comparators will have different element orders
		List<String> list1 = new SortedArrayList<>(Comparator.naturalOrder());
		list1.add("a");
		list1.add("b");
		list1.add("c");
		// list1 is ["a", "b", "c"]

		List<String> list2 = new SortedArrayList<>(Comparator.reverseOrder());
		list2.add("c");
		list2.add("b");
		list2.add("a");
