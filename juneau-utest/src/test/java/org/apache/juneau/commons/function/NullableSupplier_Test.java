...
class NullableSupplier_Test extends TestBase {
	...
	void a01_of() {
		...
		NullableSupplier<String> supplier = NullableSupplier.of(() -> {
	...
	void a02_of_nullSupplier() {
		assertThrows(IllegalArgumentException.class, () -> NullableSupplier.of(null));
	}

	@Test
	void a03_ofNullable() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("value");
		assertEquals("value", supplier.get());
	}

	@Test
	void a04_ofNullable_null() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable(null);
		assertNull(supplier.get());
	}

	@Test
	void a05_empty() {
		NullableSupplier<String> supplier = NullableSupplier.empty();
		assertNull(supplier.get());
	}
	...
	void c01_map_present() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hello");
		NullableSupplier<Integer> mapped = supplier.map(String::length);
	...
	void c04_map_returnsNull() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("value");
		NullableSupplier<String> mapped = supplier.map(s -> null);
		assertNull(mapped.get());
	}
	...
	void d01_flatMap_present() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hello");
		NullableSupplier<Integer> mapped = supplier.flatMap(s -> NullableSupplier.ofNullable(s.length()));
		assertEquals(5, mapped.get());
	}
	...
	void d03_flatMap_returnsEmpty() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hello");
		NullableSupplier<Integer> mapped = supplier.flatMap(s -> NullableSupplier.empty());
		assertNull(mapped.get());
	}
	...
	void d04_flatMap_returnsNull() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hello");
		NullableSupplier<Integer> mapped = supplier.flatMap(s -> null);
		assertNull(mapped.get());
	}
	...
	void e01_filter_matches() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hello");
		NullableSupplier<String> filtered = supplier.filter(s -> s.length() > 3);
		assertEquals("hello", filtered.get());
	}

	@Test
	void e02_filter_noMatch() {
		NullableSupplier<String> supplier = NullableSupplier.ofNullable("hi");
		NullableSupplier<String> filtered = supplier.filter(s -> s.length() > 3);
