...
class ReflectionMap_Test extends TestBase {
	...
	class B_Method {
		...
		static ReflectionMap<Number>
			...
			B1m1_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1", 1).build(),
			B1m1i_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1(int)", 1).build(),
			B1m1s_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1(String)", 1).build(),
			B1m1ss_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1(java.lang.String)", 1).build(),
			B1m1si_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1(String,int)", 1).build(),
			B1m1ssi_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$B_Method$B1.m1(java.lang.String , int)", 1).build();
		// @formatter:on
	...
	class D_Constructor {
		...
		static ReflectionMap<Number>
			...
			D_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1()", 1).build(),
			Di_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1(int)", 1).build(),
			Ds_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1(String)", 1).build(),
			Dss_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1(java.lang.String)", 1).build(),
			Dsi_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1(String, int)", 1).build(),
			Dssi_FULL = create().append("org.apache.juneau.commons.reflect.ReflectionMap_Test$D_Constructor$D1(java.lang.String, int)", 1).build();
		// @formatter:on
