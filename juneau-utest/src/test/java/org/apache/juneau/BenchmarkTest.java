...
public class BenchmarkTest {
	...
	private static final Consumer<List<Integer>> list_for = x -> {for (Integer element : x) result += element;};
	...
	private static final ThrowingConsumer<List<Integer>> slist_for = x -> {for (Integer element : x) result += element;};
	...
	@Test public void a01a_list_iterator() { TestUtils.assertNotThrown(()->list_iterator.accept(LIST)); }
	@Test public void a01b_list_for() { TestUtils.assertNotThrown(()->list_for.accept(LIST)); }
	@Test public void a01c_list_foreach() { TestUtils.assertNotThrown(()->list_foreach.accept(LIST)); }

	@Test public void a01a_map_iterator1_S() { TestUtils.assertNotThrown(()->map_iterator1.accept(MAP)); }
	@Test public void a01b_map_iterator2_S() { TestUtils.assertNotThrown(()->map_iterator2.accept(MAP)); }
	@Test public void a01c_map_forEach1_S() { TestUtils.assertNotThrown(()->map_forEach1.accept(MAP)); }
	@Test public void a01d_map_forEach2_S() { TestUtils.assertNotThrown(()->map_forEach2.accept(MAP)); }

	@Test public void b01a_list_iterator() { TestUtils.assertNotThrown(()->slist_iterator.accept(LIST)); }
	@Test public void b01b_list_for() { TestUtils.assertNotThrown(()->slist_for.accept(LIST)); }
	@Test public void b01c_list_foreach() { TestUtils.assertNotThrown(()->slist_foreach.accept(LIST)); }

	@Test public void b01a_map_iterator1_S() { TestUtils.assertNotThrown(()->smap_iterator1.accept(MAP)); }
	@Test public void b01b_map_iterator2_S() { TestUtils.assertNotThrown(()->smap_iterator2.accept(MAP)); }
	@Test public void b01c_map_forEach1_S() { TestUtils.assertNotThrown(()->smap_forEach1.accept(MAP)); }
	@Test public void b01d_map_forEach2_S() { TestUtils.assertNotThrown(()->smap_forEach2.accept(MAP)); }
