 ...
 *    {@link org.apache.juneau.json.JsonParserSession} overrides both, but the public
 ...
 *  - The XML follow-up bug (TODO-155 #12) was a {@code doParseIntoMap}/{@code doParseIntoCollection}
...
class ParserSession_Test extends TestBase {
	...
	@Test void g12_builder_schemaDefault_noOverwrite() {
		...
		var sch1 = org.apache.juneau.httppart.HttpPartSchema.create("string").build();
		var sch2 = org.apache.juneau.httppart.HttpPartSchema.create("integer").build();
	...
	@Test void g13_builder_schemaDefault_setsWhenAbsent() {
		var s = P.createSession()
			.schemaDefault(org.apache.juneau.httppart.HttpPartSchema.create("string").build())
			.build();
	...
	@Test void h06_getSchema_setExplicit() {
		var schema = org.apache.juneau.httppart.HttpPartSchema.create("string").build();
	...
	public static class ExposingSession extends ParserSession {
		...
		public org.apache.juneau.LocaleFormat exposeGetLocaleFormat() { return getLocaleFormat(); }
		public org.apache.juneau.TimeZoneFormat exposeGetTimeZoneFormat() { return getTimeZoneFormat(); }
		public org.apache.juneau.DurationFormat exposeGetDurationFormat() { return getDurationFormat(); }
		public org.apache.juneau.PeriodFormat exposeGetPeriodFormat() { return getPeriodFormat(); }
		public org.apache.juneau.CalendarFormat exposeGetCalendarFormat() { return getCalendarFormat(); }
		public org.apache.juneau.DateFormat exposeGetDateFormat() { return getDateFormat(); }
		public org.apache.juneau.TemporalFormat exposeGetTemporalFormat() { return getTemporalFormat(); }
		...
		public org.apache.juneau.collections.JsonMap exposeGetLastLocation() { return getLastLocation(); }
	...
	@Test void s01_doParseIntoMap_default_throwsUnsupported() {
		...
		assertThrows(UnsupportedOperationException.class,
			() -> s.doParseIntoMap_callDirect());
	}

	@Test void s02_doParseIntoCollection_default_throwsUnsupported() {
		var s = new ExposingSession(JsonParser.DEFAULT);
		assertThrows(UnsupportedOperationException.class,
			() -> s.doParseIntoCollection_callDirect());
	}
}
