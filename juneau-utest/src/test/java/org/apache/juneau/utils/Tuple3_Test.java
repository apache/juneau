...
class Tuple3_Test extends TestBase {
	...
	@Test void a02_equality() {
		var x1 = Tuple3.of("foo",1,2);
		var x2 = Tuple3.of("foo",1,2);
		var x3 = Tuple3.of(null,1,2);
		var x4 = Tuple3.of("foo",null,2);
		var x5 = Tuple3.of("foo",1,null);
		assertEquals(x1, x2);
