...
public class ReflectionMapTest {
	...
	public void e01_blankInput() throws Exception {
		assertThrown(()->create().append("", 1)).message().is("Invalid reflection signature: []");
	}

	@Test
	public void e02_nullInput() throws Exception {
		assertThrown(()->create().append(null, 1)).message().is("Invalid reflection signature: [null]");
	}

	@Test
	public void e03_badInput() throws Exception {
		assertThrown(()->create().append("foo)", 1)).message().is("Invalid reflection signature: [foo)]");
	}
