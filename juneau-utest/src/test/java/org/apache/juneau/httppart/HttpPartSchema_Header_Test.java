...
class HttpPartSchema_Header_Test extends SimpleTestBase {
	...
	@Test void a01_value() {
		var s = HttpPartSchema.create().applyAll(Header.class, A01.class).build();
	...
	@Test void a02_basic_onClass() {
		var s = HttpPartSchema.create().applyAll(Header.class, A02.class).noValidate().build();
		assertEquals("x", s.getName());
	...
	@Test void a03_basic_onParameter() throws Exception {
		...
		var s = HttpPartSchema.create().applyAll(Header.class, mpi).noValidate().build();
		assertEquals("x", s.getName());
		assertEquals(HttpPartDataType.NUMBER, s.getType());
		assertEquals(HttpPartFormat.INT32, s.getFormat());
		assertEquals(HttpPartCollectionFormat.CSV, s.getCollectionFormat());
	...
	@Test void a05_basic_nestedItems_onClass() {
		var s = HttpPartSchema.create().applyAll(Header.class, A05.class).noValidate().build();
		assertEquals("x", s.getName());
	...
	@Test void b01_required() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B01.class).build();
		s.validateInput("x");
	...
	@Test void b02a_pattern() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B02a.class).build();
		s.validateInput("x");
		s.validateInput("xx");
	...
	@Test void b03a_length() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B03a.class).build();
		s.validateInput("12");
		s.validateInput("123");
	...
	@Test void b03b_length_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B03b.class).build();
	...
	@Test void b04a_enum() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B04a.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
	...
	@Test void b04b_enum() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B04b.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match one of the expected values.  Must be one of the following:  X, Y", ()->s.validateInput("Z"));
	...
	@Test void b04c_enum_json() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B04c.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match one of the expected values.  Must be one of the following:  X, Y", ()->s.validateInput("Z"));
	...
	@Test void b04d_enum_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, B04d.class).build();
	...
	@Test void c01a_minmax_ints() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C01a.class).build();
	...
	@Test void c01b_minmax_ints_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C01b.class).build();
	...
	@Test void c02a_minmax_exclusive() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C02a.class).build();
	...
	@Test void c02b_minmax_exclusive_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C02b.class).build();
	...
	@Test void c03_minmax_floats() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C03a.class).build();
	...
	@Test void c03b_minmax_floats_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C03b.class).build();
	...
	@Test void c04a_minmax_floats_exclusive() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C04a.class).build();
	...
	@Test void c04b_minmax_floats_exclusive_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C04b.class).build();
	...
	@Test void c05a_multipleOf() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C05a.class).build();
	...
	@Test void c05b_multipleOf_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C05b.class).build();
	...
	@Test void c06a_multipleOf_floats() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C06a.class).build();
		s.validateOutput(0, BeanContext.DEFAULT);
		s.validateOutput(10.1f, BeanContext.DEFAULT);
	...
	@Test void c06b_multipleOf_floats_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, C06b.class).build();
	...
	@Test void d02a_minMaxItems_arrays() throws Exception {
		var s = HttpPartSchema.create().applyAll(Header.class, D02.class).build();
