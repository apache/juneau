...
class OpenApiPartSerializer_Test extends TestBase {
	...
	@Test void a02_outputValidations_emptyOutput() throws Exception {
		...
		assertEquals("", serialize(tNone().allowEmptyValue().build(), ""));
		assertThrowsWithMessage(SchemaValidationException.class, "Empty value not allowed.", ()->serialize(tNone().allowEmptyValue(false).build(), ""));
		assertThrowsWithMessage(SchemaValidationException.class, "Empty value not allowed.", ()->serialize(tNone().allowEmptyValue(false).build(), ""));
	...
	@Test void a03_outputValidations_pattern() throws Exception {
		...
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match expected pattern.  Must match pattern: x.*", ()->serialize(ps, "y"));
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match expected pattern.  Must match pattern: x.*", ()->serialize(ps, ""));
	...
	@Test void a05_outputValidations_minMaxLength() throws Exception {
		...
		assertThrowsWithMessage(SchemaValidationException.class, "Minimum length of value not met.", ()->serialize(ps, ""));
		assertThrowsWithMessage(SchemaValidationException.class, "Maximum length of value exceeded.", ()->serialize(ps, "123"));
	}
	...
	@Test void c06_stringType_dateFormat() throws Exception {
		var ps = T_DATE;
		var in = opt("2012-12-21").filter(x1 -> ! isBlank(x1)).map(x -> GranularZonedDateTime.of("2012-12-21").getZonedDateTime()).map(GregorianCalendar::from).orElse(null);
	...
	@Test void c07_stringType_dateTimeFormat() throws Exception {
		var ps = T_DATETIME;
		var in = opt("2012-12-21T12:34:56.789").filter(x1 -> ! isBlank(x1)).map(x -> GranularZonedDateTime.of("2012-12-21T12:34:56.789").getZonedDateTime()).map(GregorianCalendar::from).orElse(null);
		assertTrue(serialize(ps, in).contains("2012"));
		assertEquals("null", serialize(ps, null));
	}
	...
	@Test void h01_objectType() throws Exception {
		...
		assertEquals("f1=1,f2=2,f3=true", serialize(ps, Json5Map.ofString("{f1:'1',f2:2,f3:true}")));
		assertEquals("f1=null,f2=null,f3=null", serialize(ps, Json5Map.ofString("{f1:null,f2:null,f3:null}")));
		assertEquals("null", serialize(ps, null));
	}
	...
	@Test void h03_objectType_2d() throws Exception {
		...
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=null\\,f2=null\\,f3=null,null", serialize(ps, a(Json5Map.ofString("{f1:'1',f2:2,f3:true}"),Json5Map.ofString("{f1:null,f2:null,f3:null}"),null)));
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=null\\,f2=null\\,f3=null,null", serialize(ps, l(Json5Map.ofString("{f1:'1',f2:2,f3:true}"),Json5Map.ofString("{f1:null,f2:null,f3:null}"),null)));
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=1\\,f2=2\\,f3=true,null", serialize(ps, ao(new H1("1",2,true),Json5Map.ofString("{f1:'1',f2:2,f3:true}"),null)));
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=1\\,f2=2\\,f3=true,null", serialize(ps, l(new H1("1",2,true),Json5Map.ofString("{f1:'1',f2:2,f3:true}"),null)));
	}
	...
	@Test void h03_objectType_3d() throws Exception {
		...
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=4\\\\\\,f3=false,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, a(a(Json5Map.ofString("{f1:'1',f2:2,f3:true}"),Json5Map.ofString("{f1:'x',f2:4,f3:false}")),a(Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=4\\\\\\,f3=false,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, l(a(Json5Map.ofString("{f1:'1',f2:2,f3:true}"),Json5Map.ofString("{f1:'x',f2:4,f3:false}")),a(Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=4\\\\\\,f3=false,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, l(l(Json5Map.ofString("{f1:'1',f2:2,f3:true}"),Json5Map.ofString("{f1:'x',f2:4,f3:false}")),l(Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=1\\\\\\,f2=2\\\\\\,f3=true,\\,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, a2(ao(new H1("1",2,true),Json5Map.ofString("{f1:'1',f2:2,f3:true}")),ao(new H1(null,null,null),Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=1\\\\\\,f2=2\\\\\\,f3=true,\\,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, l(ao(new H1("1",2,true),Json5Map.ofString("{f1:'1',f2:2,f3:true}")),ao(new H1(null,null,null),Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=1\\\\\\,f2=2\\\\\\,f3=true,\\,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, l(l(new H1("1",2,true),Json5Map.ofString("{f1:'1',f2:2,f3:true}")),l(new H1(null,null,null),Json5Map.ofString("{f1:null,f2:null,f3:null}"),null),null)));
	}
...
//f1=1,f2=2,f3=true|f1=x,f2=3,f3=false null null
	...
	@Test void h04_objectType_simpleProperties() throws Exception {
		...
		assertEquals(
			...
			serialize(ps, new H2("foo",foob,opt("2012-12-21T12:34:56Z").filter(x1 -> ! isBlank(x1)).map(x -> GranularZonedDateTime.of("2012-12-21T12:34:56Z").getZonedDateTime()).map(GregorianCalendar::from).orElse(null),foob,foob,"foo",1,2,1.0,1.0,true,1))
		);
		assertEquals("", serialize(ps, new H2(null,null,null,null,null,null,null,null,null,null,null,null)));
		assertEquals("null", serialize(ps, null));
		assertEquals(
			"f01=foo,f02=Zm9v,f04=2012-12-21T12:34:56Z,f05=666F6F,f06=66 6F 6F,f07=foo,f08=1,f09=2,f10=1.0,f11=1.0,f12=true,f99=1",
			serialize(ps, JsonMap.of("f01","foo","f02",foob,"f04",opt("2012-12-21T12:34:56Z").filter(x11 -> ! isBlank(x11)).map(x2 -> GranularZonedDateTime.of("2012-12-21T12:34:56Z").getZonedDateTime()).map(GregorianCalendar::from).orElse(null),"f05",foob,"f06",foob,"f07","foo","f08",1,"f09",2,"f10",1.0,"f11",1.0,"f12",true,"f99",1))
		);
	}
	...
	@Test void i01b_noSchemaTests_IntegerArray() throws Exception {
		assertEquals("1,2147483647,-2147483648", serialize((HttpPartSchema)null, a(Integer.valueOf(1), Integer.MAX_VALUE, Integer.MIN_VALUE)));
	}
	...
	@Test void i02b_noSchemaTests_ShortArray() throws Exception {
		assertEquals("1,32767,-32768,null", serialize((HttpPartSchema)null, a(Short.valueOf((short)1), Short.MAX_VALUE, Short.MIN_VALUE, null)));
	}
	...
	@Test void i03b_noSchemaTests_LongArray() throws Exception {
		assertEquals("1,9223372036854775807,-9223372036854775808,null", serialize((HttpPartSchema)null, a(Long.valueOf(1), Long.MAX_VALUE, Long.MIN_VALUE, null)));
	}
	...
	@Test void i04b_noSchemaTests_FloatArray() throws Exception {
		assertEquals("1.0,3.4028235E38,1.4E-45", serialize((HttpPartSchema)null, a(Float.valueOf(1f), Float.MAX_VALUE, Float.MIN_VALUE)));
	}
	...
	@Test void i05b_noSchemaTests_DoubleArray() throws Exception {
		assertEquals("1.0,1.7976931348623157E308,4.9E-324", serialize((HttpPartSchema)null, a(Double.valueOf(1), Double.MAX_VALUE, Double.MIN_VALUE)));
	}
	...
	@Test void i06b_noSchemaTests_BooleanArray() throws Exception {
		assertEquals("true,false,null", serialize((HttpPartSchema)null, a(Boolean.TRUE, Boolean.FALSE, null)));
	}
	...
	@Test void i08b_noSchemaTests_StringArray() throws Exception {
		assertEquals("foo,,null", serialize((HttpPartSchema)null, a("foo", "", null)));
	}
}