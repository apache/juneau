...
public class OpenApiPartSerializer_Test {
	...
	public void a01_outputValidations_nullOutput() throws Exception {
		...
		assertThrown(()->serialize(tNone().required().build(), null)).message().is("Required value not provided.");
		assertThrown(()->serialize(tNone().required(true).build(), null)).message().is("Required value not provided.");
	}
	...
	public void a02_outputValidations_emptyOutput() throws Exception {
		...
		assertEquals("", serialize(tNone().allowEmptyValue().build(), ""));
		assertThrown(()->serialize(tNone().allowEmptyValue(false).build(), "")).message().is("Empty value not allowed.");
		assertThrown(()->serialize(tNone().allowEmptyValue(false).build(), "")).message().is("Empty value not allowed.");
	...
	public void a03_outputValidations_pattern() throws Exception {
		...
		assertThrown(()->serialize(ps, "y")).message().is("Value does not match expected pattern.  Must match pattern: x.*");
		assertThrown(()->serialize(ps, "")).message().is("Value does not match expected pattern.  Must match pattern: x.*");
	...
	public void a04_outputValidations_enum() throws Exception {
		...
		assertThrown(()->serialize(ps, "bar")).message().is("Value does not match one of the expected values.  Must be one of the following:  foo");
		assertThrown(()->serialize(ps, "")).message().is("Value does not match one of the expected values.  Must be one of the following:  foo");
	...
	public void a05_outputValidations_minMaxLength() throws Exception {
		...
		assertThrown(()->serialize(ps, "")).message().is("Minimum length of value not met.");
		assertThrown(()->serialize(ps, "123")).message().is("Maximum length of value exceeded.");
	}
	...
	public void c10_stringType_noneFormat_2d() throws Exception {
		...
		assertEquals("foo,bar,null", serialize(ps, AList.of("foo","bar",null)));
		assertEquals("foo,bar,null", serialize(ps, new Object[]{"foo","bar",null}));
		assertEquals("foo,bar,null", serialize(ps, AList.of((Object)"foo",(Object)"bar",null)));
		assertEquals("foo,bar,null,null", serialize(ps, new C2[]{new C2("foo"),new C2("bar"),new C2(null),null}));
		assertEquals("foo,bar,null,null", serialize(ps, AList.of(new C2("foo"),new C2("bar"),new C2(null),null)));
	...
	public void c11_stringType_noneFormat_3d() throws Exception {
		...
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(new String[]{"foo","bar"}, new String[]{"baz",null},null)));
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(AList.of("foo","bar"),AList.of("baz",null),null)));
		assertEquals("foo,bar|baz,null|null", serialize(ps, new Object[][]{{"foo","bar"},{"baz",null},null}));
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(new Object[]{"foo","bar"}, new String[]{"baz",null},null)));
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(AList.of((Object)"foo",(Object)"bar"),AList.of((Object)"baz",null),null)));
		assertEquals("foo,bar|baz,null,null|null", serialize(ps, new C2[][]{{new C2("foo"),new C2("bar")},{new C2("baz"),new C2(null),null},null}));
		assertEquals("foo,bar|baz,null,null|null", serialize(ps, AList.of(new C2[]{new C2("foo"),new C2("bar")}, new C2[]{new C2("baz"),new C2(null),null},null)));
		assertEquals("foo,bar|baz,null,null|null", serialize(ps, AList.of(AList.of(new C2("foo"),new C2("bar")),AList.of(new C2("baz"),new C2(null),null),null)));
		assertEquals("foo,bar|baz,null|null|null", serialize(ps, new C3[]{new C3("foo","bar"),new C3("baz",null),new C3((String)null),null}));
		assertEquals("foo,bar|baz,null|null|null", serialize(ps, AList.of(new C3("foo","bar"),new C3("baz",null),new C3((String)null),null)));
	}
	...
	public void d01_arrayType_collectionFormatCsv() throws Exception {
		...
		assertEquals("foo,bar,null", serialize(ps, AList.of("foo","bar",null)));
		assertEquals("foo,bar,null", serialize(ps, AList.of("foo","bar",null)));
		assertEquals("foo,bar,null,null", serialize(ps, AList.of(new D("foo"),new D("bar"),new D(null),null)));
	...
	public void d05_arrayType_collectionFormatUon() throws Exception {
		...
		assertEquals("@(foo,bar,'null',null)", serialize(ps, new D[]{new D("foo"),new D("bar"),new D("null"),null}));
		assertEquals("@(foo,bar,'null',null)", serialize(ps, AList.of("foo","bar","null",null)));
		assertEquals("@(foo,bar,'null',null)", serialize(ps, AList.of("foo","bar","null",null)));
		assertEquals("@(foo,bar,'null',null)", serialize(ps, AList.of(new D("foo"),new D("bar"),new D("null"),null)));
	...
	public void d08_arrayType_collectionFormatCsvAndPipes() throws Exception {
		...
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(AList.of("foo","bar"),AList.of("baz",null),null)));
		assertEquals("foo,bar|baz,null|null", serialize(ps, AList.of(AList.of("foo","bar"),AList.of("baz",null),null)));
		assertEquals("foo,bar|baz,null,null|null", serialize(ps, AList.of(AList.of(new D("foo"),new D("bar")),AList.of(new D("baz"),new D(null),null),null)));
	}
	...
	public void d09_arrayType_itemsInteger() throws Exception {
		...
		assertEquals("1,2,null", serialize(ps, AList.of(1,2,null)));
	}
	...
	public void e03_booleanType_2d() throws Exception {
		...
		assertEquals("true,null", serialize(ps, AList.of(true,null)));
		...
		assertEquals("true,null,null", serialize(ps, AList.of(new E1(true),new E1(null),null)));
	...
	public void e04_booleanType_3d() throws Exception {
		...
		assertEquals("true,true|false", serialize(ps, AList.of(new boolean[]{true,true},new boolean[]{false})));
		assertEquals("true,true|false,null", serialize(ps, new Boolean[][]{{true,true},{false,null}}));
		assertEquals("true,true|false,null", serialize(ps, AList.of(new Boolean[]{true,true},new Boolean[]{false,null})));
		assertEquals("true,true|false,null", serialize(ps, AList.of(AList.of(true,true),AList.of(false,null))));
		assertEquals("true,true|false,null,null", serialize(ps, AList.of(AList.of("true","true"),AList.of("false","null",null))));
		assertEquals("true,true|false,null,null", serialize(ps, AList.of(new String[]{"true","true"},new String[]{"false","null",null})));
		assertEquals("true,true|false,null", serialize(ps, new Object[][]{{true,true},{false,null}}));
		assertEquals("true,true|false,null", serialize(ps, AList.of(AList.of((Object)true,(Object)true),AList.of((Object)false,null))));
		assertEquals("true,true|false,null", serialize(ps, AList.of(new Object[]{true,true},new Object[]{false,null})));
		assertEquals("true,true|false,null", serialize(ps, new E1[][]{{new E1(true),new E1(true)},{new E1(false),new E1(null)}}));
		assertEquals("true,true|false,null", serialize(ps, AList.of(AList.of(new E1(true),new E1(true)), AList.of(new E1(false),new E1(null)))));
		assertEquals("true,true|false,null", serialize(ps, AList.of(new E1[]{new E1(true),new E1(true)},new E1[]{new E1(false),new E1(null)})));
		assertEquals("true,true|false,null", serialize(ps, new E2[]{new E2(true,true),new E2(false,null)}));
		assertEquals("true,true|false,null", serialize(ps, AList.of(new E2(true,true),new E2(false,null))));
	}
	...
	public void f02_integerType_int32_2d() throws Exception {
		...
		assertEquals("1,2,null", serialize(ps, AList.of(new Short((short)1),new Short((short)2),null)));
		assertEquals("1,2", serialize(ps, new long[]{1l,2l}));
		assertEquals("1,2,null", serialize(ps, new Long[]{1l,2l,null}));
		assertEquals("1,2,null", serialize(ps, AList.of(1l,2l,null)));
		assertEquals("1,2,null,null", serialize(ps, new String[]{"1","2","null",null}));
		assertEquals("1,2,null,null", serialize(ps, AList.of("1","2","null",null)));
		assertEquals("1,2,null", serialize(ps, new Object[]{1,2,null}));
		assertEquals("1,2,null", serialize(ps, AList.of(1,2,null)));
		assertEquals("1,2,null,null", serialize(ps, new F1[]{new F1(1),new F1(2),new F1(null),null}));
		assertEquals("1,2,null,null", serialize(ps, AList.of(new F1(1),new F1(2),new F1(null),null)));
	...
	public void f03_integerType_int32_3d() throws Exception {
		...
		assertEquals("1,2|3|null", serialize(ps, AList.of(new int[]{1,2},new int[]{3},null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Integer[][]{{1,2},{3,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Integer[]{1,2},new Integer[]{3,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of(1,2),AList.of(3,null),null)));
		assertEquals("1,2|3|null", serialize(ps, new short[][]{{1,2},{3},null}));
		assertEquals("1,2|3|null", serialize(ps, AList.of(new short[]{1,2},new short[]{3},null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Short[][]{{1,2},{3,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Short[]{1,2},new Short[]{3,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of(new Short((short)1),new Short((short)2)),AList.of(new Short((short)3),null),null)));
		assertEquals("1,2|3|null", serialize(ps, new long[][]{{1l,2l},{3l},null}));
		assertEquals("1,2|3|null", serialize(ps, AList.of(new long[]{1l,2l},new long[]{3l},null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Long[][]{{1l,2l},{3l,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Long[]{1l,2l},new Long[]{3l,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of(new Long(1),new Long(2)),AList.of(new Long(3),null),null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, new String[][]{{"1","2"},{"3","null",null},null}));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(new String[]{"1","2"},new String[]{"3","null",null},null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(AList.of("1","2"),AList.of("3","null",null),null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Object[][]{{1,2},{3,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Object[]{1,2},new Object[]{3,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of(1,2),AList.of(3,null),null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, new F1[][]{{new F1(1),new F1(2)},{new F1(3),new F1(null),null},null}));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(new F1[]{new F1(1),new F1(2)},new F1[]{new F1(3),new F1(null),null},null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(AList.of(new F1(1),new F1(2)),AList.of(new F1(3),new F1(null),null),null)));
		assertEquals("1,2|3,null|null", serialize(ps, new F2[]{new F2(1,2),new F2(3,null),null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new F2(1,2),new F2(3,null),null)));
	}
	...
	public void f05_integerType_int64_2d() throws Exception {
		...
		assertEquals("1,2", serialize(ps, new short[]{1,2}));
		assertEquals("1,2,null", serialize(ps, new Short[]{1,2,null}));
		assertEquals("1,2,null", serialize(ps, AList.of((short)1,(short)2,null)));
		assertEquals("1,2", serialize(ps, new long[]{1l,2l}));
		assertEquals("1,2,null", serialize(ps, new Long[]{1l,2l,null}));
		assertEquals("1,2,null", serialize(ps, AList.of(1l,2l,null)));
		assertEquals("1,2,null,null", serialize(ps, new String[]{"1","2","null",null}));
		assertEquals("1,2,null,null", serialize(ps, AList.of("1","2","null",null)));
		assertEquals("1,2,null", serialize(ps, new Object[]{1,2,null}));
		assertEquals("1,2,null", serialize(ps, AList.of((Object)1,(Object)2,null)));
		assertEquals("1,2,null,null", serialize(ps, new F3[]{new F3(1l),new F3(2l),new F3(null),null}));
		assertEquals("1,2,null,null", serialize(ps, AList.of(new F3(1l),new F3(2l),new F3(null),null)));
	...
	public void f06_integerType_int64_3d() throws Exception {
		...
		assertEquals("1,2|3,null|null", serialize(ps, new Short[][]{{1,2},{3,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Short[]{1,2},new Short[]{3,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of((short)1,(short)2),AList.of((short)3,null),null)));
		assertEquals("1,2|3|null", serialize(ps, new long[][]{{1l,2l},{3l},null}));
		assertEquals("1,2|3|null", serialize(ps, AList.of(new long[]{1l,2l},new long[]{3l},null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Long[][]{{1l,2l},{3l,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Long[]{1l,2l},new Long[]{3l,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of(1l,2l),AList.of(3l,null),null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, new String[][]{{"1","2"},{"3","null",null},null}));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(new String[]{"1","2"},new String[]{"3","null",null},null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(AList.of("1","2"),AList.of("3","null",null),null)));
		assertEquals("1,2|3,null|null", serialize(ps, new Object[][]{{1,2},{3,null},null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new Object[]{1,2},new Object[]{3,null},null)));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(AList.of((Object)1,(Object)2),AList.of((Object)3,null),null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, new F3[][]{{new F3(1l),new F3(2l)},{new F3(3l),new F3(null),null},null}));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(new F3[]{new F3(1l),new F3(2l)},new F3[]{new F3(3l),new F3(null),null},null)));
		assertEquals("1,2|3,null,null|null", serialize(ps, AList.of(AList.of(new F3(1l),new F3(2l)),AList.of(new F3(3l),new F3(null),null),null)));
		assertEquals("1,2|3,null|null", serialize(ps, new F4[]{new F4(1l,2l),new F4(3l,null),null}));
		assertEquals("1,2|3,null|null", serialize(ps, AList.of(new F4(1l,2l),new F4(3l,null),null)));
	}
	...
	public void g02_numberType_float_2d() throws Exception {
		...
		assertEquals("1.0,2.0,null", serialize(ps, AList.of(1f,2f,null)));
		assertEquals("1.0,2.0", serialize(ps, new double[]{1,2}));
		assertEquals("1.0,2.0,null", serialize(ps, new Double[]{1d,2d,null}));
		assertEquals("1.0,2.0,null", serialize(ps, AList.of(1d,2d,null)));
		assertEquals("1.0,2.0,null,null", serialize(ps, new String[]{"1","2","null",null}));
		assertEquals("1.0,2.0,null,null", serialize(ps, AList.of("1","2","null",null)));
		assertEquals("1.0,2.0,null", serialize(ps, new Object[]{1,2,null}));
		assertEquals("1.0,2.0,null", serialize(ps, AList.of((Object)1,(Object)2,null)));
		assertEquals("1.0,2.0,null,null", serialize(ps, new G1[]{new G1(1f),new G1(2f),new G1(null),null}));
		assertEquals("1.0,2.0,null,null", serialize(ps, AList.of(new G1(1f),new G1(2f),new G1(null),null)));
	...
	public void g03_numberType_float_3d() throws Exception {
		...
		assertEquals("1.0,2.0|3.0|null", serialize(ps, AList.of(new float[]{1,2},new float[]{3},null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, new Float[][]{{1f,2f},{3f,null},null}));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(new Float[]{1f,2f},new Float[]{3f,null}, null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(AList.of(1f,2f),AList.of(3f,null),null)));
		assertEquals("1.0,2.0|3.0|null", serialize(ps, new double[][]{{1d,2d},{3d},null}));
		assertEquals("1.0,2.0|3.0|null", serialize(ps, AList.of(new double[]{1d,2d},new double[]{3d},null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, new Double[][]{{1d,2d},{3d,null},null}));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(new Double[]{1d,2d},new Double[]{3d,null},null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(AList.of(1d,2d),AList.of(3d,null),null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new String[][]{{"1","2"},{"3","null",null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new String[]{"1","2"},new String[]{"3","null",null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(AList.of(1d,2d),AList.of(3f,"null",null),null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new Object[][]{{1d,2d},{3f,"null",null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new Object[]{1d,2d},new Object[]{3f,"null",null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(AList.of(1d,2d),AList.of(3f,"null",null),null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new G1[][]{{new G1(1f),new G1(2f)},{new G1(3f),new G1(null),null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new G1[]{new G1(1f),new G1(2f)},new G1[]{new G1(3f),new G1(null),null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(AList.of(new G1(1f),new G1(2f)),AList.of(new G1(3f),new G1(null),null),null)));
		assertEquals("1.0,2.0,null|null", serialize(ps, new G2[]{new G2(1f,2f,null),null}));
		assertEquals("1.0,2.0,null|null", serialize(ps, AList.of(new G2(1f,2f,null),null)));
	}
	...
	public void g05_numberType_double_2d() throws Exception {
		...
		assertEquals("1.0,2.0,null,null", serialize(ps, AList.of(1d,2f,"null",null)));
		assertEquals("1.0,2.0,null,null", serialize(ps, new G3[]{new G3(1d),new G3(2d),new G3(null),null}));
		assertEquals("1.0,2.0,null,null", serialize(ps, AList.of(new G3(1d),new G3(2d),new G3(null),null)));
	...
	public void g06_numberType_double_3d() throws Exception {
		...
		assertEquals("1.0,2.0|3.0|null", serialize(ps, AList.of(new float[]{1f,2f},new float[]{3f},null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, new Float[][]{{1f,2f},{3f,null},null}));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(new Float[]{1f,2f},new Float[]{3f,null},null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(AList.of(1f,2f),AList.of(3f,null),null)));
		assertEquals("1.0,2.0|3.0|null", serialize(ps, new double[][]{{1d,2d},{3d},null}));
		...
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new String[][]{{"1","2"},{"3","null",null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new String[]{"1","2"},new String[]{"3","null",null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(AList.of("1","2"),AList.of("3","null",null),null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new Object[][]{{1d,2d},{"3","null",null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new Object[]{1d,2d},new Object[]{"3","null",null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.<Object>of(AList.of(1d,2f),AList.of(3d,"null",null),null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, new G3[][]{{new G3(1d),new G3(2d)},{new G3(3d),new G3(null),null},null}));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(new G3[]{new G3(1d),new G3(2d)},new G3[]{new G3(3d),new G3(null),null},null)));
		assertEquals("1.0,2.0|3.0,null,null|null", serialize(ps, AList.of(AList.of(new G3(1d),new G3(2d)),AList.of(new G3(3d),new G3(null),null),null)));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, new G4[]{new G4(1d,2d),new G4(3d,null),null}));
		assertEquals("1.0,2.0|3.0,null|null", serialize(ps, AList.of(new G4(1d,2d),new G4(3d,null),null)));
	}
	...
	public void h03_objectType_2d() throws Exception {
		...
		assertEquals("f1=1\\,f2=2\\,f3=true,,null", serialize(ps, AList.of(new H1("1",2,true),new H1(null,null,null),null)));
		...
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=null\\,f2=null\\,f3=null,null", serialize(ps, AList.of(OMap.ofJson("{f1:'1',f2:2,f3:true}"),OMap.ofJson("{f1:null,f2:null,f3:null}"),null)));
		...
		assertEquals("f1=1\\,f2=2\\,f3=true,f1=1\\,f2=2\\,f3=true,null", serialize(ps, AList.of(new H1("1",2,true),OMap.ofJson("{f1:'1',f2:2,f3:true}"),null)));
	}
	...
	public void h03_objectType_3d() throws Exception {
		...
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=3\\\\\\,f3=false,\\,null,null", serialize(ps, AList.of(new H1[]{new H1("1",2,true),new H1("x",3,false)},new H1[]{new H1(null,null,null),null},null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=3\\\\\\,f3=false,\\,null,null", serialize(ps, AList.of(AList.of(new H1("1",2,true),new H1("x",3,false)),AList.of(new H1(null,null,null),null),null)));
		...
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=4\\\\\\,f3=false,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, AList.of(new OMap[]{OMap.ofJson("{f1:'1',f2:2,f3:true}"),OMap.ofJson("{f1:'x',f2:4,f3:false}")},new OMap[]{OMap.ofJson("{f1:null,f2:null,f3:null}"),null},null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=x\\\\\\,f2=4\\\\\\,f3=false,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, AList.of(AList.of(OMap.ofJson("{f1:'1',f2:2,f3:true}"),OMap.ofJson("{f1:'x',f2:4,f3:false}")),AList.of(OMap.ofJson("{f1:null,f2:null,f3:null}"),null),null)));
		...
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=1\\\\\\,f2=2\\\\\\,f3=true,\\,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, AList.of(new Object[]{new H1("1",2,true),OMap.ofJson("{f1:'1',f2:2,f3:true}")},new Object[]{new H1(null,null,null),OMap.ofJson("{f1:null,f2:null,f3:null}"),null},null)));
		assertEquals("f1=1\\\\\\,f2=2\\\\\\,f3=true\\,f1=1\\\\\\,f2=2\\\\\\,f3=true,\\,f1=null\\\\\\,f2=null\\\\\\,f3=null\\,null,null", serialize(ps, AList.of(AList.of(new H1("1",2,true),OMap.ofJson("{f1:'1',f2:2,f3:true}")),AList.of(new H1(null,null,null),OMap.ofJson("{f1:null,f2:null,f3:null}"),null),null)));
	}
