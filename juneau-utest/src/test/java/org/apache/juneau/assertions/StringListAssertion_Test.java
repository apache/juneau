...
public class StringListAssertion_Test {
	...
	public void ba01a_asString() {
		List<String> x = ulist("1"), nil = null;
	...
	public void ba03_asJsonSorted() {
		List<String> x1 = ulist("2","1"), nil = null;
	...
	public void ba04_apply() {
		List<String> x1 = ulist("1"), x2 = ulist("2");
	...
	public void bc02_item() {
		List<String> x = ulist("a"), nil = null;
	...
	public void bc03a_sorted() {
		List<String> x = ulist("2","1"), nil = null;
	...
	public void bd01a_join() {
		List<String> x = ulist("1","2"), nil = null;
	...
	public void ca04a_is_T() {
		List<String> x1 = ulist("1"), x1a = ulist(new String("1")), x2 = ulist("2"), nil = null;
		test(x1).is(x1);
		test(x1).is(x1a);
		test(nil).is(nil);
	...
	public void ca09_isSameJsonAs() {
		List<String> x1 = ulist("1"), x1a = ulist("1"), x2 = ulist("2"), nil = null;
	...
	public void cb01_isEmpty() {
		List<String> x1 = ulist(), x2 = ulist("1"), nil = null;
		test(x1).isEmpty();
	...
	public void cc02_each() {
		List<String> x1 = ulist("1","2"), nil = null;
