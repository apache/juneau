...
class DateAssertion_Test extends TestBase {
	...
	@Test void cc02_isAfter() {
		...
		assertThrows(BasicAssertionError.class, ()->assertion17.isAfter(x2), "Value was null.");
	}
	...
	@Test void cc04_isBefore() {
		...
		assertThrows(BasicAssertionError.class, ()->assertion19.isBefore(x1), "Value was null.");
	}
