...
class Json_Test extends TestBase {
	...
	@Test void a01_to() throws Exception {
		...
		assertString(expected1, Json.of(in1));
		assertString(expected1, Json.of(in1,stringWriter()));
		assertString(expected2, Json.of(in2));
		assertString(expected2, Json.of(in2,stringWriter()));
	}
