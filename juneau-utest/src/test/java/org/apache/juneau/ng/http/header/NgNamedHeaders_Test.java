...
/**
 * Parametric tests over every concrete header class in {@code org.apache.juneau.ng.http.header}.
 *
 * <p>
...
class NgNamedHeaders_Test extends TestBase {
	...
	static Stream<Class<?>> headerClasses() throws Exception {
		return NgPackageScanner.enumerateConcreteClasses("org.apache.juneau.ng.http.header", HttpHeaderBean.class)
			.stream()
