...
class BeanStore_Test extends TestBase {
	...
	public static class A3 extends BasicBeanStore2 {
	...
	@Test void a00_dummy() {
		assertDoesNotThrow(BasicBeanStore2.Void::new);
	}

	@Test void a01_builderCopyConstructor() {
		var b1p = BasicBeanStore2.create().readOnly().threadSafe().build();
		var b1c = BasicBeanStore2.create().parent(b1p).build();
		assertContains("readOnly=true", b1c.toString());
		assertContains("threadSafe=true", b1c.toString());
	}

	@Test void a02_readOnly() {
		var b1p = BasicBeanStore2.create().readOnly().build();
		var b1c = BasicBeanStore2.create().parent(b1p).build();
		var b2p = BasicBeanStore2.create().readOnly().threadSafe().build();
		var b2c = BasicBeanStore2.create().parent(b1p).threadSafe().build();

		for (var b : array(b1p, b2p)) {
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.add(A1.class, a1a));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.add(A1.class, a1a, "foo"));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.addBean(A1.class, a1a));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.addBean(A1.class, a1a, "foo"));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.addSupplier(A1.class, ()->a1a));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", ()->b.addSupplier(A1.class, ()->a1a, "foo"));
			assertThrowsWithMessage(IllegalStateException.class, "Method cannot be used because BasicBeanStore2 is read-only.", b::clear);
		}
	...
	@Test void a04_addBean() {
		var b1p = BasicBeanStore2.create().build();
		var b1c = BasicBeanStore2.of(b1p);
		var b2p = BasicBeanStore2.create().threadSafe().build();
		var b2c = BasicBeanStore2.create().threadSafe().parent(b2p).build();
...
//			assertList(b.stream(A1.class).map(BasicBeanStore2.Entry::get), a1b, a1a);
//		}
//
...
//			assertList(b.stream(A2.class).map(BasicBeanStore2.Entry::get), a2a);
//		}
//
...
//			assertTrue(b.hasBean(A1.class));
//			assertEquals(a1a, b.getBean(A1.class).get());
//			assertList(b.stream(A1.class).map(BasicBeanStore2.Entry::get), a1a);
//		}
//
...
//		for (var b : array(b1p, b2p)) {
//			assertList(b.stream(A1.class).map(BasicBeanStore2.Entry::get), a1d,a1c,a1b,a1a);
//		}
//		for (var b : array(b1c, b2c)) {
//			assertList(b.stream(A1.class).map(BasicBeanStore2.Entry::get), a1e,a1d,a1c,a1b,a1a);
//		}
//
		for (var b : array(b1p, b1c, b2p, b2c)) {
	...
	public static class B1 {
		...
		public B1(A1 a1, Optional<A2> a2, BasicBeanStore2 a3) {
			this.a1 = a1;
			this.a2 = a2;
			this.a3 = a3;
		}
		...
		public void m1(A1 a1, Optional<A2> a2, BasicBeanStore2 a3) {
			this.a1 = a1;
			this.a2 = a2;
			this.a3 = a3;
		}
		...
		public static B1 m3(A1 a1, Optional<A2> a2, BasicBeanStore2 a3) {
	...
	@Test void b01_getParams() {
		...
		Predicate<Object> pIsBeanStore = BasicBeanStore2.class::isInstance;
		...
		var b1p = BasicBeanStore2.create().build().addBean(B1.class, outer);
		var b1c = BasicBeanStore2.create().parent(b1p).build();
		var b2p = BasicBeanStore2.create().threadSafe().build().addBean(B1.class, outer);
		var b2c = BasicBeanStore2.create().parent(b1p).threadSafe().build();

		var ci = ClassInfo.of(B1.class);
		var c1 = ci.getPublicConstructor(x -> x.hasParameterTypes(A1.class, Optional.class, BasicBeanStore2.class)).get();
	...
	public class B2 {
		...
		public B2(A1 a1, Optional<A2> a2, BasicBeanStore2 a3) {
			this.a1 = a1;
			this.a2 = a2;
			this.a3 = a3;
		}
	...
	@Test void b02_getParams_innerClass() {
		...
		var b1p = BasicBeanStore2.create().build().addBean(BeanStore_Test.class, this);
		var b1c = BasicBeanStore2.create().parent(b1p).build();
		var b2p = BasicBeanStore2.create().threadSafe().build().addBean(BeanStore_Test.class, this);
		var b2c = BasicBeanStore2.create().parent(b1p).threadSafe().build();

		var ci = ClassInfo.of(B2.class);
		var c1 = ci.getPublicConstructor(x -> x.hasParameterTypes(BeanStore_Test.class, A1.class, Optional.class, BasicBeanStore2.class)).get();
	...
	@Test void c00_createMethodFinder_invalidArgs() {
		var b = BasicBeanStore2.create().build();
//		assertThrowsWithMessage(IllegalArgumentException.class, "Method cannot be used without outer bean definition.", ()->new BeanCreateMethodFinder<>(null, b));
	...
	public static class C3 {
		...
		public static C createC6(BasicBeanStore2 bs) { assertNotNull(bs); return new C(); }
	}
	...
	@Test void d02_createBean_staticCreator_create() {
		var bs = BasicBeanStore2.INSTANCE;
	...
	@Test void d15_createBean_constructors_namedBean_withOuter() {
		var bs = BasicBeanStore2.create().build().addBean(BeanStore_Test.class, new BeanStore_Test());
