...
class Pre_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		var x1 = new Pre("a1", strong("a2"));
		assertString("<pre>a1<strong>a2</strong></pre>", x1);
