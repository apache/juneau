...
class Rb_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		var x1 = new Rb("a1", strong("a2"));
		assertString("<rb>a1<strong>a2</strong></rb>", x1);
