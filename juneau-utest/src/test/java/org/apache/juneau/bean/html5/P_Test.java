...
class P_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		P x1 = new P("a1", strong("a2"));
		assertString("<p>a1<strong>a2</strong></p>", x1);
