...
class I_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		I x1 = new I("a1", strong("a2"));
		assertString("<i>a1<strong>a2</strong></i>", x1);
