...
class U_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		U x1 = new U("a1", strong("a2"));
		assertString("<u>a1<strong>a2</strong></u>", x1);
