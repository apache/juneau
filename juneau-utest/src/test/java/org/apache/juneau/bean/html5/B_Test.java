...
class B_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		B x1 = new B("a1", strong("a2"));
		assertString("<b>a1<strong>a2</strong></b>", x1);
