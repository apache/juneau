...
class H4_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		var x1 = new H4("a1", strong("a2"));
		assertString("<h4>a1<strong>a2</strong></h4>", x1);
