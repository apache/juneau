...
class Q_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		Q x1 = new Q("a1", strong("a2"));
		assertString("<q>a1<strong>a2</strong></q>", x1);
