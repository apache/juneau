...
class H6_Test extends TestBase {
	...
	@Test void a03_otherConstructors() {
		var x1 = new H6("a1", strong("a2"));
		assertString("<h6>a1<strong>a2</strong></h6>", x1);
