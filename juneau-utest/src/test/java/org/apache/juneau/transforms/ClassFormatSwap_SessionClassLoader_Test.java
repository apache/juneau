...
class ClassFormatSwap_SessionClassLoader_Test extends TestBase {
	 ...
	 */
	private static final String ISOLATED_FQCN = "org.apache.juneau.test.isolated.IsolatedBean";
	...
	static void compileIsolatedBean() throws Exception {
		...
		Files.writeString(srcFile, "package org.apache.juneau.test.isolated; public class IsolatedBean {}");
