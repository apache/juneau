...
class Builder_ComboRoundTripTest extends ComboRoundTripTest_Base {
	...
	private static ComboRoundTrip_Tester<?>[] TESTERS = {
		tester(1, "A", A.class, new A(null).init())
			...
			.build(),
		tester(2, "B", B.class, new B(null).init())
			.json("{a:1}")
			.jsonT("{a:1}")
			.jsonR("{\n\ta: 1\n}")
			.xml("<object><a>1</a></object>")
			...
			.verify(x -> verify(x.createdByBuilder).isTrue())
			.build(),
		tester(3, "C", C.class, new C(null).init())
			.json("{a:1}")
			.jsonT("{a:1}")
			.jsonR("{\n\ta: 1\n}")
			.xml("<object><a>1</a></object>")
			...
			.verify(x -> verify(x.createdByBuilder).isTrue())
			.build(),
		tester(4, "D", D.class, new D(null).init())
			.json("{a:1}")
			.jsonT("{a:1}")
			.jsonR("{\n\ta: 1\n}")
			.xml("<object><a>1</a></object>")
			...
			.verify(x -> verify(x.createdByBuilder).isTrue())
			.build(),
		tester(5, "E", E.class, new E(null).init())
			.json("{a:1}")
			.jsonT("{a:1}")
			.jsonR("{\n\ta: 1\n}")
			.xml("<object><a>1</a></object>")
			...
			.verify(x -> verify(x.createdByBuilder).isTrue())
			.build(),
		tester(6, "H", H.class, new H(null).init())
			.json("{fooBar:1}")
			.jsonT("{fooBar:1}")
			.jsonR("{\n\tfooBar: 1\n}")
