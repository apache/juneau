...
class BeanDictionary_ComboRoundTripTest extends ComboRoundTripTest_Base {
	...
	private static final ComboRoundTrip_Tester<?>[] TESTERS = {
		...
		tester(3, "A[][][]", A[][][].class, a(a(a(new A().init(),null),null),null))
			.json5("[[[{_type:'A',a:1},null],null],null]")
			.json5T("[[[{t:'A',a:1},null],null],null]")
			.json5R("[\n\t[\n\t\t[\n\t\t\t{\n\t\t\t\t_type: 'A',\n\t\t\t\ta: 1\n\t\t\t},\n\t\t\tnull\n\t\t],\n\t\tnull\n\t],\n\tnull\n]")
		...
		tester(4, "List<A[][][]>", getType(List.class, A[][][].class), l(a(a(a(new A().init(),null),null),null),null))
			.json5("[[[[{_type:'A',a:1},null],null],null],null]")
			.json5T("[[[[{t:'A',a:1},null],null],null],null]")
			.json5R("[\n\t[\n\t\t[\n\t\t\t[\n\t\t\t\t{\n\t\t\t\t\t_type: 'A',\n\t\t\t\t\ta: 1\n\t\t\t\t},\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t],\n\tnull\n]")
		...
		tester(5, "Map<String,A[][][]>", getType(Map.class,String.class,A[][][].class), m("x", a(a(a(new A().init(),null),null),null)))
			.json5("{x:[[[{_type:'A',a:1},null],null],null]}")
			.json5T("{x:[[[{t:'A',a:1},null],null],null]}")
			.json5R("{\n\tx: [\n\t\t[\n\t\t\t[\n\t\t\t\t{\n\t\t\t\t\t_type: 'A',\n\t\t\t\t\ta: 1\n\t\t\t\t},\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t]\n}")
		...
		tester(6, "Map<String,List<A[][][]>>", getType(Map.class,String.class,List.class,A[][][].class), m("x",l(a(a(a(new A().init(),null),null),null),null)))
			.json5("{x:[[[[{_type:'A',a:1},null],null],null],null]}")
			.json5T("{x:[[[[{t:'A',a:1},null],null],null],null]}")
			.json5R("{\n\tx: [\n\t\t[\n\t\t\t[\n\t\t\t\t[\n\t\t\t\t\t{\n\t\t\t\t\t\t_type: 'A',\n\t\t\t\t\t\ta: 1\n\t\t\t\t\t},\n\t\t\t\t\tnull\n\t\t\t\t],\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t]\n}")
		...
		tester(15, "B[][][]", B[][][].class, a(a(a(new B().init(),null),null),null))
			.json5("[[[{z:'B',b:1},null],null],null]")
			.json5T("[[[{z:'B',b:1},null],null],null]")
			.json5R("[\n\t[\n\t\t[\n\t\t\t{\n\t\t\t\tz: 'B',\n\t\t\t\tb: 1\n\t\t\t},\n\t\t\tnull\n\t\t],\n\t\tnull\n\t],\n\tnull\n]")
		...
		tester(16, "List<B[][][]>", getType(List.class, B[][][].class), l(a(a(a(new B().init(),null),null),null),null))
			.json5("[[[[{z:'B',b:1},null],null],null],null]")
			.json5T("[[[[{z:'B',b:1},null],null],null],null]")
			.json5R("[\n\t[\n\t\t[\n\t\t\t[\n\t\t\t\t{\n\t\t\t\t\tz: 'B',\n\t\t\t\t\tb: 1\n\t\t\t\t},\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t],\n\tnull\n]")
		...
		tester(17, "Map<String,B[][][]>", getType(Map.class,String.class,B[][][].class), m("x",a(a(a(new B().init(),null),null),null)))
			.json5("{x:[[[{z:'B',b:1},null],null],null]}")
			.json5T("{x:[[[{z:'B',b:1},null],null],null]}")
			.json5R("{\n\tx: [\n\t\t[\n\t\t\t[\n\t\t\t\t{\n\t\t\t\t\tz: 'B',\n\t\t\t\t\tb: 1\n\t\t\t\t},\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t]\n}")
		...
		tester(18, "Map<String,List<B[][][]>>", getType(Map.class,String.class,List.class,B[][][].class), m("x",l(a(a(a(new B().init(),null),null),null),null)))
			.json5("{x:[[[[{z:'B',b:1},null],null],null],null]}")
			.json5T("{x:[[[[{z:'B',b:1},null],null],null],null]}")
			.json5R("{\n\tx: [\n\t\t[\n\t\t\t[\n\t\t\t\t[\n\t\t\t\t\t{\n\t\t\t\t\t\tz: 'B',\n\t\t\t\t\t\tb: 1\n\t\t\t\t\t},\n\t\t\t\t\tnull\n\t\t\t\t],\n\t\t\t\tnull\n\t\t\t],\n\t\t\tnull\n\t\t],\n\t\tnull\n\t]\n}")
