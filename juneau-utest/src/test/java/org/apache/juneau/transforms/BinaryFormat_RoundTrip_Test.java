 ...
 * 	<li>As a {@link List} element (exercises the {@code DefaultSwaps} {@link org.apache.juneau.swaps.BinarySwap}
 ...
 * the raw {@code byte[]} back to {@link org.apache.juneau.serializer.OutputStreamSerializerSession}
 ...
 * through the default-swap dispatch ({@link org.apache.juneau.swaps.BinarySwap}) which short-circuits to
...
class BinaryFormat_RoundTrip_Test extends TestBase {
	...
	// {@link org.apache.juneau.swaps.BinarySwap}, which honours {@link BinaryFormat} for text
