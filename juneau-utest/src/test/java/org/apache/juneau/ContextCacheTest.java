...
public class ContextCacheTest {
	...
	public void testBadConstructor() {
		ContextPropertiesBuilder cpb = ContextProperties.create();
		ContextProperties cp = cpb.build();
		assertThrown(()->ContextCache.INSTANCE.create(D1.class, cp)).message().is("Could not create instance of class 'org.apache.juneau.ContextCacheTest$D1'");
		assertThrown(()->ContextCache.INSTANCE.create(D2.class, cp)).message().is("Could not create instance of class 'org.apache.juneau.ContextCacheTest$D2'");
	}
