...
/**
 * Regression tests for path-traversal hardening in {@link BasicJspResource#render render(...)}.
 *
 * <p>
 ...
 * @since 9.5.0
 */
class BasicJspResource_PathTraversal_Test extends TestBase {
	...
	public static class A extends BasicRestServlet {
		...
		public BasicJspResource jsp() {
			return BasicJspResource.create().basePath("/WEB-INF/views/").build();
		}
	}
