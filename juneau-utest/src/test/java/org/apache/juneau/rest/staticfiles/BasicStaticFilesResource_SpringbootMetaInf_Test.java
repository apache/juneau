...
/**
 * Spring Boot {@code META-INF/resources/} bridge test for {@link BasicStaticFilesResource}.
 *
 * <p>
 ...
 *
 * <p>
 * Companion to {@link BasicStaticFilesResource_Springboot_Test} which exercises the default
 * classpath ({@code static/} + {@code htdocs/}) under the same Spring Boot wiring.
 *
 * @since 9.5.0
 */
@SpringBootTest(classes = BasicStaticFilesResource_SpringbootMetaInf_Test.TestApp.class,
