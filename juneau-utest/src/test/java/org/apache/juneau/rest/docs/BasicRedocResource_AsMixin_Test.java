...
/**
 * Validates {@link BasicRedocResource} mounted as a mixin.
 *
 * <p>
 * Acceptance:
 * <ul>
 * 	<li>Transitive resolution brings in {@link BasicOpenApiResource}: {@code /openapi}, {@code /openapi.json},
 ...
 * </ul>
 */
class BasicRedocResource_AsMixin_Test extends TestBase {
	...
	@Test void a06_subContextsConstructed() throws Exception {
		...
		assertNotNull(contexts.get(BasicRedocResource.class), "BasicRedocResource sub-context must be present");
		assertNotNull(contexts.get(BasicOpenApiResource.class), "BasicOpenApiResource sub-context must be transitively present");
	}
}
