...
/**
 * Validates {@link BasicSwaggerUiResource} mounted as a mixin.
 *
 * <p>
 * Acceptance:
 * <ul>
 * 	<li>Transitive resolution brings in {@link BasicSwaggerResource}: {@code /api} is mounted alongside
 * 		{@code /swagger}.
 ...
 * </ul>
 */
class BasicSwaggerUiResource_AsMixin_Test extends TestBase {
	...
	@Test void a04_subContextsConstructed() throws Exception {
		...
		assertNotNull(contexts.get(BasicSwaggerUiResource.class), "BasicSwaggerUiResource sub-context must be present");
		assertNotNull(contexts.get(BasicSwaggerResource.class), "BasicSwaggerResource sub-context must be transitively present");
	}
}
