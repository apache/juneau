 ...
 *
 * <p>
 * Mirrors {@code BasicJspResource_PathTraversal_Test}: the handler must reject any user-supplied
...
class BasicThymeleafResource_PathTraversal_Test extends TestBase {
	...
	public static class A extends BasicRestServlet {
		...
		public BasicThymeleafResource thymeleaf() {
			return BasicThymeleafResource.create().basePath("/templates/").build();
		}
	}
