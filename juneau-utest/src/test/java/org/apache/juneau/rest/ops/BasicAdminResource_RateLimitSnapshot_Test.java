...
/**
 * Validates that {@link BasicAdminResource#getRateLimit} on the {@code /admin/ratelimit} endpoint
 * surfaces both static {@code config} and live {@code snapshot} bucket state when a
 * {@link RateLimitGuard} is registered.
 *
 * <p>
 * Builds on {@code BasicAdminResource_AsMixin_Test}'s {@code c01_rateLimitListsRegisteredGuard}
...
class BasicAdminResource_RateLimitSnapshot_Test extends TestBase {
	...
	// same instance BasicAdminResource resolves from the bean store. The @Bean RateLimitGuard
