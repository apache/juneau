 ...
 *
 * <p>
 * The host below mounts both {@link BasicStaticFilesResource} (static-file serving) and
 * {@link BasicOpenApiResource} (OpenAPI generator) as mixins on a vanilla {@link RestServlet}
...
class BasicStaticFilesResource_OpenApiHidden_Test extends TestBase {
	 ...
	 */
	@Rest(
		mixins={BasicStaticFilesResource.class, BasicOpenApiResource.class},
	...
	@Test void a01_openapiSpecExcludesStaticPaths() throws Exception {
		// /openapi.json is format-pinned to JSON regardless of Accept (per BasicOpenApiResource);
	 ...
	 * the api-docs mixin pack inherited and no explicit {@link BasicStaticFilesResource}. The
