...
class NoInherit_Test extends TestBase {
	...
	private static RestContext restContext(Class<? extends BasicRestObject> c) throws Exception {
		...
		return new RestContext(new RestContext.Args(c, parentContext, null, () -> o, "", null, null, null)).postInit().postInitChildFirst();
	}
	...
	void a06_restOp_noInherit_defaultCharset_skipsContextCharset() throws Exception {
		...
		var ctx = new RestContext(new RestContext.Args(CharsetNoInheritPlain.class, null, null, () -> o, "", null, null, null)).postInit().postInitChildFirst();
	...
	void a07_restOp_withoutNoInherit_defaultCharset_inheritsContext() throws Exception {
		...
		var ctx = new RestContext(new RestContext.Args(CharsetInheritPlain.class, null, null, () -> o, "", null, null, null)).postInit().postInitChildFirst();
		var op = ctx.getRestOperations().getOpContexts().get(0);
	...
	void a08_restOp_noInherit_maxInput_skipsContextMaxInput() throws Exception {
		...
		var ctx = new RestContext(new RestContext.Args(MaxNoInheritPlain.class, null, null, () -> o, "", null, null, null)).postInit().postInitChildFirst();
		var op = ctx.getRestOperations().getOpContexts().get(0);
	...
	void a09_restOp_withoutNoInherit_maxInput_inheritsContext() throws Exception {
		...
		var ctx = new RestContext(new RestContext.Args(MaxInheritPlain.class, null, null, () -> o, "", null, null, null)).postInit().postInitChildFirst();
		var op = ctx.getRestOperations().getOpContexts().get(0);
