 ...
 * {@link ServletRegistrationBean}, supplies a Spring {@code @Bean BasicEchoResource}, and hits
 ...
 * 		{@code @Bean BasicEchoResource} during the FINISHED-72 mixin walk through
...
class BasicEchoResource_Springboot_Test {
	...
	public static class TestApp {
		...
		@Bean public BasicEchoResource echoResource() {
			return BasicEchoResource.create().bodyLimit(2048L).build();
		}
	}
