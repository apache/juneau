...
/**
 * Validates {@link BasicWellKnownResource} mounted as a mixin via {@code @Rest(mixins=...)} on a
 ...
 * 	<li>Importer's {@code @Bean BasicWellKnownResource} factory drives the body content.
