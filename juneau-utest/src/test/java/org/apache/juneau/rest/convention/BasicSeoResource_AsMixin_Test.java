...
/**
 * Validates {@link BasicSeoResource} mounted as a mixin via {@code @Rest(mixins=...)} on a vanilla
 * {@link RestServlet}.
 *
 * <p>
 * Cases:
 ...
 * 	<li>Importer's {@code @Bean BasicSeoResource} factory drives custom robots policy and sitemap
 * 		entries.
