...
/**
 * MockRest-level assertions for {@link BasicJspResource} composition + route wiring.
 *
 * <p>
 ...
 *
 * <p>
 * Real JSP rendering is exercised by {@code BasicJspResource_JettyMicroservice_Test} and
 * {@code BasicJspResource_Springboot_Test}, which boot real servlet containers with a JSP engine.
 *
 * @since 9.5.0
 */
class BasicJspResource_MockRest_Test extends TestBase {
