 ...
 * {@link FreemarkerMixin}.
 *
 * <p>
 * Apache FreeMarker renders directly to the response writer under MockRest (no servlet-container
 * deps), so we can verify the SVL substitution moved the mount point by asserting that the
 * default {@code /freemarker/*} no longer matches (404) while the overridden prefix does (200
 ...
 * @since 9.5.0
 */
class FreemarkerMixin_SvlPathOverride_Test extends TestBase {
