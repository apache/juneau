...
/**
 * Validates the {@code ${juneau.redoc.path:redoc}} SVL override on {@link BasicRedocResource}.
 *
 * <p>
 ...
 * @since 9.5.0
 */
class BasicRedocResource_SvlPathOverride_Test extends TestBase {
	...
	@Test void a01_svlOverrideChangesPath() throws Exception {
		...
		System.setProperty(key, "custom-redoc");
		try {
