...
public class RestOp_BeanConfig_Test {
	...
	public void a01_bpi() throws Exception {
		...
		a1.get("/a").json().run().assertContent().is("{\"a\":1,\"_b\":\"foo\"}");
		...
		a1.get("/a").uon().run().assertContent().is("(a=1,_b=foo)");
		a1.get("/a").urlEnc().run().assertContent().is("a=1&_b=foo");
		a1.get("/b").json().run().assertContent().is("{\"a\":1}");
		...
		a1.get("/b").uon().run().assertContent().is("(a=1)");
		a1.get("/b").urlEnc().run().assertContent().is("a=1");
		a1.get("/c").json().run().assertContent().is("{\"_b\":\"foo\"}");
		...
		a1.get("/c").uon().run().assertContent().is("(_b=foo)");
		a1.get("/c").urlEnc().run().assertContent().is("_b=foo");
	}
	...
	public void a02_bpx() throws Exception {
		...
		a2.get("/a").json().run().assertContent().is("{}");
		a2.get("/a").xml().run().assertContent().isContains("<object/>");
		a2.get("/a").html().run().assertContent().isContains("<table></table>");
		a2.get("/a").uon().run().assertContent().is("()");
		a2.get("/a").urlEnc().run().assertContent().is("");
		a2.get("/b").json().run().assertContent().is("{\"_b\":\"foo\"}");
		...
		a2.get("/b").uon().run().assertContent().is("(_b=foo)");
		a2.get("/b").urlEnc().run().assertContent().is("_b=foo");
		a2.get("/c").json().run().assertContent().is("{\"a\":1}");
		...
		a2.get("/c").uon().run().assertContent().is("(a=1)");
		a2.get("/c").urlEnc().run().assertContent().is("a=1");
	}
	...
	public void a03_bpi_overridesClass() throws Exception {
		...
		c.get("/a").json().run().assertContent().is("{\"a\":1,\"_b\":\"foo\"}");
		...
		c.get("/a").uon().run().assertContent().is("(a=1,_b=foo)");
		c.get("/a").urlEnc().run().assertContent().is("a=1&_b=foo");
		c.get("/b").json().run().assertContent().is("{\"a\":1}");
		...
		c.get("/b").uon().run().assertContent().is("(a=1)");
		c.get("/b").urlEnc().run().assertContent().is("a=1");
		c.get("/c").json().run().assertContent().is("{\"_b\":\"foo\"}");
		...
		c.get("/c").uon().run().assertContent().is("(_b=foo)");
		c.get("/c").urlEnc().run().assertContent().is("_b=foo");
	}
	...
	public void a04_bpx_overridesClass() throws Exception {
		...
		a4.get("/a").json().run().assertContent().is("{}");
		a4.get("/a").xml().run().assertContent().isContains("<object/>");
		a4.get("/a").html().run().assertContent().isContains("<table></table>");
		a4.get("/a").uon().run().assertContent().is("()");
		a4.get("/a").urlEnc().run().assertContent().is("");
		a4.get("/b").json().run().assertContent().is("{\"_b\":\"foo\"}");
		...
		a4.get("/b").uon().run().assertContent().is("(_b=foo)");
		a4.get("/b").urlEnc().run().assertContent().is("_b=foo");
		a4.get("/c").json().run().assertContent().is("{\"a\":1}");
		...
		a4.get("/c").uon().run().assertContent().is("(a=1)");
		a4.get("/c").urlEnc().run().assertContent().is("a=1");
	}
	...
	public void a05_bpi_metaMatching() throws Exception {
		...
		a5.get("/a").json().run().assertContent().is("{\"a\":1}");
		...
		a5.get("/a").uon().run().assertContent().is("(a=1)");
		a5.get("/a").urlEnc().run().assertContent().is("a=1");
	}
	...
	public void a06_bpi_fullyQualifiedClassNames() throws Exception {
		...
		a6.get("/a").json().run().assertContent().is("{\"a\":1}");
		...
		a6.get("/a").uon().run().assertContent().is("(a=1)");
		a6.get("/a").urlEnc().run().assertContent().is("a=1");
	}
	...
	public void a07_bpi_negativeMatching() throws Exception {
		...
		a7.get("/a").json().run().assertContent().is("{\"a\":1,\"_b\":\"foo\"}");
		...
		a7.get("/a").uon().run().assertContent().is("(a=1,_b=foo)");
		a7.get("/a").urlEnc().run().assertContent().is("a=1&_b=foo");
		a7.get("/b").json().run().assertContent().is("{\"a\":1,\"_b\":\"foo\"}");
		...
		a7.get("/b").uon().run().assertContent().is("(a=1,_b=foo)");
		a7.get("/b").urlEnc().run().assertContent().is("a=1&_b=foo");
	}
