...
class BsonAnnotation_Test extends org.apache.juneau.TestBase {
	...
	@org.apache.juneau.bson.Bson(description = "a")
	...
	void d01_comparisonWithDeclarativeAnnotations() {
		var d1 = D1.class.getAnnotationsByType(org.apache.juneau.bson.Bson.class)[0];
		var d2 = D2.class.getAnnotationsByType(org.apache.juneau.bson.Bson.class)[0];
