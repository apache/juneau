...
class InvalidXmlBeans_Test extends TestBase {
	...
	private static final Input[] INPUT = {
		...
		input(
			...
			"org.apache.juneau.marshall.xml.InvalidXmlBeansTest$BeanWithMultipleAttrs: Multiple instances of ATTRS properties defined on class.  Only one property can be designated as such."
		),
		input(
			"BeanWithWrongAttrsType",
			new BeanWithWrongAttrsType(),
			"org.apache.juneau.marshall.xml.InvalidXmlBeansTest$BeanWithWrongAttrsType: Invalid type for ATTRS property.  Only properties of type Map and bean can be used."
		),
		input(
		...
		input(
			...
			"org.apache.juneau.marshall.xml.InvalidXmlBeansTest$BeanWithMulipleMixed: Multiple instances of MIXED properties defined on class.  Only one property can be designated as such."
		),
		input(
			"BeanWithConflictingChildNames",
			new BeanWithConflictingChildNames(),
			"org.apache.juneau.marshall.xml.InvalidXmlBeansTest$BeanWithConflictingChildNames: Multiple properties found with the child name 'X'."
		),
		input(
		...
		input(
			...
			"org.apache.juneau.marshall.xml.InvalidXmlBeansTest$BeanWithChildAndPropNameConflict: Child element name conflicts found with another property."
		)
	};
	...
	private static class Input {
		...
		public Input(String label, Object in, String expected) {
			this.in = in;
			this.expected = expected;
		}
	}

	private static Input input(String label, Object in, String expected) {
