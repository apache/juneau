...
class HttpPartSchema_Path_Test extends TestBase {
	...
	@Test void a01_value() {
		var s = HttpPartSchema.create().applyAll(Path.class, A01.class).build();
	...
	@Test void b02a_pattern() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B02a.class).build();
		s.validateInput("x");
		s.validateInput("xx");
	...
	@Path @Schema(minl=2, maxl=3)
	public static class B03a {}

	@Test void b03a_length() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B03a.class).build();
		s.validateInput("12");
		s.validateInput("123");
	...
	@Test void b03b_length_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B03b.class).build();
	...
	@Test void b04a_enum() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B04a.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
	...
	@Test void b04b_enum() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B04b.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match one of the expected values.  Must be one of the following:  X, Y", ()->s.validateInput("Z"));
	...
	@Test void b04c_enum_json() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B04c.class).build();
		s.validateInput("X");
		s.validateInput("Y");
		s.validateInput(null);
		assertThrowsWithMessage(SchemaValidationException.class, "Value does not match one of the expected values.  Must be one of the following:  X, Y", ()->s.validateInput("Z"));
	...
	@Test void b04d_enum_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, B04d.class).build();
	...
	@Path @Schema(min="10", max="100")
	public static class C01a {}

	@Test void c01a_minmax_ints() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C01a.class).build();
		s.validateOutput(10);
	...
	@Test void c01b_minmax_ints_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C01b.class).build();
	...
	@Test void c02a_minmax_exclusive() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C02a.class).build();
		s.validateOutput(11);
		s.validateOutput(99);
		s.validateOutput(null);
	...
	@Test void c02b_minmax_exclusive_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C02b.class).build();
	...
	@Test void c03_minmax_floats() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C03a.class).build();
	...
	@Test void c03b_minmax_floats_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C03b.class).build();
	...
	@Test void c04a_minmax_floats_exclusive() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C04a.class).build();
	...
	@Test void c04b_minmax_floats_exclusive_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C04b.class).build();
	...
	@Test void c05a_multipleOf() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C05a.class).build();
		s.validateOutput(0);
		s.validateOutput(10);
		s.validateOutput(20);
	...
	@Test void c05b_multipleOf_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C05b.class).build();
	...
	@Test void c06a_multipleOf_floats() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C06a.class).build();
		s.validateOutput(0);
		s.validateOutput(10.1f);
	...
	@Test void c06b_multipleOf_floats_items() throws Exception {
		var s = HttpPartSchema.create().applyAll(Path.class, C06b.class).build();
