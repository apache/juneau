...
class UriTooLong_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws UriTooLong {
			throw new UriTooLong();
		}
		@RestGet
		public void f2() throws UriTooLong {
			throw new UriTooLong("foo %s", "bar");
		}
		@RestGet
		public void f3() throws UriTooLong {
			throw new UriTooLong(new RuntimeException("baz"));
		}
		@RestGet
		public void f4() throws UriTooLong {
			throw new UriTooLong(new RuntimeException("baz"), "foo %s", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new UriTooLong((Throwable)null);
		assertEquals(UriTooLong.REASON_PHRASE, x.getMessage());
	}
}
