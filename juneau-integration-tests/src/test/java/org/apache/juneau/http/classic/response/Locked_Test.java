...
import static org.apache.juneau.http.classic.response.Locked.*;
...
class Locked_Test extends TestBase {
	...
	public static class A {
		...
		public void f4() throws Locked {
			throw new Locked(new RuntimeException("baz"), "foo %s", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new Locked((Throwable)null);
		assertEquals(Locked.REASON_PHRASE, x.getMessage());
	}
}
