...
import static org.apache.juneau.http.classic.response.VariantAlsoNegotiates.*;
...
class VariantAlsoNegotiates_Test extends TestBase {

	@Rest
	public static class A {
		@RestGet
		public void f1() throws VariantAlsoNegotiates {
	...
	@Test void a02_nullCause() {
		var x = new VariantAlsoNegotiates((Throwable)null);
		assertEquals(VariantAlsoNegotiates.REASON_PHRASE, x.getMessage());
	}
}