...
import static org.apache.juneau.http.classic.response.NotImplemented.*;
...
class NotImplemented_Test extends TestBase {
	...
	public static class A {
		@RestGet
		public void f1() throws NotImplemented {
	...
	@Test void a02_nullCause() {
		var x = new NotImplemented((Throwable)null);
		assertEquals(NotImplemented.REASON_PHRASE, x.getMessage());
	}
}
