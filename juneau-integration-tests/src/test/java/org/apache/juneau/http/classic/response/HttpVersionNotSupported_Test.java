...
import static org.apache.juneau.http.classic.response.HttpVersionNotSupported.*;
...
class HttpVersionNotSupported_Test extends TestBase {
	...
	public static class A {
		...
		public void f2() throws HttpVersionNotSupported {
			throw new HttpVersionNotSupported("foo %s", "bar");
		}
		@RestGet
		...
		public void f4() throws HttpVersionNotSupported {
			throw new HttpVersionNotSupported(new RuntimeException("baz"), "foo %s", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new HttpVersionNotSupported((Throwable)null);
		assertEquals(HttpVersionNotSupported.REASON_PHRASE, x.getMessage());
	}
}
