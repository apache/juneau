...
class BasicEntityTagHeader_Test extends TestBase {
	...
	@Test void a03_factoryNullReturn() {
		assertNull(BasicEntityTagHeader.of("Foo", (EntityTag)null));
	}

	@Test void a04_orElseAndToEntityTag() {
		var h = new BasicEntityTagHeader("Foo", "\"bar\"");
		assertNotNull(h.orElse((EntityTag)null));
		assertNotNull(h.toEntityTag());

		// supplier returns null
		var h2 = new BasicEntityTagHeader("Foo", (Supplier<EntityTag>) () -> null);
		assertNull(h2.orElse((EntityTag)null));
