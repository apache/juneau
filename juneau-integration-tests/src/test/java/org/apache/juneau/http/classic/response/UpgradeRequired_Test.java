...
class UpgradeRequired_Test extends TestBase {
	...
	public static class A {
		...
		public void f2() throws UpgradeRequired {
			throw new UpgradeRequired("foo %s", "bar");
		}
		@RestGet
		...
		public void f4() throws UpgradeRequired {
			throw new UpgradeRequired(new RuntimeException("baz"), "foo %s", "bar");
		}
		@RestGet
	...
	@Test void a02_nullCause() {
		var x = new UpgradeRequired((Throwable)null);
		assertEquals(UpgradeRequired.REASON_PHRASE, x.getMessage());
	}
}
