 ...
 * {@link org.apache.juneau.rest.server.server.beans.RouteDescriptions} POJO rather than writing a fixed format, so the host's
 ...
 * browsable page with the route {@linkplain org.apache.juneau.rest.server.server.beans.RouteDescription#getPath() path} rendered as
