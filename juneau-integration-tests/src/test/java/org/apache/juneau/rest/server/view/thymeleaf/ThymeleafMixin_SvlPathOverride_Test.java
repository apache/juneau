 ...
 *
 * <p>
 * Thymeleaf renders directly to the response writer under MockRest (no servlet-container deps), so
 * we can verify the SVL substitution moved the mount point by asserting that the default
 * {@code /thymeleaf/*} no longer matches (404) while the overridden prefix does (200 with the
