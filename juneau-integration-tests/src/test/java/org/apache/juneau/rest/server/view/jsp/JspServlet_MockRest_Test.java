...
/**
 * MockRest-level assertions for the standalone {@link JspServlet} companion.
 *
 * <p>
 ...
 * through the shared {@link org.apache.juneau.rest.server.server.view.RawTemplateDispatcher RawTemplateDispatcher}
 * (the {@link JspMixin} delegate) &mdash; surfacing the no-engine diagnostic (500) rather
