...
class BasicSwaggerProviderSession_Coverage_Test extends TestBase {
	...
	public static class E1 {
		@RestGet(path="/exc")
		@SuppressWarnings({
			"unused" // Throws clause is required for swagger reflection via mi.getExceptionTypes(); removing it suppresses the 404 response entry in the generated swagger doc.
		})
