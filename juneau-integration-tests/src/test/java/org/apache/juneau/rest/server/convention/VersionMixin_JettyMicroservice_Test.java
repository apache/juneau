...
/**
 * Real-Jetty deployment-parity assertion for {@link VersionMixin}.
 *
 * <p>
 ...
 * with the version mixin and a {@code @Bean VersionMixin} factory configuring known
 ...
 * 	<li>JSON serialization through {@link org.apache.juneau.rest.server.server.RestResponse#getDirectWriter
 * 		getDirectWriter("application/json")} on a vanilla {@link RestServlet} host (no JSON
 * 		serializer wired up explicitly).
 * 	<li>Mixin-walk + bean-store override flow when {@code @Bean VersionMixin} is
...
class VersionMixin_JettyMicroservice_Test extends TestBase {
